forward
global type w_repacta_mora_mantencion_reprog_while from window
end type
type st_cliente_tercero from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_txt_saldo_ins from statictext within w_repacta_mora_mantencion_reprog_while
end type
type em_saldo_insoluto from statictext within w_repacta_mora_mantencion_reprog_while
end type
type cb_terceros from commandbutton within w_repacta_mora_mantencion_reprog_while
end type
type st_print_detalle from statictext within w_repacta_mora_mantencion_reprog_while
end type
type dw_print_ctto from datawindow within w_repacta_mora_mantencion_reprog_while
end type
type st_9 from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_factor from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_txt_valor_cta2 from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_val_cuota_uf2 from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_val_cuota_peso2 from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_txt_cob_adm from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_txt_valor_cta from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_val_cuota_uf from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_val_cuota_peso from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_val_interes_adm_uf from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_val_interes_adm_pesos from statictext within w_repacta_mora_mantencion_reprog_while
end type
type rb_calc_uf from radiobutton within w_repacta_mora_mantencion_reprog_while
end type
type rb_calc_pesos from radiobutton within w_repacta_mora_mantencion_reprog_while
end type
type st_6 from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_dscto from statictext within w_repacta_mora_mantencion_reprog_while
end type
type em_descuento from editmask within w_repacta_mora_mantencion_reprog_while
end type
type st_val_interes_tot_total from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_8 from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_7 from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_5 from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_val_interes_total from statictext within w_repacta_mora_mantencion_reprog_while
end type
type em_mora_cta from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_txt_total from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_moneda from statictext within w_repacta_mora_mantencion_reprog_while
end type
type em_moneda from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_uf_dia from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_monto_uf from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_deuda_uf from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_monto_en_uf from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_ctas_mant_pago from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_cta_txt from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_fecha_prox_pago from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_4 from statictext within w_repacta_mora_mantencion_reprog_while
end type
type cb_filtrar from commandbutton within w_repacta_mora_mantencion_reprog_while
end type
type cb_ordenar from commandbutton within w_repacta_mora_mantencion_reprog_while
end type
type cb_exportar from commandbutton within w_repacta_mora_mantencion_reprog_while
end type
type p_fec from picture within w_repacta_mora_mantencion_reprog_while
end type
type em_fecha from editmask within w_repacta_mora_mantencion_reprog_while
end type
type st_fec_cuo from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_txt_real from statictext within w_repacta_mora_mantencion_reprog_while
end type
type cb_grabar from commandbutton within w_repacta_mora_mantencion_reprog_while
end type
type st_cliente from statictext within w_repacta_mora_mantencion_reprog_while
end type
type em_cuotas from editmask within w_repacta_mora_mantencion_reprog_while
end type
type st_3 from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_numero from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_serie from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_base from statictext within w_repacta_mora_mantencion_reprog_while
end type
type st_2 from statictext within w_repacta_mora_mantencion_reprog_while
end type
type cb_proceso from commandbutton within w_repacta_mora_mantencion_reprog_while
end type
type st_1 from statictext within w_repacta_mora_mantencion_reprog_while
end type
type cb_cerrar from commandbutton within w_repacta_mora_mantencion_reprog_while
end type
type dw_detalle from datawindow within w_repacta_mora_mantencion_reprog_while
end type
type em_val_presente from statictext within w_repacta_mora_mantencion_reprog_while
end type
type em_gastos_adm from statictext within w_repacta_mora_mantencion_reprog_while
end type
type dw_lista from datawindow within w_repacta_mora_mantencion_reprog_while
end type
type cb_imprimir from commandbutton within w_repacta_mora_mantencion_reprog_while
end type
type gb_2 from groupbox within w_repacta_mora_mantencion_reprog_while
end type
type cb_eliminar from commandbutton within w_repacta_mora_mantencion_reprog_while
end type
type gb_1 from groupbox within w_repacta_mora_mantencion_reprog_while
end type
type gb_3 from groupbox within w_repacta_mora_mantencion_reprog_while
end type
end forward
...
global w_repacta_mora_mantencion_reprog_while w_repacta_mora_mantencion_reprog_while
...
on w_repacta_mora_mantencion_reprog_while.create
...
on w_repacta_mora_mantencion_reprog_while.destroy
...
integer height = 388
integer taborder = 90
string dataobject = "dw_print_contrato_c_parque_conce"
...
event clicked;long		ll_val_ctas,ll_suma_cta, ll_cta_mora,ll_rut,ll_tot_renta,ll_grupo_f,ll_rut_aux,ll_est_resp=0,ll_rut_cont=0,ll_row=0,ll_sum_ctas_pag,ll_cta_pag_isa, ll_cta_repacta,&
			ll_plazo,ll_cod_parque,ll_count_vig,ll_ctas_mora_mant,ll_cta_pag_m
...
String	ls_base_aux,ls_barra,ls_barra_aux, ls_num,ls_nom,ls_ap_pat,ls_ap_mat,ls_dir_p,ls_pob,ls_sec,ls_com,ls_ciu,ls_fono_p,ls_sexo,ls_est_civ,&
			...
			ls_estado_cadena,ls_base='R'
double	ld_val_cta_uf, ld_val_deuda_uf,ld_factor,ldb_valor_cuota,ldb_valor_cuota_mant,ldb_pie
...
Date		ld_fecha, ld_fecha_hoy,ld_fec_pago,ld_fecha_tope_pago,ldt_fec_prox_pago,ldt_fec_prox_pago1,ldt_fec_prox_pago2,ldt_fec_prox_pago5
...
//		il_monto								= dw_lista.getitemnumber(1,'total_deuda')  // VER
		...
		next
		dw_detalle.object.t_titulo.text		= 'Detalle Cuotas Reprogramación Nº:   R - '+is_serie+' - '+string(il_numero,"###,###,###,###,##0")+'-'+string(il_corr,"###,###,###,###,###")
...
//				il_monto								= long(st_val_interes_total.text)				// NUEVO
			...
			if ld_fec_pago >= ld_fecha_tope_pago then
				do while ld_fec_pago >= ld_fecha_tope_pago
					DECLARE sp_prox_pago5 PROCEDURE FOR sp_calcular_vencimiento( :ld_fecha_tope_pago, :ll_cant_mant );
					EXECUTE sp_prox_pago5;
					if sqlca.sqlcode=0 then
						fetch sp_prox_pago5 into :ldt_fec_prox_pago5 ;
						close sp_prox_pago5;
						if not isnull(ldt_fec_prox_pago5) then
							ld_fecha_tope_pago 	= ldt_fec_prox_pago5
							ii_cantidad++
							ll_sw_cta	++
						end if
					end if
   ...
   WHERE ( "REPACTA_MANTENCION"."BASE_ORIGINAL" = :ls_base_ori ) AND  
	...
	if ll_resp=1 then
		if is_base='C' and gs_conexion="Parque El Prado" then //sigue igual solo cambios
			if w_repacta_mora_mantencion_reprog.cb_terceros.italic=false then
