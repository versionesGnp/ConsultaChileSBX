forward
global type w_repacta_mora_mantencion_ok from window
end type
type st_cliente_tercero from statictext within w_repacta_mora_mantencion_ok
end type
type cb_terceros from commandbutton within w_repacta_mora_mantencion_ok
end type
type st_print_detalle from statictext within w_repacta_mora_mantencion_ok
end type
type dw_print_ctto from datawindow within w_repacta_mora_mantencion_ok
end type
type st_9 from statictext within w_repacta_mora_mantencion_ok
end type
type st_factor from statictext within w_repacta_mora_mantencion_ok
end type
type st_txt_valor_cta2 from statictext within w_repacta_mora_mantencion_ok
end type
type st_val_cuota_uf2 from statictext within w_repacta_mora_mantencion_ok
end type
type st_val_cuota_peso2 from statictext within w_repacta_mora_mantencion_ok
end type
type st_txt_cob_adm from statictext within w_repacta_mora_mantencion_ok
end type
type st_txt_valor_cta from statictext within w_repacta_mora_mantencion_ok
end type
type st_val_cuota_uf from statictext within w_repacta_mora_mantencion_ok
end type
type st_val_cuota_peso from statictext within w_repacta_mora_mantencion_ok
end type
type st_val_interes_adm_uf from statictext within w_repacta_mora_mantencion_ok
end type
type st_val_interes_adm_pesos from statictext within w_repacta_mora_mantencion_ok
end type
type rb_calc_uf from radiobutton within w_repacta_mora_mantencion_ok
end type
type rb_calc_pesos from radiobutton within w_repacta_mora_mantencion_ok
end type
type st_6 from statictext within w_repacta_mora_mantencion_ok
end type
type st_dscto from statictext within w_repacta_mora_mantencion_ok
end type
type em_descuento from editmask within w_repacta_mora_mantencion_ok
end type
type st_val_interes_tot_total from statictext within w_repacta_mora_mantencion_ok
end type
type st_8 from statictext within w_repacta_mora_mantencion_ok
end type
type st_7 from statictext within w_repacta_mora_mantencion_ok
end type
type st_5 from statictext within w_repacta_mora_mantencion_ok
end type
type st_val_interes_total from statictext within w_repacta_mora_mantencion_ok
end type
type em_val_total from statictext within w_repacta_mora_mantencion_ok
end type
type st_txt_total from statictext within w_repacta_mora_mantencion_ok
end type
type st_moneda from statictext within w_repacta_mora_mantencion_ok
end type
type em_moneda from statictext within w_repacta_mora_mantencion_ok
end type
type st_uf_dia from statictext within w_repacta_mora_mantencion_ok
end type
type st_monto_uf from statictext within w_repacta_mora_mantencion_ok
end type
type st_deuda_uf from statictext within w_repacta_mora_mantencion_ok
end type
type st_monto_en_uf from statictext within w_repacta_mora_mantencion_ok
end type
type st_ctas_mant_pago from statictext within w_repacta_mora_mantencion_ok
end type
type st_cta_txt from statictext within w_repacta_mora_mantencion_ok
end type
type st_fecha_prox_pago from statictext within w_repacta_mora_mantencion_ok
end type
type st_4 from statictext within w_repacta_mora_mantencion_ok
end type
type cb_filtrar from commandbutton within w_repacta_mora_mantencion_ok
end type
type cb_ordenar from commandbutton within w_repacta_mora_mantencion_ok
end type
type cb_exportar from commandbutton within w_repacta_mora_mantencion_ok
end type
type p_fec from picture within w_repacta_mora_mantencion_ok
end type
type em_fecha from editmask within w_repacta_mora_mantencion_ok
end type
type st_fec_cuo from statictext within w_repacta_mora_mantencion_ok
end type
type st_txt_real from statictext within w_repacta_mora_mantencion_ok
end type
type cb_grabar from commandbutton within w_repacta_mora_mantencion_ok
end type
type st_cliente from statictext within w_repacta_mora_mantencion_ok
end type
type em_cuotas from editmask within w_repacta_mora_mantencion_ok
end type
type st_3 from statictext within w_repacta_mora_mantencion_ok
end type
type st_numero from statictext within w_repacta_mora_mantencion_ok
end type
type st_serie from statictext within w_repacta_mora_mantencion_ok
end type
type st_base from statictext within w_repacta_mora_mantencion_ok
end type
type st_2 from statictext within w_repacta_mora_mantencion_ok
end type
type cb_proceso from commandbutton within w_repacta_mora_mantencion_ok
end type
type st_1 from statictext within w_repacta_mora_mantencion_ok
end type
type cb_cerrar from commandbutton within w_repacta_mora_mantencion_ok
end type
type dw_detalle from datawindow within w_repacta_mora_mantencion_ok
end type
type em_deuda from statictext within w_repacta_mora_mantencion_ok
end type
type em_val_interes from statictext within w_repacta_mora_mantencion_ok
end type
type dw_lista from datawindow within w_repacta_mora_mantencion_ok
end type
type cb_imprimir from commandbutton within w_repacta_mora_mantencion_ok
end type
type gb_2 from groupbox within w_repacta_mora_mantencion_ok
end type
type cb_eliminar from commandbutton within w_repacta_mora_mantencion_ok
end type
type gb_1 from groupbox within w_repacta_mora_mantencion_ok
end type
type gb_3 from groupbox within w_repacta_mora_mantencion_ok
end type
end forward
...
global w_repacta_mora_mantencion_ok w_repacta_mora_mantencion_ok
...
on w_repacta_mora_mantencion_ok.create
...
on w_repacta_mora_mantencion_ok.destroy
...
if st_val_interes_tot_total.text='' or st_val_interes_adm_uf.text='' or &
	...
	elseif ldb_pie > 0 and ldt_fecha_pie=date('01/01/1900') then
		...
		if sqlca.sqlcode=0 then
			...
			ld_saldo_finan	= ld_val_deuda_uf - ldb_pie
...
//		if ld_fecha_ini <= date(ldt_fecha_venc_mant) then // ld_fec_pago then
		if  ld_fec_pago > ld_fecha_tope_pago then // ld_fec_pago then
...
//						ii_cantidad++
//						ll_cant_mant_mas++
//						ll_anno_tope			= ll_anno_tope + 4
//						ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//						ld_fecha_tope_pago	= date(ls_fecha_tope)
//						if ld_fec_pago >= ld_fecha_tope_pago then 
//							ii_cantidad++
//							ll_cant_mant_mas++
//							ll_anno_tope			= ll_anno_tope + 5
//							ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//							ld_fecha_tope_pago	= date(ls_fecha_tope)
//							if ld_fec_pago >= ld_fecha_tope_pago then 
//								ii_cantidad++
//								ll_cant_mant_mas++
//								ll_anno_tope			= ll_anno_tope + 6
//								ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//								ld_fecha_tope_pago	= date(ls_fecha_tope)
//								if ld_fec_pago >= ld_fecha_tope_pago then 
//									ii_cantidad++
//									ll_cant_mant_mas++
//									ll_anno_tope			= ll_anno_tope + 7
//									ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//									ld_fecha_tope_pago	= date(ls_fecha_tope)
//									if ld_fec_pago >= ld_fecha_tope_pago then 
//										ii_cantidad++
//										ll_cant_mant_mas++
//										ll_anno_tope			= ll_anno_tope + 8
//										ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//										ld_fecha_tope_pago	= date(ls_fecha_tope)
//										if ld_fec_pago >= ld_fecha_tope_pago then 
//											ii_cantidad++
//											ll_cant_mant_mas++
//											ll_anno_tope			= ll_anno_tope + 9
//											ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//											ld_fecha_tope_pago	= date(ls_fecha_tope)
//											if ld_fec_pago >= ld_fecha_tope_pago then 
//												ii_cantidad++
//												ll_cant_mant_mas++
//												ll_anno_tope			= ll_anno_tope + 10
//												ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//												ld_fecha_tope_pago	= date(ls_fecha_tope)
//												if ld_fec_pago >= ld_fecha_tope_pago then 
//													ii_cantidad++
//													ll_cant_mant_mas++
//													ll_anno_tope			= ll_anno_tope + 11
//													ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//													ld_fecha_tope_pago	= date(ls_fecha_tope)
//													if ld_fec_pago >= ld_fecha_tope_pago then 
//														ii_cantidad++
//														ll_cant_mant_mas++
//														ll_anno_tope			= ll_anno_tope + 12
//														ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//														ld_fecha_tope_pago	= date(ls_fecha_tope)
//														if ld_fec_pago >= ld_fecha_tope_pago then 
//															ii_cantidad++
//															ll_cant_mant_mas++
//															ll_anno_tope			= ll_anno_tope + 13
//															ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//															ld_fecha_tope_pago	= date(ls_fecha_tope)
//															if ld_fec_pago >= ld_fecha_tope_pago then 
//																ii_cantidad++
//																ll_cant_mant_mas++
//																ll_anno_tope			= ll_anno_tope + 14
//																ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//																ld_fecha_tope_pago	= date(ls_fecha_tope)
//																if ld_fec_pago >= ld_fecha_tope_pago then 
//																	ii_cantidad++
//																	ll_cant_mant_mas++
//																	ll_anno_tope			= ll_anno_tope + 15
//																	ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//																	ld_fecha_tope_pago	= date(ls_fecha_tope)
//																	if ld_fec_pago >= ld_fecha_tope_pago then 
//																		ii_cantidad++
//																		ll_cant_mant_mas++
//																		ll_anno_tope			= ll_anno_tope + 16
//																		ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//																		ld_fecha_tope_pago	= date(ls_fecha_tope)
//																		if ld_fec_pago >= ld_fecha_tope_pago then 
//																			ii_cantidad++
//																			ll_cant_mant_mas++
//																			ll_anno_tope			= ll_anno_tope + 17
//																			ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//																			ld_fecha_tope_pago	= date(ls_fecha_tope)
//																			if ld_fec_pago >= ld_fecha_tope_pago then 
//																				ii_cantidad++
//																				ll_cant_mant_mas++
//																				ll_anno_tope			= ll_anno_tope + 18
//																				ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//																				ld_fecha_tope_pago	= date(ls_fecha_tope)
//																				if ld_fec_pago >= ld_fecha_tope_pago then 
//																					ii_cantidad++
//																					ll_cant_mant_mas++
//																					ll_anno_tope			= ll_anno_tope + 19
//																					ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//																					ld_fecha_tope_pago	= date(ls_fecha_tope)
//																					if ld_fec_pago >= ld_fecha_tope_pago then 
//																						ii_cantidad++
//																						ll_cant_mant_mas++
//																						ll_anno_tope			= ll_anno_tope + 20
//																						ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//																						ld_fecha_tope_pago	= date(ls_fecha_tope)
//																						if ld_fec_pago >= ld_fecha_tope_pago then 
//																							ii_cantidad++
//																							ll_cant_mant_mas++
//																							ll_anno_tope			= ll_anno_tope + 21
//																							ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//																							ld_fecha_tope_pago	= date(ls_fecha_tope)
//																							if ld_fec_pago >= ld_fecha_tope_pago then 
//																								ii_cantidad++
//																								ll_cant_mant_mas++
//																								ll_anno_tope			= ll_anno_tope + 22
//																								ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//																								ld_fecha_tope_pago	= date(ls_fecha_tope)
//																								if ld_fec_pago >= ld_fecha_tope_pago then 
//																									ii_cantidad++
//																									ll_cant_mant_mas++
//																									ll_anno_tope			= ll_anno_tope + 23
//																									ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//																									ld_fecha_tope_pago	= date(ls_fecha_tope)
//																									if ld_fec_pago >= ld_fecha_tope_pago then 
//																										ii_cantidad++
//																										ll_cant_mant_mas++
//																										ll_anno_tope			= ll_anno_tope + 24
//																										ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//																										ld_fecha_tope_pago	= date(ls_fecha_tope)
//																										if ld_fec_pago >= ld_fecha_tope_pago then 
//																											ii_cantidad++
//																											ll_cant_mant_mas++
//																											ll_anno_tope			= ll_anno_tope + 25
//																											ls_fecha_tope			= string(ll_dia_tope,'00')+'/'+string(ll_mes_tope,'00')+'/'+string(ll_anno_tope,'0000')
//																											ld_fecha_tope_pago	= date(ls_fecha_tope)
//																											if ld_fec_pago >= ld_fecha_tope_pago then 
//																												ii_cantidad++
	...
	if ll_resp=1 then
		...
		if dw_print_ctto.retrieve(ls_base_ori,ls_serie_ori,il_numero)=0 then //ll_num_ori
			...
			if f_printdlg2(dw_print_ctto,gstr_print,w_repacta_mora_mantencion)=0 then
				...
				WHERE ( "REPACTA_MANTENCION_L"."BASE" = 'R' ) AND  
						( "REPACTA_MANTENCION_L"."SERIE" = :is_serie ) AND  
						( "REPACTA_MANTENCION_L"."NUMERO" = :il_numero )   
				Using	sqlca ;
				if sqlca.sqlcode=0 then
					commit;
