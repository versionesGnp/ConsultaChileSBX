forward
global type w_repacta_mora_mantencion from window
end type
type st_cliente_tercero from statictext within w_repacta_mora_mantencion
end type
type cb_terceros from commandbutton within w_repacta_mora_mantencion
end type
type st_print_detalle from statictext within w_repacta_mora_mantencion
end type
type dw_print_ctto from datawindow within w_repacta_mora_mantencion
end type
type st_9 from statictext within w_repacta_mora_mantencion
end type
type st_factor from statictext within w_repacta_mora_mantencion
end type
type st_txt_valor_cta2 from statictext within w_repacta_mora_mantencion
end type
type st_val_cuota_uf2 from statictext within w_repacta_mora_mantencion
end type
type st_val_cuota_peso2 from statictext within w_repacta_mora_mantencion
end type
type st_txt_cob_adm from statictext within w_repacta_mora_mantencion
end type
type st_txt_valor_cta from statictext within w_repacta_mora_mantencion
end type
type st_val_cuota_uf from statictext within w_repacta_mora_mantencion
end type
type st_val_cuota_peso from statictext within w_repacta_mora_mantencion
end type
type st_val_interes_adm_uf from statictext within w_repacta_mora_mantencion
end type
type st_val_interes_adm_pesos from statictext within w_repacta_mora_mantencion
end type
type rb_calc_uf from radiobutton within w_repacta_mora_mantencion
end type
type rb_calc_pesos from radiobutton within w_repacta_mora_mantencion
end type
type st_6 from statictext within w_repacta_mora_mantencion
end type
type st_dscto from statictext within w_repacta_mora_mantencion
end type
type em_descuento from editmask within w_repacta_mora_mantencion
end type
type st_val_interes_tot_total from statictext within w_repacta_mora_mantencion
end type
type st_8 from statictext within w_repacta_mora_mantencion
end type
type st_7 from statictext within w_repacta_mora_mantencion
end type
type st_5 from statictext within w_repacta_mora_mantencion
end type
type st_val_interes_total from statictext within w_repacta_mora_mantencion
end type
type em_val_total from statictext within w_repacta_mora_mantencion
end type
type st_txt_total from statictext within w_repacta_mora_mantencion
end type
type st_moneda from statictext within w_repacta_mora_mantencion
end type
type em_moneda from statictext within w_repacta_mora_mantencion
end type
type st_uf_dia from statictext within w_repacta_mora_mantencion
end type
type st_monto_uf from statictext within w_repacta_mora_mantencion
end type
type st_deuda_uf from statictext within w_repacta_mora_mantencion
end type
type st_monto_en_uf from statictext within w_repacta_mora_mantencion
end type
type st_ctas_mant_pago from statictext within w_repacta_mora_mantencion
end type
type st_cta_txt from statictext within w_repacta_mora_mantencion
end type
type st_fecha_prox_pago from statictext within w_repacta_mora_mantencion
end type
type st_4 from statictext within w_repacta_mora_mantencion
end type
type cb_filtrar from commandbutton within w_repacta_mora_mantencion
end type
type cb_ordenar from commandbutton within w_repacta_mora_mantencion
end type
type cb_exportar from commandbutton within w_repacta_mora_mantencion
end type
type p_fec from picture within w_repacta_mora_mantencion
end type
type em_fecha from editmask within w_repacta_mora_mantencion
end type
type st_fec_cuo from statictext within w_repacta_mora_mantencion
end type
type st_txt_real from statictext within w_repacta_mora_mantencion
end type
type cb_grabar from commandbutton within w_repacta_mora_mantencion
end type
type st_cliente from statictext within w_repacta_mora_mantencion
end type
type em_cuotas from editmask within w_repacta_mora_mantencion
end type
type st_3 from statictext within w_repacta_mora_mantencion
end type
type st_numero from statictext within w_repacta_mora_mantencion
end type
type st_serie from statictext within w_repacta_mora_mantencion
end type
type st_base from statictext within w_repacta_mora_mantencion
end type
type st_2 from statictext within w_repacta_mora_mantencion
end type
type cb_proceso from commandbutton within w_repacta_mora_mantencion
end type
type st_1 from statictext within w_repacta_mora_mantencion
end type
type cb_cerrar from commandbutton within w_repacta_mora_mantencion
end type
type dw_detalle from datawindow within w_repacta_mora_mantencion
end type
type em_deuda from statictext within w_repacta_mora_mantencion
end type
type em_val_interes from statictext within w_repacta_mora_mantencion
end type
type dw_lista from datawindow within w_repacta_mora_mantencion
end type
type cb_imprimir from commandbutton within w_repacta_mora_mantencion
end type
type gb_2 from groupbox within w_repacta_mora_mantencion
end type
type cb_eliminar from commandbutton within w_repacta_mora_mantencion
end type
type gb_1 from groupbox within w_repacta_mora_mantencion
end type
type gb_3 from groupbox within w_repacta_mora_mantencion
end type
end forward
...
global w_repacta_mora_mantencion w_repacta_mora_mantencion
...
public subroutine wf_grabar ();long		ll_val_ctas,ll_suma_cta, ll_cta_mora,ll_count_anexo
Datetime	ldt_fecha_1, ldt_fecha_crea
date		ld_fecha_1, ld_fecha_crea
time		lt_hora
String		ls_base_aux,ls_barra,ls_barra_aux, ls_num,ls_string_folio
...
if sqlca.sqlcode=0 then
	if dw_lista.update()=1 then
		...
		if ll_count_anexo = 0 then
			...
			VALUES	( 'L', 			'R',   			:il_numero,   	:gdt_fec_sistema,   	:gs_user,   				null,   				null,   					null,   					0,   					:gdt_fec_sistema,   		:ls_string_folio,   			null,   			:gs_user,   						null,   					'I',   					null,   								null,   						null,   			null,   						null,   									null,   						null,   							null,   								null,   												0,   					null,   				null,   				1,   			1 )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
				...
				VALUES 	( 'L',   		'R',   			:il_numero,   	:gdt_fec_sistema,  :gs_user,   				0,   			:gdt_fec_sistema,   	:ls_string_folio,	'-',   			null,   				null,   						null,   					'-',   							null,   									null,   					null,   					null,   						null,   										0,   					'N',   								null,   				null )  
				USING	sqlca;
				if sqlca.sqlcode=0 then
					commit;
				else
...
on w_repacta_mora_mantencion.create
...
on w_repacta_mora_mantencion.destroy
...
Double	ld_factor_uf,ldb_pie,ldb_calc_monto,ldb_uf_ctto
Date		ld_fecha,ld_fec_pago,ldt_fec_prox_pago
String	ls_fecha,ls_fecha_tope, ls_titulo,ls_dv,ls_nom,ls_ap_pat,ls_ap_mat,ls_nombre_aux,ls_ap_pat_aux,ls_ap_mat_aux,ls_dv_aux,ls_base_reprog,ls_serie_reprog
...
if isnull(gd_uf_dia) or gd_uf_dia=0 then
	...
	if il_tot_reg > 0 then
		...
		ldb_uf_ctto					= dw_lista.getitemnumber(1,'uf_dia')
	end if
	if isnull(ldb_pie) then ldb_pie=0
	if ldb_uf_ctto > 0 then
		ll_pie_peso					= round(ldb_pie * ldb_uf_ctto,0)
	else
...
//	ll_anno_tope					= ll_anno_tope + il_nro_ctas
	...
	if ldb_uf_ctto > 0 then
		ldb_calc_monto				= round(il_monto / ldb_uf_ctto,4)
		il_monto						= round(ldb_calc_monto * ldb_uf_ctto,0)
		st_monto_uf.text			= string(ldb_uf_ctto,"###,###,###,###,###,##0.00")
		id_monto_uf					= il_monto / ldb_uf_ctto
	else
	...
	if is_base<>'' and not isnull(is_base) and is_serie<>'' and not isnull(is_serie) and il_numero>0 and il_corr > 0 then
		...
		if il_tot_reg > 0 then
			ls_base_reprog						= dw_lista.getitemstring(1,'base')
			ls_serie_reprog						= dw_lista.getitemstring(1,'serie')
...
//			messagebox("st_val_interes_total.text",st_val_interes_total.text)
			...
			for i=1 to il_nro_ctas
				...
				if ldb_uf_ctto > 0 then
					dw_detalle.setitem(ll_new,'uf',ldb_uf_ctto)
				else
			...
			if ll_rut > 0 then
				dw_detalle.object.t_titulo.text		= 'Detalle Cuotas Repactación Nº:   '+ls_base_reprog+' - '+ls_serie_reprog+' - '+string(il_numero,"###,###,###,###,###")+'-'+string(il_corr,"###,###,###,###,###")	//is_serie
				...
				dw_detalle.object.t_titulo.text		= 'NO EXISTE Reprogramación de Mantención Indicada'
				dw_detalle.object.t_titulo_1.text	= 'CLIENTE  '+string(ll_rut,"###,###,###,##0")+' - '+ls_dv+'     '+ls_nom+' '+ls_ap_pat+' '+ls_ap_mat
				dw_detalle.object.t_titulo_2.text	= 'CONTRATO ORIGINAL:   '+is_base+' - '+is_serie+ ' - '+string(il_numero,"###,###,###,###,##0")
				dw_detalle.object.t_titulo_3.text	= ls_titulo
			end if
...
event clicked;long		ll_val_ctas,ll_suma_cta, ll_cta_mora,ll_rut,ll_tot_renta,ll_grupo_f,ll_rut_aux,ll_plazo,ll_count_vig,ll_est_resp=0,ll_rut_cont=0,&
			ll_cta_pag_mant,ll_count_anexo
...
String	ls_base_aux,ls_barra,ls_barra_aux, ls_num,ls_nom,ls_ap_pat,ls_ap_mat,ls_dir_p,ls_pob,ls_sec,ls_com,ls_ciu,ls_fono_p,ls_sexo,ls_est_civ,&
			ls_dom_c,ls_fono_c,ls_dv,ls_est_cob,ls_glosa_cob,ls_es_deudor='S',	ls_estado_deudor,ls_tipo='I',ls_est_titular='A',ls_dv_aux,ls_base='L',&
			ls_moneda,ls_estado_cadena,ls_string_folio
double	ld_val_cta_uf, ld_val_deuda_uf,ld_factor,ldb_valor_cuota,ldb_valor_cuota_mant,ldb_pie,ldb_sub_total,ldb_total_cobros,ld_saldo_finan,ldb_tasa,ldb_tasa_int_cta
...
if st_val_interes_tot_total.text='' or st_val_interes_adm_uf.text='' or &
	...
	elseif ldb_pie > 0 and ldt_fecha_pie=date('01/01/1900') then
		...
		if sqlca.sqlcode=0 then
			...
			ld_saldo_finan		= double(st_deuda_uf.text)		//ld_val_deuda_uf		// - ldb_pie
			...
			if gi_rut_tercero > 0 and not isnull(gi_rut_tercero) then
				INSERT INTO "REPACTA_MANTENCION_L"  
							( "BASE",   "SERIE",   		"NUMERO",   "BASE_ORIGINAL",   	"SERIE_ORIGINAL",   	"NUMERO_ORIGINAL",   	"FECHA_CREA",  	"CORRELATIVO",	"TOTAL_DEUDA",   "CUOTAS_PACTADAS",   "ESTADO_PAGO",   "VALOR_CUOTA",   "FECHA_PRIMERA_CTA",   "CUOTAS_EN_MORA",   "USUARIO",   "ABONO",	"SALDO",	"RUT_CLIENTE",			"DV_CLIENTE",	"UF_DIA",	"TIPO_MONEDA",	"TOTAL_DEUDA_UF",	"VALOR_CUOTA_UF",	"INTERES_CUOTA_PESOS",	"INTERES_DEUDA_PESOS",	"POR_DESCUENTO",	"INTERES_ADM_PESOS",	"FACTOR_APLICADO",	"TOTAL_PAGADO",	"FECHA_ULT",		"CTA_MORA_ORIGINAL",		"CANT_PRINT",	"CTAS_PAGADAS","CTAS_PAG_M_ORIGINAL","VALOR_PRESENTE_PESOS","VALOR_GTOS_ADM_PESOS","VALOR_MORA_CTA_PESOS","VALOR_SALDO_INSOLUTO","TIPO_REPROG",	"PIE",		"FECHA_PIE",	"SUB_TOTAL",	"TOTAL_COBROS", 	"TASA",		"TASA_INTERES_CUOTA")  
				VALUES 	( 'L',   		'R', 			:il_numero, 	:is_base,   				:is_serie,   				:ll_num_ori,   	  			:ldt_fecha_crea,	:il_corr,				:il_deuda,   	  		:il_nro_ctas,   	  			'V',   			 			:ll_val_ctas,   		:ldt_fecha_1,   		  		:gl_n_cuotas_pag,   		:gs_user,    		0,			0,			:gi_rut_tercero,			:gs_dv,			:gd_uf_dia,	:gs_moneda,		:ld_val_deuda_uf,		:ld_val_cta_uf,			:il_val_int_cta,					:il_val_int,						:il_por_descto,			:il_int_adm_peso,			:ld_factor,					0,							:ldt_fecha_ult,		:gl_cta_mora_original,		1,					0,						:gl_ctas_pag_m,			 	0,									0,							  			0,							 		0,									'R',					:ldb_pie,	:ldt_fecha_pie,	:ldb_sub_total,	:ldb_total_cobros,		:ldb_tasa,	:ldb_tasa_int_cta)  
				Using	sqlca;
			else
				INSERT INTO "REPACTA_MANTENCION_L"  
							( "BASE",   "SERIE",   "NUMERO",   "BASE_ORIGINAL",   "SERIE_ORIGINAL",   "NUMERO_ORIGINAL",   "FECHA_CREA",   "CORRELATIVO",	"TOTAL_DEUDA",   "CUOTAS_PACTADAS",   "ESTADO_PAGO",   "VALOR_CUOTA",   "FECHA_PRIMERA_CTA",   "CUOTAS_EN_MORA",   "USUARIO",   "ABONO",	"SALDO",	"RUT_CLIENTE",	"DV_CLIENTE",	"UF_DIA",	"TIPO_MONEDA",	"TOTAL_DEUDA_UF",	"VALOR_CUOTA_UF",	"INTERES_CUOTA_PESOS",	"INTERES_DEUDA_PESOS",	"POR_DESCUENTO",	"INTERES_ADM_PESOS",	"FACTOR_APLICADO",	"TOTAL_PAGADO",	"FECHA_ULT",		"CTA_MORA_ORIGINAL",		"CANT_PRINT",	"CTAS_PAGADAS","CTAS_PAG_M_ORIGINAL","VALOR_PRESENTE_PESOS","VALOR_GTOS_ADM_PESOS","VALOR_MORA_CTA_PESOS","VALOR_SALDO_INSOLUTO","TIPO_REPROG",	"PIE",		"FECHA_PIE",	"SUB_TOTAL",	"TOTAL_COBROS",	"TASA",		"TASA_INTERES_CUOTA")  
...
Date		ld_fecha, ld_fecha_hoy,ld_fec_pago,ld_fecha_tope_pago,ldt_fec_prox_pago,ld_fecha_ini
long 		i,ll_cuotas, ll_mes,ll_dia_aux,ll_new,ll_cuotas_div, ll_val_cta_inicial,ll_mora_mant,ll_dias_mora_mant,ll_dia, ll_anno, ll_monto, ll_suma_interes_peso, ll_suma_interes_uf,&
			...
			ll_cant_mant,ll_cant_cred,ll_contador
...
Datetime	ldt_fecha_venc_mant,ldt_fecha_pie
...
ldb_pie							= dw_lista.getitemnumber(1,'pie')
ldt_fecha_pie					= dw_lista.getitemdatetime(1,'fecha_pie')
st_ctas_mant_pago.text		= string(long(substr(1,7,Message.StringParm)),"###,###,###,###,##0")
if isnull(ldb_pie) then ldb_pie=0
ll_pie_peso						= round(ldb_pie * gd_uf_dia,0)
...
//			loop
		if ld_fec_pago >= ld_fecha_tope_pago then 
			ll_cant_mant_mas++
			ii_cantidad++
			ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant,ld_fecha_tope_pago)
			if ld_fec_pago >= ld_fecha_tope_pago then 
				ii_cantidad++
				ll_cant_mant_mas++
				ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)	// *2
				if ld_fec_pago >= ld_fecha_tope_pago then 
					ii_cantidad++
					ll_cant_mant_mas++
					ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant,ld_fecha_tope_pago)		// *3
					if ld_fec_pago >= ld_fecha_tope_pago then 
						ii_cantidad++
						ll_cant_mant_mas++
						ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant,ld_fecha_tope_pago)		// *4
						if ld_fec_pago >= ld_fecha_tope_pago then 
							ii_cantidad++
							ll_cant_mant_mas++
							ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *5
							if ld_fec_pago >= ld_fecha_tope_pago then 
								ii_cantidad++
								ll_cant_mant_mas++
								ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant,ld_fecha_tope_pago)		// *6
								if ld_fec_pago >= ld_fecha_tope_pago then 
									ii_cantidad++
									ll_cant_mant_mas++
									ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *7
									if ld_fec_pago >= ld_fecha_tope_pago then 
										ii_cantidad++
										ll_cant_mant_mas++
										ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *8
										if ld_fec_pago >= ld_fecha_tope_pago then 
											ii_cantidad++
											ll_cant_mant_mas++
											ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *9
											if ld_fec_pago >= ld_fecha_tope_pago then 
												ii_cantidad++
												ll_cant_mant_mas++
												ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *10
												if ld_fec_pago >= ld_fecha_tope_pago then 
													ii_cantidad++
													ll_cant_mant_mas++
													ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *11
													if ld_fec_pago >= ld_fecha_tope_pago then 
														ii_cantidad++
														ll_cant_mant_mas++
														ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant, ld_fecha_tope_pago)		// *12
														if ld_fec_pago >= ld_fecha_tope_pago then 
															ii_cantidad++
															ll_cant_mant_mas++
															ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *13
															if ld_fec_pago >= ld_fecha_tope_pago then 
																ii_cantidad++
																ll_cant_mant_mas++
																ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *14
																if ld_fec_pago >= ld_fecha_tope_pago then 
																	ii_cantidad++
																	ll_cant_mant_mas++
																	ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *15
																	if ld_fec_pago >= ld_fecha_tope_pago then 
																		ii_cantidad++
																		ll_cant_mant_mas++
																		ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *16
																		if ld_fec_pago >= ld_fecha_tope_pago then 
																			ii_cantidad++
																			ll_cant_mant_mas++
																			ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *17
																			if ld_fec_pago >= ld_fecha_tope_pago then 
																				ii_cantidad++
																				ll_cant_mant_mas++
																				ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *18
																				if ld_fec_pago >= ld_fecha_tope_pago then 
																					ii_cantidad++
																					ll_cant_mant_mas++
																					ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *19
																					if ld_fec_pago >= ld_fecha_tope_pago then 
																						ii_cantidad++
																						ll_cant_mant_mas++
																						ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *20
																						if ld_fec_pago >= ld_fecha_tope_pago then 
																							ii_cantidad++
																							ll_cant_mant_mas++
																							ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *21
																							if ld_fec_pago >= ld_fecha_tope_pago then 
																								ii_cantidad++
																								ll_cant_mant_mas++
																								ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *22
																								if ld_fec_pago >= ld_fecha_tope_pago then 
																									ii_cantidad++
																									ll_cant_mant_mas++
																									ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *23
																									if ld_fec_pago >= ld_fecha_tope_pago then 
																										ii_cantidad++
																										ll_cant_mant_mas++
																										ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *24
																										if ld_fec_pago >= ld_fecha_tope_pago then 
																											ii_cantidad++
																											ll_cant_mant_mas++
																											ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *25
																											if ld_fec_pago >= ld_fecha_tope_pago then 
																												ii_cantidad++
																												ll_cant_mant_mas++
																												ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *26
																												if ld_fec_pago >= ld_fecha_tope_pago then 
																													ii_cantidad++
																													ll_cant_mant_mas++
																													ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *27
																													if ld_fec_pago >= ld_fecha_tope_pago then 
																														ii_cantidad++
																														ll_cant_mant_mas++
																														ld_fecha_tope_pago	= f_retorna_fecha_pago_mant(ll_cant_mant ,ld_fecha_tope_pago)		// *28
																														if ld_fec_pago >= ld_fecha_tope_pago then 
																															ii_cantidad++
																															ll_cant_mant_mas++
																														end if
...
//		em_val_total.text					= string(il_monto,'###,###,###,##0')
	...
	//		st_val_cuota_uf.text			= string((ll_monto_cta / gd_uf_dia),"###,###,###,##0.00")
		...
		if dw_detalle.rowcount() > 0 then
			...
			dw_detalle.object.t_titulo.text		= 'Detalle Cuotas Repactación Nº:   L - '+'R'+' - '+string(il_numero,"###,###,###,###,###")	//+'-'+string(il_corr,"###,###,###,###,###")
			dw_detalle.object.t_titulo_1.text	= 'CLIENTE  '+string(gi_rut,"###,###,###,##0")+' - '+gs_dv+'     '+trim(st_cliente.text)
			dw_detalle.object.t_titulo_2.text	= 'CONTRATO ORIGINAL:   '+is_base+' - '+is_serie+ ' - '+string(gi_numero,"###,###,###,###,##0")	//string(il_numero,"###,###,###,###,##0")
			dw_detalle.object.t_titulo_3.text	= ls_titulo
			dw_detalle.object.t_valor_pie.text	= string(ldb_pie,'###,###,###,##0.0###')
			dw_detalle.object.t_fecha_pie.text	= string(ldt_fecha_pie,'dd/mm/yyyy')
			dw_detalle.accepttext()
...
String		ls_base_ori, ls_serie_ori,ls_base_repro,ls_serie_repro,ls_nom,ls_ap_pat,ls_ap_mat  
...
if dw_detalle.rowcount() > 0 then
	...
	USING	sqlca;
	if sqlca.sqlcode=0 then
		if not isnull(ls_nom) then
			if not isnull(ls_ap_pat) then ls_nom = ls_nom +' '+ls_ap_pat
			if not isnull(ls_ap_mat) then ls_nom = ls_nom +' '+ls_ap_mat
		end if
	else
		SELECT 	"CLIENTE_DEUDOR_TERCERO"."NOMBRE", 	"CLIENTE_DEUDOR_TERCERO"."A_PATERNO",	"CLIENTE_DEUDOR_TERCERO"."A_MATERNO"  
		INTO 		:ls_nom,   											:ls_ap_pat,   											:ls_ap_mat  
		FROM 	"CLIENTE_DEUDOR_TERCERO"  
	...
	dw_detalle.object.t_titulo_1.text	= 'CLIENTE  '+string(gi_rut,"###,###,###,##0")+' - '+gs_dv+'     '+ls_nom
	dw_detalle.object.t_titulo_2.text	= 'CONTRATO ORIGINAL:   '+is_base+' - '+is_serie+ ' - '+string(gi_numero,"###,###,###,###,##0")
	dw_detalle.object.t_titulo_3.text	= ''	//ls_titulo
	...
	if sqlca.sqlcode=0 then
		...
		elseif ll_cont_print=0 or ll_cont_print=1 then
			ll_cont_print	= 1
...
if dw_lista.rowcount()>0 then
	...
	Using		sqlca ;
	if sqlca.sqlcode=0 then
		ll_resp = MessageBox("Eliminar", "Está Seguro Eliminar Repactación Nº "+'L-'+'R'+'-'+string(il_numero,"###,###,###,###,###"), &
				Exclamation!, YesNo!, 2)
		IF ll_resp = 1 THEN
			SELECT 		SUM("INGRESO"."FOLIO")
			INTO 			:ll_count_reg
			FROM 		"INGRESO"  
			WHERE	( "INGRESO"."BASE" = 'L' ) AND  
						( "INGRESO"."SERIE" = 'R' ) AND  
						( "INGRESO"."CONTRATO" = :il_numero ) 
			Using	sqlca ;
			if sqlca.sqlcode=0 then
...
//						else
//							rollback;
//							messagebox("Error Eliminar","Error al Eliminar Reprogramación (CADENA) SQL: "+sqlca.sqlerrtext)
//						end if
						dw_lista.reset()
						dw_detalle.reset()
						em_cuotas.text	= ''
						...
						rollback;
						messagebox("Error Eliminar","Error al Eliminar Reprogramación (REPACTA_MANTENCION) SQL: "+sqlca.sqlerrtext)
					end if
				end if
			end if
		END IF
