forward
global type w_premios_ofertas_historica from window
end type
type rb_grupo from radiobutton within w_premios_ofertas_historica
end type
type rb_1 from radiobutton within w_premios_ofertas_historica
end type
type rb_estadistica from radiobutton within w_premios_ofertas_historica
end type
type st_fecha from statictext within w_premios_ofertas_historica
end type
type rb_resumen from radiobutton within w_premios_ofertas_historica
end type
type rb_supervisores from radiobutton within w_premios_ofertas_historica
end type
type rb_agentes from radiobutton within w_premios_ofertas_historica
end type
type dw_2 from datawindow within w_premios_ofertas_historica
end type
type cb_3 from commandbutton within w_premios_ofertas_historica
end type
type cb_imprimir from commandbutton within w_premios_ofertas_historica
end type
type dw_paso from datawindow within w_premios_ofertas_historica
end type
type dw_1 from datawindow within w_premios_ofertas_historica
end type
type dw_ofertas from datawindow within w_premios_ofertas_historica
end type
type st_2 from statictext within w_premios_ofertas_historica
end type
type st_1 from statictext within w_premios_ofertas_historica
end type
type p_2 from picture within w_premios_ofertas_historica
end type
type em_2 from editmask within w_premios_ofertas_historica
end type
type p_1 from picture within w_premios_ofertas_historica
end type
type em_1 from editmask within w_premios_ofertas_historica
end type
type cb_2 from commandbutton within w_premios_ofertas_historica
end type
type cb_1 from commandbutton within w_premios_ofertas_historica
end type
type gb_2 from groupbox within w_premios_ofertas_historica
end type
type gb_1 from groupbox within w_premios_ofertas_historica
end type
end forward
...
global w_premios_ofertas_historica w_premios_ofertas_historica
...
on w_premios_ofertas_historica.create
...
on w_premios_ofertas_historica.destroy
...
gf_centrar(w_premios_ofertas_historica)
gs_ventana		= 'w_premios_ofertas_historica'
f_valida_objeto2()
...
event clicked;close(w_premios_ofertas_historica)
end event
