forward
global type w_datos_vendedor_lib from window
end type
type sle_1 from singlelineedit within w_datos_vendedor_lib
end type
type pb_1 from picturebutton within w_datos_vendedor_lib
end type
type cb_2 from commandbutton within w_datos_vendedor_lib
end type
type cb_1 from commandbutton within w_datos_vendedor_lib
end type
type dw_1 from datawindow within w_datos_vendedor_lib
end type
type gb_1 from groupbox within w_datos_vendedor_lib
end type
end forward
...
global w_datos_vendedor_lib w_datos_vendedor_lib
...
on w_datos_vendedor_lib.create
...
on w_datos_vendedor_lib.destroy
destroy(this.sle_1)
destroy(this.pb_1)
destroy(this.cb_2)
destroy(this.cb_1)
...
event open;gf_centrar(w_datos_vendedor_lib)
dw_1.settransobject(sqlca)
dw_1.retrieve()
gs_ventana	= 'w_datos_vendedor_lib'
f_valida_objeto_1()
...
event clicked;close(w_datos_vendedor_lib)
end event
...
event doubleclicked;if dw_1.getrow() > 0 then OpenWithParm(w_agentes_print_lib,getitemstring(this.getrow(),'agentes_cod_age'))
end event
