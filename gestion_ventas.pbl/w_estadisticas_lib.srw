forward
global type w_estadisticas_lib from window
end type
type dw_parque from datawindow within w_estadisticas_lib
end type
type st_1 from statictext within w_estadisticas_lib
end type
type cb_1 from commandbutton within w_estadisticas_lib
end type
type dw_1 from datawindow within w_estadisticas_lib
end type
type cb_2 from commandbutton within w_estadisticas_lib
end type
end forward
...
global w_estadisticas_lib w_estadisticas_lib
...
gf_centrar(w_estadisticas_lib)
gs_ventana				= 'w_estadisticas_lib'
f_valida_objeto_1()
...
integer height = 1440
integer taborder = 20
string dataobject = "dw_estadisticas_lib"
