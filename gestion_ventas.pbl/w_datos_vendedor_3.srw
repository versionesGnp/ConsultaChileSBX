forward
global type w_datos_vendedor_3 from window
end type
type pb_1 from picturebutton within w_datos_vendedor_3
end type
type sle_1 from singlelineedit within w_datos_vendedor_3
end type
type cb_2 from commandbutton within w_datos_vendedor_3
end type
type cb_1 from commandbutton within w_datos_vendedor_3
end type
type dw_1 from datawindow within w_datos_vendedor_3
end type
type gb_1 from groupbox within w_datos_vendedor_3
end type
end forward
...
global w_datos_vendedor_3 w_datos_vendedor_3
...
event open;gf_centrar(w_datos_vendedor_3)
dw_1.settransobject(sqlca)
dw_1.retrieve()
gs_ventana	= 'w_datos_vendedor_3'
f_valida_objeto_1()
...
event clicked;close(w_datos_vendedor_3)
end event
...
event doubleclicked;if this.getrow() > 0 then OpenWithParm(w_agentes_print_3,getitemstring(this.getrow(),'agentes_cod_age'))
end event
