forward
global type w_datos_vendedor from window
end type
type pb_1 from picturebutton within w_datos_vendedor
end type
type sle_1 from singlelineedit within w_datos_vendedor
end type
type cb_2 from commandbutton within w_datos_vendedor
end type
type cb_1 from commandbutton within w_datos_vendedor
end type
type dw_1 from datawindow within w_datos_vendedor
end type
type gb_1 from groupbox within w_datos_vendedor
end type
end forward
...
global w_datos_vendedor w_datos_vendedor
...
event open;gf_centrar(w_datos_vendedor)
dw_1.settransobject(sqlca)
dw_1.retrieve()
gs_ventana	= 'w_datos_vendedor'
f_valida_objeto_1()
...
event clicked;close(w_datos_vendedor)
end event
...
event doubleclicked;if this.getrow() > 0 then OpenWithParm(w_agentes_print,getitemstring(this.getrow(),'agentes_cod_age'))
end event
