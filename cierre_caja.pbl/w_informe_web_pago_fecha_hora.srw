forward
global type w_informe_web_pago_fecha_hora from window
end type
type cb_ctacte from commandbutton within w_informe_web_pago_fecha_hora
end type
type cb_imprimir from commandbutton within w_informe_web_pago_fecha_hora
end type
type cb_filtrar from commandbutton within w_informe_web_pago_fecha_hora
end type
type cb_exportar from commandbutton within w_informe_web_pago_fecha_hora
end type
type cb_mostrar from commandbutton within w_informe_web_pago_fecha_hora
end type
type pb_aceptar from picturebutton within w_informe_web_pago_fecha_hora
end type
type em_hora_fin from editmask within w_informe_web_pago_fecha_hora
end type
type st_4 from statictext within w_informe_web_pago_fecha_hora
end type
type p_hasta from picture within w_informe_web_pago_fecha_hora
end type
type em_hasta from editmask within w_informe_web_pago_fecha_hora
end type
type st_3 from statictext within w_informe_web_pago_fecha_hora
end type
type em_hora_ini from editmask within w_informe_web_pago_fecha_hora
end type
type st_2 from statictext within w_informe_web_pago_fecha_hora
end type
type p_desde from picture within w_informe_web_pago_fecha_hora
end type
type em_de from editmask within w_informe_web_pago_fecha_hora
end type
type st_1 from statictext within w_informe_web_pago_fecha_hora
end type
type cb_cerrar from commandbutton within w_informe_web_pago_fecha_hora
end type
type dw_lista from datawindow within w_informe_web_pago_fecha_hora
end type
type gb_1 from groupbox within w_informe_web_pago_fecha_hora
end type
type gb_2 from groupbox within w_informe_web_pago_fecha_hora
end type
type gb_3 from groupbox within w_informe_web_pago_fecha_hora
end type
end forward
...
string title = "Informe Cierre Caja WEB Pagos (Fecha / Hora)"
...
global w_informe_web_pago_fecha_hora w_informe_web_pago_fecha_hora

on w_informe_web_pago_fecha_hora.create
...
on w_informe_web_pago_fecha_hora.destroy
...
event open;gf_centrar(w_informe_web_pago_fecha_hora)
...
dw_lista.object.t_14.visible	= false
end event
...
if cb_mostrar.text='No Mostrar Detalle' then
	if dw_lista.rowcount()>0 then
		ldt_fecha_pago	= dw_lista.getitemdatetime(dw_lista.getrow(),'web_pagos_fecha_pago')
		ls_caja			= dw_lista.getitemstring(dw_lista.getrow(),'ingreso_cod_caja')
		ll_folio			= dw_lista.getitemnumber(dw_lista.getrow(),'ingreso_folio')
		ls_tipo_cob		= dw_lista.getitemstring(dw_lista.getrow(),'ingreso_tipo_cob')
		SELECT	"INGRESO"."BASE",   
					"INGRESO"."SERIE",   
					"INGRESO"."CONTRATO",   
					"INGRESO"."RUT"  
...
event clicked;if cb_mostrar.text='Mostrar Detalle' then
	...
	dw_lista.object.t_14.visible	= true
else
	dw_lista.Modify ( "DataWindow.detail.height=0" )
...
ld_fecha_ini		= datetime(date(STRING(em_de.text)),time(ls_hora_w_ini))
ld_fecha_fin		= datetime(date(STRING(em_hasta.text)),time(ls_hora_w_fin))
d_fec_ini			= date(em_de.text)
d_fec_din		= date(em_hasta.text)
//ll_tot_reg		= dw_lista.retrieve(ld_fecha_ini,ld_fecha_fin,d_fec_ini,d_fec_din)
...
event clicked;close(w_informe_web_pago_fecha_hora)
end event
...
integer height = 1028
integer taborder = 60
string dataobject = "dw_informe_caja_por_dia_hora_web_pago"
