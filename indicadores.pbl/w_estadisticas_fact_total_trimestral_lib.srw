forward
global type w_estadisticas_fact_total_trimestral_lib from window
end type
type cb_3 from commandbutton within w_estadisticas_fact_total_trimestral_lib
end type
type dw_1 from datawindow within w_estadisticas_fact_total_trimestral_lib
end type
type cb_2 from commandbutton within w_estadisticas_fact_total_trimestral_lib
end type
type cb_1 from commandbutton within w_estadisticas_fact_total_trimestral_lib
end type
end forward
...
global w_estadisticas_fact_total_trimestral_lib w_estadisticas_fact_total_trimestral_lib

type variables
string param
end variables

on w_estadisticas_fact_total_trimestral_lib.create
...
on w_estadisticas_fact_total_trimestral_lib.destroy
destroy(this.cb_3)
destroy(this.dw_1)
destroy(this.cb_2)
destroy(this.cb_1)
...
OpenWithParm(w_grafico_restadistico_total_trimes_lib,param)
end event
...
close(w_estadisticas_fact_total_trimestral_lib)
end event
