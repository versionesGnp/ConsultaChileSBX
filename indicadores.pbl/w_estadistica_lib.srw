forward
global type w_estadistica_lib from window
end type
type rb_mora from radiobutton within w_estadistica_lib
end type
type st_1 from statictext within w_estadistica_lib
end type
type ddlb_1 from dropdownlistbox within w_estadistica_lib
end type
type rb_facturacion_anual from radiobutton within w_estadistica_lib
end type
type cb_2 from commandbutton within w_estadistica_lib
end type
type cb_1 from commandbutton within w_estadistica_lib
end type
type gb_1 from groupbox within w_estadistica_lib
end type
end forward
...
global w_estadistica_lib w_estadistica_lib

type variables
date fecha
end variables

on w_estadistica_lib.create
...
event clicked;close(w_estadistica_lib)
end event
