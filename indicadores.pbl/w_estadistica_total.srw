forward
global type w_estadistica_total from window
end type
type rb_mora from radiobutton within w_estadistica_total
end type
type st_1 from statictext within w_estadistica_total
end type
type ddlb_1 from dropdownlistbox within w_estadistica_total
end type
type rb_facturacion_anual from radiobutton within w_estadistica_total
end type
type cb_2 from commandbutton within w_estadistica_total
end type
type cb_1 from commandbutton within w_estadistica_total
end type
type gb_1 from groupbox within w_estadistica_total
end type
end forward
...
global w_estadistica_total w_estadistica_total

type variables
date fecha
end variables

on w_estadistica_total.create
...
on w_estadistica_total.destroy
...
//ddlb_1.SelectItem(f_ddlb_all_1(ddlb_1,sql,fech))
end event
...
if rb_facturacion_anual.checked = true then
	OpenWithParm(w_estadisticas_fact_total,param)	
