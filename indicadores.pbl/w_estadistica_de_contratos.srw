forward
global type w_estadistica_de_contratos from window
end type
type cb_3 from commandbutton within w_estadistica_de_contratos
end type
type cb_2 from commandbutton within w_estadistica_de_contratos
end type
type cb_1 from commandbutton within w_estadistica_de_contratos
end type
type dw_1 from datawindow within w_estadistica_de_contratos
end type
end forward
...
global w_estadistica_de_contratos w_estadistica_de_contratos

type variables
string c_fecha
end variables

on w_estadistica_de_contratos.create
...
on w_estadistica_de_contratos.destroy
destroy(this.cb_3)
destroy(this.cb_2)
destroy(this.cb_1)
destroy(this.dw_1)
...
if dw_1.retrieve(gi_parque_select) = 0 then
	...
	close(w_estadistica_de_contratos)
else
...
event clicked;close(w_estadistica_de_contratos)
end event
...
integer width = 3099
integer height = 1524
string dataobject = "dw_estadistica_contratos"
