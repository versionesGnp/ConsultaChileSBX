forward
global type w_ingreso_ficha_cadaver_transito from window
end type
type cb_1 from commandbutton within w_ingreso_ficha_cadaver_transito
end type
type cb_tablas from commandbutton within w_ingreso_ficha_cadaver_transito
end type
type cb_volver from commandbutton within w_ingreso_ficha_cadaver_transito
end type
type cb_print from commandbutton within w_ingreso_ficha_cadaver_transito
end type
type cb_eliminar from commandbutton within w_ingreso_ficha_cadaver_transito
end type
type cb_buscar from commandbutton within w_ingreso_ficha_cadaver_transito
end type
type pb_primer from picturebutton within w_ingreso_ficha_cadaver_transito
end type
type pb_sigue from picturebutton within w_ingreso_ficha_cadaver_transito
end type
type pb_antes from picturebutton within w_ingreso_ficha_cadaver_transito
end type
type pb_fin from picturebutton within w_ingreso_ficha_cadaver_transito
end type
type cb_grabar from commandbutton within w_ingreso_ficha_cadaver_transito
end type
type cb_limpiar from commandbutton within w_ingreso_ficha_cadaver_transito
end type
type dw_print from datawindow within w_ingreso_ficha_cadaver_transito
end type
type tab_1 from tab within w_ingreso_ficha_cadaver_transito
end type
...
type cb_cerrar from commandbutton within w_ingreso_ficha_cadaver_transito
end type
type gb_1 from groupbox within w_ingreso_ficha_cadaver_transito
end type
type gb_2 from groupbox within w_ingreso_ficha_cadaver_transito
end type
end forward
...
global w_ingreso_ficha_cadaver_transito w_ingreso_ficha_cadaver_transito

type variables
datawindowchild			idw_detalle5,idw_detalle6,idw_detalle7,idw_detalle8,idw_detalle9
Long		il_tab,il_count_reg,il_count_otro,il_hora_ini,il_min_ini,il_hora_fin,il_min_fin,&
			il_intervalo,il_veces,il_capacidad,il_dw_tit_fall
String		is_nro_tecnico,is_usuario_esta,is_nuevo,is_modif
Datetime	idt_fecha_sistema
end variables

forward prototypes
public subroutine wf_setear_datos ()
public subroutine wf_sw_sin_sepultura (long al_cod_parque, long al_sw_sin)
public function string wf_validar ()
public subroutine wf_valida_contrato ()
public subroutine wf_limpiar_sin_mensaje ()
public subroutine wf_cargar_dw (string ls_nom_titular, string ls_ap_pat_titular, string ls_ap_mat_titular, long ll_rut_titular, string ls_dv_titular)
end prototypes
...
public subroutine wf_setear_datos ();Long		ll_tot_reg,ll_indi,ll_corr_interno,ll_rut_fall,ll_edad_fall,ll_rut_tit,ll_comprobante,ll_hora_def,ll_min_def,ll_sw_derecho_sepult,ll_sw_mov_sarcofago,ll_sw_cambio_ubicacion,&
			ll_sw_reduccion,ll_sw_certificado_defun,ll_sw_pago_liberado,ll_hora_util,ll_minuto_util,	ll_sw_tit_fall,ll_sw_otros_pagos,ll_sw_alto_impacto
String		ls_dv_fall,ls_nombre_fall,ls_ap_pat_fall,ls_ap_mat_fall,ls_sexo_fall,ls_tipo_via_fall,ls_direc_fall,ls_num_dir_fall,ls_dpto_dir_fall,ls_block_dir_fall,ls_sector_fall,&
			...
			ls_obs_fall,ls_usar_capilla,ls_obs_alto_impacto,ls_obs_cuerpo,ls_cod_est_ctto
Datetime	ldt_fec_defun,ldt_fec_nac,ldt_fech_sepult,ldt_fech_contrato,ldt_fech_recep
Double	ldb_uf_dia,ldb_der_sepult_uf,ldb_mov_sarcofago,ldb_cambio_ubica,ldb_reduccion,ldb_cert_defuncion,ldb_monto_canc,ldb_otros_pagos,ll_numero,ll_llave_fallecido
...
for ll_indi=1 to ll_tot_reg
	...
	ll_sw_mov_sarcofago		= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'sw_mov_sarcofago')
	ll_sw_cambio_ubicacion	= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'sw_cambio_ubicacion')
	ll_sw_reduccion			= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'sw_reduccion')
	ll_sw_certificado_defun	= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'sw_certificado_defun')
	...
	tab_1.tabpage_3.dw_ficha_sepult.setitem(ll_indi,'valor_mov_sarcofago',ldb_mov_sarcofago)
	tab_1.tabpage_3.dw_ficha_sepult.setitem(ll_indi,'valor_cambio_de_ubicacion',ldb_cambio_ubica)
	tab_1.tabpage_3.dw_ficha_sepult.setitem(ll_indi,'valor_reduccion',ldb_reduccion)
	tab_1.tabpage_3.dw_ficha_sepult.setitem(ll_indi,'valor_certificado_defuncion',ldb_cert_defuncion)
	...
	tab_1.tabpage_3.dw_ficha_sepult.setitem(ll_indi,'sw_mov_sarcofago',ll_sw_mov_sarcofago)
	tab_1.tabpage_3.dw_ficha_sepult.setitem(ll_indi,'sw_cambio_ubicacion',ll_sw_cambio_ubicacion)
	tab_1.tabpage_3.dw_ficha_sepult.setitem(ll_indi,'sw_reduccion',ll_sw_reduccion)
	tab_1.tabpage_3.dw_ficha_sepult.setitem(ll_indi,'sw_certificado_defun',ll_sw_certificado_defun)
	...
	tab_1.tabpage_3.dw_ficha_sepult.setitem(ll_indi,'sw_otros_pagos',ll_sw_otros_pagos)
	tab_1.tabpage_3.dw_ficha_sepult.setitem(ll_indi,'valor_otros_pagos',ldb_otros_pagos)
...
public subroutine wf_sw_sin_sepultura (long al_cod_parque, long al_sw_sin);String	ls_nulo

SetNull(ls_nulo)
if al_cod_parque > 0 and al_sw_sin = 0 then
	tab_1.tabpage_3.dw_ficha_sepult.Setitem(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'sector','CT')
	tab_1.tabpage_3.dw_ficha_sepult.Setitem(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'sepultura','CT')
	tab_1.tabpage_3.dw_ficha_sepult.setitem(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'estado_reg','P')
else
	tab_1.tabpage_3.dw_ficha_sepult.Setitem(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'sector',ls_nulo)
	tab_1.tabpage_3.dw_ficha_sepult.Setitem(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'sepultura',ls_nulo)
	tab_1.tabpage_3.dw_ficha_sepult.setitem(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'estado_reg',ls_nulo)
end if
tab_1.tabpage_3.dw_ficha_sepult.accepttext()
...
long 		ll_rut_fall,ret,ll_rut_tit,ll_hora_sepult,ll_minuto_sepult,ll_funeraria,&
			...
			ll_hora_uso_capilla,ll_min_uso_capilla,ll_sw_otros_pagos
		...
		if ls_pasa='S' then
			...
			if sqlca.sqlcode=0 then
				if ls_estado_ctto='V' or ls_estado_ctto='C' then
					...
					idw_detalle7.retrieve(ll_capacidad,ll_cod_parque)
...
public subroutine wf_limpiar_sin_mensaje ();tab_1.tabpage_1.dw_ant_fall.reset()
...
tab_1.tabpage_3.dw_ficha_sepult.setitem(1,'sw_sin_sepultura',1)
...
public subroutine wf_cargar_dw (string ls_nom_titular, string ls_ap_pat_titular, string ls_ap_mat_titular, long ll_rut_titular, string ls_dv_titular);Long		ll_resp,ll_cod_parque,ll_hora,ll_minutos,ll_capacidad,ll_hora_recep,ll_minuto_recep,&
			ll_hora_lleg_efec,ll_minu_lleg_efec,ll_new_titular,ll_new_fall,ll_new_ara,ll_new,ll_sw_sin
String		ls_cod_ejecutivo,ls_sector,ls_sepultura,ls_base,ls_serie,ls_estado_ctto,ls_nro_tecnico,ls_vd_estadistico,&
			ls_nombre_tit,ls_ap_pat_tit,ls_ap_mat_tit,ls_tipo_via_tit,ls_direc_tit,ls_num_dir_tit,ls_dpto_dir_tit,&
			ls_block_dir_tit,ls_pob_villa_tit,ls_sector_tit,ls_cod_ciud_tit,ls_cod_com_tit,ls_fono_titular
Datetime	ldt_fecha_sepult,ldt_fecha_recep
Double	ll_numero
...
ll_resp			= messagebox("Advertencia","Para Solicitante " +string(ll_rut_titular,'###,###,###,###,###')+'-'+ls_dv_titular+' '+ls_nom_titular+' '+ls_ap_pat_titular+' '+ls_ap_mat_titular+ ", desea Crear OTRA Ficha de Cadaver en Transito",Exclamation!,YesNo!,2)
if ll_resp=1 then
	is_nuevo												= 'S'
	tab_1.tabpage_3.dw_ficha_sepult.accepttext()
	tab_1.tabpage_3.dw_ficha_sepult.enabled	= true
	...
	ll_sw_sin			= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(1,'sw_sin_sepultura')
	...
	ll_capacidad  		= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(1,'capacidad')
	...
	tab_1.tabpage_3.dw_ficha_sepult.setitem(ll_new,'sw_sin_sepultura',ll_sw_sin)
...
on w_ingreso_ficha_cadaver_transito.create
...
on w_ingreso_ficha_cadaver_transito.destroy
destroy(this.cb_1)
...
gf_centrar(w_ingreso_ficha_cadaver_transito)
...
tab_1.tabpage_3.dw_ficha_sepult.setitem(ll_new,'sw_sin_sepultura',1)
...
tab_1.tabpage_4.dw_aranceles.enabled		= false
tab_1.tabpage_3.dw_ficha_sepult.enabled	= true
gs_ventana	= 'w_ingreso_ficha_cadaver_transito'
f_valida_objeto2()
tab_1.tabpage_3.dw_ficha_sepult.setfocus()
tab_1.tabpage_3.dw_ficha_sepult.setcolumn('cod_parque')
end event
...
SELECT	Count("FICHA_TRANSITO"."FECHA_SEPULTACION")  
INTO 		:ll_count_reg  
FROM 		"FICHA_TRANSITO"  
WHERE  ( "FICHA_TRANSITO"."FECHA_SEPULTACION" = :ldt_fecha_sepult ) AND  
		 ( "FICHA_TRANSITO"."SECTOR" = :ls_sector ) AND  
		 ( "FICHA_TRANSITO"."SEPULTURA" = :ls_sepultura ) AND  
		 ( "FICHA_TRANSITO"."COD_PARQUE" = :ll_cod_parque )   
USINg		sqlca;
...
if ll_tot_reg > 0 and not isnull(ldt_fecha_sepult) and not isnull(ls_sector) and not isnull(ls_sepultura) and ll_cod_parque > 0 then
	...
	if ll_resp=1 then
		...
		if not isnull(ldt_fecha_sepult) and ll_cod_parque>0 and not isnull(ls_sector) and not isnull(ls_sepultura) then
			SELECT	Count("FICHA_TRANSITO"."COD_PARQUE")  
			INTO 		:ll_count  
			FROM 		"FICHA_TRANSITO"  
			WHERE  ( "FICHA_TRANSITO"."COD_PARQUE" = :ll_cod_parque ) AND  
					 ( "FICHA_TRANSITO"."FECHA_SEPULTACION" = :ldt_fecha_sepult ) AND  
					 ( "FICHA_TRANSITO"."SECTOR" = :ls_sector ) AND  
					 ( "FICHA_TRANSITO"."SEPULTURA" = :ls_sepultura )  AND
					 ( "FICHA_TRANSITO"."NOMBRE_FALLECIDO" = :ls_nom_fall )  AND
					 ( "FICHA_TRANSITO"."AP_PATERNO_FALL" = :ls_ap_pat_fall ) AND
					 ( "FICHA_TRANSITO"."AP_MATERNO_FALL" = :ls_ap_mat_fall )
			USING		sqlca;
			if ll_count>0 then
				SELECT 	"FICHA_TRANSITO"."CODIGO_EJECUTIVO",	"FICHA_TRANSITO"."FECHA_SEPULTACION",	"FICHA_TRANSITO"."HORA",	"FICHA_TRANSITO"."MINUTOS",	"FICHA_TRANSITO"."CODIGO_FUNERARIA",	"FICHA_TRANSITO"."NOMBRE_FALLECIDO",	"FICHA_TRANSITO"."AP_PATERNO_FALL",	"FICHA_TRANSITO"."AP_MATERNO_FALL",	"FICHA_TRANSITO"."DIRECCION_FALL",	"FICHA_TRANSITO"."NUMERO_DIRECCION_FALL",	"FICHA_TRANSITO"."DEPTO_DIRECCION_FALL",	"FICHA_TRANSITO"."BLOCK_DIRECCION_FALL",	"FICHA_TRANSITO"."POBLACION_VILLA_FALL",	"FICHA_TRANSITO"."SECTOR_FALL",	"FICHA_TRANSITO"."CODIGO_COMUNA_FALL",	"FICHA_TRANSITO"."CODIGO_CIUDAD_FALL",	"FICHA_TRANSITO"."FECHA_DEFUNCION",	"FICHA_TRANSITO"."ESTADO_RESPONSO",	"FICHA_TRANSITO"."RUT_DIACONO",	"FICHA_TRANSITO"."DV_DIACONO",	"FICHA_TRANSITO"."FECHA_NACIMIENTO_FALL",	"FICHA_TRANSITO"."RUT_FALLECIDO",	"FICHA_TRANSITO"."DV_FALLECIDO",	"FICHA_TRANSITO"."COD_ESTADO_FALL",	"FICHA_TRANSITO"."COD_PARQUE_DESDE",	"FICHA_TRANSITO"."COD_PARQUE_HACIA",	"FICHA_TRANSITO"."PASE_SEPULTACION",	"FICHA_TRANSITO"."CAUSA_FALLECIMIENTO",	"FICHA_TRANSITO"."CAPILLA_VELATORIA",	"FICHA_TRANSITO"."DIRECCION_CAPILLA",	"FICHA_TRANSITO"."VALOR_DERECHO_SEPULTACION_UF",	"FICHA_TRANSITO"."CODIGO_PARENTESCO",	"FICHA_TRANSITO"."MONTO_CANCELAR",	"FICHA_TRANSITO"."FOLIO_COMPROBANTE",	"FICHA_TRANSITO"."OBSERVACION",	"FICHA_TRANSITO"."BASE",	"FICHA_TRANSITO"."SERIE",	"FICHA_TRANSITO"."NUMERO",	"FICHA_TRANSITO"."SECTOR",	"FICHA_TRANSITO"."SEPULTURA",	"FICHA_TRANSITO"."NUMERO_TECNICO",	"FICHA_TRANSITO"."CAPACIDAD",	"FICHA_TRANSITO"."NIVEL",	"FICHA_TRANSITO"."COD_PARQUE",	"FICHA_TRANSITO"."NOMBRE_TITULAR",	"FICHA_TRANSITO"."AP_PATERNO_TITULAR",	"FICHA_TRANSITO"."AP_MATERNO_TITULAR",	"FICHA_TRANSITO"."DIRECCION_TITULAR",	"FICHA_TRANSITO"."NUM_DIRECCION_TITULAR",	"FICHA_TRANSITO"."DEPTO_DIRECCION_TITULAR",	"FICHA_TRANSITO"."BLOCK_DIRECCION_TITULAR",	"FICHA_TRANSITO"."POBLACION_VILLA_TITULAR",	"FICHA_TRANSITO"."SECTOR_TITULAR",	"FICHA_TRANSITO"."CODIGO_COMUNA_TITULAR",	"FICHA_TRANSITO"."CODIGO_CIUDAD_TITULAR",	"FICHA_TRANSITO"."FONO_TITULAR",	"FICHA_TRANSITO"."FECHA_RECEPCION",	"FICHA_TRANSITO"."HORA_RECEPCION",	"FICHA_TRANSITO"."MINUTO_RECEPCION",	"FICHA_TRANSITO"."HORA_LLEGADA_EFECTIVA",	"FICHA_TRANSITO"."MINUTO_LLEGADA_EFECTIVA",	"FICHA_TRANSITO"."VB_ESTADISTICO",	"FICHA_TRANSITO"."FONO_FUNERARIA",	"FICHA_TRANSITO"."COD_ESTADO_CONTRATO",	"FICHA_TRANSITO"."RUT_TITULAR",	"FICHA_TRANSITO"."DV_TITULAR",	"FICHA_TRANSITO"."VALOR_MOV_SARCOFAGO",	"FICHA_TRANSITO"."VALOR_CAMBIO_DE_UBICACION",	"FICHA_TRANSITO"."VALOR_REDUCCION",	"FICHA_TRANSITO"."VALOR_CERTIFICADO_DEFUNCION",	"FICHA_TRANSITO"."UF_DIA",	"FICHA_TRANSITO"."EDAD_FALLECIDO",	"FICHA_TRANSITO"."SEXO_FALLECIDO",	"FICHA_TRANSITO"."TIPO_VIA_FALLECIDO",	"FICHA_TRANSITO"."TIPO_VIA_TITULAR",	"FICHA_TRANSITO"."CORRELATIVO_INTERNO",	"FICHA_TRANSITO"."CORRELATIVO_MENSUAL",	"FICHA_TRANSITO"."CORRELATIVO_ANUAL",	"FICHA_TRANSITO"."ESTADO_REG",	"FICHA_TRANSITO"."COD_REGISTRO_PASE",	"FICHA_TRANSITO"."INSCRIPCION_PASE",	"FICHA_TRANSITO"."REGISTRO_PASE",	"FICHA_TRANSITO"."ANNO_PASE",	"FICHA_TRANSITO"."FECHA_PASE",	"FICHA_TRANSITO"."FECHA_SISTEMA",	"FICHA_TRANSITO"."HORA_DEF",	"FICHA_TRANSITO"."MINUTO_DEF",	"FICHA_TRANSITO"."MODIF_ADM",	"FICHA_TRANSITO"."SW_DERECHO_SEPULT",	"FICHA_TRANSITO"."SW_MOV_SARCOFAGO",	"FICHA_TRANSITO"."SW_CAMBIO_UBICACION",	"FICHA_TRANSITO"."SW_REDUCCION",	"FICHA_TRANSITO"."SW_CERTIFICADO_DEFUN",	"FICHA_TRANSITO"."SW_PAGO_LIBERADO",	"FICHA_TRANSITO"."PERIODO_NACIMIENTO",	"FICHA_TRANSITO"."COD_TAMANO_CUERPO",	"FICHA_TRANSITO"."OBSERVACION_FALLECIDO",	"FICHA_TRANSITO"."USAR_CAPILLA",	"FICHA_TRANSITO"."HORA_UTIL_CAPILLA",	"FICHA_TRANSITO"."MINUTO_UTIL_CAPILLA",	"FICHA_TRANSITO"."IP",	"FICHA_TRANSITO"."SW_TITULAR_FALL",	"FICHA_TRANSITO"."SW_OTROS_PAGOS",	"FICHA_TRANSITO"."VALOR_OTROS_PAGOS",	"FICHA_TRANSITO"."SW_PASE_SEPULTACION",	"FICHA_TRANSITO"."SW_ALTO_IMPACTO",	"FICHA_TRANSITO"."OBS_ALTO_IMPACTO",	"FICHA_TRANSITO"."COD_OBS_CUERPO",	"FICHA_TRANSITO"."VALOR_EXHUMACION",	"FICHA_TRANSITO"."SW_EXHUMACION",	"FICHA_TRANSITO"."CORRELATIVO_FICHA"
				INTO 		:ls_cod_ejec,									:ldt_fec_sep,									:ll_hora,						:ll_min,								:ll_cod_fune,									:ls_nom_fall2,									:ls_ap_pat_fall2,							:ls_ap_mat_fall2,							:ls_dir_fall,								:ls_nro_dire_fall,								:ls_depto_fall,									:ls_block_fall,									:ls_pob_fall,										:ls_sector_fall,						:ls_cod_comuna_fall,							:ls_cod_ciudad_fall,							:ldt_fec_defuncion,						:ls_est_responso,							:ll_rut_diacono,						:ls_dv_diacono,						:ldt_fec_nac_fall,								:ll_rut_fall,								:ls_dv_fall,							:ls_cod_estado_fall,						:ll_cod_parque_desde,						:ll_cod_parque_hacia,						:ls_pase_sepult,								:ls_causa_fall,									:ls_capilla_vela,								:ls_dire_capilla,								:ldb_val_der_esp,												:ls_cod_parentesco,							:ldb_monto_cancelar,						:ll_folio,										:ls_obs,									:ls_base,						:ls_serie,						:ll_numero,						:ls_sector2,					:ls_sepultura2,					:ls_num_tec,								:ll_capacidad,						:ls_nivel,						:ll_cod_parque2,						:ls_nom_tit,								:ls_ap_pat_tit,								:ls_ap_mat_tit,								:ls_direc_tit,									:ls_num_dir_tit,									:ls_depto_tit,											:ls_block_tit,											:ls_pob_villa_tit,									:ls_sector_tit,							:ls_cod_comuna_tit,								:ls_cod_ciudad_tit,								:ls_fono_tit,							:ldt_fec_recep,							:ll_hora_recep, 							:ll_min_recep,									:ll_hora_llegada_efec,							:ll_min_llegada_efec,								:ls_vb_estadistico,							:ls_fono_fune,							:ls_cod_est_ctto,									:ll_rut_tit,							:ls_dv_tit,								:ldb_val_mov_sarcof,								:ldb_val_cambio_ubi,										:ldb_val_reduc,							:ldb_val_certif_def,										:ldb_uf_dia,					:ll_edad_fall,								:ls_sexo_fall,								:ls_tipo_via_fall,							:ls_tipo_via_tit,								:ll_corr_int,										:ll_corr_mensual,									:ll_corr_anual,								:ls_estado_reg, 						:ls_cod_reg_pase, 							:ls_inscrip_pase,								:ls_registro_pase,						:ll_anno_pase,						:ldt_fec_pase,							:ldt_fec_sistema,							:ll_hora_def,						:ll_min_def, 							:ls_modif_adm,						:ll_sw_der_sep,								:ll_sw_mov_sercof,							:ll_sw_cambio_ubi,								:ll_sw_reduc,							:ll_sw_certif_def,								:ll_sw_pago_lib,								:ls_periodo_nac,								:ls_cod_tamano_cuerpo,						:ls_obs_fall,										:ls_usar_capilla, 					:ll_hora_util_cap, 							:ll_min_util_cap,									:ls_ip,						:ll_sw_tit_fall, 							:ll_sw_otros_pagos,						:ldb_val_otros_pag,							:ll_sw_pase_sepult,								:ll_sw_alto_impac,						:ls_obs_alto_imp,								:ls_cod_obs_cuerpo,						:ldb_val_axhuma,								:ll_sw_exhuma,								:ll_corr_ficha
				FROM 		"FICHA_TRANSITO"  
				WHERE  ( "FICHA_TRANSITO"."COD_PARQUE" = :ll_cod_parque ) AND  
						 ( "FICHA_TRANSITO"."FECHA_SEPULTACION" = :ldt_fecha_sepult ) AND  
						 ( "FICHA_TRANSITO"."SECTOR" = :ls_sector ) AND  
				...
				USING		sqlca;
				if sqlca.sqlcode=0 then
					INSERT INTO "LOG_FICHA_TRANSITO"  
							 ( "LOG_FICHA_TRANSITO"."CODIGO_EJECUTIVO",	"LOG_FICHA_TRANSITO"."FECHA_SEPULTACION",	"LOG_FICHA_TRANSITO"."HORA",	"LOG_FICHA_TRANSITO"."MINUTOS",	"LOG_FICHA_TRANSITO"."CODIGO_FUNERARIA",	"LOG_FICHA_TRANSITO"."NOMBRE_FALLECIDO",	"LOG_FICHA_TRANSITO"."AP_PATERNO_FALL",	"LOG_FICHA_TRANSITO"."AP_MATERNO_FALL",	"LOG_FICHA_TRANSITO"."DIRECCION_FALL",	"LOG_FICHA_TRANSITO"."NUMERO_DIRECCION_FALL",	"LOG_FICHA_TRANSITO"."DEPTO_DIRECCION_FALL",	"LOG_FICHA_TRANSITO"."BLOCK_DIRECCION_FALL",	"LOG_FICHA_TRANSITO"."POBLACION_VILLA_FALL",	"LOG_FICHA_TRANSITO"."SECTOR_FALL",	"LOG_FICHA_TRANSITO"."CODIGO_COMUNA_FALL",	"LOG_FICHA_TRANSITO"."CODIGO_CIUDAD_FALL",	"LOG_FICHA_TRANSITO"."FECHA_DEFUNCION",	"LOG_FICHA_TRANSITO"."ESTADO_RESPONSO",	"LOG_FICHA_TRANSITO"."RUT_DIACONO",	"LOG_FICHA_TRANSITO"."DV_DIACONO",	"LOG_FICHA_TRANSITO"."FECHA_NACIMIENTO_FALL",	"LOG_FICHA_TRANSITO"."RUT_FALLECIDO",	"LOG_FICHA_TRANSITO"."DV_FALLECIDO",	"LOG_FICHA_TRANSITO"."COD_ESTADO_FALL",	"LOG_FICHA_TRANSITO"."COD_PARQUE_DESDE",	"LOG_FICHA_TRANSITO"."COD_PARQUE_HACIA",	"LOG_FICHA_TRANSITO"."PASE_SEPULTACION",	"LOG_FICHA_TRANSITO"."CAUSA_FALLECIMIENTO",	"LOG_FICHA_TRANSITO"."CAPILLA_VELATORIA",	"LOG_FICHA_TRANSITO"."DIRECCION_CAPILLA",	"LOG_FICHA_TRANSITO"."VALOR_DERECHO_SEPULTACION_UF",	"LOG_FICHA_TRANSITO"."CODIGO_PARENTESCO",	"LOG_FICHA_TRANSITO"."MONTO_CANCELAR",	"LOG_FICHA_TRANSITO"."FOLIO_COMPROBANTE",	"LOG_FICHA_TRANSITO"."OBSERVACION",	"LOG_FICHA_TRANSITO"."BASE",	"LOG_FICHA_TRANSITO"."SERIE",	"LOG_FICHA_TRANSITO"."NUMERO",	"LOG_FICHA_TRANSITO"."SECTOR",	"LOG_FICHA_TRANSITO"."SEPULTURA",	"LOG_FICHA_TRANSITO"."NUMERO_TECNICO",	"LOG_FICHA_TRANSITO"."CAPACIDAD",	"LOG_FICHA_TRANSITO"."NIVEL",	"LOG_FICHA_TRANSITO"."COD_PARQUE",	"LOG_FICHA_TRANSITO"."NOMBRE_TITULAR",	"LOG_FICHA_TRANSITO"."AP_PATERNO_TITULAR",	"LOG_FICHA_TRANSITO"."AP_MATERNO_TITULAR",	"LOG_FICHA_TRANSITO"."DIRECCION_TITULAR",	"LOG_FICHA_TRANSITO"."NUM_DIRECCION_TITULAR",	"LOG_FICHA_TRANSITO"."DEPTO_DIRECCION_TITULAR",	"LOG_FICHA_TRANSITO"."BLOCK_DIRECCION_TITULAR",	"LOG_FICHA_TRANSITO"."POBLACION_VILLA_TITULAR",	"LOG_FICHA_TRANSITO"."SECTOR_TITULAR",	"LOG_FICHA_TRANSITO"."CODIGO_COMUNA_TITULAR",	"LOG_FICHA_TRANSITO"."CODIGO_CIUDAD_TITULAR",	"LOG_FICHA_TRANSITO"."FONO_TITULAR",	"LOG_FICHA_TRANSITO"."FECHA_RECEPCION",	"LOG_FICHA_TRANSITO"."HORA_RECEPCION",	"LOG_FICHA_TRANSITO"."MINUTO_RECEPCION",	"LOG_FICHA_TRANSITO"."HORA_LLEGADA_EFECTIVA",	"LOG_FICHA_TRANSITO"."MINUTO_LLEGADA_EFECTIVA",	"LOG_FICHA_TRANSITO"."VB_ESTADISTICO",	"LOG_FICHA_TRANSITO"."FONO_FUNERARIA",	"LOG_FICHA_TRANSITO"."COD_ESTADO_CONTRATO",	"LOG_FICHA_TRANSITO"."RUT_TITULAR",	"LOG_FICHA_TRANSITO"."DV_TITULAR",	"LOG_FICHA_TRANSITO"."VALOR_MOV_SARCOFAGO",	"LOG_FICHA_TRANSITO"."VALOR_CAMBIO_DE_UBICACION",	"LOG_FICHA_TRANSITO"."VALOR_REDUCCION",	"LOG_FICHA_TRANSITO"."VALOR_CERTIFICADO_DEFUNCION",	"LOG_FICHA_TRANSITO"."UF_DIA",	"LOG_FICHA_TRANSITO"."EDAD_FALLECIDO",	"LOG_FICHA_TRANSITO"."SEXO_FALLECIDO",	"LOG_FICHA_TRANSITO"."TIPO_VIA_FALLECIDO",	"LOG_FICHA_TRANSITO"."TIPO_VIA_TITULAR",	"LOG_FICHA_TRANSITO"."CORRELATIVO_INTERNO",	"LOG_FICHA_TRANSITO"."CORRELATIVO_MENSUAL",	"LOG_FICHA_TRANSITO"."CORRELATIVO_ANUAL",	"LOG_FICHA_TRANSITO"."ESTADO_REG",	"LOG_FICHA_TRANSITO"."COD_REGISTRO_PASE",	"LOG_FICHA_TRANSITO"."INSCRIPCION_PASE",	"LOG_FICHA_TRANSITO"."REGISTRO_PASE",	"LOG_FICHA_TRANSITO"."ANNO_PASE",	"LOG_FICHA_TRANSITO"."FECHA_PASE",	"LOG_FICHA_TRANSITO"."FECHA_SISTEMA",	"LOG_FICHA_TRANSITO"."HORA_DEF",	"LOG_FICHA_TRANSITO"."MINUTO_DEF",	"LOG_FICHA_TRANSITO"."MODIF_ADM",	"LOG_FICHA_TRANSITO"."SW_DERECHO_SEPULT",	"LOG_FICHA_TRANSITO"."SW_MOV_SARCOFAGO",	"LOG_FICHA_TRANSITO"."SW_CAMBIO_UBICACION",	"LOG_FICHA_TRANSITO"."SW_REDUCCION",	"LOG_FICHA_TRANSITO"."SW_CERTIFICADO_DEFUN",	"LOG_FICHA_TRANSITO"."SW_PAGO_LIBERADO",	"LOG_FICHA_TRANSITO"."PERIODO_NACIMIENTO",	"LOG_FICHA_TRANSITO"."COD_TAMANO_CUERPO",	"LOG_FICHA_TRANSITO"."OBSERVACION_FALLECIDO",	"LOG_FICHA_TRANSITO"."USAR_CAPILLA",	"LOG_FICHA_TRANSITO"."HORA_UTIL_CAPILLA",	"LOG_FICHA_TRANSITO"."MINUTO_UTIL_CAPILLA",	"LOG_FICHA_TRANSITO"."IP",	"LOG_FICHA_TRANSITO"."SW_TITULAR_FALL",	"LOG_FICHA_TRANSITO"."SW_OTROS_PAGOS",	"LOG_FICHA_TRANSITO"."VALOR_OTROS_PAGOS",	"LOG_FICHA_TRANSITO"."SW_PASE_SEPULTACION",	"LOG_FICHA_TRANSITO"."SW_ALTO_IMPACTO",	"LOG_FICHA_TRANSITO"."OBS_ALTO_IMPACTO",	"LOG_FICHA_TRANSITO"."COD_OBS_CUERPO",	"LOG_FICHA_TRANSITO"."VALOR_EXHUMACION",	"LOG_FICHA_TRANSITO"."SW_EXHUMACION",	"CORRELATIVO_FICHA",	"USUARIO_ELIMINA" )
...
tab_1.tabpage_1.dw_ant_fall.setfocus()
tab_1.tabpage_1.dw_ant_fall.setcolumn('rut_fallecido')
OpenWithParm(w_buscar_ficha, "CT")
end event
...
ls_sw									= wf_validar()
if ls_sw = 'S' then
	ret 								= MessageBox('Actualizar', "Desea Grabar Ficha Cadaver en Transito", Question!, YesNo!, 2)
	IF ret = 1 THEN
		wf_setear_datos()
		...
		if tab_1.tabpage_3.dw_ficha_sepult.update()=1 then
			...
			for ll_indi=1 to ll_tot_reg
				...
				if isnull(tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(ll_indi,'correlativo_ficha')) or tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(ll_indi,'correlativo_ficha')=0 then
					SELECT	MAX("FICHA_TRANSITO"."CORRELATIVO_FICHA")  
					INTO 		:ll_max_ficha  
					FROM 		"FICHA_TRANSITO"  
					WHERE		"FICHA_TRANSITO"."COD_PARQUE" = :ll_parque
					USING		sqlca;
					...
					if sqlca.sqlcode=0 then
						...
						if ll_tot_reg>0 then
							...
							if ll_count_reg_aux=0 or isnull(ll_count_reg_aux) then
								...
								ls_asunto				= 'AVISO DE RECEPCION DE CADAVERES PARA EL DIA '+STRING(ldt_fech_sepult,"dd/mm/yyyy")+' HORA: '+string(ll_hora_sepult,'00')+' '+string(ll_minuto_sepult,'00')+' enviado por: '+ls_nom_usuario+' PARQUE: '+ls_descrip_parque
								ls_texto 				= 'Recordamos que se GENERO Ficha de Cadaver en Transito a Realizarse el día '+string(ldt_fech_sepult,'dd/mm/yyyy')+' a las '+string(ll_hora_sepult,'00')+':'+string(ll_minuto_sepult,'00')+', Sector: '+ls_sector+' Nº Sepultura: '+ls_sepultura+' Nº Técnico: '+ls_numero_tecni+', el Nombre del Fallecido es '+ls_nombre_fall+' '+ls_ap_pat_fall+' '+ls_ap_mat_fall
							else
								if (ll_hora_sepult_aux <> ll_hora_sepult and ll_min_sepult_aux <> ll_minuto_sepult) then
									ls_asunto			= 'AVISO MODIFICACION DE RECEPCION DE CADAVERES PARA EL DIA '+STRING(ldt_fech_sepult,"dd/mm/yyyy")+' HORA: '+string(ll_hora_sepult,'00')+' '+string(ll_minuto_sepult,'00')+' enviado por : '+ls_nom_usuario+' PARQUE: '+ls_descrip_parque
									ls_texto 			= 'Recordamos que se MODIFICO HORARIO Ficha de Cadaver en Transito a Realizarse el día '+string(ldt_fech_sepult,'dd/mm/yyyy')+' a las '+string(ll_hora_sepult,'00')+':'+string(ll_minuto_sepult,'00')+', Sector: '+ls_sector+' Nº Sepultura: '+ls_sepultura+' Nº Técnico: '+ls_numero_tecni+', el Nombre del Fallecido es '+ls_nombre_fall+' '+ls_ap_pat_fall+' '+ls_ap_mat_fall
								end if
							end if
...
integer height = 600
string title = "none"
string dataobject = "dw_ingreso_ficha_transito_print"
...
integer height = 2276
long backcolor = 67108864
string text = "  Ficha Cadaver en Transito"
...
long backcolor = 67108864
string text = "Ficha Recepción Cadaver en Transito"
boolean focusrectangle = false
end type
...
integer taborder = 20
string title = "none"
string dataobject = "dw_ingreso_ficha_transito"
...
event itemchanged;String	ls_columna,ls_base, ls_ciudad,ls_serie,ls_sector_sepult,ls_nro_sepultura,ls_estado_ctto,&
			ls_nro_tecnico,ls_dv_titular,ls_nom_titular,ls_ap_pat_titular,ls_ap_mat_titular,&
			ls_cod_tipo_via,ls_direccion_p,ls_nro_part,ls_depto_part,ls_block_part,ls_pob_part,&
			ls_sector_part,ls_comuna_part,ls_ciudad_part,ls_fono_part,ls_sector,ls_sepultura,ls_obs_credito,&
			ls_obs_mantencion,ls_vd_estadistico,ls_nombre_tit,ls_ap_pat_tit,ls_ap_mat_tit, ls_tipo_via_tit,&
			ls_direc_tit,ls_num_dir_tit,ls_dpto_dir_tit,ls_block_dir_tit,ls_pob_villa_tit,ls_sector_tit,&
			ls_cod_ciud_tit,ls_cod_com_tit,ls_fono_titular,ls_cod_ejecutivo,ls_nivel,ls_var_nivel,ls_var_final,&
			ls_nivel_aux,ls_var_cap,ls_dv,ls_parque,ls_estado_reg,ls_cod_age_aux,ls_ciu_tit,ls_pasa,ls_pasa1,&
			ls_est_ctto,ls_descrip_estado,ls_nulo,ls_pasa_ctrol,ls_obs_pase,ls_mensaje_prov,ls_nro_tec_ctto,&
			ls_est_responso
Long		ll_cod_parque,ll_capacidad,ll_mora_cred,ll_mora_mant,ll_rut_titular,ll_hora,ll_count_fosa,&
			ll_minutos,ll_new,ll_resp,ll_hora_recep,ll_minuto_recep,ll_hora_lleg_efec,ll_minu_lleg_efec,&
			ll_new_titular,ll_count_fall,ll_pos,ll_rut,ll_hora_hoy,ll_minutos_hoy,ll_new_fall,ll_new_ara,&
			ll_anno,ll_hora_fijada,ll_min_fijada,ll_parque_tras,ll_count_sep,ll_count_tras,ll_count_suma,&
			ll_count_reserva,ll_parque_aux,ll_count_tiene,ll_sw_pase_sepultacion,ll_ins_fall,ll_count_cap,&
			ll_nulo,ll_capacidad_ctto,ll_nro_tec_ctto,ll_count_red,ll_sw_sin,ll_count_trans,ll_res,ll_count
...
ls_columna				= dwo.name
if ls_columna='sw_sin_sepultura' then
	ll_cod_parque		= this.getitemnumber(this.getrow(),'cod_parque')
	ll_sw_sin			= long(DATA)
	wf_sw_sin_sepultura(ll_cod_parque, ll_sw_sin)
end if
if ls_columna='cod_parque' or ls_columna='sector' or ls_columna='sepultura' or ls_columna='fecha_sepultacion' or &
	ls_columna='fecha_sepultacion_1' then
	ll_cod_parque		= this.getitemnumber(this.getrow(),'cod_parque')
	ls_sector			= this.getitemstring(this.getrow(),'sector')
	ls_sepultura		= this.getitemstring(this.getrow(),'sepultura')
	if not isnull(ll_cod_parque) and ll_cod_parque>0 and not isnull(ls_sector) and ls_sector<>'' and &
		...
		if ls_pasa='S' or ls_pasa1='S' then
			...
			ll_sw_sin			= this.getitemnumber(this.getrow(),'sw_sin_sepultura')
			if ll_sw_sin=0 then
				SELECT	COUNT("FICHA_TRANSITO"."SECTOR")  
				INTO		:ll_count  
				FROM 		"FICHA_TRANSITO"  
				WHERE  ( "FICHA_TRANSITO"."SECTOR" = :ls_sector ) AND  
						 ( "FICHA_TRANSITO"."SEPULTURA" = :ls_sepultura ) AND  
						 ( "FICHA_TRANSITO"."COD_PARQUE" = :ll_cod_parque ) AND  
						 ( "FICHA_TRANSITO"."FECHA_SEPULTACION" = :ldt_fecha_sepult )   
				USING		sqlca;
				if ll_count=0 then
					ll_res			= messagebox("Advertencia","Recuerde Ficha Cadaver en Transito NO tiene Sepultura Asociada, desar Crearla",Exclamation!,YesNo!,2)
					if ll_res=1 then
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'c_estadistico',is_usuario_esta)
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'codigo_ejecutivo',gs_user)
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'sw_pase_sepultacion',1)
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'sw_titular_fall',1)
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'c_estado_reg','S')
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'correlativo_interno',dw_ficha_sepult.rowcount())
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'sw_condolencia',1)
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'sw_dato_funeraria',1)
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'est_uso_firma_digital',1)
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'estado_responso','N')
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'hora',0)
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'minutos',0)
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'hora_recepcion',0)
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'minuto_recepcion',0)
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'hora_llegada_efectiva',0)
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'minuto_llegada_efectiva',0)
						if idw_detalle4.retrieve(ll_cod_parque)=0 then
							idw_detalle4.insertrow(0)
						end if
						tab_1.tabpage_2.dw_ant_titular.enabled	= true
						...
						wf_limpiar_sin_mensaje()
						tab_1.tabpage_2.dw_ant_titular.enabled	= false
						tab_1.tabpage_1.dw_ant_fall.enabled		= false
						tab_1.tabpage_4.dw_aranceles.enabled	= false
					end if
				else
					dw_ficha_sepult.retrieve(ll_cod_parque,ls_sector,ls_sepultura,ldt_fecha_sepult)
					...
					if ls_estado_reg='A' then
						...
						wf_cargar_dw(ls_nom_titular,ls_ap_pat_titular,ls_ap_mat_titular,ll_rut_titular,ls_dv_titular)
					end if
					pb_fin.triggerevent(clicked!)
				end if
			else
				if not isnull(ll_cod_parque) and ll_cod_parque>0 and not isnull(ls_sector) and ls_sector<>'' and &
					...
					if dw_ficha_sepult.retrieve(ll_cod_parque,ls_sector,ls_sepultura,ldt_fecha_sepult)=0 then
						...
						dw_ficha_sepult.setitem(ll_new,'sw_sin_sepultura',ll_sw_sin)
						dw_ficha_sepult.accepttext()
						dw_ficha_sepult.setcolumn('fecha_sepultacion')
								...
								if ls_est_ctto='V' or ls_est_ctto='C' or ls_est_ctto='R' or ls_est_ctto='S' or sqlca.sqlcode=100 then
									if not isnull(ldt_fecha_sepult) then
										...
										if ldt_fecha_sepult <= ldt_fecha_fin and ldt_fecha_sepult >= ldt_fecha_ini then
											...
											if isnull(ls_ap_pat_titular) then ls_ap_pat_titular=''
											if isnull(ls_ap_mat_titular) then ls_ap_mat_titular=''
											ll_resp		= messagebox("Advertencia","Para Solicitante " +string(ll_rut_titular,'###,###,###,###,###')+'-'+ls_dv_titular+' '+ls_nom_titular+' '+ls_ap_pat_titular+' '+ls_ap_mat_titular+" No Existe Ficha Cadaver en Transito, desea Ingresarla",Exclamation!,YesNo!,2)
											if ll_resp=1 then
												is_nuevo						= 'S'
												dw_ficha_sepult.accepttext()
												SELECT sysdate INTO :gdt_fec_sistema  FROM "TASA"  WHERE "TASA"."LOOK" = 1   ;
												...
												if ls_base='O' then
													...
													if sqlca.sqlcode=0 then
														...
														idw_detalle7.retrieve(il_capacidad,ll_cod_parque)
														
														dw_ficha_sepult.setitem(this.getrow(),'numero_tecnico',is_nro_tecnico)
												...
												elseif ls_base='C' then
													SELECT	"CADENA"."ESTADO",	"CADENA"."COD_PARQUE",	"CADENA_MORA"."MORA_CRED",	"CADENA_MORA"."MORA_MANT",	"CLIENTE"."RUT",	"CLIENTE"."DV",	"CLIENTE"."NOMBRE",	"CLIENTE"."A_PATERNO",	"CLIENTE"."A_MATERNO",	"CLIENTE"."TIPO_VIA",	"CLIENTE"."DIRECCION_P",	"CLIENTE"."NUMERO_PARTICULAR",	"CLIENTE"."DEPTO_PARTICULAR",	"CLIENTE"."BLOCK_PARTICULAR",	"CLIENTE"."POBLACION",	"CLIENTE"."SECTOR",	"CLIENTE"."COMUNA",	"CLIENTE"."CIUDAD",	"CLIENTE"."FONO_P",	"CONTRATO"."SECTOR",	"CONTRATO"."SEPULTURA",	"CONTRATO"."FECHA",	"CONTRATO"."CAPACIDAD",		"CONTRATO"."NRO_TEC"
													INTO 		:ls_estado_ctto,		:ll_cod_parque,			:ll_mora_cred,					:ll_mora_mant,					:ll_rut_titular,	:ls_dv_titular,	:ls_nom_titular,		:ls_ap_pat_titular,		:ls_ap_mat_titular,		:ls_cod_tipo_via,			:ls_direccion_p,				:ls_nro_part,							:ls_depto_part,					:ls_block_part,   				:ls_pob_part,				:ls_sector_part, 		:ls_comuna_part,		:ls_ciudad_part,		:ls_fono_part  ,		:ls_sector_sepult,	:ls_nro_sepultura,		:ldt_fecha_ctto,		:ll_capacidad_ctto,			:ll_nro_tec_ctto
													FROM 		"CADENA",	"CADENA_MORA",	"CLIENTE",	"CONTRATO"  
													WHERE  ( "CADENA"."CODIGO" = "CADENA_MORA"."BASE" ) and  
															 ( "CADENA"."SERIE" = "CADENA_MORA"."SERIE" ) and  
															 ( "CADENA"."NUMERO" = "CADENA_MORA"."NUMERO" ) and  
												...
												dw_ficha_sepult.setitem(ll_new,'sw_pase_sepultacion',1)
												dw_ficha_sepult.setitem(ll_new,'sw_titular_fall',1)
												dw_ficha_sepult.setitem(ll_new,'sw_sin_sepultura',1)
		...
		if not isnull(ll_cod_parque) and not isnull(ls_sector) and not isnull(ls_sepultura) and not isnull(ldt_fecha_sepult) then
			...
			if ll_count_fosa > 0 then
				messagebox("Advertencia","No es posible Generar Ficha Cadaver en Transito de Fosa Común")
...
if ls_columna='estado_responso' then
	ls_est_responso	= data
	if ls_est_responso='N' then
...
if ls_columna='capacidad' then
	...
	if idw_detalle7.retrieve(ll_capacidad,ll_cod_parque)=0 then
		idw_detalle7.insertrow(0)
	end if
end if
this.accepttext()
...
//		tab_1.tabpage_3.dw_ficha_sepult.Setitem(this.getrow(),'minuto_def',ll_min_fijada)
	...
	USING		sqlca;
	SELECT	Count("FICHA_TRANSITO"."CODIGO_EJECUTIVO")  
	INTO 		:ll_count_trans
	FROM 		"FICHA_TRANSITO"  
	WHERE  ( "FICHA_TRANSITO"."FECHA_SEPULTACION" = :ldt_fec_tras ) AND 
			 ( "FICHA_TRANSITO"."COD_PARQUE" = :ll_parque_tras ) AND 
			 ( "FICHA_TRANSITO"."HORA_DEF" = :ll_hora_fijada ) AND  
			 ( "FICHA_TRANSITO"."MINUTO_DEF" = :ll_min_fijada )   
	USING		sqlca;
	...
	if isnull(ll_count_trans) then ll_count_trans=0
	ll_count_suma	= ll_count_sep + ll_count_tras + ll_count_red + ll_count_trans
...
event clicked;Long 		ll_hora, ll_minutos,ll_cod_parque,ll_new,ll_resp,ll_numero,ll_mora_cred,ll_mora_mant,ll_count_fosa,ll_hora_recep,ll_minuto_recep,ll_hora_lleg_efec,ll_minu_lleg_efec,ll_rut_titular,ll_new_1,&
			...
			ll_sw_sin,ll_ins_fall,ll_new_titular,ll_new_fall,ll_new_ara,ll_res,ll_count
Datetime	ldt_fecha_sepult,ldt_fecha_ctto,ldt_fecha_recep,ldt_fecha_hoy,ldt_nulo,ldt_fecha_ini,ldt_fecha_fin
Date		ld_fecha
String	ls_columna,ls_estado_reg,ls_sector,ls_sepultura,ls_pasa,ls_pasa1,ls_base,ls_serie,ls_pasa_ctrol,ls_cod_age_aux,ls_est_ctto,ls_dv_titular,ls_nom_titular,ls_ap_pat_titular,ls_ap_mat_titular,&
			ls_sector_sepult,ls_nro_sepultura,ls_estado_ctto,ls_cod_tipo_via,ls_direccion_p,ls_nro_part,ls_depto_part,ls_block_part,ls_pob_part,ls_sector_part,ls_comuna_part,ls_ciudad_part,ls_fono_part,ls_nro_tec_ctto,&
			ls_parque,ls_descrip_estado,ls_ciu_tit,ls_cod_ejecutivo,ls_nro_tecnico,ls_obs_credito,ls_obs_mantencion,ls_vd_estadistico,ls_nombre_tit,ls_ap_pat_tit,ls_ap_mat_tit,ls_tipo_via_tit,ls_direc_tit,&
			ls_num_dir_tit,ls_dpto_dir_tit,ls_block_dir_tit,ls_pob_villa_tit,ls_sector_tit,ls_cod_ciud_tit,ls_cod_com_tit,ls_fono_titular,ls_fecha,ls_ejecutivo,ls_obs,ls_nombre,ls_ap_pat,ls_ap_mat,ls_string,&
			ls_tipo_cons
...
event itemfocuschanged;String	ls_nulo,ls_columna,ls_sector,ls_sepultura
Long		ll_nulo,ll_cod_parque,ll_hora,ll_minutos
Datetime	ldt_nulo,ldt_fecha
...
ls_sector			= this.getitemstring(this.getrow(),'sector')
ls_sepultura		= this.getitemstring(this.getrow(),'sepultura')
ldt_fecha			= this.getitemdatetime(this.getrow(),'fecha_sepultacion')
if ll_cod_parque>0 and not isnull(ls_sector) and not isnull(ls_sepultura) and not isnull(ldt_fecha) then
	ll_hora	= this.getitemnumber(this.getrow(),'hora_recepcion')
	if ll_hora>23 then
		this.setitem(this.getrow(),'hora_recepcion',0)
	end if
	...
	ll_hora	= this.getitemnumber(this.getrow(),'hora_def')
	if ll_hora>23 then
		this.setitem(this.getrow(),'hora_def',0)
	end if
	ll_minutos	= this.getitemnumber(this.getrow(),'minuto_def')
	if ll_minutos>59 then
		this.setitem(this.getrow(),'minuto_def',0)
	end if
...
integer height = 2276
long backcolor = 67108864
string text = "  Antecedente Solicitante"
long tabtextcolor = 33554432
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Antecedentes del Solicitante"
boolean focusrectangle = false
end type
...
integer taborder = 20
string title = "none"
string dataobject = "dw_ingreso_antecedente_solicitante_ficha"
boolean border = false
boolean livescroll = true
end type
...
integer taborder = 20
string title = "none"
string dataobject = "dw_ingreso_antecedente_fall_transito"
boolean border = false
boolean livescroll = true
end type

event itemchanged;String	ls_columna,ls_ciudad,ls_dv,ls_nulo,ls_periodo,ls_usar_capilla,ls_nombre,ls_sexo,ls_tamano
Long		ll_rut,ll_resp,ll_new,ll_year,ll_mes,ll_dia,ll_year_hoy,ll_mes_hoy,ll_dia_hoy,ll_edad,&
			ll_hora,ll_minutos,ll_sw_tit_fall,ll_res,ll_nulo,ll_fila,ll_alto_impacto,ll_pos
...
integer taborder = 20
string title = "none"
string dataobject = "dw_ingreso_aranceles_ficha_transito"
boolean border = false
boolean livescroll = true
end type

event itemchanged;string 	ls_columna,ls_cod_parentesco
double 	ldb_valor_uf_dia,ldb_valor_arancel,ldb_valor_uf,ldb_valor_der,ldb_valor_mov_sar,&
			ldb_valor_cambio,ldb_valor_red,ldb_valor_cert,ldb_total,ldb_valor_otros_p,ldb_valor_otros
datetime ldt_fecha_hoy 
Long		ll_cod_parque,ll_sw_derecho,ll_sw_otros_pagos
...
if ls_columna = 'codigo_parentesco' then 
	...
	if ll_cod_parque>0 then
		if not isnull(ls_cod_parentesco) or ls_cod_parentesco<>'' then
			...
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_mov_sarcofago',1)
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_cambio_ubicacion',1)
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_reduccion',1)
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_certificado_defun',1)
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_otros_pagos',1)
			dw_aranceles.setitem(dw_aranceles.getrow(),'valor_mov_sarcofago',0)
			dw_aranceles.setitem(dw_aranceles.getrow(),'valor_cambio_de_ubicacion',0)
			dw_aranceles.setitem(dw_aranceles.getrow(),'valor_reduccion',0)
			dw_aranceles.setitem(dw_aranceles.getrow(),'valor_certificado_defuncion',0)
			dw_aranceles.setitem(dw_aranceles.getrow(),'valor_otros_pagos',0)
		end if	
	else
...
elseif ls_columna='sw_derecho_sepult' then
	...
	if ll_cod_parque>0 and not isnull(ls_cod_parentesco) then
		...
		ldb_valor_der		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'valor_derecho_sepultacion_uf')
		ldb_valor_mov_sar	= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'valor_mov_sarcofago')
		ldb_valor_cambio	= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'valor_cambio_de_ubicacion')
		ldb_valor_red		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'valor_reduccion')
		ldb_valor_cert		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'valor_certificado_defuncion')
		ldb_valor_otros_p	= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'valor_otros_pagos')
		ldb_total			= round(ldb_valor_der + ldb_valor_mov_sar + ldb_valor_cambio + ldb_valor_red + ldb_valor_cert + ldb_valor_otros_p,4)
		dw_aranceles.setitem(dw_aranceles.getrow(),'monto_cancelar',ldb_total)
	end if
elseif ls_columna='sw_mov_sarcofago' then
	ll_sw_derecho		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_mov_sarcofago')
	ls_cod_parentesco	= dw_aranceles.getitemstring(dw_aranceles.getrow(),'codigo_parentesco')
	ll_cod_parque		= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'cod_parque')
	if ll_cod_parque>0 and not isnull(ls_cod_parentesco) then
		if ll_sw_derecho=1 then
			...
			WHERE 	"CUENTA_CONTABLE_OTROS"."CODIGO_OTROS" = '50'   
			USING		sqlca;
			if sqlca.sqlcode=0 then
				dw_aranceles.setitem(dw_aranceles.getrow(),'valor_mov_sarcofago',ldb_valor_uf)
				dw_aranceles.accepttext()
				dw_aranceles.setfocus()
				dw_aranceles.setcolumn('valor_mov_sarcofago')
			end if
		else
			dw_aranceles.setitem(dw_aranceles.getrow(),'valor_mov_sarcofago',0)
		end if
...
elseif ls_columna='sw_cambio_ubicacion' then
	ll_sw_derecho		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_cambio_ubicacion')
	ls_cod_parentesco	= dw_aranceles.getitemstring(dw_aranceles.getrow(),'codigo_parentesco')
	ll_cod_parque		= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'cod_parque')
	if ll_cod_parque>0 and not isnull(ls_cod_parentesco) then
		if ll_sw_derecho=1 then
			...
			INTO 		:ldb_valor_uf  
			FROM 		"CUENTA_CONTABLE_OTROS"  
			WHERE 	"CUENTA_CONTABLE_OTROS"."CODIGO_OTROS" = '32'   
			USING		sqlca;
			if sqlca.sqlcode=0 then
				dw_aranceles.setitem(dw_aranceles.getrow(),'valor_cambio_de_ubicacion',ldb_valor_uf)
				dw_aranceles.accepttext()
				dw_aranceles.setfocus()
				dw_aranceles.setcolumn('valor_cambio_de_ubicacion')
			end if
		else
			dw_aranceles.setitem(dw_aranceles.getrow(),'valor_cambio_de_ubicacion',0)
		end if
...
elseif ls_columna='sw_reduccion' then
	ll_sw_derecho		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_reduccion')
	ls_cod_parentesco	= dw_aranceles.getitemstring(dw_aranceles.getrow(),'codigo_parentesco')
	ll_cod_parque		= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'cod_parque')
	if ll_cod_parque>0 and not isnull(ls_cod_parentesco) then
		if ll_sw_derecho=1 then
			...
			INTO 		:ldb_valor_uf  
			FROM 		"CUENTA_CONTABLE_OTROS"  
			WHERE 	"CUENTA_CONTABLE_OTROS"."CODIGO_OTROS" = '30'   
			USING		sqlca;
			if sqlca.sqlcode=0 then
				dw_aranceles.setitem(dw_aranceles.getrow(),'valor_reduccion',ldb_valor_uf)
				dw_aranceles.accepttext()
				dw_aranceles.setfocus()
				dw_aranceles.setcolumn('valor_reduccion')
			end if
		else
			dw_aranceles.setitem(dw_aranceles.getrow(),'valor_reduccion',0)
		end if
...
elseif ls_columna='sw_certificado_defun' then
	ll_sw_derecho		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_certificado_defun')
	ls_cod_parentesco	= dw_aranceles.getitemstring(dw_aranceles.getrow(),'codigo_parentesco')
	ll_cod_parque		= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'cod_parque')
	if ll_cod_parque>0 and not isnull(ls_cod_parentesco) then
		if ll_sw_derecho=1 then
			...
			INTO 		:ldb_valor_uf  
			FROM 		"CUENTA_CONTABLE_OTROS"  
			WHERE 	"CUENTA_CONTABLE_OTROS"."CODIGO_OTROS" = '46'   
			USING		sqlca;
			if sqlca.sqlcode=0 then
				dw_aranceles.setitem(dw_aranceles.getrow(),'valor_certificado_defuncion',ldb_valor_uf)
				dw_aranceles.accepttext()
				dw_aranceles.setfocus()
				dw_aranceles.setcolumn('valor_certificado_defuncion')
			end if
		else
			dw_aranceles.setitem(dw_aranceles.getrow(),'valor_certificado_defuncion',0)
		end if
...
elseif ls_columna='sw_otros_pagos' then
	if long(data)=0 then
		dw_aranceles.accepttext()
		dw_aranceles.setfocus()
		dw_aranceles.setcolumn('valor_otros_pagos')
	else
		dw_aranceles.setitem(dw_aranceles.getrow(),'valor_otros_pagos',0)
	end if
	
elseif ls_columna='valor_otros_pagos' then
	ll_sw_otros_pagos	= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_otros_pagos')
	if ll_sw_otros_pagos=0 then
		ldb_valor_otros	= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'valor_otros_pagos')
		if ldb_valor_otros < 50 then
			if isnull(ldb_valor_otros) then ldb_valor_otros=0
			dw_aranceles.setitem(dw_aranceles.getrow(),'valor_otros_pagos',ldb_valor_otros)
			dw_aranceles.accepttext()
			ldb_valor_der		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'valor_derecho_sepultacion_uf')
			ldb_valor_mov_sar	= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'valor_mov_sarcofago')
			ldb_valor_cambio	= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'valor_cambio_de_ubicacion')
			...
			messagebox('Advertencia','Recuerde Ingresar Monto "Otros Pagos" en U.F.')
			dw_aranceles.setitem(dw_aranceles.getrow(),'otros_pagos_origen',0)
			dw_aranceles.setitem(dw_aranceles.getrow(),'otros_pagos_destino',0)
		end if
	else
		dw_aranceles.setitem(dw_aranceles.getrow(),'otros_pagos_origen',0)
		dw_aranceles.setitem(dw_aranceles.getrow(),'otros_pagos_destino',0)
...
elseif ls_columna='sw_pago_liberado' then
	...
	if ll_sw_derecho=0 then
		...
		dw_aranceles.setitem(dw_aranceles.getrow(),'valor_reduccion',0)
		dw_aranceles.setitem(dw_aranceles.getrow(),'valor_certificado_defuncion',0)
		dw_aranceles.setitem(dw_aranceles.getrow(),'monto_cancelar',0)
		dw_aranceles.setitem(dw_aranceles.getrow(),'valor_otros_pagos',0)
	end if
end if
if ls_columna='valor_derecho_sepultacion_uf' or ls_columna='valor_mov_sarcofago' or &
	ls_columna='valor_cambio_de_ubicacion' or ls_columna='valor_reduccion' or &
	ls_columna='valor_certificado_defuncion' or ls_columna='valor_otros_pagos' then
...
event clicked;close(w_ingreso_ficha_cadaver_transito)
end event
