forward
global type w_ingreso_ficha_sepultacion_bkp_iva from window
end type
type cb_qr_sep from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type dw_qr_sepultacion from datawindow within w_ingreso_ficha_sepultacion_bkp_iva
end type
type dw_etiqueta_qr from datawindow within w_ingreso_ficha_sepultacion_bkp_iva
end type
type dw_qr from datawindow within w_ingreso_ficha_sepultacion_bkp_iva
end type
type cb_2 from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type dw_resumen from datawindow within w_ingreso_ficha_sepultacion_bkp_iva
end type
type cb_1 from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type cb_tablas from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type cb_volver from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type cb_print from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type cb_eliminar from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type cb_buscar from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type pb_primer from picturebutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type pb_sigue from picturebutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type pb_antes from picturebutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type pb_fin from picturebutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type cb_grabar from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type cb_limpiar from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type dw_print from datawindow within w_ingreso_ficha_sepultacion_bkp_iva
end type
type tab_1 from tab within w_ingreso_ficha_sepultacion_bkp_iva
end type
...
type cb_cerrar from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type gb_1 from groupbox within w_ingreso_ficha_sepultacion_bkp_iva
end type
type gb_2 from groupbox within w_ingreso_ficha_sepultacion_bkp_iva
end type
type cb_carta_lapida from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type cb_lapida from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
type cb_carta from commandbutton within w_ingreso_ficha_sepultacion_bkp_iva
end type
end forward
...
global w_ingreso_ficha_sepultacion_bkp_iva w_ingreso_ficha_sepultacion_bkp_iva
...
String		is_nro_tecnico,is_usuario_esta,is_nuevo,is_modif,is_dv,is_fono_contacto,is_celular_contacto,is_columna,is_obsval_uso_templo,is_dscto_01,is_dscto_02,&
			is_dscto_03,is_dscto_04,is_dscto_05,is_dscto_06
...
public subroutine wf_setear_datos ();Long		ll_tot_reg,ll_indi,ll_corr_interno,ll_rut_fall,ll_edad_fall,ll_rut_tit,ll_comprobante,ll_hora_def,ll_min_def,ll_sw_derecho_sepult,ll_sw_pago_liberado,ll_hora_util,ll_minuto_util,&
			...
			ll_hora_fin_templo,ll_minuto_fin_templo,ll_sala_templo,ll_sala_velatorio,ll_sw_adicional_1,ll_sw_adicional_2,ll_sw_adicional_3,ll_sw_adicional_4
...
Double	ldb_uf_dia,ldb_der_sepult_uf,ldb_pago_1,ldb_pago_2,ldb_pago_3,ldb_pago_4,ldb_pago_5,ldb_pago_6,ldb_monto_canc,ldb_dscto_1,ldb_dscto_2,ldb_dscto_3,ldb_dscto_4,ldb_dscto_5,&
			...
			ldb_pago_d4,ldb_pago_d5,ldb_pago_d6,ldb_monto_adic_1,ldb_monto_adic_2,ldb_monto_adic_3,ldb_monto_adic_4,ldb_total_adicional
...
ldb_uf_iva_der_sep	= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_fila,'compute_7')
...
public subroutine wf_carga_detalle_boletas (string as_base, string as_serie, long al_numero, long al_corr_interno, long al_rut_tit, date adt_fech_sepult, long al_parque);String		ls_estado_reg,ls_pago_1,ls_pago_2,ls_pago_3,ls_pago_4,ls_pago_5,ls_pago_6,ls_dscto_1,ls_dscto_2,ls_dscto_3,ls_dscto_4,&
			ls_dscto_5,ls_dscto_6,ls_tipo_mov,ls_tipo_cob,ls_adicional_1,ls_adicional_2,ls_adicional_3,ls_adicional_4,ls_tipo_cobro_aux
...
for ll_indi=1 to ll_tot_reg
	...
	ldb_der_sepult_uf			= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'valor_derecho_sepultacion_uf')
	ldb_iva_der_sep_uf		= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'compute_7')
	ll_sw_derecho_sepult		= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'sw_derecho_sepult')
	ll_sw_pago_1				= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'sw_pago_1')
	ll_sw_pago_2				= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'sw_pago_2')
	ll_sw_pago_3				= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'sw_pago_3')
			...
			if (ll_total_apagar = 0 or ll_total_apagar = 1) then
				if ldb_der_sepult_uf + ldb_iva_der_sep_uf > 0 then
					if ls_dscto_1='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf = ldb_dscto_1 then ls_tipo_cob = 'BE'
					elseif ls_dscto_2='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf = ldb_dscto_2 then ls_tipo_cob = 'BE'
					elseif ls_dscto_3='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf = ldb_dscto_3 then ls_tipo_cob = 'BE'
					elseif ls_dscto_4='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf = ldb_dscto_4 then ls_tipo_cob = 'BE'
					elseif ls_dscto_5='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf = ldb_dscto_5 then ls_tipo_cob = 'BE'
					elseif ls_dscto_6='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf = ldb_dscto_6 then ls_tipo_cob = 'BE'
					end if
				end if
				if ls_pago_1='21' then
					if ls_dscto_1='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_1 = ldb_dscto_1 then ls_tipo_cob = 'BE'
					elseif ls_dscto_2='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_1 = ldb_dscto_2 then ls_tipo_cob = 'BE'
					elseif ls_dscto_3='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_1 = ldb_dscto_3 then ls_tipo_cob = 'BE'
					elseif ls_dscto_4='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_1 = ldb_dscto_4 then ls_tipo_cob = 'BE'
					elseif ls_dscto_5='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_1 = ldb_dscto_5 then ls_tipo_cob = 'BE'
					elseif ls_dscto_6='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_1 = ldb_dscto_6 then ls_tipo_cob = 'BE'
					end if	
				elseif ls_pago_2='21' then
					if ls_dscto_1='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_2 = ldb_dscto_1 then ls_tipo_cob = 'BE'
					elseif ls_dscto_2='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_2 = ldb_dscto_2 then ls_tipo_cob = 'BE'
					elseif ls_dscto_3='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_2 = ldb_dscto_3 then ls_tipo_cob = 'BE'
					elseif ls_dscto_4='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_2 = ldb_dscto_4 then ls_tipo_cob = 'BE'
					elseif ls_dscto_5='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_2 = ldb_dscto_5 then ls_tipo_cob = 'BE'
					elseif ls_dscto_6='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_2 = ldb_dscto_6 then ls_tipo_cob = 'BE'
					end if	
				elseif ls_pago_3='21' then
					if ls_dscto_1='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_3 = ldb_dscto_1 then ls_tipo_cob = 'BE'
					elseif ls_dscto_2='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_3 = ldb_dscto_2 then ls_tipo_cob = 'BE'
					elseif ls_dscto_3='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_3 = ldb_dscto_3 then ls_tipo_cob = 'BE'
					elseif ls_dscto_4='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_3 = ldb_dscto_4 then ls_tipo_cob = 'BE'
					elseif ls_dscto_5='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_3 = ldb_dscto_5 then ls_tipo_cob = 'BE'
					elseif ls_dscto_6='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_3 = ldb_dscto_6 then ls_tipo_cob = 'BE'
					end if	
				elseif ls_pago_4='21' then
					if ls_dscto_1='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_4 = ldb_dscto_1 then ls_tipo_cob = 'BE'
					elseif ls_dscto_2='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_4 = ldb_dscto_2 then ls_tipo_cob = 'BE'
					elseif ls_dscto_3='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_4 = ldb_dscto_3 then ls_tipo_cob = 'BE'
					elseif ls_dscto_4='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_4 = ldb_dscto_4 then ls_tipo_cob = 'BE'
					elseif ls_dscto_5='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_4 = ldb_dscto_5 then ls_tipo_cob = 'BE'
					elseif ls_dscto_6='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_4 = ldb_dscto_6 then ls_tipo_cob = 'BE'
					end if	
				elseif ls_pago_5='21' then
					if ls_dscto_1='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_5 = ldb_dscto_1 then ls_tipo_cob = 'BE'
					elseif ls_dscto_2='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_5 = ldb_dscto_2 then ls_tipo_cob = 'BE'
					elseif ls_dscto_3='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_5 = ldb_dscto_3 then ls_tipo_cob = 'BE'
					elseif ls_dscto_4='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_5 = ldb_dscto_4 then ls_tipo_cob = 'BE'
					elseif ls_dscto_5='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_5 = ldb_dscto_5 then ls_tipo_cob = 'BE'
					elseif ls_dscto_6='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_5 = ldb_dscto_6 then ls_tipo_cob = 'BE'
					end if	
				elseif ls_pago_6='21' then
					if ls_dscto_1='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_6 = ldb_dscto_1 then ls_tipo_cob = 'BE'
					elseif ls_dscto_2='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_6 = ldb_dscto_2 then ls_tipo_cob = 'BE'
					elseif ls_dscto_3='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_6 = ldb_dscto_3 then ls_tipo_cob = 'BE'
					elseif ls_dscto_4='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_6 = ldb_dscto_4 then ls_tipo_cob = 'BE'
					elseif ls_dscto_5='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_6 = ldb_dscto_5 then ls_tipo_cob = 'BE'
					elseif ls_dscto_6='109' then
						if ldb_der_sepult_uf + ldb_iva_der_sep_uf + ldb_pago_6 = ldb_dscto_6 then ls_tipo_cob = 'BE'
					end if	
				end if
//				ls_tipo_cobro_aux			= 'BE'
...
//         "SOL_ESTATUS"."CODIGO_SOLICITUD",   
//         "SOL_ESTATUS"."OBSERVACION",   
//         "SOL_ESTATUS"."ESTADO_REG",   
//         "CADENA"."ESTADO",   
//         "CADENA"."FECHA_RES",   
//         "SOL_COMPROMISO_PAGO"."BASE",   
//         "SOL_COMPROMISO_PAGO"."SERIE",   
//         "SOL_COMPROMISO_PAGO"."NUMERO",   
//         "SOL_COMPROMISO_PAGO"."CORRELATIVO",   
//         "SOL_COMPROMISO_PAGO"."RUT_TITULAR",   
//         "SOL_COMPROMISO_PAGO"."FECHA_NAC",   
//         "SOL_COMPROMISO_PAGO"."ESTADO_CIVIL",   
//         "SOL_COMPROMISO_PAGO"."TOTAL_RENTA",   
//         "SOL_COMPROMISO_PAGO"."GRUPO_F",   
//         "SOL_COMPROMISO_PAGO"."ESTADO_COB",   
//         "SOL_COMPROMISO_PAGO"."FECHA_ACTUAL",   
//         "SOL_COMPROMISO_PAGO"."FECHA_RESCIL",   
//         "SOL_COMPROMISO_PAGO"."MORA_MANT",   
//         "SOL_COMPROMISO_PAGO"."MORA_CREDITO",   
//         "SOL_COMPROMISO_PAGO"."FECHA_SOLICITUD",   
//         "SOL_COMPROMISO_PAGO"."FECVTA_1_VCTO",   
//         "SOL_COMPROMISO_PAGO"."FECVTA_ULT_VCTO",   
//         "SOL_COMPROMISO_PAGO"."FECREP_1_VCTO",   
//         "SOL_COMPROMISO_PAGO"."FECREP_ULT_VCTO",   
//         "SOL_COMPROMISO_PAGO"."COD_AGENTE",   
//         "SOL_COMPROMISO_PAGO"."COD_SUPER",   
//         "SOL_COMPROMISO_PAGO"."ESTATUS_OPERACION",   
//         "SOL_COMPROMISO_PAGO"."ESTATUS_INFORMATICA",   
//         "SOL_COMPROMISO_PAGO"."NOMBRE",   
//         "SOL_COMPROMISO_PAGO"."AP_PATERNO",   
//         "SOL_COMPROMISO_PAGO"."AP_MATERNO",   
//         "SOL_COMPROMISO_PAGO"."MOD_ANT_CLIENTE",   
//         "SOL_COMPROMISO_PAGO"."USUARIO_OPERA",   
//         "SOL_COMPROMISO_PAGO"."FECHA_OPERA",   
//         "SOL_COMPROMISO_PAGO"."USUARIO_INFOR",   
//         "SOL_COMPROMISO_PAGO"."FECHA_INFOR",   
//         "SOL_COMPROMISO_PAGO"."FECHA_PROX_VCTO"
	INTO	:ll_count_sol
    FROM "CADENA",   
         "CLIENTE",   
         "SOL_ESTATUS",   
   ...
   WHERE ( "CADENA"."RUT" = "CLIENTE"."RUT" ) and  
		...
		if ls_base='O' or ls_base='L' or ls_base='D' or ls_base='A' or ls_base='P' or ls_base='F' then
...
on w_ingreso_ficha_sepultacion_bkp_iva.create
...
on w_ingreso_ficha_sepultacion_bkp_iva.destroy
...
event clicked;string   	ls_pasa_dscto='N',ls_sw='S',ls_dv_fall,ls_nombre_fall,ls_ap_pat_fall,ls_ap_mat_fall,ls_direc_fall,ls_dpto_dir_fall,ls_block_dir_fall,ls_sector_fall,ls_villa_fall,ls_ciud_fall,ls_comu_fall,ls_cod_est_fall,ls_causa_fall,&
			...
			ls_estado_titular_tit,ls_est_cob_tit
long 		ll_rut_fall,ret,ll_rut_tit,ll_hora_sepult,ll_minuto_sepult,ll_funeraria,ll_parque,ll_capacidad,ll_cant_sepultados,ll_cap_libre_sep,ll_res_grabar,&
			...
			ll_sala_velatorio,ll_corre_titular,ll_corr_tit
Datetime	ldt_fec_defun,ldt_fec_nac,ldt_fech_sepult,ldt_fech_contrato,ldt_fech_recep,ldt_fecha_hoy,ldt_fecha_sepult1,ldt_fecha_ini_velatorio,ldt_fecha_fin_velatorio,ldt_fec_nac_tit
Double	ldb_uf_dia,ldb_der_sepult_uf,ldb_mov_sarcofago,ldb_cambio_ubica,ldb_reduccion,ldb_cert_defuncion,ldb_monto_canc,ll_numero,ll_num_inven,ldb_dscto_1,&
			...
			ldb_monto_1,ldb_monto_2,ldb_monto_3,ldb_monto_4,ldb_monto_5,ldb_monto_6
//Validar Datos
tab_1.tabpage_4.dw_aranceles.accepttext()
ls_pasa_mora							= 'N'
...
//								INTO 		:ll_corre_titular
//								FROM 	"SOL_CAMBIO_ESTADO_TITULAR"  
//								WHERE 	( "SOL_CAMBIO_ESTADO_TITULAR"."BASE" = :ls_base ) AND  
//											( "SOL_CAMBIO_ESTADO_TITULAR"."SERIE" = :ls_serie ) AND  
//											( "SOL_CAMBIO_ESTADO_TITULAR"."NUMERO" = :ll_numero )
//								USING	sqlca;
//								if sqlca.sqlcode=0 then
//									if ll_corre_titular=0 or isnull(ll_corre_titular) then 
//										ll_corre_titular	= 1
//									else
//										ll_corre_titular++
//									end if
...
//									ll_corre_titular	= 1
//								end if
//								SELECT	"CLIENTE"."TIPO",    "CLIENTE"."A_PATERNO",   "CLIENTE"."A_MATERNO",   "CLIENTE"."DIRECCION_P",   "CLIENTE"."POBLACION",   "CLIENTE"."SECTOR",   "CLIENTE"."COMUNA",   "CLIENTE"."CIUDAD",   "CLIENTE"."FONO_P",  "CLIENTE"."FECHA_NAC",   "CLIENTE"."ESTA_CIVIL",	"CLIENTE"."TIPO_VIA",	"CLIENTE"."NUMERO_PARTICULAR",	"CLIENTE"."DEPTO_PARTICULAR",	"CLIENTE"."BLOCK_PARTICULAR",	"ESTADO_TITULAR" //,   "CLIENTE"."SEXO", "CLIENTE"."DOMICILIO_C",   "CLIENTE"."FONO_C", ,  "CLIENTE"."FECHA_INGR",   "CLIENTE"."TOTAL_RENT",   "CLIENTE"."GRUPO_F",  "CLIENTE"."ESTADO_COBRANZA"  
//								INTO 		:ls_tipo_tit,   		   :ls_a_pat_tit,   				 :ls_a_mat_tit,   				  :ls_direc_p_tit,   				  :ls_pob_tit,   					:ls_sector_cli_tit,		 :ls_comuna_tit,   		  :ls_ciudad_tit,   			:ls_fono_p_tit,   			:ldt_fec_nac_tit,   			 :ls_est_civil_tit,						:ls_tipo_via_tit,				:ls_nro_part_tit,							:ls_depto_part_tit,					:ls_block_part_tit,					:ls_estado_titular_tit //,   			 :ls_sexo_tit   ,			:ls_domic_c_tit,   				:ls_fono_c_tit,,   			 :ld_fec_ing_tit,   				:ll_tot_renta_tit,   			  :ll_grupo_f_tit,,   			 :ls_est_cob_tit
//								FROM 		"CLIENTE"  
//								WHERE 	"CLIENTE"."RUT" = :ll_rut_tit   
//								USING		sqlca;
//								if len(ls_direc_p_tit)>60 then
//									ls_direc_p_tit	= mid(ls_direc_p_tit,1,60)
//								end if
//								if isnull(ls_direc_p_tit) then
//									ls_direc_p_tit	= ''
//								end if
//								if len(ls_pob_tit)>60 then
//									ls_pob_tit	= mid(ls_pob_tit,1,60)
//								end if
//								if isnull(ls_pob_tit) then
//									ls_pob_tit	= ''
//								end if
//								if len(ls_sector_cli_tit)>60 then
//									ls_sector_cli_tit	= mid(ls_sector_cli_tit,1,60)
//								end if
//								if isnull(ls_sector_cli_tit) then
//									ls_sector_cli_tit= ''
//								end if
//								if len(ls_comuna_tit)>60 then
//									ls_comuna_tit	= mid(ls_comuna_tit,1,60)
//								end if
//								if isnull(ls_comuna_tit) then
//									ls_comuna_tit= ''
//								end if
//								if len(ls_ciudad_tit)>15 then
//									ls_ciudad_tit	= mid(ls_ciudad_tit,1,15)
//								end if
//								if isnull(ls_ciudad_tit) then
//									ls_ciudad_tit= ''
//								end if
//								if len(ls_fono_p_tit)>25 then
//									ls_fono_p_tit	= mid(ls_fono_p_tit,1,25)
//								end if
//								if isnull(ls_fono_p_tit) then
//									ls_fono_p_tit= ''
//								end if
//								if isnull(ldt_fec_nac_tit) or date(ldt_fec_nac_tit)=date("01/01/1900") or date(ldt_fec_nac_tit)=date("00/00/0000") then
//									setnull(ldt_fec_nac_tit)
//								end if
//								if len(ls_est_civil_tit)>1 then
//									ls_est_civil_tit	= mid(ls_est_civil_tit,1,1)
//								end if
//								if isnull(ls_est_civil_tit) then
//									ls_est_civil_tit= ''
//								end if
...
////									ls_fono_c	= ''
////								end if
////								if isnull(ll_tot_renta_tit) or ll_tot_renta_tit<0 then
////									ll_tot_renta_tit= 0
////								end if
////								if isnull(ll_grupo_f_tit) or ll_grupo_f_tit<0 then
////									ll_grupo_f_tit	= 0
////								end if
////								if len(ls_est_cob)>2 then
////									ls_est_cob	= mid(ls_est_cob,1,2)
////								end if
//								if isnull(ls_est_cob_tit) then
//									ls_est_cob_tit	= ''
//								end if
...
//											"SERIE" 					= :ls_serie,   
//											"NUMERO" 				= :ll_numero,   
//											"CORRELATIVO" 		= :ll_corr_tit,   
//											"RUT_TITULAR" 		= :ll_rut_tit,
//    											"AP_PATERNO"	 		= :ls_a_pat_tit,
//											"A	P_PATERNO"		= :ls_a_mat_tit,	 
//											"NOMBRE"		 		= :ls_nombre_tit, 
//											"TIPO_VIA"				= :ls_tipo_via_tit,
//											"DIRECCION_P"  		= :ls_direc_p_tit,
//										//	"NUMERO_PARTICU"	= :ls_nro_part_tit,
//										//	"DEPTO_PARTICUL"	= :ls_depto_part_tit,
//										//	"BLOCK_PARTICUL"	= :ls_block_part_tit,
//											"POBLACION"			= :ls_pob_tit,
//											"SECTOR"				= :ls_sector_cli_tit,
//											"COMUNA"				= :ls_comuna_tit,
//											"CIUDAD"				= :ls_ciudad_tit,
//											"FONO_P"				= :ls_fono_p_tit,
//											"FECHA_NAC"			= :ldt_fec_nac_tit,
//											"ESTADO_CIVIL"		= :ls_est_civil_tit//,
//											//"ESTADO_CTTO_FI"	= 1 //,
////											"ESTATUS_OPERAC"	= 0 //,
////											"ESTATUS_INFORM"	= 0
//								WHERE 	"SOL_CAMBIO_ESTADO_TITULAR"."BASE" = :ll_rut_tit and
//											"SOL_CAMBIO_ESTADO_TITULAR"."SERIE" = :ll_rut_tit and
//											"SOL_CAMBIO_ESTADO_TITULAR"."NUMERO" = :ll_rut_tit and
//											"SOL_CAMBIO_ESTADO_TITULAR"."CORRELATIVO" = :ll_rut_tit
//								USING		sqlca;
//								if sqlca.sqlcode=0 then
//									commit;
//								else
...
event itemchanged;String 	ls_columna,ls_cod_parentesco,ls_cod_pago_1,ls_nulo,ls_cod_pago_anterior,ls_cod_pago,ls_cod_pago_2,ls_cod_pago_3,ls_cod_pago_4,ls_cod_pago_5,&
			...
			ls_cod_adic,ls_cod_adic_3,ls_cod_adic_4,ls_adicional_1,ls_adicional_2,ls_adicional_3,ls_adicional_4
Double 	ldb_valor_uf_dia,ldb_valor_arancel,ldb_valor_uf,ldb_valor_der,ldb_total,ldb_valor_1,ldb_valor_2,ldb_valor_3,ldb_valor_4,ldb_valor_5,ldb_valor_6,&
			...
			lb_suma_dscto_2,lb_total_dscto,lb_suma_dscto_3,lb_suma_dscto_4,ldb_uf_iva_derecho_sep
DateTime ldt_fecha_hoy
...
elseif ls_columna='sw_pago_liberado' then
	...
	if ll_sw_derecho=0 then
		...
		if ll_sw_derecha_sep = 0 then
			...
			ldb_uf_iva_derecho_sep	= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'compute_7')
