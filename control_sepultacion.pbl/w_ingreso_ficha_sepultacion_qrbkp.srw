forward
global type w_ingreso_ficha_sepultacion_qrbkp from window
end type
type dw_qr_sepultacion from datawindow within w_ingreso_ficha_sepultacion_qrbkp
end type
type cb_qr_sep from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type dw_qr from datawindow within w_ingreso_ficha_sepultacion_qrbkp
end type
type cb_2 from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type dw_resumen from datawindow within w_ingreso_ficha_sepultacion_qrbkp
end type
type cb_1 from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type cb_tablas from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type cb_volver from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type cb_print from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type cb_eliminar from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type cb_buscar from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type pb_primer from picturebutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type pb_sigue from picturebutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type pb_antes from picturebutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type pb_fin from picturebutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type cb_grabar from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type cb_limpiar from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type dw_print from datawindow within w_ingreso_ficha_sepultacion_qrbkp
end type
type tab_1 from tab within w_ingreso_ficha_sepultacion_qrbkp
end type
...
type cb_cerrar from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type gb_1 from groupbox within w_ingreso_ficha_sepultacion_qrbkp
end type
type gb_2 from groupbox within w_ingreso_ficha_sepultacion_qrbkp
end type
type cb_carta_lapida from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type cb_lapida from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
type cb_carta from commandbutton within w_ingreso_ficha_sepultacion_qrbkp
end type
end forward
...
global w_ingreso_ficha_sepultacion_qrbkp w_ingreso_ficha_sepultacion_qrbkp
...
for ll_indi=1 to ll_tot_reg
	...
	if ll_sw_derecho_sepult=0 then
		...
		if sqlca.sqlcode=0 then
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   				"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA" )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_der_sepult_uf,	'0',   						:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS' )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
	...
	if sqlca.sqlcode=0 then
		INSERT INTO "FICHA_SEPULTACION_PAGO"  
					( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA"  )  
		VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_pago_1,	:ls_pago_1,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS' )  
		USING	sqlca;
		if sqlca.sqlcode=0 then
			commit;
		else
	...
	if sqlca.sqlcode=0 then
		INSERT INTO "FICHA_SEPULTACION_PAGO"  
					( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA"  )  
		VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_dscto_1,	:ls_dscto_1,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS' )  
		USING	sqlca;
		if sqlca.sqlcode=0 then
			commit;
		else
	...
	if sqlca.sqlcode=0 then
		INSERT INTO "FICHA_SEPULTACION_PAGO"  
					( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA"  )  
		VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_pago_2,	:ls_pago_2,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS' )  
		USING	sqlca;
		if sqlca.sqlcode=0 then
			commit;
		else
	...
	if sqlca.sqlcode=0 then
		INSERT INTO "FICHA_SEPULTACION_PAGO"  
					( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA"  )  
		VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_dscto_2,	:ls_dscto_2,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS' )  
		USING	sqlca;
		if sqlca.sqlcode=0 then
			commit;
		else
	...
	if sqlca.sqlcode=0 then
		INSERT INTO "FICHA_SEPULTACION_PAGO"  
					( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA"  )  
		VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_pago_3,	:ls_pago_3,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS' )  
		USING	sqlca;
		if sqlca.sqlcode=0 then
			commit;
		else
	...
	if sqlca.sqlcode=0 then
		INSERT INTO "FICHA_SEPULTACION_PAGO"  
					( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA"  )  
		VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_dscto_3,	:ls_dscto_3,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS' )  
		USING	sqlca;
		if sqlca.sqlcode=0 then
			commit;
		else
	...
	if sqlca.sqlcode=0 then
		INSERT INTO "FICHA_SEPULTACION_PAGO"  
					( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA"  )  
		VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_pago_4,	:ls_pago_4,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS' )  
		USING	sqlca;
		if sqlca.sqlcode=0 then
			commit;
		else
	...
	if sqlca.sqlcode=0 then
		INSERT INTO "FICHA_SEPULTACION_PAGO"  
					( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA"  )  
		VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_dscto_4,	:ls_dscto_4,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS' )  
		USING	sqlca;
		if sqlca.sqlcode=0 then
			commit;
		else
	...
	if sqlca.sqlcode=0 then
		INSERT INTO "FICHA_SEPULTACION_PAGO"  
					( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA"  )  
		VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_pago_5,	:ls_pago_5,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS' )  
		USING	sqlca;
		if sqlca.sqlcode=0 then
			commit;
		else
	...
	if sqlca.sqlcode=0 then
		INSERT INTO "FICHA_SEPULTACION_PAGO"  
					( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA"  )  
		VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_dscto_5,	:ls_dscto_5,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS' )  
		USING	sqlca;
		if sqlca.sqlcode=0 then
			commit;
		else
	...
	if sqlca.sqlcode=0 then
		INSERT INTO "FICHA_SEPULTACION_PAGO"  
					( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA"  )  
		VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_pago_6,	:ls_pago_6,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS' )  
		USING	sqlca;
		if sqlca.sqlcode=0 then
			commit;
		else
	...
	if sqlca.sqlcode=0 then
		INSERT INTO "FICHA_SEPULTACION_PAGO"  
					( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA"  )  
		VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_dscto_6,	:ls_dscto_6,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS' )  
		USING	sqlca;
		if sqlca.sqlcode=0 then
			commit;
		else
...
on w_ingreso_ficha_sepultacion_qrbkp.create
...
this.Control[]={this.dw_qr_sepultacion,&
this.cb_qr_sep,&
this.dw_qr,&
this.cb_2,&
this.dw_resumen,&
...
on w_ingreso_ficha_sepultacion_qrbkp.destroy
...
event clicked;String		ls_sector,ls_sepultura,ls_nombre_tit,ls_ap_pat_tit,ls_ap_mat_tit,ls_dv_tit,ls_direc_tit,ls_num_dir_tit,&
			...
			ls_nom_archivo,ls_file_cbb,ls_dir,ls_print = 'S',ls_mat_fall,ls_nombre_parque,ls_categoria
...
event clicked;string   	ls_pasa_dscto='N',ls_sw='S',ls_dv_fall,ls_nombre_fall,ls_ap_pat_fall,ls_ap_mat_fall,ls_direc_fall,ls_dpto_dir_fall,ls_block_dir_fall,ls_sector_fall,ls_villa_fall,ls_ciud_fall,ls_comu_fall,ls_cod_est_fall,ls_causa_fall,&
			...
			ls_cod_pago_1,ls_cod_pago_2,ls_cod_pago_3,ls_cod_pago_4,ls_cod_pago_5,ls_cod_pago_6,ls_uso_velatorio,ls_observacion_velatorio
long 		ll_rut_fall,ret,ll_rut_tit,ll_hora_sepult,ll_minuto_sepult,ll_funeraria,ll_parque,ll_capacidad,ll_cant_sepultados,ll_cap_libre_sep,ll_res_grabar,&
			...
			ll_sala_velatorio
Datetime	ldt_fec_defun,ldt_fec_nac,ldt_fech_sepult,ldt_fech_contrato,ldt_fech_recep,ldt_fecha_hoy,ldt_fecha_sepult1,ldt_fecha_ini_velatorio,ldt_fecha_fin_velatorio
...
double 	ldb_valor_uf_dia,ldb_valor_arancel,ldb_valor_uf,ldb_valor_der,ldb_total,ldb_valor_1,ldb_valor_2,ldb_valor_3,ldb_valor_4,ldb_valor_5,ldb_valor_6,&
			...
			ll_suma_valor,ldb_valor,ldb_valor_condolencia,ldb_valor_dscto_be,ldb_monto_condo,ldb_valor_templovelatorio
datetime ldt_fecha_hoy 
Long		ll_cod_parque,ll_sw_derecho,ll_sw_otros_pagos,ll_sw_pago_1,ll_sw_pago_anterior,ll_sw_pago_3,ll_sw_pago_4,ll_sw_pago_5,ll_sw_pago_6,&
			...
			ll_cod_benef_det,ll_sw_condolencia,ll_count_benef,ll_sum_condolencia,ls_pasa_m,ll_sum_templo_velatorio=0
...
elseif ls_columna='sw_pago_liberado' then
	...
	if ll_sw_derecho=0 then
		il_sw_dscto_01					= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_dscto_1')
		is_dscto_01						= dw_aranceles.getitemstring(dw_aranceles.getrow(),'dscto_otro_1')
		ldb_dscto_01					= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_dscto_1')
		il_sw_dscto_02					= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_dscto_2')
		is_dscto_02						= dw_aranceles.getitemstring(dw_aranceles.getrow(),'dscto_otro_2')
		ldb_dscto_02					= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_dscto_2')
		il_sw_dscto_03					= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_dscto_3')
		is_dscto_03						= dw_aranceles.getitemstring(dw_aranceles.getrow(),'dscto_otro_3')
		ldb_dscto_03					= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_dscto_3')
		il_sw_dscto_04					= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_dscto_4')
		is_dscto_04						= dw_aranceles.getitemstring(dw_aranceles.getrow(),'dscto_otro_4')
		ldb_dscto_04					= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_dscto_4')
		il_sw_dscto_05					= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_dscto_5')
		is_dscto_05						= dw_aranceles.getitemstring(dw_aranceles.getrow(),'dscto_otro_5')
		ldb_dscto_05					= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_dscto_5')
		il_sw_dscto_06					= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_dscto_6')
		is_dscto_06						= dw_aranceles.getitemstring(dw_aranceles.getrow(),'dscto_otro_6')
		ldb_dscto_06					= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_dscto_6')
