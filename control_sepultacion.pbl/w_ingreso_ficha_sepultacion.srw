forward
global type w_ingreso_ficha_sepultacion from window
end type
type cb_qr_sep from commandbutton within w_ingreso_ficha_sepultacion
end type
type dw_qr_sepultacion from datawindow within w_ingreso_ficha_sepultacion
end type
type dw_etiqueta_qr from datawindow within w_ingreso_ficha_sepultacion
end type
type dw_qr from datawindow within w_ingreso_ficha_sepultacion
end type
type cb_2 from commandbutton within w_ingreso_ficha_sepultacion
end type
type dw_resumen from datawindow within w_ingreso_ficha_sepultacion
end type
type cb_1 from commandbutton within w_ingreso_ficha_sepultacion
end type
type cb_tablas from commandbutton within w_ingreso_ficha_sepultacion
end type
type cb_volver from commandbutton within w_ingreso_ficha_sepultacion
end type
type cb_print from commandbutton within w_ingreso_ficha_sepultacion
end type
type cb_eliminar from commandbutton within w_ingreso_ficha_sepultacion
end type
type cb_buscar from commandbutton within w_ingreso_ficha_sepultacion
end type
type pb_primer from picturebutton within w_ingreso_ficha_sepultacion
end type
type pb_sigue from picturebutton within w_ingreso_ficha_sepultacion
end type
type pb_antes from picturebutton within w_ingreso_ficha_sepultacion
end type
type pb_fin from picturebutton within w_ingreso_ficha_sepultacion
end type
type cb_grabar from commandbutton within w_ingreso_ficha_sepultacion
end type
type cb_limpiar from commandbutton within w_ingreso_ficha_sepultacion
end type
type dw_print from datawindow within w_ingreso_ficha_sepultacion
end type
type tab_1 from tab within w_ingreso_ficha_sepultacion
end type
...
type cb_cerrar from commandbutton within w_ingreso_ficha_sepultacion
end type
type gb_1 from groupbox within w_ingreso_ficha_sepultacion
end type
type gb_2 from groupbox within w_ingreso_ficha_sepultacion
end type
type cb_carta_lapida from commandbutton within w_ingreso_ficha_sepultacion
end type
type cb_lapida from commandbutton within w_ingreso_ficha_sepultacion
end type
type cb_carta from commandbutton within w_ingreso_ficha_sepultacion
end type
end forward
...
event ue_parentesco pbm_cbnmodified
cb_qr_sep cb_qr_sep
dw_qr_sepultacion dw_qr_sepultacion
...
global w_ingreso_ficha_sepultacion w_ingreso_ficha_sepultacion
...
datawindowchild			idw_detalle5,idw_detalle6,idw_detalle7,idw_detalle8,idw_detalle9,idw_detalle10,idw_detalle16,idw_detalle17,idw_detalle18,&
								idw_detalle20,idw_detalle21,idw_detalle22,idw_detalle23,idw_detalle24,idw_detalle25,idw_detalle26,idw_detalle27,idw_detalle28,&
								idw_detalle29,idw_detalle30,idw_detalle31
Long		il_tab,il_count_reg,il_count_otro,il_hora_ini,il_min_ini,il_hora_fin,il_min_fin,	il_intervalo,il_veces,il_capacidad,il_dw_tit_fall,il_modif1,il_modif2,il_modif3,&
			...
			il_horaval_uso_templo,il_minval_uso_templo,il_horavalfin_uso_templo,il_minvalfin_uso_templo,il_sw_dscto_01,il_sw_dscto_02,il_sw_dscto_03,il_sw_dscto_04,&
			il_sw_dscto_05,il_sw_dscto_06
String		is_nro_tecnico,is_usuario_esta,is_nuevo,is_modif,is_dv,is_fono_contacto,is_celular_contacto,is_columna,is_obsval_uso_templo,is_dscto_01,is_dscto_02,&
			is_dscto_03,is_dscto_04,is_dscto_05,is_dscto_06,is_opcion_base, is_tipo_origen,is_tipo_sep
Datetime	idt_fecha_sistema
Double	ldb_dscto_01,ldb_dscto_02,ldb_dscto_03,ldb_dscto_04,ldb_dscto_05,ldb_dscto_06
end variables
...
public subroutine wf_validar_templo (string as_estado_templo)
public subroutine wf_validar_velatorio (string as_estado_velatorio)
public function double wf_valor_arancel (string as_cod_pago)
public function double wf_valor_adicional (string ls_cod_adic)
public subroutine wf_carga_datos (long al_getrow)
public subroutine wf_sw_pago_1 ()
public subroutine wf_sw_pago_2 ()
public subroutine wf_sw_pago_3 ()
public subroutine wf_sw_pago_4 ()
public subroutine wf_sw_pago_5 ()
public subroutine wf_sw_pago_6 ()
public subroutine wf_sw_dscto_1 ()
public subroutine wf_sw_dscto_2 ()
public subroutine wf_sw_dscto_3 ()
public subroutine wf_sw_dscto_4 ()
public subroutine wf_sw_dscto_5 ()
public subroutine wf_sw_dscto_6 ()
public subroutine wf_total_adicional (long al_fila)
public subroutine wf_valida_seguro_desg ()
end prototypes

event ue_parentesco;wf_parentesco()
end event
...
//	end if
	...
	if (ls_base='O' and ll_numero>=84001 and gs_conexion="Parque El Prado") or &
		(ls_base='O' and ll_numero>=15885 and gs_conexion="Parque La Foresta") or &
		(ls_base='U' and gs_conexion="Parque El Prado") or &
		(ls_base='U' and gs_conexion="Parque La Foresta")then
		SELECT	"CD_FOLIO"."COD_PARQUE",	"CD_FOLIO"."COD_AGENTE"  
		INTO 		:ll_parque_aux,				:ls_cod_age_aux  
		FROM 	"CD_FOLIO"  
		WHERE  ( "CD_FOLIO"."BASE" = :ls_base ) AND  
...
//			 ls_descto_5='109' or ls_descto_5='122' or ls_descto_6='109' or ls_descto_6='122') and (isnull(ls_obs_benef) or ls_obs_benef='-') then
	elseif (((ls_descto_1<>'109' and ls_descto_1<>'122') and not isnull(ls_descto_1)) or ((ls_descto_2<>'109' and ls_descto_2<>'122') and not isnull(ls_descto_2)) or ((ls_descto_3<>'109' and ls_descto_3<>'122') and not isnull(ls_descto_3)) or ((ls_descto_4<>'109' and ls_descto_4<>'122') and not isnull(ls_descto_4)) or &
			((ls_descto_5<>'109' and ls_descto_5<>'122') and not isnull(ls_descto_5)) or ((ls_descto_6<>'109' and ls_descto_6<>'122') and not isnull(ls_descto_6)) ) and (isnull(ls_obs_benef) or ls_obs_benef='-' or ls_obs_benef='') then
	...
	elseif ll_sw_liberado = 0 and (isnull(ls_obs_benef) or ls_obs_benef='-' or ls_obs_benef='') then
		messagebox('Advertencia','Debe Ingresar Observación Beneficio')
		tab_1.SelectedTab	= 4
		tab_1.tabpage_4.dw_aranceles.setfocus()
		tab_1.tabpage_4.dw_aranceles.scrolltorow(ll_indi)
...
public subroutine wf_setear_datos ();Long		ll_tot_reg,ll_indi,ll_corr_interno,ll_rut_fall,ll_edad_fall,ll_rut_tit,ll_comprobante,ll_hora_def,ll_min_def,ll_sw_derecho_sepult,ll_sw_pago_liberado,ll_hora_util,ll_minuto_util,&
			...
			ll_hora_fin_templo,ll_minuto_fin_templo,ll_sala_templo,ll_sala_velatorio,ll_sw_adicional_1,ll_sw_adicional_2,ll_sw_adicional_3,ll_sw_adicional_4,ll_sw_homeja
String		ls_dv_fall,ls_nombre_fall,ls_ap_pat_fall,ls_ap_mat_fall,ls_sexo_fall,ls_tipo_via_fall,ls_direc_fall,ls_num_dir_fall,ls_dpto_dir_fall,ls_block_dir_fall,ls_sector_fall,&
			...
			ls_obs_beneficio,ls_adicional_1,ls_adicional_2,ls_adicional_3,ls_adicional_4
...
Double	ldb_uf_dia,ldb_der_sepult_uf,ldb_pago_1,ldb_pago_2,ldb_pago_3,ldb_pago_4,ldb_pago_5,ldb_pago_6,ldb_monto_canc,ldb_dscto_1,ldb_dscto_2,ldb_dscto_3,ldb_dscto_4,ldb_dscto_5,&
			...
			ldb_pago_d4,ldb_pago_d5,ldb_pago_d6,ldb_monto_adic_1,ldb_monto_adic_2,ldb_monto_adic_3,ldb_monto_adic_4,ldb_total_adicional,ll_llave_fallecido
...
for ll_indi=1 to ll_tot_reg
	...
	ls_comu_fall	   				= tab_1.tabpage_1.dw_ant_fall.GetItemString(ll_indi,'codigo_comuna_fall')
	ls_cod_est_fall   			= tab_1.tabpage_1.dw_ant_fall.GetItemString(ll_indi,'cod_estado_fall')
	ls_causa_fall	   			= TRIM(tab_1.tabpage_1.dw_ant_fall.GetItemString(ll_indi,'causa_fallecimiento'))
	ls_capilla						= TRIM(tab_1.tabpage_1.dw_ant_fall.GetItemString(ll_indi,'capilla_velatoria'))
	...
	ls_obs_alto_impacto		= TRIM(tab_1.tabpage_1.dw_ant_fall.GetItemString(ll_indi,'obs_alto_impacto'))
	...
	ls_obs_templo				= TRIM(tab_1.tabpage_1.dw_ant_fall.GetItemString(ll_indi,'observacion_templo'))
	...
	ll_rut_tit						= tab_1.tabpage_2.dw_ant_titular.GetItemNumber(ll_indi,'rut_titular')
	ls_dv_tit			 			= tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'dv_titular')
	ls_nombre_tit				= TRIM(tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'nombre_titular'))
	ls_ap_pat_tit				= TRIM(tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'ap_paterno_titular'))
	ls_ap_mat_tit				= TRIM(tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'ap_materno_titular'))
	ls_tipo_via_tit   			= tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'tipo_via_titular')
	ls_direc_tit					= TRIM(tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'direccion_titular'))
	ls_num_dir_tit	   			= TRIM(tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'num_direccion_titular'))
	ls_dpto_dir_tit				= TRIM(tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'depto_direccion_titular'))
	ls_block_dir_tit				= TRIM(tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'block_direccion_titular'))
	ls_villa_tit	   				= TRIM(tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'poblacion_villa_titular'))
	ls_sector_tit	   				= TRIM(tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'sector_titular'))
	ls_ciud_tit	 	   			= tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'codigo_ciudad_titular')
	ls_comu_tit	      			= tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'codigo_comuna_titular')
	ls_fono_titular   			= TRIM(tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'fono_titular')	)
	ls_cel_titular   				= TRIM(tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'celular_titular'))
	ls_email						= TRIM(tab_1.tabpage_2.dw_ant_titular.GetItemString(ll_indi,'email_titular'))
	//
	ls_nombre_contac			= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'nombre_contacto'))
	ls_dire_contac   			= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'direccion_contacto'))
	ls_fono_contac   			= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'fono_contacto'))
	ls_cel_contac   				= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'celular_contacto'))
	ls_email_contac   			= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'email_contacto'))
	ls_parentesco_contac   	= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'parentesco_contacto')
	ls_email_pagador			= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'email_pagador'))
	...
	ls_nombre_tercero		= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'nombre_tercero'))
	ls_ap_pater_tercero		= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'ap_paterno_tercero'))
	ls_ap_mater_tercero		= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'ap_materno_tercero'))
	ls_dire_tercero   			= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'direccion_tercero'))
	ls_fono_tercero  			= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'fono_tercero'))
	ls_cel_tercero  				= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'celular_tercero'))
	ls_email_tercero   			= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_indi,'email_tercero'))
	...
	ll_sw_homeja				= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'sw_perfil_homenaje')
	
	/////////////////////////////////////////////// FRANCK ///////////////////////////////////////////////////
	ll_sw_adicional_1			= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'sw_adicional_1')
	ll_sw_adicional_2			= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'sw_adicional_2')
	ll_sw_adicional_3			= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'sw_adicional_3')
	ll_sw_adicional_4			= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'sw_adicional_4')
	...
	ldb_monto_adic_1			= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'monto_adicional_1')
	ldb_monto_adic_2			= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'monto_adicional_2')
	ldb_monto_adic_3			= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'monto_adicional_3')
	ldb_monto_adic_4			= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'monto_adicional_4')
	ldb_total_adicional			= tab_1.tabpage_4.dw_aranceles.GetItemNumber(ll_indi,'total_adicional_1')
	...
	tab_1.tabpage_3.dw_ficha_sepult.setitem(ll_indi,'sw_perfil_homenaje',ll_sw_homeja)
	
	/////////////////////////////// franck //////////////////////////////////////////////
	
	tab_1.tabpage_3.dw_ficha_sepult.SetItem(ll_indi,'sw_adicional_1',ll_sw_adicional_1)
	tab_1.tabpage_3.dw_ficha_sepult.SetItem(ll_indi,'sw_adicional_2',ll_sw_adicional_2)
	tab_1.tabpage_3.dw_ficha_sepult.SetItem(ll_indi,'sw_adicional_3',ll_sw_adicional_3)
	tab_1.tabpage_3.dw_ficha_sepult.SetItem(ll_indi,'sw_adicional_4',ll_sw_adicional_4)
	
	tab_1.tabpage_3.dw_ficha_sepult.SetItem(ll_indi,'adicional_1',ls_adicional_1)
	tab_1.tabpage_3.dw_ficha_sepult.SetItem(ll_indi,'adicional_2',ls_adicional_2)
	tab_1.tabpage_3.dw_ficha_sepult.SetItem(ll_indi,'adicional_3',ls_adicional_3)
	tab_1.tabpage_3.dw_ficha_sepult.SetItem(ll_indi,'adicional_4',ls_adicional_4)
	
	tab_1.tabpage_3.dw_ficha_sepult.SetItem(ll_indi,'monto_adicional_1',ldb_monto_adic_1)
	tab_1.tabpage_3.dw_ficha_sepult.SetItem(ll_indi,'monto_adicional_2',ldb_monto_adic_2)
	tab_1.tabpage_3.dw_ficha_sepult.SetItem(ll_indi,'monto_adicional_3',ldb_monto_adic_3)
	tab_1.tabpage_3.dw_ficha_sepult.SetItem(ll_indi,'monto_adicional_4',ldb_monto_adic_4)
	
	tab_1.tabpage_3.dw_ficha_sepult.SetItem(ll_indi,'total_adicional',ldb_total_adicional)
	...
	tab_1.tabpage_1.dw_ant_fall.setitem(ll_indi,'poblacion_villa_fall',ls_villa_fall)
	tab_1.tabpage_1.dw_ant_fall.setitem(ll_indi,'causa_fallecimiento',ls_causa_fall)
	tab_1.tabpage_1.dw_ant_fall.setitem(ll_indi,'capilla_velatoria',ls_capilla)
	tab_1.tabpage_1.dw_ant_fall.setitem(ll_indi,'direccion_capilla',ls_dir_capilla)
	tab_1.tabpage_1.dw_ant_fall.setitem(ll_indi,'observacion_fallecido',ls_obs_fall)
	tab_1.tabpage_1.dw_ant_fall.setitem(ll_indi,'obs_alto_impacto',ls_obs_alto_impacto)
	tab_1.tabpage_1.dw_ant_fall.setitem(ll_indi,'observacion_templo',ls_obs_templo)
	...
	tab_1.tabpage_2.dw_ant_titular.setitem(ll_indi,'email_titular',ls_email)
	...
	tab_1.tabpage_2.dw_ant_titular.setitem(ll_indi,'fono_contacto',ls_fono_contac)
	...
	tab_1.tabpage_2.dw_ant_titular.setitem(ll_indi,'email_pagador',ls_email_pagador)
	tab_1.tabpage_2.dw_ant_titular.setitem(ll_indi,'nombre_tercero',ls_nombre_tercero)
	tab_1.tabpage_2.dw_ant_titular.setitem(ll_indi,'ap_paterno_tercero',ls_ap_pater_tercero)
	tab_1.tabpage_2.dw_ant_titular.setitem(ll_indi,'ap_materno_tercero',ls_ap_mater_tercero)
	tab_1.tabpage_2.dw_ant_titular.setitem(ll_indi,'direccion_tercero',ls_dire_tercero)
	tab_1.tabpage_2.dw_ant_titular.setitem(ll_indi,'fono_tercero',ls_fono_tercero)
	tab_1.tabpage_2.dw_ant_titular.setitem(ll_indi,'celular_tercero',ls_cel_tercero)
	tab_1.tabpage_2.dw_ant_titular.setitem(ll_indi,'email_tercero',ls_email_tercero)
...
public subroutine wf_cargar_datos ();String	ls_cod_ejecutivo,ls_sector,ls_sepultura,ls_base,ls_serie,ls_estado_ctto,ls_nro_tecnico,ls_obs_credito,ls_obs_mantencion,ls_vd_estadistico,ls_dv_titular,ls_nombre_tit,ls_ap_pat_tit,&
			ls_ap_mat_tit,ls_tipo_via_tit,ls_direc_tit,ls_num_dir_tit,ls_dpto_dir_tit,ls_block_dir_tit,ls_pob_villa_tit,ls_sector_tit,ls_cod_ciud_tit,ls_cod_com_tit,ls_fono_titular,ls_nro_tec_ctto,&
			ls_tipo_cons
Long		ll_cod_parque,ll_hora,ll_minutos,ll_mora_cred,ll_mora_mant,ll_hora_recep,ll_minuto_recep,ll_hora_lleg_efec,ll_minu_lleg_efec,ll_rut_titular,ll_new_titular,ll_capacidad_ctto,ll_nro_tec_ctto,&
...
ls_sector						= TRIM(tab_1.tabpage_3.dw_ficha_sepult.getitemstring(1,'sector'))
ls_sepultura					= TRIM(tab_1.tabpage_3.dw_ficha_sepult.getitemstring(1,'sepultura'))
...
ls_nro_tecnico   			= TRIM(tab_1.tabpage_3.dw_ficha_sepult.getitemstring(1,'numero_tecnico'))
...
ls_obs_credito				= TRIM(tab_1.tabpage_3.dw_ficha_sepult.getitemstring(1,'observacion_credito'))
ll_mora_mant      			= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(1,'estado_mantencion')
ls_obs_mantencion 		= TRIM(tab_1.tabpage_3.dw_ficha_sepult.getitemstring(1,'observacion_mantencion'))
...
ls_nombre_tit				= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(1,'nombre_titular'))
ls_ap_pat_tit  				= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(1,'ap_paterno_titular'))
ls_ap_mat_tit    			= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(1,'ap_materno_titular'))
ls_tipo_via_tit				= tab_1.tabpage_2.dw_ant_titular.getitemstring(1,'tipo_via_titular')
ls_direc_tit      				= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(1,'direccion_titular'))
ls_num_dir_tit				= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(1,'num_direccion_titular'))
ls_dpto_dir_tit 				= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(1,'depto_direccion_titular'))
ls_block_dir_tit  			= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(1,'block_direccion_titular'))
ls_pob_villa_tit  			= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(1,'poblacion_villa_titular'))
ls_sector_tit					= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(1,'sector_titular'))
...
ls_fono_titular   			= TRIM(tab_1.tabpage_2.dw_ant_titular.getitemstring(1,'fono_titular'))
...
if idw_detalle4.retrieve(ll_cod_parque,is_tipo_origen)=0 then
...
if idw_detalle5.retrieve(ll_cod_parque,is_tipo_sep)=0 then
...
public subroutine wf_actualizar_calculo (long al_fila);Double	ldb_valor_der,ldb_valor_1,ldb_valor_2,ldb_valor_3,ldb_valor_4,ldb_valor_5,ldb_valor_6,ldb_total,ldb_dscto_1,ldb_dscto_2,ldb_dscto_3,ldb_dscto_4,ldb_dscto_5,&
			ldb_dscto_6,ldb_total_dscto,ldb_adicional_1,ldb_adicional_2,ldb_adicional_3,ldb_adicional_4,ldb_total_adicional,ldb_uf_iva_der_sep

tab_1.tabpage_4.dw_aranceles.accepttext()
ldb_valor_der			= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_fila,'valor_derecho_sepultacion_uf')
ldb_uf_iva_der_sep	= round(tab_1.tabpage_4.dw_aranceles.getitemnumber(al_fila,'compute_7'),10)
...
ldb_total					= round(ldb_valor_der + ldb_valor_1 + ldb_valor_2 + ldb_valor_3 + ldb_valor_4 + ldb_valor_5 + ldb_valor_6 + ldb_uf_iva_der_sep,2)
...
ldb_adicional_1				= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_fila,'monto_adicional_1')
ldb_adicional_2				= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_fila,'monto_adicional_2')
ldb_adicional_3				= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_fila,'monto_adicional_3')
ldb_adicional_4				= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_fila,'monto_adicional_4')
ldb_total_adicional			= round(ldb_adicional_1 + ldb_adicional_2 + ldb_adicional_3 + ldb_adicional_4,2)
tab_1.tabpage_4.dw_aranceles.setitem(al_fila,'total_adicional_1',ldb_total_adicional)
tab_1.tabpage_4.dw_aranceles.accepttext()
end subroutine

public subroutine wf_setear_arancel_sw (long al_fila);tab_1.tabpage_4.dw_aranceles.setitem(al_fila,'sw_derecho_sepult',1)
tab_1.tabpage_4.dw_aranceles.setitem(al_fila,'sw_perfil_homenaje',1)
...
WHERE 			( "FICHA_SEPULTACION_PAGO"."BASE" = :as_base ) AND  
					...
					( "FICHA_SEPULTACION_PAGO"."TIPO_FICHA" ='FS' )
USING	sqlca;
if sqlca.sqlcode=0 then
	commit;
else
...
for ll_indi=1 to ll_tot_reg
	...
	if ll_sw_derecho_sepult=0 then
		...
		if sqlca.sqlcode=0 then
			...
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_der_sepult_uf,	'0',   						:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',				:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
...
//					ldb_dscto_6			= ldb_dscto_6 + ldb_iva_der_sep_uf
			...
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA",		"TIPO_COBRO_AUX"  )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_pago_1,	:ls_pago_1,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
...
//					ldb_dscto_1				= round(ldb_dscto_1,2) + ldb_iva_der_sep_uf
			...
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA",		"TIPO_COBRO_AUX"   )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_dscto_1,	:ls_dscto_1,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
...
//					ldb_dscto_6			= ldb_dscto_6 + ldb_iva_der_sep_uf
			...
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA",		"TIPO_COBRO_AUX"   )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_pago_2,	:ls_pago_2,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
	...
	if not isnull(ls_dscto_2) then
		...
		if sqlca.sqlcode=0 then
			...
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA" ,		"TIPO_COBRO_AUX"  )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_dscto_2,	:ls_dscto_2,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
...
//					ldb_dscto_6			= ldb_dscto_6 + ldb_iva_der_sep_uf
			...
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA" ,		"TIPO_COBRO_AUX"  )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_pago_3,	:ls_pago_3,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
...
//					ldb_dscto_3			= ldb_dscto_3 + ldb_iva_der_sep_uf
			...
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA",		"TIPO_COBRO_AUX"   )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_dscto_3,	:ls_dscto_3,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
...
//					ldb_dscto_6			= ldb_dscto_6 + ldb_iva_der_sep_uf
			...
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA",		"TIPO_COBRO_AUX"   )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_pago_4,	:ls_pago_4,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
...
//					ldb_dscto_4			= ldb_dscto_4 + ldb_iva_der_sep_uf
			...
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA" ,		"TIPO_COBRO_AUX"  )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_dscto_4,	:ls_dscto_4,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
...
//					ldb_dscto_6			= ldb_dscto_6 + ldb_iva_der_sep_uf
			...
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA" ,		"TIPO_COBRO_AUX"  )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_pago_5,	:ls_pago_5,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
...
//					ldb_dscto_5			= ldb_dscto_5 + ldb_iva_der_sep_uf
			...
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA" ,		"TIPO_COBRO_AUX"  )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_dscto_5,	:ls_dscto_5,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
...
//					ldb_dscto_6			= ldb_dscto_6 + ldb_iva_der_sep_uf
			...
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA",		"TIPO_COBRO_AUX"   )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_pago_6,	:ls_pago_6,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
...
//					ldb_dscto_6			= ldb_dscto_6 + ldb_iva_der_sep_uf
			...
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   		"CODIGO_OTRO",   	"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA" ,		"TIPO_COBRO_AUX"  )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_dscto_6,	:ls_dscto_6,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
	...
	if not isnull(ls_adicional_1) then
		...
		if sqlca.sqlcode=0 then
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   				"CODIGO_OTRO",   		"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA",		"TIPO_COBRO_AUX"   )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_monto_adc_1,	:ls_adicional_1,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
	...
	if not isnull(ls_adicional_2) then
		...
		if sqlca.sqlcode=0 then
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   				"CODIGO_OTRO",   		"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA",		"TIPO_COBRO_AUX"   )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_monto_adc_2,	:ls_adicional_2,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
	...
	if not isnull(ls_adicional_3) then
		...
		if sqlca.sqlcode=0 then
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   				"CODIGO_OTRO",   		"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA",		"TIPO_COBRO_AUX"   )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_monto_adc_3,	:ls_adicional_3,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
	...
	if not isnull(ls_adicional_4) then
		...
		if sqlca.sqlcode=0 then
			INSERT INTO "FICHA_SEPULTACION_PAGO"  
						( "BASE",  	"SERIE",   	"NUMERO",   	"CORRELATIVO_FICHA",   	"RUT_TITULAR",   "MONTO",   				"CODIGO_OTRO",   		"TIPO_COB",		"TIPO_MOV",   	"FECHA_SEPULTACION",   	"COD_PARQUE",	"TIPO_FICHA" ,		"TIPO_COBRO_AUX"  )  
			VALUES 	( :as_base,  :as_serie,   	:al_numero,   	:al_corr_interno,   			:al_rut_tit,   		:ldb_monto_adc_4,	:ls_adicional_4,   			:ls_tipo_cob,		:ls_tipo_mov,   	:adt_fech_sepult,   			:al_parque,			'FS',					:ls_tipo_cobro_aux )  
			USING	sqlca;
			if sqlca.sqlcode=0 then
				commit;
			else
...
Long		ll_cod_parque,ll_numero,ll_reg,ll_sw_condolencia,ll_cod_benef,ll_cod_benef_det,ll_sum_condolencia=0,ll_sum_templo_velatorio=0,&
			ls_pasa_m=0
Double	ldb_valor_uf_dia,ldb_valor_arancel,ll_valor,ll_suma_valor,ldb_valor,ldb_valor_condolencia,ldb_valor_dscto_be,ldb_valor_templovelatorio
		...
		if sqlca.sqlcode=0 then
			...
			DO WHILE sqlca.sqlcode=0
				...
				if not isnull(ls_cod_mov) and ll_valor > 0 then
					if ( ls_uso_velatorio = 'N' and ll_cod_benef=6 and ll_cod_benef_det=14 ) then
						ls_pasa		= 'N'
					elseif ( ll_cod_benef=4 and ll_cod_benef_det=2 ) or (ll_cod_benef=6 and ll_cod_benef_det=15 ) then
						ls_pasa		= 'S'
					elseif ( ll_cod_benef=4 and ll_cod_benef_det=4 ) then
						ls_pasa		= 'S'
					else
						ls_pasa		= 'S'
					end if
...
//				
					if ls_pasa = 'S' then
						...
						elseif ls_cod_mov = '29' then 
							...
							ldb_valor_templovelatorio	= ll_valor
						end if
						ll_reg ++
			...
			LOOP
			close x2;
			if isnull(ldb_valor_condolencia) then ldb_valor_condolencia=0
			if ll_reg >= 0 then
				...
				if sqlca.sqlcode = 0 then
					...
					tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_1',ldb_valor_dscto_be)
					tab_1.tabpage_4.dw_aranceles.accepttext()
				end if
				if ll_suma_valor > 0 and ls_pasa_m > 0 then
					if ldb_valor_templovelatorio > 0 then
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_2',0)
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_2','151')
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_2',ldb_valor_templovelatorio )
						if ll_suma_valor - ldb_valor_templovelatorio > 0 then
							tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_3',0)
							tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_3','109')
							tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_3',ll_suma_valor - ldb_valor_templovelatorio )
						end if
					end if
					if ll_suma_valor - ldb_valor_templovelatorio > 0 and ldb_valor_templovelatorio = 0 then
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_3',0)
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_3','109')
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_3',ll_suma_valor - ldb_valor_templovelatorio )
					end if////NUEVO
					tab_1.tabpage_4.dw_aranceles.accepttext()
				elseif ll_suma_valor > 0 then
					tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_1',0)
					//dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_1','109')
					if ldb_valor_condolencia > 0 then
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_1','151')
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_1',ldb_valor_condolencia )
						if ll_suma_valor - ldb_valor_condolencia > 0 then
							tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_2',0)
							tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_2','109')
							tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_2',ll_suma_valor - ldb_valor_condolencia )
						end if
					else
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_1',0)
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_1','109')
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_1',ll_suma_valor - ldb_valor_condolencia )
					end if////NUEVO
					tab_1.tabpage_4.dw_aranceles.accepttext()
...
//					//tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_1','109')
//					tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_1','151')
//					tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_1',ll_suma_valor )////NUEVO
//					tab_1.tabpage_4.dw_aranceles.accepttext()
//				end if
...
//				tab_1.tabpage_4.dw_aranceles.setcolumn('valor_derecho_sepultacion_uf')
			...
			if (ll_sw_condolencia = 0 and ll_reg = 0) or (ll_sw_condolencia = 1 and ll_reg > 0) then
				if ls_cod_mov='21' or ls_cod_mov='29' then
	...
	//							( "FICHA_CUENTA_CONTABLE_OTROS"."CODIGO_OTROS" = '21' ) AND  
								( "FICHA_CUENTA_CONTABLE_OTROS"."CODIGO_OTROS" = :ls_cod_mov ) AND
...
public subroutine wf_validar_templo (string as_estado_templo);String		ls_cod_parentesco,ls_base,ls_serie,ls_nulo,ls_uso_velatorio,ls_uso_templo,ls_cod_mov,ls_pasa,ls_cod_movconsulta
Long		ll_cod_parque,ll_numero,ll_reg,ll_sw_condolencia,ll_cod_benef,ll_cod_benef_det,ll_sum_condolencia=0,ll_sum_templo_velatorio=0,&
			ls_pasa_m=0
Double	ldb_valor_uf_dia,ldb_valor_arancel,ll_valor,ll_suma_valor,ldb_valor,ldb_valor_condolencia,ldb_valor_dscto_be
Datetime	ldt_fecha_hoy
...
if ll_cod_parque>0 then
	if not isnull(ls_cod_parentesco) or ls_cod_parentesco<>'' then
		...
		if sqlca.sqlcode=0 then
			...
			ll_sw_condolencia			= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'sw_condolencia')
			ls_uso_velatorio			= tab_1.tabpage_1.dw_ant_fall.getitemstring(tab_1.tabpage_1.dw_ant_fall.getrow(),'usar_capilla')
			ls_uso_templo				= as_estado_templo	//tab_1.tabpage_1.dw_ant_fall.getitemstring(tab_1.tabpage_1.dw_ant_fall.getrow(),'usar_templo')
			DECLARE x2 CURSOR FOR  
			SELECT DISTINCT	"TIPO_PROMOCION_ASOCIADOS"."COD_BENEFICIO",		"TIPO_PROMOCION_ASOCIADOS"."COD_BENEF_DETALLE",	"BENEFICIOS_COMPLEMENTARIO_DET"."COD_MOV_CONSULTA", "CUENTA_CONTABLE_OTROS"."VALOR"
			FROM 	"BENEFICIOS_COMPLEMENTARIO_DET",	"CUENTA_CONTABLE_OTROS",		"TIPO_PROMOCION_ASOCIADOS"  
			WHERE ( "TIPO_PROMOCION_ASOCIADOS"."COD_BENEFICIO" = "BENEFICIOS_COMPLEMENTARIO_DET"."CODIGO" ) and  
			...
			if ll_reg >= 0 then
				...
				if ll_suma_valor > 0 and ls_pasa_m > 0 then
					if ldb_valor_condolencia > 0 then
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_2',0)
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_2','151')
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_2',ldb_valor_condolencia )
						if ll_suma_valor - ldb_valor_condolencia > 0 then
							tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_3',0)
							tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_3','109')
							tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_3',ll_suma_valor - ldb_valor_condolencia )
						end if
					end if
					if ll_suma_valor - ldb_valor_condolencia > 0 and ldb_valor_condolencia = 0 then
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_3',0)
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_3','109')
						tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_3',ll_suma_valor - ldb_valor_condolencia )
					end if////NUEVO
...
public subroutine wf_validar_velatorio (string as_estado_velatorio);String		ls_cod_parentesco,ls_base,ls_serie,ls_nulo,ls_uso_velatorio,ls_uso_templo,ls_cod_mov,ls_pasa,ls_cod_movconsulta
Long		ll_cod_parque,ll_numero,ll_reg,ll_sw_condolencia,ll_cod_benef,ll_cod_benef_det,ll_sum_condolencia=0,ll_sum_templo_velatorio=0,&
			ls_pasa_m=0
Double	ldb_valor_uf_dia,ldb_valor_arancel,ll_valor,ll_suma_valor,ldb_valor,ldb_valor_condolencia,ldb_valor_dscto_be
Datetime	ldt_fecha_hoy
...
if ll_cod_parque>0 then
	if not isnull(ls_cod_parentesco) or ls_cod_parentesco<>'' then
		...
		if sqlca.sqlcode=0 then
			...
			ll_sw_condolencia			= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'sw_condolencia')
			ls_uso_velatorio			= as_estado_velatorio	//tab_1.tabpage_1.dw_ant_fall.getitemstring(tab_1.tabpage_1.dw_ant_fall.getrow(),'usar_capilla')
			ls_uso_templo				= tab_1.tabpage_1.dw_ant_fall.getitemstring(tab_1.tabpage_1.dw_ant_fall.getrow(),'usar_templo')
			DECLARE x2 CURSOR FOR  
			SELECT DISTINCT	"TIPO_PROMOCION_ASOCIADOS"."COD_BENEFICIO",		"TIPO_PROMOCION_ASOCIADOS"."COD_BENEF_DETALLE",	"BENEFICIOS_COMPLEMENTARIO_DET"."COD_MOV_CONSULTA", "CUENTA_CONTABLE_OTROS"."VALOR"
			FROM 	"BENEFICIOS_COMPLEMENTARIO_DET",	"CUENTA_CONTABLE_OTROS",		"TIPO_PROMOCION_ASOCIADOS"  
...
public function double wf_valor_arancel (string as_cod_pago);double	ldb_valor_arancel

//wf_valor_arancel(as_cod_pago)

SELECT 	"CUENTA_CONTABLE_OTROS"."VALOR"  
INTO 		:ldb_valor_arancel  
FROM 	"CUENTA_CONTABLE_OTROS"  
WHERE 	( "CUENTA_CONTABLE_OTROS"."CODIGO_OTROS" = :as_cod_pago ) AND  
			( "CUENTA_CONTABLE_OTROS"."TIPO_COB" = 'L' ) AND  
			( "CUENTA_CONTABLE_OTROS"."TIPO_COMPROBANTE" = 'BE' )  
USING 	sqlca;
if isnull(ldb_valor_arancel) then ldb_valor_arancel=0

Return ldb_valor_arancel

end function

public function double wf_valor_adicional (string ls_cod_adic);DOUBLE ldb_valor_adicional

//wf_valor_adicional()

SELECT DISTINCT "CUENTA_CONTABLE_OTROS"."VALOR"  
INTO :ldb_valor_adicional  
FROM "CUENTA_CONTABLE_OTROS"  
WHERE "CUENTA_CONTABLE_OTROS"."CODIGO_OTROS" = :ls_cod_adic  

USING	sqlca;

if isnull(ldb_valor_adicional) then ldb_valor_adicional=0

RETURN ldb_valor_adicional
end function

public subroutine wf_carga_datos (long al_getrow);

ldb_dscto_01					= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_getrow,'monto_dscto_1')
il_sw_dscto_01					= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_getrow,'sw_dscto_1')
is_dscto_01						= tab_1.tabpage_4.dw_aranceles.getitemstring(al_getrow,'dscto_otro_1')
il_sw_dscto_02					= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_getrow,'sw_dscto_2')
is_dscto_02						= tab_1.tabpage_4.dw_aranceles.getitemstring(al_getrow,'dscto_otro_2')
ldb_dscto_02					= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_getrow,'monto_dscto_2')
il_sw_dscto_03					= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_getrow,'sw_dscto_3')
is_dscto_03						= tab_1.tabpage_4.dw_aranceles.getitemstring(al_getrow,'dscto_otro_3')
ldb_dscto_03					= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_getrow,'monto_dscto_3')
il_sw_dscto_04					= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_getrow,'sw_dscto_4')
is_dscto_04						= tab_1.tabpage_4.dw_aranceles.getitemstring(al_getrow,'dscto_otro_4')
ldb_dscto_04					= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_getrow,'monto_dscto_4')
il_sw_dscto_05					= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_getrow,'sw_dscto_5')
is_dscto_05						= tab_1.tabpage_4.dw_aranceles.getitemstring(al_getrow,'dscto_otro_5')
ldb_dscto_05					= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_getrow,'monto_dscto_5')
il_sw_dscto_06					= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_getrow,'sw_dscto_6')
is_dscto_06						= tab_1.tabpage_4.dw_aranceles.getitemstring(al_getrow,'dscto_otro_6')
ldb_dscto_06					= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_getrow,'monto_dscto_6')

if isnull(il_sw_dscto_01) then il_sw_dscto_01 = 1
if isnull(is_dscto_01) then setnull(is_dscto_01)
if isnull(ldb_dscto_01) then ldb_dscto_01 = 0
if isnull(il_sw_dscto_02) then il_sw_dscto_02 = 1
if isnull(is_dscto_02) then setnull(is_dscto_02)
if isnull(ldb_dscto_02) then ldb_dscto_02 = 0
if isnull(il_sw_dscto_03) then il_sw_dscto_03 = 1
if isnull(is_dscto_03) then setnull(is_dscto_03)
if isnull(ldb_dscto_03) then ldb_dscto_03 = 0
if isnull(il_sw_dscto_04) then il_sw_dscto_04 = 1
if isnull(is_dscto_04) then setnull(is_dscto_04)
if isnull(ldb_dscto_04) then ldb_dscto_04 = 0
if isnull(il_sw_dscto_05) then il_sw_dscto_05 = 1
if isnull(is_dscto_05) then setnull(is_dscto_05)
if isnull(ldb_dscto_05) then ldb_dscto_05 = 0
if isnull(il_sw_dscto_06) then il_sw_dscto_06 = 1
if isnull(is_dscto_06) then setnull(is_dscto_06)
if isnull(ldb_dscto_06) then ldb_dscto_06 = 0

//ldb_dscto_05					= tab_1.tabpage_4.dw_aranceles.getitemnumber( tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_5')
end subroutine

public subroutine wf_sw_pago_1 ();String ls_nulo
Setnull(ls_nulo)
...
public subroutine wf_sw_pago_2 ();String ls_nulo
Setnull(ls_nulo)
...
public subroutine wf_sw_pago_3 ();String ls_nulo
Setnull(ls_nulo)
...
public subroutine wf_sw_pago_4 ();String ls_nulo
SetNull(ls_nulo)
...
public subroutine wf_sw_pago_5 ();String ls_nulo
SetNull(ls_nulo)
...
public subroutine wf_sw_pago_6 ();String ls_nulo
SetNull(ls_nulo)
...
public subroutine wf_sw_dscto_1 ();String ls_nulo
SetNull(ls_nulo)
...
public subroutine wf_sw_dscto_2 ();String ls_nulo
SetNull(ls_nulo)
...
public subroutine wf_sw_dscto_3 ();String ls_nulo
SetNull(ls_nulo)
...
public subroutine wf_sw_dscto_4 ();String ls_nulo
SetNull(ls_nulo)
...
public subroutine wf_sw_dscto_5 ();String ls_nulo
SetNull(ls_nulo)
...
public subroutine wf_sw_dscto_6 ();String ls_nulo
SetNull(ls_nulo)
...
public subroutine wf_total_adicional (long al_fila);Double	ldb_adicio_1,ldb_adicio_2,ldb_adicio_3,ldb_adicio_4,ldb_total_adicio

tab_1.tabpage_4.dw_aranceles.accepttext()
ldb_adicio_1				= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_fila,'monto_adicional_1')
ldb_adicio_2				= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_fila,'monto_adicional_2')
ldb_adicio_3				= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_fila,'monto_adicional_3')
ldb_adicio_4				= tab_1.tabpage_4.dw_aranceles.getitemnumber(al_fila,'monto_adicional_4')
if isNull(ldb_adicio_1) then ldb_adicio_1 = 0 
if isNull(ldb_adicio_2) then ldb_adicio_2 = 0 
if isNull(ldb_adicio_3) then ldb_adicio_3 = 0 
if isNull(ldb_adicio_4) then ldb_adicio_4 = 0 
ldb_total_adicio			= round(ldb_adicio_1+ldb_adicio_2+ldb_adicio_3+ldb_adicio_4,2)
tab_1.tabpage_4.dw_aranceles.setitem(al_fila,'total_adicional',ldb_total_adicio)
end subroutine

public subroutine wf_valida_seguro_desg ();string 	ls_pasa = 'N', ls_base, ls_serie,ls_estado,ls_string
long		ll_ctas_pag_s,ll_plazo,ll_count_sol,ll_sum_est,ll_corr
double	ll_numero
...
if ls_base = 'O' or ls_base='U' then
	SELECT	"OFERTA_V"."CTA_PAG_S",   	"PAGO_OFERTA"."NRO_CUOTAS"  
	INTO 		:ll_ctas_pag_s,   					:ll_plazo  
	...
	if ll_ctas_pag_s < ll_plazo and ls_estado = 'V' then
		SELECT DISTINCT count("SOL_ESTATUS"."NUMERO")
		INTO	:ll_count_sol
		FROM "CADENA",   
				"CLIENTE",   
				"SOL_ESTATUS",   
		...
		WHERE ( "CADENA"."RUT" = "CLIENTE"."RUT" ) and  
				( "SOL_ESTATUS"."BASE" = "SOL_COMPROMISO_PAGO"."BASE" ) and  
				...
				( "CADENA"."CODIGO" = "SOL_COMPROMISO_PAGO"."BASE" ) and  
				( "CADENA"."SERIE" = "SOL_COMPROMISO_PAGO"."SERIE" ) and  
				( "CADENA"."NUMERO" = "SOL_COMPROMISO_PAGO"."NUMERO" ) and  
				( ( "SOL_ESTATUS"."BASE" = :ls_base ) AND  
				( "SOL_ESTATUS"."SERIE" = :ls_serie ) AND  
				( "SOL_ESTATUS"."NUMERO" = :ll_numero ) AND  
				( "SOL_ESTATUS"."CODIGO_SOLICITUD" = '4' ) )  ;
				
		ll_corr = ll_count_sol+1
		if ls_base='O' or ls_base='U' or ls_base='L' or ls_base='D' or ls_base='A' or ls_base='P' or ls_base='F' then
			...
			if sqlca.sqlcode=0 then
				if ls_estado='C' or ls_estado='V' or ls_estado='R' or ls_estado='P' then
					...
					WHERE 	( "SOL_ESTATUS"."BASE" = "SOL_SEGURO_DESG"."BASE" ) and  
								...
								( ( "SOL_SEGURO_DESG"."BASE" = :ls_base ) AND  
								( "SOL_SEGURO_DESG"."SERIE" = :ls_serie ) AND  
								( "SOL_SEGURO_DESG"."NUMERO" = :ll_numero ) AND  
								( "SOL_ESTATUS"."CODIGO_SOLICITUD" = '4' ) )   
					Using		sqlca;
					if sqlca.sqlcode=0 then
						if ll_sum_est=0 or isnull(ll_sum_est) then
							...
							ls_string	= ls_base+'~t'+ls_serie+'~t'+string(ll_numero)+'~t'+'4'+'~t'+string(ll_corr)+'~t'+'N'+'~t'+ls_estado+'~t'+string(date(ldt_fecha_res))
	...
	//		open(w_mantencion_fromulario_solicitudes)
	end if
elseif ls_base = 'C' then
...
on w_ingreso_ficha_sepultacion.create
this.cb_qr_sep=create cb_qr_sep
this.dw_qr_sepultacion=create dw_qr_sepultacion
...
this.Control[]={this.cb_qr_sep,&
this.dw_qr_sepultacion,&
this.dw_etiqueta_qr,&
this.dw_qr,&
this.cb_2,&
this.dw_resumen,&
...
on w_ingreso_ficha_sepultacion.destroy
destroy(this.cb_qr_sep)
destroy(this.dw_qr_sepultacion)
...
is_opcion_base		= Message.StringParm
if is_opcion_base<>'U' then
	w_ingreso_ficha_sepultacion.title								= 'Ficha de Sepultación'
	w_ingreso_ficha_sepultacion.tab_1.tabpage_3.text		= 'Ficha Sepultación'
	w_ingreso_ficha_sepultacion.tab_1.tabpage_3.st_3.text	= 'Ficha de Sepultación'
	w_ingreso_ficha_sepultacion.cb_qr_sep.text				= 'QR Sepultacion'
	is_tipo_origen														= 'FS'
	is_tipo_sep															= 'SE'
else
	w_ingreso_ficha_sepultacion.title								= 'Ficha Columbario'
	w_ingreso_ficha_sepultacion.tab_1.tabpage_3.text		= 'Ficha Columbario'
	w_ingreso_ficha_sepultacion.tab_1.tabpage_3.st_3.text	= 'Ficha Columbario'
	w_ingreso_ficha_sepultacion.cb_qr_sep.text				= 'QR Columbario'
	is_tipo_origen														= 'CO'
	is_tipo_sep															= 'CO'
end if
...
dw_qr_sepultacion.settransobject(sqlca)
...
tab_1.tabpage_4.dw_aranceles.getchild('adicional_1',idw_detalle26)
idw_detalle26.settransobject(sqlca)
if idw_detalle26.retrieve('FS')=0 then
	idw_detalle26.insertrow(0)
end if
tab_1.tabpage_4.dw_aranceles.getchild('adicional_2',idw_detalle27)
idw_detalle27.settransobject(sqlca)
if idw_detalle27.retrieve('FS')=0 then
	idw_detalle27.insertrow(0)
end if
tab_1.tabpage_4.dw_aranceles.getchild('adicional_3',idw_detalle28)
idw_detalle28.settransobject(sqlca)
if idw_detalle28.retrieve('FS')=0 then
	idw_detalle28.insertrow(0)
end if
tab_1.tabpage_4.dw_aranceles.getchild('adicional_4',idw_detalle29)
idw_detalle29.settransobject(sqlca)
if idw_detalle29.retrieve('FS')=0 then
	idw_detalle29.insertrow(0)
end if
tab_1.tabpage_4.dw_aranceles.getchild('adicional_5',idw_detalle30)
idw_detalle30.settransobject(sqlca)
if idw_detalle30.retrieve('FS')=0 then
	idw_detalle30.insertrow(0)
end if
tab_1.tabpage_4.dw_aranceles.getchild('adicional_6',idw_detalle31)
idw_detalle31.settransobject(sqlca)
if idw_detalle31.retrieve('FS')=0 then
...
if gs_conexion	= "Parque El Prado" then
	idw_detalle4.retrieve(1,is_tipo_origen)
elseif gs_conexion = "Parque La Foresta" then
	idw_detalle4.retrieve(11,is_tipo_origen)
end if
...
event clicked;String		ls_sector,ls_sepultura,ls_nombre_tit,ls_ap_pat_tit,ls_ap_mat_tit,ls_dv_tit,ls_direc_tit,ls_num_dir_tit,&
			...
			ls_nom_comp_fall,ls_nom_fall,ls_pat_fall,ls_nom_terc,ls_pat_terc,ls_mat_terc,ls_dv_terc,ls_dire_terc,ls_cbb_code,&
			ls_nom_archivo,ls_file_cbb,ls_dir,ls_print = 'S',ls_mat_fall,ls_nombre_parque,ls_categoria,ls_emp
Long		ll_cod_parque,ll_row,ll_resp,ll_rut_tit,ll_capacidad,ll_hora_sepult,ll_minuto_sepult,ll_funeraria,ll_count,&
			...
			ll_row_reg,ll_rut_terc,ll_res,ll_folio,ll_cod_dcto
Double	ll_numero
date		ld_fech_sepul
...
ld_fech_sepul								= date(tab_1.tabpage_3.dw_ficha_sepult.getitemdatetime(ll_row,'fecha_sepultacion'))
ls_base										= tab_1.tabpage_3.dw_ficha_sepult.getitemstring(ll_row,'base')
ls_serie										= tab_1.tabpage_3.dw_ficha_sepult.getitemstring(ll_row,'serie')
ll_numero									= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(ll_row,'numero')
...
ls_mat_fall									= tab_1.tabpage_1.dw_ant_fall.getitemstring(ll_row,'ap_materno_fall')
ll_rut_fall										= tab_1.tabpage_1.dw_ant_fall.getitemnumber(ll_row,'rut_fallecido')
ls_categoria									= 'SP'
ll_cod_dcto									= 1
//ll_folio										= 1
ls_file_cbb 									= 'C:\mod_cp\consulta\QR_'+string(ll_rut_fall)+'.jpg'	

if tab_1.tabpage_3.dw_ficha_sepult.rowcount()>0 and ll_row>0 and not isnull(ls_sector) and &
	not isnull(ls_sepultura) and ll_cod_parque>0 and ll_hora_sepult>0 and not isnull(ls_base) then
	if isnull(ls_mat_fall) then ls_mat_fall = ' '
	
	SELECT	max("FC_ARCHIVO_IMAGEN"."FOLIO_CREMACION"  )
	INTO 		:ll_folio
	FROM 	"FC_ARCHIVO_IMAGEN"  
	WHERE 	( "FC_ARCHIVO_IMAGEN"."CATEGORIA" = :ls_categoria ) AND
	...
	End If
	ls_cbb_code 						= 'Nombre Fallecido: '+ls_nom_fall+' | '+'Apellido Paterno: '+ls_pat_fall+' | '+'Apellido Materno: '+ls_mat_fall+' | '+' Contrato: '+ls_base+ ' '+ls_serie+ ' ' +string(ll_numero)+ ' | '+'Parque : '+ls_nombre_parque+' | '+'Sector: '+ls_sector+' | '+'Sepultura: '+ ls_sepultura+' | '+'https://www.nuestrosparques.cl/geomobile/?parque='+ string(ll_cod_parque) +'&sector='+ls_sector+'&sepultura='+ls_sepultura
	QRC_FastQRCode(ls_cbb_code, ls_file_cbb)
	ls_nom_archivo						=  'QR_'+string(ll_rut_fall)+'.jpg'
	f_nom_adjuntardoc( 'GUARDAR', 'FICHA',ls_nom_archivo, ls_file_cbb,ls_categoria, ll_cod_dcto, ll_rut_fall,ll_folio,ls_sector,ls_sepultura,ll_cod_parque)
	if dw_qr_sepultacion.retrieve(ll_cod_parque,ls_sector,ls_sepultura,ld_fech_sepul) > 0 then
		if ll_cod_parque = 1 then
			ls_emp	= 'logo_prado_negro.jpg'
		elseif ll_cod_parque = 101 then
			ls_emp	= 'logo_canaan_negro.jpg'
		elseif ll_cod_parque = 102 then
			ls_emp	= 'logo_manantial_negro.jpg'
		elseif ll_cod_parque = 103 then
			ls_emp	= 'logo_santiago_negro.jpg'
		elseif ll_cod_parque = 11 then
			ls_emp	= 'logo_foresta_negro.jpg'
		end if
		dw_qr_sepultacion.Modify("p_2.Filename='"+ls_emp+"'")
		
		ls_emp = 'Bajada Parques.jpg'
		dw_qr_sepultacion.Modify("p_3.Filename='"+ls_emp+"'")
		
		SELECTBLOB	"FC_ARCHIVO_IMAGEN"."IMAGEN"  
		INTO 			:lbl_qr
		FROM 		"FC_ARCHIVO_IMAGEN"  
		WHERE 		( "FC_ARCHIVO_IMAGEN"."FOLIO_CREMACION" = :ll_folio ) AND  
						( "FC_ARCHIVO_IMAGEN"."CATEGORIA" = :ls_categoria ) AND  
						( "FC_ARCHIVO_IMAGEN"."CODIGO_DOCUMENTO" = :ll_cod_dcto ) AND  
						( "FC_ARCHIVO_IMAGEN"."RUT" = :ll_rut_fall ) and
						( "FC_ARCHIVO_IMAGEN"."SECTOR" = :ls_sector )  and
						( "FC_ARCHIVO_IMAGEN"."SEPULTURA" = :ls_sepultura ) and
						( "FC_ARCHIVO_IMAGEN"."COD_PARQUE" = :ll_cod_parque )
		USING	sqlca;
		if sqlca.sqlcode=1 then
			ls_file_cbb 					= ls_dir + 'QR_' + string(ll_rut_fall)+'.jpg'
			f_blobaarchivo( lbl_qr, ls_file_cbb )
			dw_qr_sepultacion.Modify("p_1.Filename='"+ls_file_cbb+"'")
			f_printdlg(dw_qr_sepultacion,gstr_print,w_ingreso_ficha_sepultacion)
			do while ls_print = 'S'
				ll_res						= messagebox("Advertencia","Imprimio Correctamente",Exclamation!,YesNo!,2)
				if ll_res<>1 then
					dw_qr_sepultacion.print()
				else
	...
	if ll_row = 0 or isnull(ll_row) then
		...
		if ll_hora_sepult = 0 or isnull(ll_hora_sepult) then
			messagebox('Advertencia','Falta Ingresar Hora Sepultación')
		end if
		if isnull(ls_sector) or ls_sector = '' then
			messagebox('Advertencia','Falta Ingresar Sector')
		end if
		if isnull(ls_sepultura) or ls_sepultura = '' then
			messagebox('Advertencia','Falta Ingresar Sector')
		end if
		if isnull(ls_base) or ls_base = '' or isnull(ls_serie) or ls_serie = '' or isnull(ll_numero) or ll_numero = 0 then
			messagebox('Advertencia','Falta Ingresar Contrato')
		end if
	end if	
end if	
end event
...
integer height = 244
string title = "none"
string dataobject = "dw_print_qr_servicio"
...
if ll_count_reg>0 then
	...
	if dw_resumen.rowcount() > 0 then 
		f_printdlg(dw_resumen,gstr_print,w_ingreso_ficha_sepultacion)
	end if
end if
end event
...
if ll_count_reg>0 then
	...
	idw_detalle4.settransobject(sqlca)
	idw_detalle4.retrieve(ll_cod_parque,is_tipo_origen)
	
	dw_print.retrieve(ll_cod_parque,ls_sector,ls_sepultura,ldt_fecha_sepult)
	if dw_print.rowcount() > 0 then 
		f_printdlg(dw_print,gstr_print,w_ingreso_ficha_sepultacion)
		dw_print.print()
	end if
end if

/*String		ls_string,ls_nombre,ls_ap_pat,ls_ap_mat,ls_base,ls_serie,ls_dv_fall,ls_cod_otro,ls_descrip,ls_cbb_code,ls_file_cbb,ls_nom_archivo,ls_categoria,&
			ls_dir,ls_print='S'
Double	ll_numero
...
ldt_fecha_recep						= Date(tab_crematorio.tabpage_1.dw_ficha.getitemdatetime(1,'fecha_ingreso_cinerario'))
ll_hora_recep							= tab_crematorio.tabpage_1.dw_ficha.getitemnumber(1,'hora_ingreso_cinerario')
ll_minuto_recep						= tab_crematorio.tabpage_1.dw_ficha.getitemnumber(1,'minuto_ingreso_cinerario')
ls_categoria								= 'FA'
ll_cod_dcto								= 12
...
elseif isnull(ll_minuto_recep) then
	...
	ls_cbb_code 						= 'Nombre Fallecido: '+ls_nombre+' | '+'Apellido Paterno: '+ls_ap_pat+' | '+'Apellido Materno: '+ls_ap_mat+' | '+'Rut Fallecido: '+string(ll_rut_fall)+'-'+ls_dv_fall+' | '+'Fecha Defuncion: '+string(ldt_fec_def)+' | '+'Tipo Servicio: '+ls_descrip+' | '+'Fecha Recepcion: '+string(ldt_fecha_recep)+' | '+'Hora Recepcion: '+string(ll_hora_recep,'00')+':'+string(ll_minuto_recep,'00')+'|'+'Folio Ficha: '+string(ll_folio)
	QRC_FastQRCode(ls_cbb_code, ls_file_cbb)
	ls_nom_archivo						=  'QR_'+string(ll_rut_fall)+'.jpg'
	f_nom_adjuntardoc( 'GUARDAR', 'FICHA',ls_nom_archivo, ls_file_cbb,ls_categoria, ll_cod_dcto, ll_rut_fall,il_folio )
			...
			if ll_count>0 then
				...
				if tab_1.tabpage_3.dw_ficha_sepult.update()=1 then
					...
					if ll_tot_reg = 0 then
						...
						tab_1.tabpage_3.dw_ficha_sepult.setitem(1,'est_uso_firma_digital',1)
						if gs_depto='R' or gs_depto='M' then
...
tab_1.tabpage_1.dw_ant_fall.setfocus()
tab_1.tabpage_1.dw_ant_fall.setcolumn('rut_fallecido')
if is_opcion_base='O' then
	OpenWithParm(w_buscar_ficha, "FS")
elseif is_opcion_base='U' then
	OpenWithParm(w_buscar_ficha, "CO")
end if
end event
...
event clicked;string   	ls_pasa_dscto,ls_sw,ls_dv_fall,ls_nombre_fall,ls_ap_pat_fall,ls_ap_mat_fall,ls_direc_fall,ls_dpto_dir_fall,ls_block_dir_fall,ls_sector_fall,ls_villa_fall,ls_ciud_fall,ls_comu_fall,ls_cod_est_fall,ls_causa_fall,&
			ls_num_dir_fall,ls_dv_tit,ls_nombre_tit,ls_ap_pat_tit,ls_ap_mat_tit,ls_direc_tit,ls_num_dir_tit,ls_dpto_dir_tit,ls_block_dir_tit,ls_sector_tit,ls_villa_tit,ls_ciud_tit,ls_comu_tit,ls_base,&
			ls_serie,ls_estad_contrato,ls_sector,ls_sepultura,ls_numero_tecni,ls_nivel,ls_est_sep_compl,ls_obs_sep_comp,ls_obs_credito,ls_obs_manten,ls_fono_titular,ls_ejecutivo,ls_fono_funera,ls_pase_sepult,&
			...
			ls_cod_pago_1,ls_cod_pago_2,ls_cod_pago_3,ls_cod_pago_4,ls_cod_pago_5,ls_cod_pago_6,ls_uso_velatorio,ls_observacion_velatorio,ls_tipo_tit,&
			ls_a_pat_tit,ls_a_mat_tit,ls_direc_p_tit,ls_pob_tit,ls_sector_cli_tit,ls_comuna_tit,ls_ciudad_tit,ls_fono_p_tit,ls_est_civil_tit,ls_nro_part_tit,ls_depto_part_tit,ls_block_part_tit,&
			ls_estado_titular_tit,ls_est_cob_tit,ls_periodo_nacimiento,ls_cod_regis,ls_inscripcion_pase,ls_funeraria,ls_otorgado_por,base_s,serie_s,ls_sector_s,ls_sepultura_s,ls_nombre_s,ls_ap_pat_s,ls_ap_mat_s,&
			ls_est_s,ls_op_s,ls_dv_s,ls_sexo_s,ls_periodo_s,ls_pase_s,ls_otorgado_por_s,ls_causa_fall_s,ls_enf_obl_s,ls_funeraria_s,ls_boleta_s,ls_carta_aut_s,ll_corr_hist_reg_s,ls_n_tec_s,ls_nivel_s,&
			ls_vta_s,ls_observaciones_s,ls_estado_contrato_s,ls_registro_pase_s,ls_cementerio_origen_s,ls_nro_sarcofago_s,ls_cod_usuario_s,ls_usuario_ult_mod,ls_estado_exhum_s,&
			ls_estado_inhuma_s,ls_estado_ti_s,ls_estado_te_s,ls_estado_re_s,ls_estado_tr_s,ls_estado_crem_s,ls_estado_reg_s,ls_estado_fall_s,ls_base_dest_s,	ls_serie_dest_s,ls_usuario_crea_s,ls_tipo_ficha_s,ls_resol_traslado_nro_s,&
			ls_nuevo,ls_estado_tit,ls_operacion
long 		ll_rut_fall,ret,ll_rut_tit,ll_hora_sepult,ll_minuto_sepult,ll_funeraria,ll_parque,ll_capacidad,ll_cant_sepultados,ll_cap_libre_sep,ll_res_grabar,&
			...
			ll_sw_dscto_2,ll_sw_dscto_3,ll_sw_dscto_4,ll_sw_dscto_5,ll_sw_dscto_6,ll_hora_ini_velatorio,ll_hora_fin_velatorio,ll_minuto_ini_velatorio,ll_minuto_fin_velatorio,&
			ll_sala_velatorio,ll_corre_titular,ll_corr_tit,ll_nm,ll_nl,ll_llave_s,ll_count_parque_s,ll_n_l_s,ll_n_m_s,ll_edad_s,ll_cod_parque_s,ll_llave_anterior_s,ll_folio_encuesta_s,ll_covid_s,ll_ubicacion_cuerpo_s,&
			ll_numero_dest_s,ll_llave,ll_folio,ll_count_fs
Datetime	ldt_fec_defun,ldt_fec_nac,ldt_fech_sepult,ldt_fech_contrato,ldt_fech_recep,ldt_fecha_hoy,ldt_fecha_sepult1,ldt_fecha_ini_velatorio,ldt_fecha_fin_velatorio,ldt_fec_nac_tit,ldt_fec_sepult_s,&
			ldt_fec_nac_s,ldt_fec_fall_s,ldt_fecha_ult_mod_s,ldt_fecha_exhum_s,ldt_fecha_inhuma_s,ldt_fecha_ti_s,ldt_fecha_te_s,ldt_fecha_re_s,ldt_fecha_tr_s,ldt_fecha_crem_s,ldt_fecha_crea_s
Double	ldb_uf_dia,ldb_der_sepult_uf,ldb_mov_sarcofago,ldb_cambio_ubica,ldb_reduccion,ldb_cert_defuncion,ldb_monto_canc,ll_numero,ll_num_inven,ldb_dscto_1,&
			...
			ldb_monto_1,ldb_monto_2,ldb_monto_3,ldb_monto_4,ldb_monto_5,ldb_monto_6,numero_s,ll_rut_s,ll_llave_fallecido
...
ll_numero								= tab_1.tabpage_3.dw_ficha_sepult.GetItemNumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'numero')
ls_uso_velatorio						= tab_1.tabpage_1.dw_ant_fall.getitemstring( tab_1.tabpage_1.dw_ant_fall.getrow(),'usar_capilla')
ldt_fecha_ini_velatorio				= tab_1.tabpage_1.dw_ant_fall.getitemdatetime( tab_1.tabpage_1.dw_ant_fall.getrow(),'fecha_ini_velatorio')
ll_hora_ini_velatorio					= tab_1.tabpage_1.dw_ant_fall.getitemnumber( tab_1.tabpage_1.dw_ant_fall.getrow(),'hora_util_capilla')
ll_minuto_ini_velatorio				= tab_1.tabpage_1.dw_ant_fall.getitemnumber( tab_1.tabpage_1.dw_ant_fall.getrow(),'minuto_util_capilla')
ldt_fecha_fin_velatorio				= tab_1.tabpage_1.dw_ant_fall.getitemdatetime( tab_1.tabpage_1.dw_ant_fall.getrow(),'fecha_fin_velatorio')
ll_hora_fin_velatorio					= tab_1.tabpage_1.dw_ant_fall.getitemnumber( tab_1.tabpage_1.dw_ant_fall.getrow(),'hora_util_capilla_fin')
ll_minuto_fin_velatorio				= tab_1.tabpage_1.dw_ant_fall.getitemnumber( tab_1.tabpage_1.dw_ant_fall.getrow(),'minuto_util_capilla_fin')
ll_sala_velatorio						= tab_1.tabpage_1.dw_ant_fall.getitemnumber( tab_1.tabpage_1.dw_ant_fall.getrow(),'sala_velatorio')
ls_observacion_velatorio				= tab_1.tabpage_1.dw_ant_fall.getitemstring( tab_1.tabpage_1.dw_ant_fall.getrow(),'capilla_velatoria')
...
if ls_pasa_mora='S' then
	...
	ls_cod_pago_1				= tab_1.tabpage_4.dw_aranceles.getitemstring(tab_1.tabpage_4.dw_aranceles.getrow(),'pago_otro_1')
	ldb_monto_1				= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_otro_1')
	ll_sw_pago_2				= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_2')
	ls_cod_pago_2				= tab_1.tabpage_4.dw_aranceles.getitemstring(tab_1.tabpage_4.dw_aranceles.getrow(),'pago_otro_2')
	ldb_monto_2				= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_otro_2')
	ll_sw_pago_3				= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_3')
	ls_cod_pago_3				= tab_1.tabpage_4.dw_aranceles.getitemstring(tab_1.tabpage_4.dw_aranceles.getrow(),'pago_otro_3')
	ldb_monto_3				= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_otro_3')
	ll_sw_pago_4				= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_4')
	ls_cod_pago_4				= tab_1.tabpage_4.dw_aranceles.getitemstring(tab_1.tabpage_4.dw_aranceles.getrow(),'pago_otro_4')
	ldb_monto_4				= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_otro_4')
	ll_sw_pago_5				= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_5')
	ls_cod_pago_5				= tab_1.tabpage_4.dw_aranceles.getitemstring(tab_1.tabpage_4.dw_aranceles.getrow(),'pago_otro_5')
	ldb_monto_5				= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_otro_5')
	ll_sw_pago_6				= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_6')
	ls_cod_pago_6				= tab_1.tabpage_4.dw_aranceles.getitemstring(tab_1.tabpage_4.dw_aranceles.getrow(),'pago_otro_6')
	ldb_monto_6				= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_otro_6')
	if ll_sw_pago_1 = 0 and (isnull(ls_cod_pago_1) or ls_cod_pago_1='') and (isnull(ldb_monto_1) or ldb_monto_1=0) then
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_1',1)
	end if
	if ll_sw_pago_2 = 0 and (isnull(ls_cod_pago_2) or ls_cod_pago_2='') and (isnull(ldb_monto_2) or ldb_monto_2=0) then
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_2',1)
	end if
	if ll_sw_pago_3 = 0 and (isnull(ls_cod_pago_3) or ls_cod_pago_3='') and (isnull(ldb_monto_3) or ldb_monto_3=0) then
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_3',1)
	end if
	if ll_sw_pago_4 = 0 and (isnull(ls_cod_pago_4) or ls_cod_pago_4='') and (isnull(ldb_monto_4) or ldb_monto_4=0) then
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_4',1)
	end if
	if ll_sw_pago_5 = 0 and (isnull(ls_cod_pago_5) or ls_cod_pago_5='') and (isnull(ldb_monto_5) or ldb_monto_5=0) then
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_5',1)
	end if
	if ll_sw_pago_6 = 0 and (isnull(ls_cod_pago_6) or ls_cod_pago_6='') and (isnull(ldb_monto_6) or ldb_monto_6=0) then
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_6',1)
	end if
	ll_sw_dscto_1				= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_1')
	...
	ls_dscto_1					= tab_1.tabpage_4.dw_aranceles.getitemstring(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_1')
	ls_dscto_2					= tab_1.tabpage_4.dw_aranceles.getitemstring(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_2')
	ls_dscto_3					= tab_1.tabpage_4.dw_aranceles.getitemstring(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_3')
	ls_dscto_4					= tab_1.tabpage_4.dw_aranceles.getitemstring(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_4')
	ls_dscto_5					= tab_1.tabpage_4.dw_aranceles.getitemstring(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_5')
	ls_dscto_6					= tab_1.tabpage_4.dw_aranceles.getitemstring(tab_1.tabpage_4.dw_aranceles.getrow(),'dscto_otro_6')
	ldb_dscto_1					= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_1')
	ldb_dscto_2					= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_2')
	ldb_dscto_3					= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_3')
	ldb_dscto_4					= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_4')
	ldb_dscto_5					= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_5')
	ldb_dscto_6					= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'monto_dscto_6')
	if ll_sw_dscto_1 = 0 and (isnull(ls_dscto_1) or ls_dscto_1='') and (isnull(ldb_dscto_1) or ldb_dscto_1=0) then
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_1',1)
	end if
	if ll_sw_dscto_2 = 0 and (isnull(ls_dscto_2) or ls_dscto_2='') and (isnull(ldb_dscto_2) or ldb_dscto_2=0) then
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_2',1)
	end if
	if ll_sw_dscto_3 = 0 and (isnull(ls_dscto_3) or ls_dscto_3='') and (isnull(ldb_dscto_3) or ldb_dscto_3=0) then
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_3',1)
	end if
	if ll_sw_dscto_4 = 0 and (isnull(ls_dscto_4) or ls_dscto_4='') and (isnull(ldb_dscto_4) or ldb_dscto_4=0) then
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_4',1)
	end if
	if ll_sw_dscto_5 = 0 and (isnull(ls_dscto_5) or ls_dscto_5='') and (isnull(ldb_dscto_5) or ldb_dscto_5=0) then
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_5',1)
	end if
	if ll_sw_dscto_6 = 0 and (isnull(ls_dscto_6) or ls_dscto_6='') and (isnull(ldb_dscto_6) or ldb_dscto_6=0) then
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_dscto_6',1)
	end if
	tab_1.tabpage_4.dw_aranceles.accepttext()
...
//					USING		sqlca;
					...
					for ll_indi=1 to ll_tot_reg
						...
						ls_ap_mat_fall				= tab_1.tabpage_1.dw_ant_fall.GetItemString(ll_indi,'ap_materno_fall')
						ls_sexo_fall      			= tab_1.tabpage_1.dw_ant_fall.getItemString(ll_indi,'sexo_fallecido')
						ls_periodo_nacimiento	= tab_1.tabpage_1.dw_ant_fall.getItemString(ll_indi,'periodo_nacimiento')
						ll_edad_fall     				= tab_1.tabpage_1.dw_ant_fall.GetItemNumber(ll_indi,'edad_fallecido')
						ls_tipo_via_fall  			= tab_1.tabpage_1.dw_ant_fall.GetItemString(ll_indi,'tipo_via_fallecido')
						ls_direc_fall					= tab_1.tabpage_1.dw_ant_fall.GetItemString(ll_indi,'direccion_fall')
						ls_num_dir_fall				= tab_1.tabpage_1.dw_ant_fall.GetItemString(ll_indi,'numero_direccion_fall')
	...
	//					if ll_count>0 then
						...
						if Trans_1.sqlcode=0 then
							if (ldt_fec_sepult_s = ldt_fech_sepult and (ls_tipo_ficha_s = 'FS' or isnull(ls_tipo_ficha_s))) then
								ls_nuevo		= 'N'
							else
								ls_nuevo		= 'S'
							end if
...
//											( "FALLECIDOS"."FOLIO_FS" = :ll_corr_ficha ) AND  
//											( "FALLECIDOS"."ESTADO_REG" = 'A' )   ;
						...
						if ls_nuevo='S' then
							...
							if   ll_n_l_s<>ll_nl or ll_n_m_s<>ll_nm or base_s<>ls_base or serie_s<>ls_serie or numero_s<>ll_numero or ls_sector_s<>ls_sector or &
								...
								ls_op_s<>'IN' or ls_op_s<>'CO' or ll_rut_s<>ll_rut_fall or ls_dv_s<>ls_dv_fall or ls_sexo_s<>ls_sexo_fall or ll_edad_s<>ll_edad_fall or ls_periodo_s<>ls_periodo_nacimiento or ldt_fec_nac_s<>ldt_fec_nac or &
...
if ll_resp=1 then
	...
	tab_1.tabpage_4.dw_aranceles.setitem(ll_new,'sw_perfil_homenaje',1)
...
event clicked;Long	ll_cod_parque,ll_tot_reg,ll_indi,ll_sw_adicional_1,ll_sw_adicional_2,ll_sw_adicional_3,ll_sw_adicional_4

ll_sw_adicional_1		= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_adicional_1')
ll_sw_adicional_2		= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_adicional_2')
ll_sw_adicional_3		= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_adicional_3')
ll_sw_adicional_4		= tab_1.tabpage_4.dw_aranceles.getitemnumber(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_adicional_4')

IF isNull(ll_sw_adicional_1) and isNull(ll_sw_adicional_2) and isNull(ll_sw_adicional_3) and isNull(ll_sw_adicional_4) then
	tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_adicional_1',1)
	tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_adicional_2',1)
	tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_adicional_3',1)
	tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_adicional_4',1)
END IF
...
event itemchanged;String		ls_columna,ls_base, ls_ciudad,ls_serie,ls_sector_sepult,ls_nro_sepultura,ls_estado_ctto,ls_nro_tecnico,ls_dv_titular,ls_nom_titular,ls_ap_pat_titular,ls_ap_mat_titular,&
			...
			ls_parentesco,ls_nom3,ls_pat3,ls_mat3,ls_tipo_via,ls_direccion,ls_num_par,ls_block,ls_depto,ls_dv3,ls_fono,ls_celular,ls_email,ls_direc3
Double	ll_numero,ll_rut3
			...
			if not isnull(ll_cod_parque) and ll_cod_parque>0 and not isnull(ls_sector) and ls_sector<>'' and &
				...
				if dw_ficha_sepult.retrieve(ll_cod_parque,ls_sector,ls_sepultura,ldt_fecha_sepult)=0 then
						...
						if ls_base='O' or ls_base='U' then
							if ll_numero=10000000 then
								...
								if Trans_2.sqlcode=0 then
									...
									if (ll_numero <= 84000 and ls_base='O' and gs_conexion	= "Parque El Prado") or &
										(ll_numero <= 15884 and ls_base='O' and gs_conexion	= "Parque La Foresta") then
										ls_pasa_ctrol	= 'S'
									else
										ls_pasa_ctrol	= 'N'
									end if
								...
								if not isnull(ldt_fecha_sepult) then
									...
									if ldt_fecha_sepult <= ldt_fecha_fin and ldt_fecha_sepult >= ldt_fecha_ini then
										...
										if ll_numero = 90000000 then
											...
											if is_opcion_base=ls_base and ls_base='U' then
												ll_resp		= messagebox("Advertencia","Para Titular " +string(ll_rut_titular,'###,###,###,###,###')+'-'+ls_dv_titular+' '+ls_nom_titular+' '+ls_ap_pat_titular+' '+ls_ap_mat_titular+" No Existe Ficha Columbario, desea Ingresarla",Exclamation!,YesNo!,2)
											elseif is_opcion_base='O' and ls_base<>'U' then
												...
												if ls_base='U' then
													messagebox("Advertencia","En Menú Principal debe Seleccionar Ficha de Sepultación")
												else
													messagebox("Advertencia","En Menú Principal debe Seleccionar Ficha Columbario")
												end if
												ll_resp		= 2
											end if
										end if
										if ll_resp=1 then
												...
												if sqlca.sqlcode=0 then
													...
													if dw_ficha_sepult.getitemnumber(this.getrow(),'cod_parque')=ll_cod_parque then
														...
														if is_opcion_base<>'U' then
															ll_resp	= messagebox("Advertencia","Parque Inválido, Promesa Registra "+ls_parque+", desea Cambiar dato",Exclamation!,YesNo!,2)
														elseif is_opcion_base='U' then
															ll_resp	= messagebox("Advertencia","Parque Inválido, Columbario Registra "+ls_parque+", desea Cambiar dato",Exclamation!,YesNo!,2)
														end if
														if ll_resp=1 then
															dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'cod_parque',ll_cod_parque)
															dw_ficha_sepult.accepttext()
													...
													if dw_ficha_sepult.getitemstring(this.getrow(),'sector')=ls_sector_sepult then
														...
														if is_opcion_base<>'U' then
															ll_resp	= messagebox("Advertencia","Sector Inválido, Promesa Registra "+ls_sector_sepult+", desea Cambiar dato",Exclamation!,YesNo!,2)
														elseif is_opcion_base='U' then
															ll_resp	= messagebox("Advertencia","Sector Inválido, Columbario Registra "+ls_sector_sepult+", desea Cambiar dato",Exclamation!,YesNo!,2)
														end if
														if ll_resp=1 then
															dw_ficha_sepult.setitem(this.getrow(),'sector',ls_sector_sepult)
															dw_ficha_sepult.accepttext()
													...
													if dw_ficha_sepult.getitemstring(this.getrow(),'sepultura')=ls_nro_sepultura then
														...
														if is_opcion_base<>'U' then
															ll_resp	= messagebox("Advertencia","Sepultura Inválida, Promesa Registra Nº "+ls_nro_sepultura+", desea Cambiar dato",Exclamation!,YesNo!,2)
														elseif is_opcion_base='U' then
															ll_resp	= messagebox("Advertencia","Sepultura Inválida, Columbario Registra Nº "+ls_nro_sepultura+", desea Cambiar dato",Exclamation!,YesNo!,2)
														end if
														if ll_resp=1 then
															dw_ficha_sepult.setitem(this.getrow(),'sepultura',ls_nro_sepultura)
															dw_ficha_sepult.accepttext()
													...
													SELECT 	"CLIENTE_TERCEROS"."PARENTESCO", 	"CLIENTE_TERCEROS"."NOMBRES_TERCERO",	"CLIENTE_TERCEROS"."APELLIDO_P_TERCERO",	"CLIENTE_TERCEROS"."APELLIDO_M_TERCERO",	"TIPO_VIA"."DESCRIPCION",	"CLIENTE_TERCEROS"."DIRECCION",	"CLIENTE_TERCEROS"."NUMERO_PARTICULAR",	"CLIENTE_TERCEROS"."BLOCK_PARTICULAR",	"CLIENTE_TERCEROS"."DEPTO_TERCERO",	"CLIENTE_TERCEROS"."RUT_TERCERO",	"CLIENTE_TERCEROS"."DV_RUT",	"CLIENTE_TERCEROS"."FONO_PARTICULAR",	"CLIENTE_TERCEROS"."CELULAR",		"CLIENTE_TERCEROS"."EMAIL"  
													INTO		:ls_parentesco,									:ls_nom3,												:ls_pat3,														:ls_mat3,													:ls_tipo_via,							:ls_direccion,								:ls_num_par,												:ls_block,												:ls_depto,											:ll_rut3,											:ls_dv3,									:ls_fono,													:ls_celular,									:ls_email
													FROM 	"CLIENTE_TERCEROS",	"TIPO_VIA"  
													WHERE 	"CLIENTE_TERCEROS"."TIPO_VIA" = "TIPO_VIA"."TIPO_VIA" AND
																"CLIENTE_TERCEROS"."RUT_TITULAR" = :ll_rut_titular   
													USING	sqlca;
													if sqlca.sqlcode=0 then
														ls_direc3			= ls_tipo_via+ ' ' +ls_direccion+ ' N: ' +ls_num_par+ ' D:' +ls_depto+ ' B:' +ls_block
														tab_1.tabpage_2.dw_ant_titular.setitem(tab_1.tabpage_2.dw_ant_titular.getrow(),'rut_tercero',ll_rut3)
														tab_1.tabpage_2.dw_ant_titular.setitem(tab_1.tabpage_2.dw_ant_titular.getrow(),'dv_tercero',ls_dv3)
														tab_1.tabpage_2.dw_ant_titular.setitem(tab_1.tabpage_2.dw_ant_titular.getrow(),'parentesco_tercero',ls_parentesco)
														tab_1.tabpage_2.dw_ant_titular.setitem(tab_1.tabpage_2.dw_ant_titular.getrow(),'nombre_tercero',ls_nom3)
														tab_1.tabpage_2.dw_ant_titular.setitem(tab_1.tabpage_2.dw_ant_titular.getrow(),'ap_paterno_tercero',ls_pat3)
														tab_1.tabpage_2.dw_ant_titular.setitem(tab_1.tabpage_2.dw_ant_titular.getrow(),'ap_materno_tercero',ls_mat3)
														tab_1.tabpage_2.dw_ant_titular.setitem(tab_1.tabpage_2.dw_ant_titular.getrow(),'direccion_tercero',ls_direc3)
														tab_1.tabpage_2.dw_ant_titular.setitem(tab_1.tabpage_2.dw_ant_titular.getrow(),'fono_tercero',ls_fono)
														tab_1.tabpage_2.dw_ant_titular.setitem(tab_1.tabpage_2.dw_ant_titular.getrow(),'celular_tercero',ls_celular)
														tab_1.tabpage_2.dw_ant_titular.setitem(tab_1.tabpage_2.dw_ant_titular.getrow(),'email_tercero',ls_email)
														tab_1.tabpage_2.dw_ant_titular.accepttext()
													end if
											...
											tab_1.tabpage_1.dw_ant_fall.setitem(ll_ins_fall,'hora_util_templo',0)
											tab_1.tabpage_1.dw_ant_fall.setitem(ll_ins_fall,'minuto_util_templo',0)
											tab_1.tabpage_1.dw_ant_fall.setitem(ll_ins_fall,'hora_util_fin_templo',0)
											tab_1.tabpage_1.dw_ant_fall.setitem(ll_ins_fall,'minuto_util_fin_templo',0)
											tab_1.tabpage_1.dw_ant_fall.setitem(ll_ins_fall,'hora_util_capilla',0)
											tab_1.tabpage_1.dw_ant_fall.setitem(ll_ins_fall,'minuto_util_capilla',0)
											tab_1.tabpage_1.dw_ant_fall.setitem(ll_ins_fall,'hora_util_capilla_fin',0)
											tab_1.tabpage_1.dw_ant_fall.setitem(ll_ins_fall,'minuto_util_capilla_fin',0)
											tab_1.tabpage_1.dw_ant_fall.accepttext()
											if gs_depto='R' or gs_depto='M' then
					...
					if ls_estado_reg='A' then
						...
						elseif is_opcion_base='U' then
							ll_resp			= messagebox("Advertencia","Para Titular " +string(ll_rut_titular,'###,###,###,###,###')+'-'+ls_dv_titular+' '+ls_nom_titular+' '+ls_ap_pat_titular+' '+ls_ap_mat_titular+ ", desea Crear OTRA Ficha Columbario",Exclamation!,YesNo!,2)
						end if
						if ll_resp=1 then
				...
				if not isnull(ll_cod_parque) and not isnull(ls_sector) and not isnull(ls_sepultura) and not isnull(ldt_fecha_sepult) then
					...
					if ll_count_fosa > 0 then
						if is_opcion_base<>'U' then
							...
							messagebox("Advertencia","No es posible Generar Ficha Columbario de Fosa Común")
						end if
						dw_ficha_sepult.setitem(dw_ficha_sepult.getrow(),'c_existe_ctto','N')
						dw_ficha_sepult.accepttext()
...
if ls_columna='sw_condolencia' then
	ll_sw_condolencia	= long(data)	//this.getitemnumber(this.getrow(),'sw_condolencia')
...
event clicked;String		ls_estado,ls_columna,ls_fecha,ls_sector,ls_sepultura,ls_base,ls_serie,ls_estado_ctto,ls_nro_tecnico,ls_obs_mantencion,ls_vd_estadistico,ls_obs_credito,ls_estado_reg,ls_dv_titular,ls_nombre_tit,ls_ap_pat_tit,&
			...
			ls_pasa_fosa='N',ls_cel_titular,ls_cel_part,ls_nombre_contac,ls_dire_contac,ls_fono_contac,ls_cel_contac,ls_email_contac,ls_parentesco,ls_nom3,ls_pat3,ls_mat3,ls_tipo_via,ls_direccion,ls_num_par,&
			ls_block,ls_depto,ls_dv3,ls_fono,ls_celular,ls_email,ls_direc3
				...
				if not isnull(ll_cod_parque) and ll_cod_parque>0 and not isnull(ls_sector) and ls_sector<>'' and &
					...
					if ldt_fecha_sepult <= ldt_fecha_fin and ldt_fecha_sepult >= ldt_fecha_ini then
								...
								if ls_base='O' or ls_base='U' then
									if ll_numero=10000000 then
										...
										if Trans_2.sqlcode=0 then
											...
											if (ll_numero <= 84000 and gs_conexion	= "Parque El Prado" and ls_base <> 'U' ) or &
												(ll_numero <= 15884 and gs_conexion	= "Parque La Foresta" and ls_base <> 'U') then
												ls_pasa_ctrol	= 'S'
											else
												ls_pasa_ctrol	= 'N'
											end if
						...
						if dw_ficha_sepult.retrieve(ll_cod_parque,ls_sector,ls_sepultura,ldt_fecha_sepult)=0 then
							...
							tab_1.tabpage_1.dw_ant_fall.setitem(ll_new_ins,'c_estadistico',is_usuario_esta)
							tab_1.tabpage_1.dw_ant_fall.setitem(ll_new_ins,'hora_util_templo',0)
							tab_1.tabpage_1.dw_ant_fall.setitem(ll_new_ins,'minuto_util_templo',0)
							tab_1.tabpage_1.dw_ant_fall.setitem(ll_new_ins,'hora_util_fin_templo',0)
							tab_1.tabpage_1.dw_ant_fall.setitem(ll_new_ins,'minuto_util_fin_templo',0)
							tab_1.tabpage_1.dw_ant_fall.setitem(ll_new_ins,'hora_util_capilla',0)
							tab_1.tabpage_1.dw_ant_fall.setitem(ll_new_ins,'minuto_util_capilla',0)
							tab_1.tabpage_1.dw_ant_fall.setitem(ll_new_ins,'hora_util_capilla_fin',0)
							tab_1.tabpage_1.dw_ant_fall.setitem(ll_new_ins,'minuto_util_capilla_fin',0)
							// Juan
...
event itemchanged;String		ls_columna,ls_ciudad,ls_dv,ls_fono_p,ls_pasa_p,ls_pasa_letras,ls_celu,ls_email_contacto,ls_nulo,ls_dv_tercero,ls_email_pagador,ls_email_tercero,ls_email_titular,&
			ls_dire_contac,ls_cel_ter,ls_fono_contac,ls_cel_contac,ls_email_contac,ls_parentesco_contac,ls_parentesco,ls_nom3,ls_pat3,ls_mat3,ls_tipo_via,ls_direccion,&
			ls_num_par,ls_block,ls_depto,ls_dv3,ls_fono,ls_celular,ls_email,ls_direc3
...
//			ll_new	= dw_ant_titular.insertrow(0)
			dw_ant_titular.scrolltorow(ll_new)
			dw_ant_titular.setitem(ll_new,'dv_titular',ls_dv)
			this.accepttext()
			dw_ant_titular.setfocus()
			dw_ant_titular.setcolumn('dv_titular')
		else
			SELECT 	"CLIENTE_TERCEROS"."PARENTESCO", 	"CLIENTE_TERCEROS"."NOMBRES_TERCERO",	"CLIENTE_TERCEROS"."APELLIDO_P_TERCERO",	"CLIENTE_TERCEROS"."APELLIDO_M_TERCERO",	"TIPO_VIA"."DESCRIPCION",	"CLIENTE_TERCEROS"."DIRECCION",	"CLIENTE_TERCEROS"."NUMERO_PARTICULAR",	"CLIENTE_TERCEROS"."BLOCK_PARTICULAR",	"CLIENTE_TERCEROS"."DEPTO_TERCERO",	"CLIENTE_TERCEROS"."RUT_TERCERO",	"CLIENTE_TERCEROS"."DV_RUT",	"CLIENTE_TERCEROS"."FONO_PARTICULAR",	"CLIENTE_TERCEROS"."CELULAR",		"CLIENTE_TERCEROS"."EMAIL"  
			INTO		:ls_parentesco,									:ls_nom3,												:ls_pat3,														:ls_mat3,													:ls_tipo_via,							:ls_direccion,								:ls_num_par,												:ls_block,												:ls_depto,											:ll_rut3,											:ls_dv3,									:ls_fono,													:ls_celular,									:ls_email
			FROM 	"CLIENTE_TERCEROS",	"TIPO_VIA"  
			WHERE 	"CLIENTE_TERCEROS"."TIPO_VIA" = "TIPO_VIA"."TIPO_VIA" AND
						"CLIENTE_TERCEROS"."RUT_TITULAR" = :ll_rut   
			USING	sqlca;
			if sqlca.sqlcode=0 then
				ls_direc3			= ls_tipo_via+ ' ' +ls_direccion+ ' N: ' +ls_num_par+ ' D:' +ls_depto+ ' B:' +ls_block
				tab_1.tabpage_2.dw_ant_titular.setitem(tab_1.tabpage_2.dw_ant_titular.getrow(),'rut_tercero',ll_rut3)
...
event itemfocuschanged;string ls_fono_p,ls_pasa_p,ls_nulo,ls_pasa_letras,ls_celu,ls_columna,ls_email_contacto,ls_email_pagador,ls_email_tercero,ls_dv_terc,ls_email_titular,ls_dv
long	ll_fono_p_largo,ll_fila,ll_cel_largo,ll_rut_terc,ll_rut
...
ll_fila							= this.getrow()
if ls_columna = 'celular_contacto' then
	ls_fono_p				= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_fila,'celular_contacto')
	ll_fono_p_largo			= len(ls_fono_p)
	if ll_fono_p_largo > 0 and ls_fono_p <> '-' and ls_fono_p <>'' and not isnull(ls_fono_p) then 
		if ls_fono_p <> '' and ls_fono_p <> '-' then
			ls_pasa_p 				= wf_valida_largo(ll_fono_p_largo,'celular_contacto')
			if ls_pasa_p='N' then
			//	tab_1.tabpage_2.dw_ant_titular.scrolltorow(ll_fila)
				tab_1.tabpage_2.dw_ant_titular.setitem(ll_fila,'celular_contacto','')
//				tab_1.tabpage_2.dw_ant_titular.setfocus()
//				tab_1.tabpage_2.dw_ant_titular.setcolumn('fono_contacto')
			else
				ls_pasa_letras 		= wf_validar_letras(ls_fono_p,'celular_contacto')
...
if ls_columna = 'fono_contacto' then
	ls_fono_p				= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_fila,'fono_contacto')
	ll_fono_p_largo			= len(ls_fono_p)
	if ll_fono_p_largo > 0 and ls_fono_p <> '-' and ls_fono_p <>'' and not isnull(ls_fono_p) then 
		if ls_fono_p <> '' and ls_fono_p <> '-' then
			ls_pasa_p 				= wf_valida_largo(ll_fono_p_largo,'fono_contacto')
			if ls_pasa_p='N' then
				tab_1.tabpage_2.dw_ant_titular.setitem(ll_fila,'fono_contacto','')
			else
				ls_pasa_letras 		= wf_validar_letras(ls_fono_p,'fono_contacto')
				if ls_pasa_letras = 'N' then
					tab_1.tabpage_2.dw_ant_titular.setitem(ll_fila,'fono_contacto','')
...
if ls_columna = 'celular_tercero' then
	ls_fono_p				= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_fila,'celular_tercero')
	ll_fono_p_largo			= len(ls_fono_p)
	if ll_fono_p_largo > 0 and ls_fono_p <> '-' and ls_fono_p <>'' and not isnull(ls_fono_p) then 
		if ls_fono_p <> '' and ls_fono_p <> '-' then
			ls_pasa_p 				= wf_valida_largo(ll_fono_p_largo,'celular_tercero')
			if ls_pasa_p='N' then
				tab_1.tabpage_2.dw_ant_titular.setitem(ll_fila,'celular_tercero','')
			else
...
if ls_columna = 'fono_tercero' then
	ls_fono_p				= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_fila,'fono_tercero')
	ll_fono_p_largo			= len(ls_fono_p)
	if ll_fono_p_largo > 0 and ls_fono_p <> '-' and ls_fono_p <>'' and not isnull(ls_fono_p) then 
		if ls_fono_p <> '' and ls_fono_p <> '-' then
			ls_pasa_p 				= wf_valida_largo(ll_fono_p_largo,'fono_tercero')
			if ls_pasa_p='N' then
				tab_1.tabpage_2.dw_ant_titular.setitem(ll_fila,'fono_tercero','')
			else
				ls_pasa_letras 		= wf_validar_letras(ls_fono_p,'fono_tercero')
				if ls_pasa_letras = 'N' then
					tab_1.tabpage_2.dw_ant_titular.setitem(ll_fila,'fono_tercero','')
...
ls_email_contacto	= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_fila,'email_contacto')
if ls_email_contacto <> '' or ls_email_contacto <> '-' then
	if Match(ls_email_contacto, "@") then
	else
		tab_1.tabpage_2.dw_ant_titular.setitem(ll_fila,'email_contacto',ls_nulo)
		tab_1.tabpage_2.dw_ant_titular.accepttext()
	end if	
end if	
//ls_email_pagador	= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_fila,'email_pagador')
//if ls_email_pagador <> '' or ls_email_pagador <> '-' then
//	if Match(ls_email_pagador, "@") then
//	else
//		tab_1.tabpage_2.dw_ant_titular.setitem(ll_fila,'email_pagador',ls_nulo)
//		tab_1.tabpage_2.dw_ant_titular.accepttext()
//	end if	
//end if	
ls_email_tercero	= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_fila,'email_tercero')
...
ls_email_titular		= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_fila,'email_titular')
if ls_email_titular <> '' or ls_email_titular <> '-' then
	if Match(ls_email_titular, "@") then
	else
		tab_1.tabpage_2.dw_ant_titular.setitem(ll_fila,'email_titular',ls_nulo)
		tab_1.tabpage_2.dw_ant_titular.accepttext()
	end if	
end if	

ll_rut_terc			= dw_ant_titular.getitemnumber(ll_fila,'rut_tercero')
ls_dv_terc			= dw_ant_titular.getitemstring(ll_fila,'dv_tercero')
if ll_rut_terc > 0 and not isnull(ls_dv_terc) and ls_dv_terc <> '' then
	if String(ls_dv_terc) <> String(gf_obtener_dv(ll_rut_terc)) then
		dw_ant_titular.setitem(ll_fila,'dv_tercero',ls_nulo)
		dw_ant_titular.accepttext()
		dw_ant_titular.setfocus()
		dw_ant_titular.setcolumn('dv_tercero')
	end if
end if

ll_rut					= dw_ant_titular.getitemnumber(ll_fila,'rut_titular')
ls_dv					= dw_ant_titular.getitemstring(ll_fila,'dv_titular')
if ll_rut>0 and not isnull(ls_dv) and ls_dv <> '' then
	if String(ls_dv) <> String(gf_obtener_dv(ll_rut)) then
		Setnull(ls_dv)
		dw_ant_titular.setitem(ll_fila,'dv_titular',ls_dv)
		dw_ant_titular.accepttext()
		dw_ant_titular.setfocus()
		dw_ant_titular.setcolumn('dv_titular')
	end if
...
Long		ll_rut,ll_resp,ll_new,ll_year,ll_mes,ll_dia,ll_year_hoy,ll_mes_hoy,ll_dia_hoy,ll_edad,ll_hora,ll_minutos,ll_sw_tit_fall,ll_res,ll_nulo,ll_fila,&
			...
			ll_hora_inivela,ll_hora_finvela,ll_minuto_inivela,ll_minuto_finvela,ll_sala_templo,ll_sala_velatorio,ll_hora_finv,ll_min_finv,ll_rut_fall
...
if ls_columna='sw_titular_fall' then
	...
	if ll_sw_tit_fall=0 then
		ll_res			= messagebox("Advertencia","Está Seguro COPIAR Antecedentes de Titular a Fallecido, De Ser Promesa Vigente Debe Completar Solicitud Seguro Desgravamen, Desea Continuar?",Exclamation!,YesNo!,2)
		if ll_res=1 then
//			if ll_rut_fall = ll_rut_tit then
			wf_valida_seguro_desg()		
//			end if
		...
		if not isnull(ls_nombre) or ls_nombre<>'' then
			...
			if ll_res=1 then
				...
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'hora_util_templo',0)
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'minuto_util_templo',0)
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'hora_util_fin_templo',0)
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'minuto_util_fin_templo',0)
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'sala_templo',ll_nulo)
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'observacion_templo',ls_nulo)
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'fecha_ini_velatorio',ldt_nulo)
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'hora_util_capilla',0)
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'minuto_util_capilla',0)
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'fecha_fin_velatorio',ldt_nulo)
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'hora_util_capilla_fin',0)
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'minuto_util_capilla_fin',0)
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'capilla_velatoria',ls_nulo)
				tab_1.tabpage_1.dw_ant_fall.setitem(ll_fila,'sala_velatorio',ll_nulo)
...
if ls_columna = 'usar_templo' then
	...
	tab_1.tabpage_1.dw_ant_fall.accepttext()
	ll_hora_uso_templo		= tab_1.tabpage_1.dw_ant_fall.getitemnumber(tab_1.tabpage_1.dw_ant_fall.getrow(),'hora_util_templo')
	ll_min_uso_templo			= tab_1.tabpage_1.dw_ant_fall.getitemnumber(tab_1.tabpage_1.dw_ant_fall.getrow(),'minuto_util_templo')
	ll_horafin_uso_templo	= tab_1.tabpage_1.dw_ant_fall.getitemnumber(tab_1.tabpage_1.dw_ant_fall.getrow(),'hora_util_fin_templo')
	ll_minfin_uso_templo		= tab_1.tabpage_1.dw_ant_fall.getitemnumber(tab_1.tabpage_1.dw_ant_fall.getrow(),'minuto_util_fin_templo')
	if isnull(ll_hora_uso_templo) then
		ll_hora_uso_templo	= 0
		tab_1.tabpage_1.dw_ant_fall.setitem(tab_1.tabpage_1.dw_ant_fall.getrow(),'hora_util_templo',0)
	end if
	if isnull(ll_min_uso_templo) then
		ll_min_uso_templo	= 0
		tab_1.tabpage_1.dw_ant_fall.setitem(tab_1.tabpage_1.dw_ant_fall.getrow(),'minuto_util_templo',0)
	end if
	if isnull(ll_horafin_uso_templo) then
		ll_horafin_uso_templo	= 0
		tab_1.tabpage_1.dw_ant_fall.setitem(tab_1.tabpage_1.dw_ant_fall.getrow(),'hora_util_fin_templo',0)
	end if
	if isnull(ll_minfin_uso_templo) then
		ll_minfin_uso_templo	= 0
		tab_1.tabpage_1.dw_ant_fall.setitem(tab_1.tabpage_1.dw_ant_fall.getrow(),'minuto_util_fin_templo',0)
	end if
	tab_1.tabpage_1.dw_ant_fall.accepttext()
	ll_hora_uso_templo		= tab_1.tabpage_1.dw_ant_fall.getitemnumber(tab_1.tabpage_1.dw_ant_fall.getrow(),'hora_util_templo')
	ll_min_uso_templo			= tab_1.tabpage_1.dw_ant_fall.getitemnumber(tab_1.tabpage_1.dw_ant_fall.getrow(),'minuto_util_templo')
...
//				  ( "FICHA_SEPULTACION"."COD_PARQUE" = :ll_cod_parque ) AND  
		...
		if ll_count_templo > 0 then
			...
			dw_ant_fall.setitem(dw_ant_fall.getrow(),'hora_util_templo',0)
			dw_ant_fall.setitem(dw_ant_fall.getrow(),'minuto_util_templo',0)
			dw_ant_fall.setitem(dw_ant_fall.getrow(),'hora_util_fin_templo',0)
			dw_ant_fall.setitem(dw_ant_fall.getrow(),'minuto_util_fin_templo',0)
			dw_ant_fall.setitem(dw_ant_fall.getrow(),'sala_templo',ll_nulo)
			dw_ant_fall.setitem(dw_ant_fall.getrow(),'observacion_templo',ls_nulo)
			dw_ant_fall.accepttext()
		end if
	elseif ls_usar_templo = 'N' then
		this.setitem(this.getrow(),'hora_util_templo',0)
		this.setitem(this.getrow(),'minuto_util_templo',0)
		this.setitem(this.getrow(),'hora_util_fin_templo',0)
		this.setitem(this.getrow(),'minuto_util_fin_templo',0)
		this.setitem(this.getrow(),'observacion_templo',ls_nulo)
		this.setitem(this.getrow(),'sala_templo',ll_nulo)
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_1',1)
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_2',1)
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_3',1)
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_4',1)
		...
		tab_1.tabpage_4.dw_aranceles.accepttext()
		dw_ant_fall.accepttext()
		wf_validar_templo(ls_usar_templo)
	end if
end if
if ls_columna='hora_util_templo' then
	...
	if ll_hora > ll_hora_sepult then
		messagebox("Advertencia","Hora No puede ser Mayor a Hora de Sepultación")
		tab_1.tabpage_1.dw_ant_fall.setitem(tab_1.tabpage_1.dw_ant_fall.getrow(),'hora_util_templo',ll_hora_sepult - 1)
		tab_1.tabpage_1.dw_ant_fall.accepttext()
	else
		ll_cod_parque	= this.getitemnumber(this.getrow(),'cod_parque')
		...
		if ll_hora>23 then
			...
			////nuevo
			tab_1.tabpage_1.dw_ant_fall.setitem(tab_1.tabpage_1.dw_ant_fall.getrow(),'hora_util_fin_templo',ll_hora + 1)
			tab_1.tabpage_1.dw_ant_fall.accepttext()
			ll_hora_sepult				= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'hora')
			ll_minuto_sepult			= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'minutos')
			ldt_fec_sepult				= tab_1.tabpage_3.dw_ficha_sepult.getitemdatetime(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'fecha_sepultacion')
			...
			ll_minfin_uso_templo		= tab_1.tabpage_1.dw_ant_fall.getitemnumber(tab_1.tabpage_1.dw_ant_fall.getrow(),'minuto_util_fin_templo')
			ll_sala_templo				= tab_1.tabpage_1.dw_ant_fall.getitemnumber(tab_1.tabpage_1.dw_ant_fall.getrow(),'sala_templo')
			ls_usar_templo				= tab_1.tabpage_1.dw_ant_fall.getitemstring(tab_1.tabpage_1.dw_ant_fall.getrow(),'usar_templo')
			if ls_usar_templo = 'S' then
				tab_1.tabpage_1.dw_ant_fall.accepttext()
				SELECT 	COUNT("FICHA_SEPULTACION"."CODIGO_EJECUTIVO")  
				INTO 		:ll_count_templo  
...
if ls_columna='minuto_util_templo' then
	...
	if ll_minutos > 59 then
		...
		elseif il_intervalo=60 then
			...
			////nuevo
			tab_1.tabpage_1.dw_ant_fall.setitem(tab_1.tabpage_1.dw_ant_fall.getrow(),'minuto_util_fin_templo',ll_minutos)
			tab_1.tabpage_1.dw_ant_fall.accepttext()
			ll_hora_sepult				= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'hora')
			ll_minuto_sepult			= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'minutos')
			ldt_fec_sepult				= tab_1.tabpage_3.dw_ficha_sepult.getitemdatetime(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'fecha_sepultacion')
...
if ls_columna='sala_templo' then
	ll_hora			= this.getitemnumber(this.getrow(),'hora_util_templo')
	ll_cod_parque	= this.getitemnumber(this.getrow(),'cod_parque')
	SELECT	"FICHA_HORAS_TEMPLO"."HORA_INICIO",   
				"FICHA_HORAS_TEMPLO"."MINUTO_INICIO",   
	...
	//				  ( "FICHA_SEPULTACION"."COD_PARQUE" = :ll_cod_parque ) AND  
		...
		ls_usar_templo				= dw_ant_fall.getitemstring(dw_ant_fall.getrow(),'usar_templo')
		wf_validar_templo(ls_usar_templo)
		////fin nuevo
	end if
end if
...
if ls_columna='usar_capilla' then
	...
	if ls_usar_capilla='N' then
		...
		this.setitem(this.getrow(),'sala_velatorio',ll_nulo)
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_1',1)
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_2',1)
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_3',1)
		tab_1.tabpage_4.dw_aranceles.setitem(tab_1.tabpage_4.dw_aranceles.getrow(),'sw_pago_4',1)
...
//		dw_ant_fall.accepttext()
		...
		if isnull(ldt_fecha_inivela) then
			...
			if isnull(ll_hora_inivela) then 
				ll_hora_inivela			= 0
				this.setitem(this.getrow(),'hora_util_capilla',ll_hora_inivela)
			end if
			if isnull(ll_minuto_inivela) then 
				ll_minuto_inivela			= 0
				this.setitem(this.getrow(),'minuto_util_capilla',ll_minuto_inivela)
			end if
			if isnull(ll_hora_finvela) then 
				ll_hora_finvela			= 0
				this.setitem(this.getrow(),'hora_util_capilla_fin',ll_hora_finvela)
			end if
			if isnull(ll_minuto_finvela) then 
				ll_minuto_finvela			= 0
				this.setitem(this.getrow(),'minuto_util_capilla_fin',ll_minuto_finvela)
			end if
			this.accepttext()
			ll_hora_inivela				= this.getitemnumber(this.getrow(),'hora_util_capilla')
			ll_minuto_inivela			= this.getitemnumber(this.getrow(),'minuto_util_capilla')
			...
			FROM 	"FICHA_SEPULTACION"  
			WHERE ( "FICHA_SEPULTACION"."FECHA_SEPULTACION" = :ldt_fec_sepult ) AND  
					  ( ( "FICHA_SEPULTACION"."FECHA_INI_VELATORIO" = :ldt_fecha_inivela ) or
			...
			if ll_count_templo > 0 then
				...
				dw_ant_fall.setitem(dw_ant_fall.getrow(),'sala_velatorio',ll_nulo)
				dw_ant_fall.accepttext()
			else
//				SELECT 	COUNT("FICHA_CONTROL_VELATORIO"."SECTOR")  
//				INTO 		:ll_count_templo  
//				FROM 	"FICHA_CONTROL_VELATORIO"  
//				WHERE ( "FICHA_CONTROL_VELATORIO"."FECHA_SEPULTACION" = :ldt_fec_sepult ) AND  
//						  ( ( "FICHA_CONTROL_VELATORIO"."FECHA_USO_INI" = :ldt_fecha_inivela ) or
//						  ( "FICHA_CONTROL_VELATORIO"."FECHA_USO_INI" >= :ldt_fecha_inivela ) AND  
//						  ( "FICHA_CONTROL_VELATORIO"."FECHA_USO_FIN" <= :ldt_fecha_finvela ) AND  
//						  ( "FICHA_CONTROL_VELATORIO"."HORA_USO_FIN" <= :ll_hora_finvela ) AND  
//						  ( "FICHA_CONTROL_VELATORIO"."MINUTO_USO_FIN" <= :ll_minuto_finvela ) )  AND
//						  ( "FICHA_CONTROL_VELATORIO"."SALA_VELATORIO" = :ll_sala_velatorio ) AND
//						  ( "FICHA_CONTROL_VELATORIO"."NUMERO" <> :ll_numero)
//				USING	sqlca;
//				if ll_count_templo > 0 then
//					messagebox("Advertencia","No es Posible Usar Velatorio, Existe Reserva")
//					dw_ant_fall.setitem(dw_ant_fall.getrow(),'usar_capilla','N')
...
if ls_columna = 'fecha_ini_velatorio' then
	...
	if ll_hora_inivela >= 0 and ll_hora_finvela > 0 then //isnull(ldt_fecha_inivela) and isnull(ldt_fecha_finvela) then
		ll_hora_sepult				= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'hora')
		ll_minuto_sepult			= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'minutos')
		ldt_fec_sepult				= tab_1.tabpage_3.dw_ficha_sepult.getitemdatetime(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'fecha_sepultacion')
		ll_cod_parque				= tab_1.tabpage_3.dw_ficha_sepult.getitemnumber(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'cod_parque')
...
if ls_columna='hora_util_capilla_fin' then
	...
	if ll_hora > 23 then
		...
		this.setitem(this.getrow(),'hora_util_capilla_fin',0)
	elseif not isnull(ll_hora_ini) and not isnull(ll_hora_fin) then
		if ll_hora_fin <= ll_hora_ini and ldt_fecha_inivela = ldt_fecha_finvela then
			messagebox("Advertencia","Rango Inválido, Hora Término NO debe ser Menor a la Hora Inicio Uso Velatorio")
			this.setitem(this.getrow(),'hora_util_capilla_fin',0)
			this.accepttext()
		end if	
...
if ls_columna='usar_capilla' or ls_columna='fecha_ini_velatorio' or ls_columna='hora_util_capilla' or ls_columna='minuto_util_capilla' or ls_columna='fecha_fin_velatorio' or &
   ls_columna='hora_util_capilla_fin' or ls_columna='minuto_util_capilla_fin' or ls_columna='sala_velatorio' then
	ldt_fec_sepult				= tab_1.tabpage_3.dw_ficha_sepult.getitemdatetime(tab_1.tabpage_3.dw_ficha_sepult.getrow(),'fecha_sepultacion')
	ldt_fecha_inivela			= this.getitemdatetime(this.getrow(),'fecha_ini_velatorio')
	ll_hora_inivela				= this.getitemnumber(this.getrow(),'hora_util_capilla')
	ll_minuto_inivela			= this.getitemnumber(this.getrow(),'minuto_util_capilla')
	...
	ll_minuto_finvela			= this.getitemnumber(this.getrow(),'minuto_util_capilla_fin')
	ll_sala_velatorio			= this.getitemnumber(this.getrow(),'sala_velatorio')
	if not isnull(ldt_fecha_inivela) and ll_hora_inivela > 0 and not isnull(ll_minuto_inivela) and not isnull(ldt_fecha_finvela) and ll_hora_finvela > 0 and &
		not isnull(ll_minuto_finvela) and not isnull(ll_sala_velatorio) then
		SELECT 	COUNT("FICHA_SEPULTACION"."CODIGO_EJECUTIVO")  
		INTO 		:ll_count_templo  
		FROM 	"FICHA_SEPULTACION"  
		WHERE ( "FICHA_SEPULTACION"."FECHA_SEPULTACION" = :ldt_fec_sepult ) AND  
...
//			end if
	...
	if ls_columna='sala_velatorio' then
		ls_usar_capilla			= dw_ant_fall.getitemstring(dw_ant_fall.getrow(),'usar_capilla')
		wf_validar_templo(ls_usar_capilla)
	end if
end if
dw_ant_fall.accepttext()
end event
...
event itemfocuschanged;String		ls_columna,ls_dv,ls_periodo,ls_nulo,ls_modif_adm,ls_usar_templo,ls_usar_capilla
Long		ll_rut,ll_new,ll_nulo,ll_year,ll_mes,ll_dia,ll_year_hoy,ll_mes_hoy,ll_dia_hoy,ll_edad,ll_hora,ll_hora_fijada,ll_min_fijada,ll_cod_parque,ll_minutos,&
			ll_hora_sepult,ll_minuto_sepult,ll_numero,ll_hora_uso_templo,ll_min_uso_templo,ll_horafin_uso_templo,ll_minfin_uso_templo,&
			ll_sala_templo,ll_count_templo
...
//		wf_parentesco()
	...
	ls_usar_capilla		= tab_1.tabpage_1.dw_ant_fall.getitemstring(tab_1.tabpage_1.dw_ant_fall.getrow(),'usar_capilla')
	if ls_usar_capilla='N' then
		dw_ant_fall.setitem(dw_ant_fall.getrow(),'usar_capilla','N')
		dw_ant_fall.setitem(dw_ant_fall.getrow(),'fecha_ini_velatorio',ldt_nulo)
		dw_ant_fall.setitem(dw_ant_fall.getrow(),'hora_util_capilla',0)
...
Datetime	ldt_fecha_sepult
Double	ll_numero,ll_rut,ll_monto,ll_monto_ds,ll_cupon,ll_cupon_existe,ll_total_mas_iva,ll_der_mas_iva,ldb_valor_m_uf
Date		ldt_fecha_hoy
...
if ll_cupon_existe > 0 then
	...
	if ll_count_reg>0 then
		...
		ll_total_mas_iva	= Double(tab_1.tabpage_4.dw_aranceles.getitemnumber(ll_fila,'compute_5'))
		ll_der_mas_iva		= Double(tab_1.tabpage_4.dw_aranceles.getitemnumber(ll_fila,'compute_6'))
		
		ldb_valor_m_uf		= Double(tab_1.tabpage_4.dw_aranceles.getitemnumber(ll_fila,'valor_derecho_sepultacion_uf'))
		...
		elseif ll_total_mas_iva <> ll_total_mas_iva - 1 AND  ll_der_mas_iva <> ll_der_mas_iva then			//elseif 	ll_monto <> ll_monto_ds then
...
//				ll_cupon ++
				...
				VALUES 	( :ls_base,   :ls_serie,   	:ll_numero,   	:ll_cupon,   			:ll_rut,   	1, 					  	:ldt_fecha_sepult,   	'V',   								'M',   				null,   					:ll_rut,   				null,   				:ldb_valor_m_uf,   					0,   								0,   									0,   										1,   						:ls_dv,   	'2' )  
				USING	sqlca;
				if sqlca.sqlcode=0 then
...
integer taborder = 20
string title = "none"
string dataobject = "dw_ingreso_aranceles_ficha_adicio"
boolean vscrollbar = true
boolean border = false
boolean livescroll = true
end type
...
event itemchanged;String 	ls_columna,ls_cod_parentesco,ls_cod_pago_1,ls_nulo,ls_cod_pago_anterior,ls_cod_pago,ls_cod_pago_2,ls_cod_pago_3,ls_cod_pago_4,ls_cod_pago_5,&
			ls_cod_pago_6,ls_base,ls_serie, ls_cod_mov,ls_cod_movconsulta,ls_uso_velatorio,ls_pasa,ls_uso_templo,ls_cod_adic_1,ls_cod_adic_2,ls_cod_adic_anterior,&
			ls_cod_adic,ls_cod_adic_3,ls_cod_adic_4,ls_adicional_1,ls_adicional_2,ls_adicional_3,ls_adicional_4,ls_cod_dscto_anterior
Double 	ldb_valor_uf_dia,ldb_valor_arancel,ldb_valor_uf,ldb_valor_der,ldb_total,ldb_valor_1,ldb_valor_2,ldb_valor_3,ldb_valor_4,ldb_valor_5,ldb_valor_6,&
			...
			ll_suma_valor,ldb_valor,ldb_valor_condolencia,ldb_valor_dscto_be,ldb_monto_condo,ldb_valor_templovelatorio,ldb_valor_adicional,lb_suma_dscto_1,&
			lb_suma_dscto_2,lb_total_dscto,lb_suma_dscto_3,lb_suma_dscto_4,ldb_uf_iva_derecho_sep,ll_dscto_anterior
DateTime ldt_fecha_hoy
Long		ll_cod_parque,ll_sw_derecho,ll_sw_otros_pagos,ll_sw_pago_1,ll_sw_pago_anterior,ll_sw_pago_3,ll_sw_pago_4,ll_sw_pago_5,ll_sw_pago_6,&
			...
			ll_cod_benef_det,ll_sw_condolencia,ll_count_benef,ll_sum_condolencia,ls_pasa_m,ll_sum_templo_velatorio=0,ll_sw_adic_1,ll_sw_adic_2,ll_sw_adic_3,&
			ll_sw_pago_2,ll_p,ll_sw_adic_4,ll_sw_adicional_1,ll_sw_adicional_2,ll_sw_adicional_3,ll_sw_adicional_4
...
elseif ls_columna='pago_otro_1' then
	...
	if not isnull(ls_cod_pago_1) then
		if ll_sw_pago_1 = 0 then
			ldb_valor_arancel			= wf_valor_arancel(ls_cod_pago_1)
...
elseif ls_columna='pago_otro_2' then
	...
	if not isnull(ls_cod_pago_1) then
		...
		if ls_cod_pago_anterior = ls_cod_pago then
			...
			if ll_sw_pago_1 = 0 then
				ldb_valor_arancel			= wf_valor_arancel(ls_cod_pago_2)
				if sqlca.sqlcode=0 then
					if ldb_valor_arancel > 100 then
...
elseif ls_columna='pago_otro_3' then
	...
	if not isnull(ls_cod_pago_3) then
		...
		if ls_cod_pago_1 = ls_cod_pago_3 or ls_cod_pago_2 = ls_cod_pago_3 then
			...
			if ll_sw_pago_1 = 0 then
				ldb_valor_arancel			= wf_valor_arancel(ls_cod_pago_3)
				if sqlca.sqlcode=0 then
					if ldb_valor_arancel > 100 then
...
elseif ls_columna='pago_otro_4' then
	...
	if not isnull(ls_cod_pago_4) then
		...
		if ls_cod_pago_1 = ls_cod_pago_4 or ls_cod_pago_2 = ls_cod_pago_4 or ls_cod_pago_3 = ls_cod_pago_4  then
			...
			if ll_sw_pago_1 = 0 then
				ldb_valor_arancel			= wf_valor_arancel(ls_cod_pago_4)
				if sqlca.sqlcode=0 then
					if ldb_valor_arancel > 100 then
...
elseif ls_columna='pago_otro_5' then
	...
	if not isnull(ls_cod_pago_5) then
		...
		if ls_cod_pago_1 = ls_cod_pago_5 or ls_cod_pago_2 = ls_cod_pago_5 or ls_cod_pago_3 = ls_cod_pago_5 or ls_cod_pago_4 = ls_cod_pago_5  then
			...
			if ll_sw_pago_1 = 0 then
				ldb_valor_arancel			= wf_valor_arancel(ls_cod_pago_5)
				if sqlca.sqlcode=0 then
					if ldb_valor_arancel > 100 then
...
elseif ls_columna='pago_otro_6' then
	...
	if not isnull(ls_cod_pago_6) then
		...
		if ls_cod_pago_1 = ls_cod_pago_6 or ls_cod_pago_2 = ls_cod_pago_6 or ls_cod_pago_3 = ls_cod_pago_6 or ls_cod_pago_4 = ls_cod_pago_6  or ls_cod_pago_5 = ls_cod_pago_6 then
			...
			if ll_sw_pago_1 = 0 then
				ldb_valor_arancel			= wf_valor_arancel(ls_cod_pago_6)
				if sqlca.sqlcode=0 then
					if ldb_valor_arancel > 100 then
...
elseif ls_columna='sw_pago_liberado' then
	...
	if ll_sw_derecho=0 then
		...
		if ll_sw_derecha_sep = 0 then
			...
			ldb_uf_iva_derecho_sep	= round(dw_aranceles.getitemnumber(dw_aranceles.getrow(),'compute_7'),10)
			ldb_monto_derecho_sep	= ldb_monto_derecho_sep + ldb_uf_iva_derecho_sep
			...
			dw_aranceles.accepttext()
			if dw_aranceles.getitemstring(dw_aranceles.getrow(),'pago_otro_1')='21' then
				ldb_monto_condo		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_otro_1')
			elseif dw_aranceles.getitemstring(dw_aranceles.getrow(),'pago_otro_2')='21' then
				ldb_monto_condo		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_otro_2')
			elseif  dw_aranceles.getitemstring(dw_aranceles.getrow(),'pago_otro_3')='21' then
				ldb_monto_condo		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_otro_3')
			elseif dw_aranceles.getitemstring(dw_aranceles.getrow(),'pago_otro_4')='21' then
				ldb_monto_condo		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_otro_4')
			elseif dw_aranceles.getitemstring(dw_aranceles.getrow(),'pago_otro_5')='21' then
				ldb_monto_condo		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_otro_5')
			elseif dw_aranceles.getitemstring(dw_aranceles.getrow(),'pago_otro_6')='21' then
				ldb_monto_condo		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_otro_6')
			end if
			if ldb_monto_derecho_sep > 0 then
				dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_1',0)
				dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_1','109')
				dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_1',ldb_monto_derecho_sep + ldb_monto_condo)
				dw_aranceles.accepttext()
				ll_monto_cancelar		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_cancelar')
				ll_descuento				= ll_monto_cancelar - (ldb_monto_derecho_sep + ldb_monto_condo)
				if ll_descuento > 0 then
					...
					if ll_count_benef > 0 then
						ls_cod_dscto_anterior		= dw_aranceles.getitemstring(dw_aranceles.getrow(),'dscto_otro_1')
						if ls_cod_dscto_anterior = '109' then
							ll_dscto_anterior		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_dscto_1')
//							dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_1',0)
//							dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_1','109')
							dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_1',ll_descuento + ll_dscto_anterior)
						else
...
//						dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_2',ll_descuento)
			...
			elseif ldb_monto_condo > 0 then
				dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_1',0)
				dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_1','122')
				dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_1',ldb_monto_condo)
				dw_aranceles.accepttext()
				ll_monto_cancelar		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'monto_cancelar')
				ll_descuento				= ll_monto_cancelar - ldb_monto_condo
				if ll_descuento > 0 then
					SELECT 	count("TIPO_PROMOCION_ASOCIADOS"."BASE")  
					INTO 		:ll_count_benef  
					FROM 	"TIPO_PROMOCION_ASOCIADOS",  	"BENEFICIOS_COMPLEMENTARIO_DET"  
...
//						dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_2',ll_descuento)
		...
		dw_aranceles.accepttext()
		if isnull(is_dscto_01) or is_dscto_01='' then
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_1',1)
			dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_1',ls_nulo)
			dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_1',0)
		else
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_1',il_sw_dscto_01)
			dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_1',is_dscto_01)
			dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_1',ldb_dscto_01)
		end if
		if isnull(is_dscto_02) or is_dscto_02='' then
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_2',1)
			dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_2',ls_nulo)
			dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_2',0)
		else
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_2',il_sw_dscto_02)
			dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_2',is_dscto_02)
			dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_2',ldb_dscto_02)
		end if
		if isnull(is_dscto_03) or is_dscto_03='' then
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_3',1)
			dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_3',ls_nulo)
			dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_3',0)
		else
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_3',il_sw_dscto_03)
			dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_3',is_dscto_03)
			dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_3',ldb_dscto_03)
		end if
		if isnull(is_dscto_04) or is_dscto_04='' then
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_4',1)
			dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_4',ls_nulo)
			dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_4',0)
		else
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_4',il_sw_dscto_04)
			dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_4',is_dscto_04)
			dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_4',ldb_dscto_04)
		end if
		if isnull(is_dscto_05) or is_dscto_05='' then
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_5',1)
			dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_5',ls_nulo)
			dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_5',0)
		else
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_5',il_sw_dscto_05)
			dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_5',is_dscto_05)
			dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_5',ldb_dscto_05)
		end if
		if isnull(is_dscto_06) or is_dscto_06='' then
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_6',1)
			dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_6',ls_nulo)
			dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_6',0)
		else
			dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_6',il_sw_dscto_06)
			dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_6',is_dscto_06)
			dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_6',ldb_dscto_06)
		end if
		dw_aranceles.accepttext()
	end if
	wf_actualizar_calculo(dw_aranceles.getrow())
				...
				if sqlca.sqlcode=0 then
					...
					if ll_reg >= 0 then
						...
						if ll_suma_valor > 0 and ls_pasa_m > 0 then
							if ldb_valor_templovelatorio > 0 then
								dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_2',0)
								dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_2','151')
								dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_2',ldb_valor_templovelatorio )
								if ll_suma_valor - ldb_valor_templovelatorio > 0 then
									dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_3',0)
									dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_3','109')
									dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_3',ll_suma_valor - ldb_valor_templovelatorio )
								end if
							end if
							if ll_suma_valor - ldb_valor_condolencia > 0 and ldb_valor_condolencia = 0 then
								dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_3',0)
								dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_3','109')
								dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_3',ll_suma_valor - ldb_valor_condolencia )
							end if////NUEVO
							dw_aranceles.accepttext()
						elseif ll_suma_valor > 0 then
							dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_1',0)
							//dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_1','109')
							if ldb_valor_condolencia > 0 then
								dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_1','151')
								dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_1',ldb_valor_condolencia )
								if ll_suma_valor - ldb_valor_condolencia > 0 then
									dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_2',0)
									dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_2','109')
									dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_2',ll_suma_valor - ldb_valor_condolencia )
								end if
							else
								dw_aranceles.setitem(dw_aranceles.getrow(),'sw_dscto_1',0)
								dw_aranceles.setitem(dw_aranceles.getrow(),'dscto_otro_1','109')
								dw_aranceles.setitem(dw_aranceles.getrow(),'monto_dscto_1',ll_suma_valor - ldb_valor_condolencia )
							end if////NUEVO
							dw_aranceles.accepttext()
...
if ls_columna='sw_adicional_1' then
	ll_sw_adicional_1		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_adicional_1')
	if ll_sw_adicional_1 = 0 then
		dw_aranceles.setitem(dw_aranceles.getrow(),'adicional_1',ls_nulo)
		dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_1',0)
		dw_aranceles.setitem(dw_aranceles.getrow(),'sw_adicional_1',1)
		dw_aranceles.setitem(dw_aranceles.getrow(),'adicional_2',ls_nulo)
		dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_2',0)
		dw_aranceles.setitem(dw_aranceles.getrow(),'sw_adicional_2',1)
		dw_aranceles.setitem(dw_aranceles.getrow(),'adicional_3',ls_nulo)
		dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_3',0)
		dw_aranceles.setitem(dw_aranceles.getrow(),'sw_adicional_3',1)
		dw_aranceles.setitem(dw_aranceles.getrow(),'adicional_4',ls_nulo)
		dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_4',0)
		dw_aranceles.setitem(dw_aranceles.getrow(),'sw_adicional_4',1)
	end if
elseif ls_columna='sw_adicional_2' then
	ll_sw_adicional_2		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_adicional_2')
	if ll_sw_adicional_2 = 0 then
		dw_aranceles.setitem(dw_aranceles.getrow(),'adicional_2',ls_nulo)
		dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_2',0)
		dw_aranceles.setitem(dw_aranceles.getrow(),'sw_adicional_2',1)
		dw_aranceles.setitem(dw_aranceles.getrow(),'adicional_3',ls_nulo)
...
elseif ls_columna='sw_adicional_3' then
	ll_sw_adicional_3		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_adicional_3')
	if ll_sw_adicional_3 = 0 then
		dw_aranceles.setitem(dw_aranceles.getrow(),'adicional_3',ls_nulo)
		dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_3',0)
		dw_aranceles.setitem(dw_aranceles.getrow(),'sw_adicional_3',1)
		dw_aranceles.setitem(dw_aranceles.getrow(),'adicional_4',ls_nulo)
...
elseif ls_columna='sw_adicional_4' then
	ll_sw_adicional_4		= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_adicional_4')
	if ll_sw_adicional_3 = 0 then
		dw_aranceles.setitem(dw_aranceles.getrow(),'adicional_4',ls_nulo)
		dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_4',0)
		dw_aranceles.setitem(dw_aranceles.getrow(),'sw_adicional_4',1)
...
///////////////////////////////////////////// FRANCK /////////////////////////////////////////////////////////////
if ls_columna='adicional_1' then
	ls_cod_adic_1				= dw_aranceles.getitemstring(dw_aranceles.getrow(),'adicional_1')
	ll_sw_adicional_1			= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_adicional_1')
	if not isnull(ls_cod_adic_1) then
		if isNull(ls_cod_adic_1) then
			messagebox("Advertencia","Detalle Pago Duplicado")
			dw_aranceles.setfocus()
			dw_aranceles.setitem(dw_aranceles.getrow(),'adicional_1',ls_nulo)
			dw_aranceles.accepttext()
			dw_aranceles.setcolumn('adicional_1')
		else
			if ll_sw_adicional_1 = 0 then
				ldb_valor_adicional = wf_valor_adicional(ls_cod_adic_1)
				if sqlca.sqlcode=0 then
					dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_1',ldb_valor_adicional)
					dw_aranceles.accepttext()
					dw_aranceles.setfocus()
					dw_aranceles.setcolumn('monto_adicional_1')
				end if
			else
				dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_1',0)
				wf_total_adicional(dw_aranceles.getrow())
				dw_aranceles.accepttext()
			end if
		end if
		wf_total_adicional(dw_aranceles.getrow())
...
if ls_columna='adicional_2' then
	ls_cod_adic_2				= dw_aranceles.getitemstring(dw_aranceles.getrow(),'adicional_2')
	ll_sw_adicional_2			= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_adicional_1')
	if not isnull(ls_cod_adic_2) then
		ls_cod_adic_anterior		= dw_aranceles.getitemstring(dw_aranceles.getrow(),'adicional_1')
		ls_cod_adic				= dw_aranceles.getitemstring(dw_aranceles.getrow(),'adicional_2')
		if ls_cod_adic_anterior = ls_cod_adic then
			messagebox("Advertencia","Detalle Pago Duplicado")
			dw_aranceles.setfocus()
			dw_aranceles.setitem(dw_aranceles.getrow(),'adicional_2',ls_nulo)
			dw_aranceles.accepttext()
			dw_aranceles.setcolumn('adicional_2')
		else
			if ll_sw_adicional_2 = 0 then
				ldb_valor_adicional = wf_valor_adicional(ls_cod_adic_2)
				if sqlca.sqlcode=0 then
					dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_2',ldb_valor_adicional)
					dw_aranceles.accepttext()
					dw_aranceles.setfocus()
					dw_aranceles.setcolumn('monto_adicional_2')
				end if
			else
				dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_2',0)
				wf_total_adicional(dw_aranceles.getrow())
...
if ls_columna='adicional_3' then
	ll_sw_adicional_3			= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_adicional_1')
	ls_cod_adic_3				= dw_aranceles.getitemstring(dw_aranceles.getrow(),'adicional_3')
	if not isnull(ls_cod_adic_3) then
		ls_cod_adic_1			= dw_aranceles.getitemstring(dw_aranceles.getrow(),'adicional_1')
		ls_cod_adic_2			= dw_aranceles.getitemstring(dw_aranceles.getrow(),'adicional_2')
		if ls_cod_adic_3 = ls_cod_adic_1 or ls_cod_adic_3 = ls_cod_adic_2 then
			messagebox("Advertencia","Detalle Pago Duplicado")
			dw_aranceles.setfocus()
			dw_aranceles.setitem(dw_aranceles.getrow(),'adicional_3',ls_nulo)
			dw_aranceles.accepttext()
			dw_aranceles.setcolumn('adicional_3')
		else
			if ll_sw_adicional_3 = 0 then
				ldb_valor_adicional = wf_valor_adicional(ls_cod_adic_3)
				if sqlca.sqlcode=0 then
					dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_3',ldb_valor_adicional)
					dw_aranceles.accepttext()
					dw_aranceles.setfocus()
					dw_aranceles.setcolumn('monto_adicional_3')
				end if
			else
				dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_3',0)
				wf_total_adicional(dw_aranceles.getrow())
...
if ls_columna='adicional_4' then
	ll_sw_adicional_4			= dw_aranceles.getitemnumber(dw_aranceles.getrow(),'sw_adicional_1')
	ls_cod_adic_4				= dw_aranceles.getitemstring(dw_aranceles.getrow(),'adicional_4')
	if not isnull(ls_cod_adic_4) then	
		ls_cod_adic_1			= dw_aranceles.getitemstring(dw_aranceles.getrow(),'adicional_1')
		ls_cod_adic_2			= dw_aranceles.getitemstring(dw_aranceles.getrow(),'adicional_2')
		ls_cod_adic_3			= dw_aranceles.getitemstring(dw_aranceles.getrow(),'adicional_3')
		if ls_cod_adic_4 = ls_cod_adic_1 or ls_cod_adic_4 = ls_cod_adic_2 or ls_cod_adic_4 = ls_cod_adic_3 then
			dw_aranceles.setfocus()
			dw_aranceles.setitem(dw_aranceles.getrow(),'adicional_4',ls_nulo)
			dw_aranceles.accepttext()
			dw_aranceles.setcolumn('adicional_4')
		else
			if ll_sw_adicional_4 = 0 then
				ldb_valor_adicional = wf_valor_adicional(ls_cod_adic_4)
				if sqlca.sqlcode=0 then
					dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_4',ldb_valor_adicional)
					dw_aranceles.accepttext()
					dw_aranceles.setfocus()
					dw_aranceles.setcolumn('monto_adicional_4')
				end if
			else
				dw_aranceles.setitem(dw_aranceles.getrow(),'monto_adicional_4',0)
				wf_total_adicional(dw_aranceles.getrow())
...
event itemfocuschanged;String		ls_columna,ls_nulo,ls_cod_pago_1,ls_cod_pago_2,ls_cod_pago_3,ls_cod_pago_4,ls_cod_pago_5,ls_cod_pago_6,ls_cod_dscto_1,ls_cod_dscto_2,ls_cod_dscto_3,ls_cod_dscto_4,&
			ls_cod_dscto_5,ls_cod_dscto_6,ls_adicional_1,ls_adicional_2,ls_adicional_3,ls_adicional_4
...
event clicked;String		ls_sector,ls_sepultura,ls_nombre_tit,ls_ap_pat_tit,ls_ap_mat_tit,ls_dv_tit,ls_direc_tit,ls_num_dir_tit,&
			ls_dpto_dir_tit,ls_block_dir_tit,ls_villa_tit,ls_sector_tit,ls_numero_tecni,ls_nombre_fall,ls_ap_pat_fall,&
			ls_ap_mat_fall,ls_base,ls_serie,ls_dv_fall,ls_tipo_via_tit,ls_fono_titular,ls_fono_com_tit,ls_primera_sepultura,&
			ls_nom_comp_fall,ls_nom_fall,ls_pat_fall,ls_nom_terc,ls_pat_terc,ls_mat_terc,ls_dv_terc,ls_dire_terc
Long		ll_cod_parque,ll_row,ll_resp,ll_rut_tit,ll_capacidad,ll_hora_sepult,ll_minuto_sepult,ll_funeraria,ll_count,&
			ll_rut_fall,ll_indi,ll_parque,ll_cod_imagen,ll_tot_reg,ll_fila,ll_count_reg,ll_cant_sepultados,&
			ll_row_reg,ll_rut_terc
Double	ll_numero
Datetime	ldt_fecha_hoy,ldt_fech_sepult,ldt_fec_nac,ldt_fec_defun
...
ls_nom_fall										= tab_1.tabpage_1.dw_ant_fall.getitemstring(ll_row,'nombre_fallecido')
ls_pat_fall										= tab_1.tabpage_1.dw_ant_fall.getitemstring(ll_row,'ap_paterno_fall')
ls_nom_terc										= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_row,'nombre_tercero')
ls_pat_terc										= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_row,'ap_paterno_tercero')
ls_mat_terc										= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_row,'ap_materno_tercero')
ll_rut_terc										= tab_1.tabpage_2.dw_ant_titular.getitemnumber(ll_row,'rut_tercero')
ls_dv_terc										= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_row,'dv_tercero')
ls_dire_terc										= tab_1.tabpage_2.dw_ant_titular.getitemstring(ll_row,'direccion_tercero')
				...
				if sqlca.sqlcode=0 then
					DO WHILE sqlca.sqlcode=0
						...
						if not isnull(ldt_fech_sepult) then
							...
							INSERT INTO "FICHA_CARTA_SEPULTACION"  
										 ( "FECHA_CARTA",		"NOMBRE_TITULAR",	"APELLIDO_PATERNO_TITULAR",	"APELLIDO_MATERNO_TITULAR",	"RUT_TITULAR",	"DV_TITULAR",	"DIRECCION_TITULAR",	"NUMERO_DIRECCION_TITULAR",	"DEPTO_DIRECCION_TITULAR",	"BLOCK_DIRECCION_TITULAR",	"POBLACION_VILLA_TITULAR",	"SECTOR_TITULAR",	"SECTOR",	"SEPULTURA",	"NUMERO_TECNICO",	"CAPACIDAD",	"NOMBRE_FALLECIDO",	"APELLIDO_PATERNO_FALL",	"APELLIDO_MATERNO_FALL",	"FECHA_SEPULTACION",	"HORA_SEPULTACION",	"MINUTO_SEPULTACION",	"CODIGO_FUNERARIA",	"FOLIO",		"BASE",	  	"SERIE",		"NUMERO",		"RUT_FALLECIDO",	"DV_FALLECIDO",	"CORRELATIVO",		"COD_PARQUE",	"TIPO_FICHA",	"TIPO_VIA_TITULAR",	"COD_PARENTESCO_AUTORIZA",	"FONO_PARTICULAR_TITULAR",	"FONO_COMERCIAL_TITULAR" ,"NOMBRES_TERCERO","AP_PATERNO_TERCERO","AP_MATERNO_TERCERO","RUT_TERC", "DV_TERC", "DIRECCION_TERC" )    
							VALUES 	 ( :ldt_fecha_hoy,	:ls_nombre_tit,	:ls_ap_pat_tit,					:ls_ap_mat_tit,					:ll_rut_tit,	:ls_dv_tit,		:ls_direc_tit,			:ls_num_dir_tit, 					:ls_dpto_dir_tit,				:ls_block_dir_tit,			:ls_villa_tit,					:ls_sector_tit,	:ls_sector,	:ls_sepultura,	:ls_numero_tecni,	:ll_capacidad,	:ls_nombre_fall,		:ls_ap_pat_fall,				:ls_ap_mat_fall,				:ldt_fech_sepult,		:ll_hora_sepult,		:ll_minuto_sepult,		:ll_funeraria,			:ll_count,	:ls_base,	:ls_serie,  :ll_numero, 	:ll_rut_fall,  	:ls_dv_fall,     	:ll_indi,			:ll_parque,		'FS',				:ls_tipo_via_tit,		'19',								:ls_fono_titular,				:ls_fono_com_tit ,	:ls_nom_terc,	:ls_pat_terc,	:ls_mat_terc,	:ll_rut_terc,	:ls_dv_terc,	:ls_dire_terc )
							USING		Trans_1;   
							if Trans_1.sqlcode=0 then
								commit using Trans_1;
							else
