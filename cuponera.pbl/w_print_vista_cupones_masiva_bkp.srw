forward
global type w_print_vista_cupones_masiva_bkp from window
end type
type cb_macanizado from commandbutton within w_print_vista_cupones_masiva_bkp
end type
type cb_print_et from commandbutton within w_print_vista_cupones_masiva_bkp
end type
type dw_etiqueta from datawindow within w_print_vista_cupones_masiva_bkp
end type
type cb_proceso from commandbutton within w_print_vista_cupones_masiva_bkp
end type
type dw_lista from datawindow within w_print_vista_cupones_masiva_bkp
end type
type cb_cancelar from commandbutton within w_print_vista_cupones_masiva_bkp
end type
type cb_imprimir from commandbutton within w_print_vista_cupones_masiva_bkp
end type
type dw_cuponeras from datawindow within w_print_vista_cupones_masiva_bkp
end type
end forward
...
global w_print_vista_cupones_masiva_bkp w_print_vista_cupones_masiva_bkp

on w_print_vista_cupones_masiva_bkp.create
...
this.Control[]={this.cb_macanizado,&
this.cb_print_et,&
this.dw_etiqueta,&
this.cb_proceso,&
this.dw_lista,&
...
on w_print_vista_cupones_masiva_bkp.destroy
...
event clicked;LONG   	il_job,i,j,ll_tot_reg,ll_fila,ll_indi,ll_estado,ll_min_cup,ll_cupon_termino,&
			ll_buscar_cup_termino,ll_max_cup,ll_cod_parque,ll_rut_aux,ll_max_nro,ll_cup_max,&
			ll_cup_final,ll_rut,ll_cup_ini,ll_cup_fin,ll_num_cuponera,&
			ll_pasa,ll_cant_cupones,ll_calculo_orden,ll_uno,ll_div_24,ll_otro,&
			ll_contador_tope,ll_mes,ll_year,ll_mes_sgte,ll_tot_porc_aux,ll_tot_porc=0,ll_num_cupon,&
			ll_nro_cuota,ll_aux,ll_indi_aux,ll_lugar,ll_plazo,ll_contar_ctto,ll_indi_reg,ll_count_reg,&
			ll_indicador,ll_inicial,ll_final,ll_cant,ll_max_corr,ll_new,ll_resp
string 	codigo,serie,ls_string,ls_base,ls_serie,ls_print_mant,ls_dv,ls_base_aux,ls_serie_aux,&
			...
			ls_sexo,ls_nro_p,ls_depto_p,ls_block_p,ls_tipo_via,ls_comuna,ls_ciudad,ls_nom_comp,&
			ls_dir_comp,ls_trato
Double	ll_valor_cta_mant,ll_div,ldb_valor_cuota,numero,numero_pro,ll_numero,ll_numero_aux
...
//			DECLARE cursor_cupones CURSOR FOR  
//			SELECT DISTINCT	"CUPONERAS"."BASE",   
//						"CUPONERAS"."SERIE",   
//						"CUPONERAS"."NUMERO"  
//			FROM 		"CUPONERAS",   
//						"CUPONERAS_DETALLE"  
...
//					 ( ( "CUPONERAS"."COD_PARQUE" = :ll_cod_parque ) AND  
//					 ( "CUPONERAS_DETALLE"."IP_PRINT" = :gs_tcp_ip ) AND  
//					 ( "CUPONERAS_DETALLE"."USUARIO_PRINT" = :gs_user ) AND  
//					 ( "CUPONERAS"."ESTADO_CUPONERA" = 'V' ) )
//			ORDER BY "CUPONERAS"."BASE" ASC,   "CUPONERAS"."SERIE" ASC,   "CUPONERAS"."NUMERO" ASC  
//			USING		sqlca;
//			open cursor_cupones;
//			if sqlca.sqlcode=0 then
//				DO WHILE sqlca.sqlcode=0
//					fetch cursor_cupones into :ls_base, :ls_serie, :ll_numero;
//					SELECT	"CUPONERAS_DETALLE"."FECHA_VENC"  
//					INTO 		:ldt_fecha_venc_min  
//					FROM 		"CUPONERAS",   
//								"CUPONERAS_DETALLE"  
//					WHERE  ( "CUPONERAS"."BASE" = "CUPONERAS_DETALLE"."BASE" ) and  
...
//					;
//
//					for ll_indi=1 to gi_cant_cup
//						
//					next
//				LOOP
//			end if
//			close cursor_cupones;
//			cb_proceso.TriggerEvent(clicked!)
