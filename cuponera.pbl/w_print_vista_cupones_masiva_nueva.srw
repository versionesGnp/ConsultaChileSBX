forward
global type w_print_vista_cupones_masiva_nueva from window
end type
type cb_setup from commandbutton within w_print_vista_cupones_masiva_nueva
end type
type cb_macanizado from commandbutton within w_print_vista_cupones_masiva_nueva
end type
type cb_print_et from commandbutton within w_print_vista_cupones_masiva_nueva
end type
type dw_etiqueta from datawindow within w_print_vista_cupones_masiva_nueva
end type
type cb_proceso from commandbutton within w_print_vista_cupones_masiva_nueva
end type
type dw_lista from datawindow within w_print_vista_cupones_masiva_nueva
end type
type cb_cancelar from commandbutton within w_print_vista_cupones_masiva_nueva
end type
type cb_imprimir from commandbutton within w_print_vista_cupones_masiva_nueva
end type
type dw_cuponeras from datawindow within w_print_vista_cupones_masiva_nueva
end type
end forward
...
global w_print_vista_cupones_masiva_nueva w_print_vista_cupones_masiva_nueva

event ue_envio_proceso();cb_proceso.triggerevent(clicked!)
end event

on w_print_vista_cupones_masiva_nueva.create
...
on w_print_vista_cupones_masiva_nueva.destroy
