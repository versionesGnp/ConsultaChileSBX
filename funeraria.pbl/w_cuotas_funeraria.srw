forward
global type w_cuotas_funeraria from window
end type
type dw_seguro from datawindow within w_cuotas_funeraria
end type
type rb_anticipado from radiobutton within w_cuotas_funeraria
end type
type rb_normal from radiobutton within w_cuotas_funeraria
end type
type cb_aceptar from commandbutton within w_cuotas_funeraria
end type
type em_numero from editmask within w_cuotas_funeraria
end type
type dw_print from datawindow within w_cuotas_funeraria
end type
type st_1 from statictext within w_cuotas_funeraria
end type
type st_protesto from statictext within w_cuotas_funeraria
end type
type st_castigado from statictext within w_cuotas_funeraria
end type
type cb_2 from commandbutton within w_cuotas_funeraria
end type
type cb_ver_cuenta from commandbutton within w_cuotas_funeraria
end type
type cb_3 from commandbutton within w_cuotas_funeraria
end type
type cb_4 from commandbutton within w_cuotas_funeraria
end type
type cb_5 from commandbutton within w_cuotas_funeraria
end type
type cb_6 from commandbutton within w_cuotas_funeraria
end type
type cb_7 from commandbutton within w_cuotas_funeraria
end type
type cb_8 from commandbutton within w_cuotas_funeraria
end type
type cb_pagare from commandbutton within w_cuotas_funeraria
end type
type cb_est_cheque from commandbutton within w_cuotas_funeraria
end type
type dw_ctto from datawindow within w_cuotas_funeraria
end type
type cb_cerrar from commandbutton within w_cuotas_funeraria
end type
type gb_1 from groupbox within w_cuotas_funeraria
end type
type em_saldo_peso from editmask within w_cuotas_funeraria
end type
type em_saldo_uf from editmask within w_cuotas_funeraria
end type
type em_pie_peso from editmask within w_cuotas_funeraria
end type
type em_pie_uf from editmask within w_cuotas_funeraria
end type
type dw_repacta from datawindow within w_cuotas_funeraria
end type
end forward
...
string title = "Reprogramación de Credito"
boolean controlmenu = true
boolean minbox = true
long backcolor = 67108864
dw_seguro dw_seguro
rb_anticipado rb_anticipado
rb_normal rb_normal
...
global w_cuotas_funeraria w_cuotas_funeraria
...
public subroutine wf_print_repro ();Long	ll_new
...
if dw_repacta.getitemnumber(1,'numero_original')>0 then
	...
	elseif rb_anticipado.checked=true then
	...
	dw_print.setitem(ll_new,'moneda_ori',dw_ctto.getitemstring(1,'pago_oferta_moneda'))
	dw_print.setitem(ll_new,'valor_cuota',dw_ctto.getitemnumber(1,'pago_oferta_valor_cuota'))
	...
	dw_print.setitem(ll_new,'plazo',dw_ctto.getitemnumber(1,'pago_oferta_nro_cuotas'))
	dw_print.setitem(ll_new,'ctas_pag_s',dw_ctto.getitemnumber(1,'oferta_v_cta_pag_s'))
	dw_print.setitem(ll_new,'tasa',dw_ctto.getitemnumber(1,'c_tasa'))
	dw_print.setitem(ll_new,'pie',dw_ctto.getitemnumber(1,'pago_oferta_pie'))
	dw_print.setitem(ll_new,'total_pagado',dw_ctto.getitemnumber(1,'oferta_v_tot_pagado'))
	dw_print.setitem(ll_new,'fecha_prox_pago',dw_ctto.getitemdatetime(1,'c_prox_pago'))
	dw_print.setitem(ll_new,'pie_pag',dw_ctto.getitemnumber(1,'pago_oferta_pie_pagado'))
	dw_print.setitem(ll_new,'fecha_pie',dw_ctto.getitemdatetime(1,'pago_oferta_fecha_pie'))
	dw_print.setitem(ll_new,'tasa_contrato',dw_ctto.getitemnumber(1,'pago_oferta_tasa'))
	dw_print.setitem(ll_new,'precio',dw_ctto.getitemnumber(1,'pago_oferta_precio'))
	dw_print.setitem(ll_new,'derecho_especial',dw_ctto.getitemnumber(1,'pago_oferta_des_esp'))
	dw_print.accepttext()
	dw_print.print()
end if
end subroutine

on w_cuotas_funeraria.create
this.dw_seguro=create dw_seguro
this.rb_anticipado=create rb_anticipado
...
on w_cuotas_funeraria.destroy
destroy(this.dw_seguro)
destroy(this.rb_anticipado)
...
event clicked;if this.checked=true then
	...
	Double	ldb_precio,ldb_pie,ll_pie_pagado_peso,ldb_valor_cuota,ldb_tasa,ldb_valor_cuotas_mora,&
				...
				ldb_gasto_adm,ldb_saldo_precio,ldb_nva_valor_cuota,ldb_total_pagado,ldb_der_esp,ldb_capital_new,&
				ldb_calc_pie,ldb_pie_new,ldb_nvo_saldo
	String	ls_moneda,ls_tipo_cob,ls_estado_comi,ls_estado_comi_sup
	Datetime	ldt_fecha_promesa,ldt_fecha_pago,ldt_fecha_venc,ldt_fecha_entre

	ldt_fecha_entre					= dw_ctto.getitemdatetime(1,'producto_pago_fecha_entre')
	if gdt_fec_sistema >= ldt_fecha_entre and not isnull(ldt_fecha_entre) then
		messagebox("Advertencia","Este Producto Funerario NO tiene Periodo de Restricción Vigente")
	end if
	st_castigado.visible			= false
	st_protesto.visible				= false
	...
	dw_repacta.setitem(ll_new,'tipo_reprog','A')
	...
	if dw_ctto.rowcount()>0 then
		dw_repacta.setitem(ll_new,'cod_age',  dw_ctto.getitemstring(1,'producto_anexo_cod_agente'))
		dw_repacta.setitem(ll_new,'cod_sup',  dw_ctto.getitemstring(1,'producto_anexo_cod_super'))
		dw_repacta.setitem(ll_new,'cod_jefe', dw_ctto.getitemstring(1,'producto_anexo_cod_jefe'))
		...
		ldb_precio					= double(dw_ctto.getitemnumber(1,'producto_pago_precio'))
		ldb_pie						= double(dw_ctto.getitemnumber(1,'producto_pago_pie'))
		ll_pie_pagado_peso		= double(dw_ctto.getitemnumber(1,'producto_pago_pie_pagado'))
		ls_moneda					= dw_ctto.getitemstring(1,'producto_pago_moneda')
		ll_plazo						= dw_ctto.getitemnumber(1,'producto_pago_plazo')
		ll_ctas_mora				= dw_ctto.getitemnumber(1,'cadena_mora_mora_cred')
		ll_ctas_pag					= dw_ctto.getitemnumber(1,'producto_anexo_cuotas_pag')
		ldb_valor_cuota			= round(double(dw_ctto.getitemnumber(1,'producto_pago_valor_cuota')),4)
		ldb_tasa						= (double(dw_ctto.getitemnumber(1,'producto_pago_tasa')) / 100)
		ldt_fecha_promesa		= dw_ctto.getitemdatetime(1,'producto_pago_fecha')
		...
		ldb_gasto_adb				= dw_ctto.getitemnumber(1,'producto_pago_gasto_adm')
		ldb_total_pagado			= dw_ctto.getitemnumber(1,'producto_anexo_total_pagado')
		ls_estado_comi				= dw_ctto.getitemstring(1,'producto_anexo_estado_comi')
		ls_estado_comi_sup		= dw_ctto.getitemstring(1,'producto_anexo_estado_comi_sup')
		...
		dw_repacta.setitem(ll_new,'valor_cuota_original',dw_ctto.getitemnumber(1,'producto_pago_valor_cuota'))
		...
		next
		ldb_cap_pag					= ldb_total_pagado
		ldb_capital_pagado			= ldb_total_pagado
		if ls_moneda='1' then
			dw_repacta.setitem(1,'capital_pagado',dw_ctto.getitemnumber(1,'oferta_v_tot_pagado'))
		else
			dw_repacta.setitem(1,'capital_pagado',round(ldb_cap_pag / gd_uf,4))
		end if
		...
		dw_repacta.setitem(1,'valor_presente',0)//ldb_valor_presente)
		dw_repacta.setitem(1,'valor_cuota_mora',0)//ldb_valor_cuotas_mora)
		dw_repacta.setitem(1,'valor_interes_mora_total',0)//ldb_interes_mora)
		...
		if ls_moneda='1' then //peso
			ldb_valor_presente	= round((ldb_precio + ldb_der_esp) / gd_uf,2)
		else
			ldb_valor_presente	= round(ldb_precio + ldb_der_esp,2)
		end if
		dw_repacta.object.t_34.text	= '(Precio + Derecho Especial)'
		dw_repacta.object.t_35.text	= '(Precio + Derecho Especial)'
		if dw_repacta.getitemstring(1,'moneda')='1' then
			if dw_ctto.getitemstring(1,'producto_pago_moneda')='1' then
				ldb_precio			= dw_ctto.getitemnumber(1,'producto_pago_precio')
				ldb_der_esp			= round( dw_ctto.getitemnumber(1,'producto_pago_der_esp') * gd_uf,0)
			elseif dw_ctto.getitemstring(1,'producto_pago_moneda')='2' then 
				ldb_precio			= dw_ctto.getitemnumber(1,'producto_pago_precio')
				ldb_der_esp			= dw_ctto.getitemnumber(1,'producto_pago_der_esp')
			end if
			ldb_saldo_precio		= ldb_precio + ldb_der_esp + ldb_nvo_saldo
		else //UF
			if dw_ctto.getitemstring(1,'producto_pago_moneda')='1' then
				ldb_precio			= round( dw_ctto.getitemnumber(1,'producto_pago_precio') / gd_uf,4)
				ldb_der_esp			= dw_ctto.getitemnumber(1,'producto_pago_der_esp')
			elseif dw_ctto.getitemstring(1,'producto_pago_moneda')='2' then
				ldb_precio			= dw_ctto.getitemnumber(1,'producto_pago_precio')
				ldb_der_esp			= dw_ctto.getitemnumber(1,'producto_pago_der_esp')
		...
		dw_repacta.setitem(1,'saldo_insoluto',0)//ldb_valor_presente + ldb_valor_cuotas_mora + ldb_interes_mora)
		SELECT	factor_pesos,factor_uf into :ldb_factor_pesos,:ldb_factor_uf 
		FROM 		interes_cuotas 
		WHERE 	nro_cuotas = 12;
		dw_repacta.accepttext()
		ls_moneda						= dw_repacta.getitemstring(1,'moneda')
		if rb_anticipado.checked=true then
			if dw_repacta.getitemstring(1,'moneda_original') ='1' then //peso
				if ls_moneda='0' then //UF
					ldb_capital_new	= round(dw_repacta.getitemnumber(1,'capital_pagado') / dw_repacta.getitemnumber(1,'uf_dia') ,4)
					ldb_calc_pie			= round(dw_repacta.getitemnumber(1,'nvo_pie') / dw_repacta.getitemnumber(1,'uf_dia') ,4)
					ldb_pie_new		= ldb_capital_new + ldb_calc_pie
				else //peso
					ldb_capital_new	= dw_repacta.getitemnumber(1,'capital_pagado')
					ldb_calc_pie			= dw_repacta.getitemnumber(1,'nvo_pie')
					ldb_pie_new		= ldb_capital_new + ldb_calc_pie
				end if
			else//uf
				if ls_moneda='0' then //UF
		...
		if ls_moneda = '0' then //UF
			...
			ldb_gasto_adm				= round(12 * id_factor_gc_nuevo,4)
			dw_repacta.setitem(1,'nvo_gasto_adm', ldb_gasto_adm)
			if rb_anticipado.checked=true then
				ldb_saldo_precio		= (Round(dw_repacta.getitemnumber(1,'saldo_precio') + ldb_gasto_adm,4)) - ldb_pie_new
			else
			...
			dw_repacta.setitem(1,'nvo_gasto_adm', ldb_gasto_adm)
			if rb_anticipado.checked=true then
				ldb_saldo_precio		= (dw_repacta.getitemnumber(1,'saldo_precio_peso') + ldb_gasto_adm) - ldb_pie_new
			else
...
event clicked;if this.checked=true then
	...
	Double	ldb_precio,ldb_pie,ll_pie_pagado_peso,ldb_valor_cuota,ldb_tasa,ldb_valor_cuotas_mora,&
				...
				ldb_sum_cuota,ldb_capital_pagado,ldb_cap_pag,ldb_capital_total_pagado,id_gc,id_im,&
				ldb_interes_mora,ldb_factor_pesos,ldb_factor_uf,ldb_tasa_peso,ldb_tasa_uf,ldb_tasa_int,&
				ldb_gasto_adm,ldb_saldo_precio,ldb_nva_valor_cuota,ldb_total_pagado,ldb_pie_pesos
	String	ls_moneda,ls_tipo_cob,ls_estado_comi,ls_estado_comi_sup
...
event clicked;Long		ll_resp,ll_count,ll_max_corr,ll_res,ll_tot_reg,ll_indi,ll_est_reg,ll_codigo
String		ls_base,ls_serie,ls_cod_sol,ls_string,ls_base_rep,ls_serie_rep,ls_pasa,ls_pasa_10,ls_modena
Double	ldb_precio,ldb_der_esp,ldb_tot_pag,ldb_porce_10,ldb_nvo_pie,ldb_precio_calc,ldb_precio_ctto,ldb_precio_calc_peso,&
			ldb_monto,ll_numero,ll_numero_rep
...
if Double(em_numero.text) > 0 and em_numero.text <> '' and not isnull(em_numero.text) then
	...
	ldb_precio_ctto			= dw_ctto.getitemnumber(1,'producto_pago_precio')
	ls_modena				= dw_ctto.getitemstring(1,'producto_pago_moneda')
	...
	if ll_res = 1 then
		ls_pasa_10				= 'S'
		if rb_anticipado.checked=true then
			if dw_repacta.getitemstring(1,'moneda')='1' then //peso
				if dw_ctto.getitemstring(1,'producto_pago_moneda')='1' then //peso
					ldb_precio	= dw_ctto.getitemnumber(1,'producto_pago_precio')
					ldb_der_esp	= round( dw_ctto.getitemnumber(1,'producto_pago_der_esp') * gd_uf,0)
					ldb_tot_pag	= dw_ctto.getitemnumber(1,'producto_anexo_total_pagado')
				elseif dw_ctto.getitemstring(1,'producto_pago_moneda')='2' then //UF
					ldb_precio	= round( dw_ctto.getitemnumber(1,'producto_pago_precio') * gd_uf,0)
					ldb_der_esp	= round( dw_ctto.getitemnumber(1,'producto_pago_der_esp') * gd_uf,0)
					ldb_tot_pag	= dw_ctto.getitemnumber(1,'producto_anexo_total_pagado')
				end if
				ldb_porce_10	= round(((ldb_precio + ldb_der_esp) * 10 ) / 100,0)
				if ldb_nvo_pie + ldb_tot_pag < ldb_porce_10 then
					ll_resp		= messagebox("Advertencia","Recuerde Pie NO debe ser Menor a "+string((ldb_porce_10 - ldb_tot_pag),'###,###,###,###,##0')+" Pesos que corresponde al 10% del Precio Contado (Precio + Derecho Especial) - Capital Pagado que es Exigido, desea Continuar",Exclamation!,YesNo!,2)
					if ll_resp <> 1 then
						ls_pasa_10	= 'N'
					end if
				end if
				...
				if dw_ctto.getitemstring(1,'producto_pago_moneda')='1' then //peso
					ldb_precio	= round( dw_ctto.getitemnumber(1,'producto_pago_precio') / gd_uf,4)
					ldb_der_esp	= dw_ctto.getitemnumber(1,'producto_pago_der_esp')
					ldb_tot_pag	= round( dw_ctto.getitemnumber(1,'producto_anexo_total_pagado') / gd_uf,4)
				elseif dw_ctto.getitemstring(1,'producto_pago_moneda')='2' then //UF
					ldb_precio	= dw_ctto.getitemnumber(1,'producto_pago_precio')
					ldb_der_esp	= dw_ctto.getitemnumber(1,'producto_pago_der_esp')
					ldb_tot_pag	= round( dw_ctto.getitemnumber(1,'producto_anexo_total_pagado') / gd_uf,4)
				end if
				ldb_porce_10	= round(((ldb_precio + ldb_der_esp) * 10 ) / 100, 4)
				if ldb_nvo_pie + ldb_tot_pag < ldb_porce_10 then
					ll_resp		= messagebox("Advertencia","Recuerde Pie NO debe ser Menor a "+string((ldb_porce_10 - ldb_tot_pag),"###,###,###,###,##0.0###")+" U.F. que corresponde al 10% del Precio Contado (Precio + Derecho Especial) - Capital Pagado que es Exigido, desea Continuar",Exclamation!,YesNo!,2)
					if ll_resp <> 1 then
						ls_pasa_10	= 'N'
					end if
				end if
		...
		if ls_pasa_10='S' then
			...
			if ls_pasa='S' then
				...
				if Double(em_numero.text) > 0 then
					dw_repacta.setitem(1,'numero', Double(em_numero.text))
					if rb_normal.checked=true then
						dw_repacta.setitem(1,'tipo_reprog','N')
					elseif rb_anticipado.checked=true then
						dw_repacta.setitem(1,'tipo_reprog','A')
					end if
					dw_repacta.accepttext()
					if dw_repacta.update() = 1 then
						commit;
						
						ls_base_rep		= dw_repacta.getitemstring(1,'base')
						ls_serie_rep		= dw_repacta.getitemstring(1,'serie')
						ll_numero_rep	= dw_repacta.getitemnumber(1,'numero')
						UPDATE		"SEGURO_ASOCIADOS"  
						SET 			"ESTADO_SEGURO" = 'I',
										"ESTADO_REG" = 1
						WHERE 	  ( "SEGURO_ASOCIADOS"."BASE" = :ls_base_rep ) AND  
									  ( "SEGURO_ASOCIADOS"."SERIE" = :ls_serie_rep ) AND  
									  ( "SEGURO_ASOCIADOS"."NUMERO" = :ll_numero_rep )   
						USING		sqlca;
						if sqlca.sqlcode=0 then
							commit;
							...
							for ll_indi=1 to ll_tot_reg
								...
								if ll_est_reg = 0 then
									...
									WHERE 	  ( "SEGURO_ASOCIADOS"."BASE" = :ls_base_rep ) AND  
												  ( "SEGURO_ASOCIADOS"."SERIE" = :ls_serie_rep ) AND  
												  ( "SEGURO_ASOCIADOS"."NUMERO" = :ll_numero_rep ) AND  
									...
									if ll_count > 0 then
										...
										elseif sqlca.sqlcode=100 then
											...
											VALUES 	( :ls_base_rep, 	:ls_serie_rep,   :ll_numero_rep,   	:ll_codigo,   				:gdt_fec_sistema,  :ldb_monto,   			:gs_user,   		0,   					0,   						'A' )  
											USING		sqlca;
											if sqlca.sqlcode=0 then
												commit;
											else
...
if ll_numero >= 0 then
	...
	USING		sqlca;
	if sqlca.sqlcode=0 then
		dw_repacta.object.t_estado_dcto.text	= "Producto Funerario DIGITADA, se encuentra en Estado "+ls_estado
		em_numero.text		= ''
...
event clicked;if isvalid(w_datos_contrato_funeraria) then close(w_datos_contrato_funeraria)
...
integer height = 452
string title = "none"
string dataobject = "d_datos_cuenta_ci_funeraria_repacta"
boolean border = false
boolean livescroll = true
end type
...
//String	ls_moneda
//ldb_der_esp	= dw_ctto.getitemnumber(1,'pago_oferta_des_esp')
//ls_moneda	= dw_repacta.getitemstring(1,'moneda')
//if ldb_der_esp>0 then
//	if ls_moneda='1' then //peso
//		dw_repacta.setitem(1,'nvo_saldo',round(ldb_der_esp * gd_uf,4))
//		em_saldo_peso.text	= string(round(ldb_der_esp * gd_uf,4),"###,###,###,###,##0")
//		em_saldo_peso.triggerevent(modified!)
//	else
//		dw_repacta.setitem(1,'nvo_saldo',ldb_der_esp)
//		em_saldo_uf.text		= string(ldb_der_esp,"###,###,###,###,##0.0###")
//		em_saldo_uf.triggerevent(modified!)
//	end if
//end if
//dw_repacta.accepttext()
end event
...
event clicked;close(w_cuotas_funeraria)
end event
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Tipo Reprogramación"
end type
...
if rb_anticipado.checked=true then
	if dw_repacta.getitemstring(1,'moneda')='1' then //peso
		if dw_ctto.getitemstring(1,'pago_oferta_moneda')='1' then //peso
			ldb_precio		= round(dw_ctto.getitemnumber(1,'pago_oferta_precio') / gd_uf,4)//2
			ldb_der_esp		= dw_ctto.getitemnumber(1,'pago_oferta_des_esp')
			ldb_tot_pag		= dw_ctto.getitemnumber(1,'oferta_v_tot_pagado')
		elseif dw_ctto.getitemstring(1,'pago_oferta_moneda')='2' then //UF
			ldb_precio		= dw_ctto.getitemnumber(1,'pago_oferta_precio')//round( dw_ctto.getitemnumber(1,'pago_oferta_precio') * gd_uf,0)
			ldb_der_esp		= dw_ctto.getitemnumber(1,'pago_oferta_des_esp')//round( dw_ctto.getitemnumber(1,'pago_oferta_des_esp') * gd_uf,0)
			ldb_tot_pag		= dw_ctto.getitemnumber(1,'oferta_v_tot_pagado')
		end if
		ldb_saldo_precio	= ldb_precio + ldb_der_esp + ldb_nvo_saldo
	else
		if dw_ctto.getitemstring(1,'pago_oferta_moneda')='1' then //peso
			ldb_precio		= round( dw_ctto.getitemnumber(1,'pago_oferta_precio') / gd_uf,4)
			ldb_der_esp		= dw_ctto.getitemnumber(1,'pago_oferta_des_esp')
			ldb_tot_pag		= round( dw_ctto.getitemnumber(1,'oferta_v_tot_pagado') / gd_uf,4)
		elseif dw_ctto.getitemstring(1,'pago_oferta_moneda')='2' then //UF
			ldb_precio		= dw_ctto.getitemnumber(1,'pago_oferta_precio')
			ldb_der_esp		= dw_ctto.getitemnumber(1,'pago_oferta_des_esp')
			ldb_tot_pag		= round( dw_ctto.getitemnumber(1,'oferta_v_tot_pagado') / gd_uf,2)
		end if
		ldb_saldo_precio	= ldb_precio + ldb_der_esp + ldb_nvo_saldo
	end if
else
...
if rb_anticipado.checked=true then
	if dw_repacta.getitemstring(1,'moneda_original') ='1' then //peso
		...
		if ls_moneda='0' then //UF
			...
			ldb_capital_new	= round(dw_repacta.getitemnumber(1,'capital_pagado') * dw_repacta.getitemnumber(1,'uf_dia'),4)
			ldb_calc_pie		= dw_repacta.getitemnumber(1,'nvo_pie')// * dw_repacta.getitemnumber(1,'uf_dia') ,0)
			ldb_pie_new			= ldb_capital_new + ldb_calc_pie
		end if
	end if
end if
if ls_moneda = '0' then //UF
	...
	dw_repacta.setitem(1,'nvo_gasto_adm', ldb_gasto_adm)
	if rb_anticipado.checked=true then
		ldb_saldo_precio		= (Round(dw_repacta.getitemnumber(1,'saldo_precio_peso') + ldb_gasto_adm,0)) - ldb_pie_new
	else
...
if rb_anticipado.checked=true then
	if dw_repacta.getitemstring(1,'moneda')='1' then //peso
		if dw_ctto.getitemstring(1,'pago_oferta_moneda')='1' then //peso
			ldb_precio		= dw_ctto.getitemnumber(1,'pago_oferta_precio')
			ldb_der_esp		= round( dw_ctto.getitemnumber(1,'pago_oferta_des_esp') * gd_uf,0)
			ldb_tot_pag		= dw_ctto.getitemnumber(1,'oferta_v_tot_pagado')
		elseif dw_ctto.getitemstring(1,'pago_oferta_moneda')='2' then //UF
			ldb_precio		= round( dw_ctto.getitemnumber(1,'pago_oferta_precio') * gd_uf,0)
			ldb_der_esp		= round( dw_ctto.getitemnumber(1,'pago_oferta_des_esp') * gd_uf,0)
			ldb_tot_pag		= dw_ctto.getitemnumber(1,'oferta_v_tot_pagado')
		end if
		ldb_saldo_precio	= ldb_precio + ldb_der_esp + ldb_nvo_saldo
...
if rb_anticipado.checked=true then
	if dw_repacta.getitemstring(1,'moneda_original') ='1' then //peso
		if ls_moneda='0' then //UF
			ldb_capital_new	= round(dw_repacta.getitemnumber(1,'capital_pagado') / dw_repacta.getitemnumber(1,'uf_dia') ,4)
			ldb_calc_pie		= dw_repacta.getitemnumber(1,'nvo_pie') //round(dw_repacta.getitemnumber(1,'nvo_pie') / dw_repacta.getitemnumber(1,'uf_dia') ,4)
			ldb_pie_new			= ldb_capital_new + ldb_calc_pie
		else //peso
			ldb_capital_new	= dw_repacta.getitemnumber(1,'capital_pagado')
			ldb_calc_pie		= dw_repacta.getitemnumber(1,'nvo_pie')
...
if ls_pasa='S' then
	...
	if ls_pasa_10='S' then
		...
		elseif rb_anticipado.checked=true then
			if dw_repacta.getitemstring(1,'moneda')='1' then //peso
				if dw_ctto.getitemstring(1,'pago_oferta_moneda')='1' then //peso
					ldb_precio		= round(dw_ctto.getitemnumber(1,'pago_oferta_precio') / gd_uf,4)//dw_ctto.getitemnumber(1,'pago_oferta_precio')
					ldb_der_esp		= dw_ctto.getitemnumber(1,'pago_oferta_des_esp')// / gd_uf,0)
				elseif dw_ctto.getitemstring(1,'pago_oferta_moneda')='2' then //UF
					ldb_precio		= dw_ctto.getitemnumber(1,'pago_oferta_precio') //round( dw_ctto.getitemnumber(1,'pago_oferta_precio') * gd_uf,0)
					ldb_der_esp		= dw_ctto.getitemnumber(1,'pago_oferta_des_esp')//round( dw_ctto.getitemnumber(1,'pago_oferta_des_esp') * gd_uf,4) //0
				end if
				ldb_saldo_precio	= ldb_precio + ldb_der_esp + ldb_nvo_saldo
			else
				if dw_ctto.getitemstring(1,'pago_oferta_moneda')='1' then //peso
...
Double	ldb_factor_pesos,ldb_factor_uf,ldb_gasto_adm,ldb_saldo_precio,ldb_nva_valor_cuota,ldb_valor_cuota,&
			...
			ldb_der_esp,ldb_precio,ldb_pie_new,ldb_capital_new,ldb_calc_pie,ll_numero
...
if ls_columna='moneda' or ls_columna='nvo_plazo' or ls_columna='nvo_pie' or &
	...
	elseif rb_anticipado.checked=true then
		if dw_repacta.getitemstring(1,'moneda')='1' then //peso
			if dw_ctto.getitemstring(1,'producto_pago_moneda')='1' then //peso
				ldb_precio				= round( dw_ctto.getitemnumber(1,'producto_pago_precio') / gd_uf,2)
				ldb_der_esp				= dw_ctto.getitemnumber(1,'producto_pago_der_esp')// * gd_uf,0)
			elseif dw_ctto.getitemstring(1,'producto_pago_moneda')='2' then //UF
				ldb_precio				= dw_ctto.getitemnumber(1,'producto_pago_precio')
				ldb_der_esp				= dw_ctto.getitemnumber(1,'producto_pago_der_esp')
			end if
