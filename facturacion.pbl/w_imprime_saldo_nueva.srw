forward
global type w_imprime_saldo_nueva from window
end type
type dw_1 from uo_datawindow within w_imprime_saldo_nueva
end type
type cb_3 from commandbutton within w_imprime_saldo_nueva
end type
type p_9 from picture within w_imprime_saldo_nueva
end type
type p_8 from picture within w_imprime_saldo_nueva
end type
type p_7 from picture within w_imprime_saldo_nueva
end type
type p_6 from picture within w_imprime_saldo_nueva
end type
type pb_fin from picturebutton within w_imprime_saldo_nueva
end type
type p_4 from picture within w_imprime_saldo_nueva
end type
type pb_antes from picturebutton within w_imprime_saldo_nueva
end type
type p_3 from picture within w_imprime_saldo_nueva
end type
type pb_sigue from picturebutton within w_imprime_saldo_nueva
end type
type p_2 from picture within w_imprime_saldo_nueva
end type
type pb_primer from picturebutton within w_imprime_saldo_nueva
end type
type p_1 from picture within w_imprime_saldo_nueva
end type
type cbx_1 from checkbox within w_imprime_saldo_nueva
end type
type cb_2 from commandbutton within w_imprime_saldo_nueva
end type
type cb_1 from commandbutton within w_imprime_saldo_nueva
end type
type gb_1 from groupbox within w_imprime_saldo_nueva
end type
end forward
...
global w_imprime_saldo_nueva w_imprime_saldo_nueva
...
on w_imprime_saldo_nueva.create
...
on w_imprime_saldo_nueva.destroy
destroy(this.dw_1)
destroy(this.cb_3)
destroy(this.p_9)
destroy(this.p_8)
...
integer width = 3557
integer height = 2136
string dataobject = "dw_oferta_saldo_nueva"
boolean border = true
...
event clicked;close(w_imprime_saldo_nueva)
end event
