forward
global type w_imprime_saldo_aumento_resciliados from window
end type
type dw_1 from uo_datawindow within w_imprime_saldo_aumento_resciliados
end type
type cb_3 from commandbutton within w_imprime_saldo_aumento_resciliados
end type
type p_9 from picture within w_imprime_saldo_aumento_resciliados
end type
type p_8 from picture within w_imprime_saldo_aumento_resciliados
end type
type p_7 from picture within w_imprime_saldo_aumento_resciliados
end type
type p_6 from picture within w_imprime_saldo_aumento_resciliados
end type
type pb_fin from picturebutton within w_imprime_saldo_aumento_resciliados
end type
type p_4 from picture within w_imprime_saldo_aumento_resciliados
end type
type pb_antes from picturebutton within w_imprime_saldo_aumento_resciliados
end type
type p_3 from picture within w_imprime_saldo_aumento_resciliados
end type
type pb_sigue from picturebutton within w_imprime_saldo_aumento_resciliados
end type
type p_2 from picture within w_imprime_saldo_aumento_resciliados
end type
type pb_primer from picturebutton within w_imprime_saldo_aumento_resciliados
end type
type p_1 from picture within w_imprime_saldo_aumento_resciliados
end type
type cbx_1 from checkbox within w_imprime_saldo_aumento_resciliados
end type
type cb_2 from commandbutton within w_imprime_saldo_aumento_resciliados
end type
type cb_1 from commandbutton within w_imprime_saldo_aumento_resciliados
end type
type gb_1 from groupbox within w_imprime_saldo_aumento_resciliados
end type
end forward
...
global w_imprime_saldo_aumento_resciliados w_imprime_saldo_aumento_resciliados
...
if dw_1.retrieve(fecha) > 0 then
	...
	dw_1.object.tipo_moneda.text = 'Aumentos en Pesos ( $ )'
	cbx_1.text = 'Ofertas en Pesos ( $ )'
	wf_formato(1)
else
	messagebox(gs_app_name,'No Existen Saldos de Aumentos procesados,',stopsign!)
	close(w_imprime_saldo_liberadores_resciliados)
end if	
end event

on w_imprime_saldo_aumento_resciliados.create
...
on w_imprime_saldo_aumento_resciliados.destroy
destroy(this.dw_1)
destroy(this.cb_3)
destroy(this.p_9)
destroy(this.p_8)
...
integer width = 3557
integer height = 2136
string dataobject = "dw_oferta_saldo_aumento_resciliados"
boolean border = true
...
OpenWithParm(w_resumen_saldo_aumento, Message.StringParm)
if cbx_1.checked = true then
	...
	cbx_1.text = 'Aumentos en Unidades de Fomento ( U.F. )'
	dw_1.SetFilter("moneda = '2'")
	dw_1.Filter()
	dw_1.object.tipo_moneda.text = 'Aumentos en Unidades de Fomento ( U.F. )'
end if
dw_1.Setsort("serie A,numero A")
dw_1.sort()
wf_formato(1)
...
if this.checked = true then
	this.text = 'Aumentos en Pesos ( $ )'
	dw_1.SetFilter("moneda = '1'")
	dw_1.Filter()
	dw_1.object.tipo_moneda.text = 'Aumentos en Pesos ( $ )'
	dw_1.Setsort("serie A,numero A")
else
	this.text = 'Aumentos en Unidades de Fomento ( U.F. )'
	dw_1.SetFilter("moneda = '2'")
	dw_1.Filter()
	dw_1.object.tipo_moneda.text = 'Aumentos en Unidades de Fomento ( U.F. )'
end if
...
event clicked;close(w_imprime_saldo_aumento_resciliados)
end event
