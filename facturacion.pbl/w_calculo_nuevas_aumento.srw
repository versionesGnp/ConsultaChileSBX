forward
global type w_calculo_nuevas_aumento from window
end type
type hpb_1 from hprogressbar within w_calculo_nuevas_aumento
end type
type dw_2 from datawindow within w_calculo_nuevas_aumento
end type
type st_3 from statictext within w_calculo_nuevas_aumento
end type
type st_2 from statictext within w_calculo_nuevas_aumento
end type
type dw_1 from datawindow within w_calculo_nuevas_aumento
end type
type cb_3 from commandbutton within w_calculo_nuevas_aumento
end type
type st_1 from statictext within w_calculo_nuevas_aumento
end type
type cb_2 from commandbutton within w_calculo_nuevas_aumento
end type
type cb_1 from commandbutton within w_calculo_nuevas_aumento
end type
type p_1 from picture within w_calculo_nuevas_aumento
end type
type em_fecha_cierre from editmask within w_calculo_nuevas_aumento
end type
type gb_1 from groupbox within w_calculo_nuevas_aumento
end type
end forward
...
global w_calculo_nuevas_aumento w_calculo_nuevas_aumento
...
on w_calculo_nuevas_aumento.create
...
on w_calculo_nuevas_aumento.destroy
destroy(this.hpb_1)
destroy(this.dw_2)
destroy(this.st_3)
destroy(this.st_2)
...
integer taborder = 50
boolean titlebar = true
string dataobject = "dw_calculo_nuevos_aumento"
boolean controlmenu = true
boolean minbox = true
boolean maxbox = true
boolean hscrollbar = true
...
event clicked;close(w_calculo_nuevas_aumento)
end event
...
if ret = 3 then 
	return
elseif ret = 2 then
	close(w_calculo_nuevas_aumento)
	return
end if
