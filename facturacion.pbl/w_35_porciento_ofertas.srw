forward
global type w_35_porciento_ofertas from window
end type
type st_7 from statictext within w_35_porciento_ofertas
end type
type st_4 from statictext within w_35_porciento_ofertas
end type
type dw_ifrs from datawindow within w_35_porciento_ofertas
end type
type p_1 from picture within w_35_porciento_ofertas
end type
type em_fecha_cierre from editmask within w_35_porciento_ofertas
end type
type hpb_1 from hprogressbar within w_35_porciento_ofertas
end type
type st_3 from statictext within w_35_porciento_ofertas
end type
type cb_actualiza from commandbutton within w_35_porciento_ofertas
end type
type st_2 from statictext within w_35_porciento_ofertas
end type
type st_1 from statictext within w_35_porciento_ofertas
end type
type sle_clave from singlelineedit within w_35_porciento_ofertas
end type
type sle_usuario from singlelineedit within w_35_porciento_ofertas
end type
type cb_aceptar from commandbutton within w_35_porciento_ofertas
end type
type cb_cancelar from commandbutton within w_35_porciento_ofertas
end type
type ln_1 from line within w_35_porciento_ofertas
end type
type ln_2 from line within w_35_porciento_ofertas
end type
type gb_1 from groupbox within w_35_porciento_ofertas
end type
end forward
...
global w_35_porciento_ofertas w_35_porciento_ofertas
...
on w_35_porciento_ofertas.create
...
on w_35_porciento_ofertas.destroy
destroy(this.st_7)
destroy(this.st_4)
...
if sqlca.sqlcode=0 then
	if not isnull(ldt_fecha) then
		ll_res 					= messagebox("Actualizar","¿ Esta seguro que desea Actualizar los Ingresos de Promesas ?",Question!,YesNoCancel! ,3)
		this.enabled 			= true
		if ll_res = 1 then
			...
			WHERE 	( "FACTURA_OFERTA"."BASE" = "CADENA"."CODIGO" ) and  
						...
						( "FACTURA_OFERTA"."PORCENTAJE_PAGO" >= 35 ) AND  
...
IF is_clave = Upper(sle_clave.text) and sle_clave.text<>'' THEN
	...
	END IF
	w_35_porciento_ofertas.height=1320
	this.enabled = false
