forward
global type w_consulta_liberadores from window
end type
type cb_4 from commandbutton within w_consulta_liberadores
end type
type cb_3 from commandbutton within w_consulta_liberadores
end type
type em_nro_oferta from editmask within w_consulta_liberadores
end type
type cb_2 from commandbutton within w_consulta_liberadores
end type
type dw_1 from uo_datawindow within w_consulta_liberadores
end type
type cb_1 from commandbutton within w_consulta_liberadores
end type
end forward
...
global w_consulta_liberadores w_consulta_liberadores

on w_consulta_liberadores.create
...
on w_consulta_liberadores.destroy
destroy(this.cb_4)
destroy(this.cb_3)
...
if dw_1.retrieve(fecha,'L') > 0 then
...
integer height = 2088
integer taborder = 10
string dataobject = "dw_modifica_liberador"
boolean border = true
...
event clicked;close(w_consulta_liberadores)
end event
