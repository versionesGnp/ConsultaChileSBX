forward
global type w_calculo_liberadores from window
end type
type cb_primera_fact from commandbutton within w_calculo_liberadores
end type
type hpb_1 from hprogressbar within w_calculo_liberadores
end type
type dw_2 from datawindow within w_calculo_liberadores
end type
type st_3 from statictext within w_calculo_liberadores
end type
type st_2 from statictext within w_calculo_liberadores
end type
type dw_1 from datawindow within w_calculo_liberadores
end type
type cb_3 from commandbutton within w_calculo_liberadores
end type
type st_1 from statictext within w_calculo_liberadores
end type
type cb_2 from commandbutton within w_calculo_liberadores
end type
type cb_1 from commandbutton within w_calculo_liberadores
end type
type p_1 from picture within w_calculo_liberadores
end type
type em_fecha_cierre from editmask within w_calculo_liberadores
end type
type gb_1 from groupbox within w_calculo_liberadores
end type
end forward
...
global w_calculo_liberadores w_calculo_liberadores
...
on w_calculo_liberadores.create
...
on w_calculo_liberadores.destroy
...
integer taborder = 50
boolean titlebar = true
string dataobject = "dw_calculo_liberador"
boolean controlmenu = true
boolean minbox = true
boolean maxbox = true
boolean hscrollbar = true
...
event clicked;OpenWithParm(w_imprime_saldo_liberadores, em_fecha_cierre.text)
end event
...
event clicked;close(w_calculo_liberadores)
end event
...
datetime fecha_prim,fecha_ult,fecha_cierre,fecha_vto,fecha_oferta
date		fecha
...
long textcolor = 255
long backcolor = 67108864
string text = "Saldos de Liberadores."
end type
