forward
global type w_ingresos_lib from window
end type
type dw_1 from datawindow within w_ingresos_lib
end type
type p_1 from picture within w_ingresos_lib
end type
type em_fecha from editmask within w_ingresos_lib
end type
type st_3 from statictext within w_ingresos_lib
end type
type cb_actualiza from commandbutton within w_ingresos_lib
end type
type st_2 from statictext within w_ingresos_lib
end type
type st_1 from statictext within w_ingresos_lib
end type
type sle_clave from singlelineedit within w_ingresos_lib
end type
type sle_usuario from singlelineedit within w_ingresos_lib
end type
type cb_aceptar from commandbutton within w_ingresos_lib
end type
type cb_cancelar from commandbutton within w_ingresos_lib
end type
type ln_1 from line within w_ingresos_lib
end type
type ln_2 from line within w_ingresos_lib
end type
type gb_1 from groupbox within w_ingresos_lib
end type
end forward
...
global w_ingresos_lib w_ingresos_lib
...
event clicked;close(w_ingresos_lib)
end event
