forward
global type w_elimina_lib from window
end type
type dw_1 from datawindow within w_elimina_lib
end type
type p_1 from picture within w_elimina_lib
end type
type em_fecha from editmask within w_elimina_lib
end type
type st_3 from statictext within w_elimina_lib
end type
type cb_actualiza from commandbutton within w_elimina_lib
end type
type st_2 from statictext within w_elimina_lib
end type
type st_1 from statictext within w_elimina_lib
end type
type sle_clave from singlelineedit within w_elimina_lib
end type
type sle_usuario from singlelineedit within w_elimina_lib
end type
type cb_aceptar from commandbutton within w_elimina_lib
end type
type cb_cancelar from commandbutton within w_elimina_lib
end type
type ln_1 from line within w_elimina_lib
end type
type ln_2 from line within w_elimina_lib
end type
type gb_1 from groupbox within w_elimina_lib
end type
end forward
...
global w_elimina_lib w_elimina_lib
...
WHERE ( "FACTURA_OFERTA"."BASE" = 'L' ) AND  
...
WHERE ( "FACTURA_OFERTA_DV"."BASE" = 'L' ) AND  
...
WHERE ( "FACTURA_OFERTA_DV_M"."BASE" = 'L' ) AND  
...
this.title = gs_app_name+' - ( Elimina Liberadores )'
...
string facename = "Arial"
boolean enabled = false
string text = "~'Elimina &Liberadores~'"
end type
...
event clicked;close(w_elimina_lib)
end event
...
long textcolor = 255
long backcolor = 79741120
string text = "Eliminación de Lib. ( Factura_Ofertas )."
end type
