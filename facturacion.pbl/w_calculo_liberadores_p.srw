forward
global type w_calculo_liberadores_p from window
end type
type hpb_1 from hprogressbar within w_calculo_liberadores_p
end type
type dw_2 from datawindow within w_calculo_liberadores_p
end type
type st_3 from statictext within w_calculo_liberadores_p
end type
type st_2 from statictext within w_calculo_liberadores_p
end type
type dw_1 from datawindow within w_calculo_liberadores_p
end type
type cb_3 from commandbutton within w_calculo_liberadores_p
end type
type st_1 from statictext within w_calculo_liberadores_p
end type
type cb_2 from commandbutton within w_calculo_liberadores_p
end type
type cb_1 from commandbutton within w_calculo_liberadores_p
end type
type p_1 from picture within w_calculo_liberadores_p
end type
type em_fecha_cierre from editmask within w_calculo_liberadores_p
end type
type gb_1 from groupbox within w_calculo_liberadores_p
end type
end forward
...
global w_calculo_liberadores_p w_calculo_liberadores_p
...
on w_calculo_liberadores_p.create
...
on w_calculo_liberadores_p.destroy
destroy(this.hpb_1)
destroy(this.dw_2)
destroy(this.st_3)
destroy(this.st_2)
...
event clicked;OpenWithParm(w_imprime_saldo_liberadores_p, em_fecha_cierre.text)
end event
...
event clicked;close(w_calculo_liberadores_p)
end event
...
long textcolor = 255
long backcolor = 67108864
string text = "Liberadores por Vencer."
end type
