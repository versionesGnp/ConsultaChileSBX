forward
global type w_calculo_ingreso from window
end type
type cb_4 from commandbutton within w_calculo_ingreso
end type
type dw_2 from datawindow within w_calculo_ingreso
end type
type st_3 from statictext within w_calculo_ingreso
end type
type st_2 from statictext within w_calculo_ingreso
end type
type dw_1 from datawindow within w_calculo_ingreso
end type
type cb_3 from commandbutton within w_calculo_ingreso
end type
type st_1 from statictext within w_calculo_ingreso
end type
type ole_meter from uo_meter_control within w_calculo_ingreso
end type
type cb_2 from commandbutton within w_calculo_ingreso
end type
type cb_1 from commandbutton within w_calculo_ingreso
end type
type p_1 from picture within w_calculo_ingreso
end type
type em_fecha_cierre from editmask within w_calculo_ingreso
end type
type gb_1 from groupbox within w_calculo_ingreso
end type
end forward
...
global w_calculo_ingreso w_calculo_ingreso
...
boolean border = true
borderstyle borderstyle = stylelowered!
string binarykey = "w_calculo_ingreso.win"
integer textsize = -8
end type
...
if dw_1.rowcount() > 0 then
	ole_meter.object.minvalue = 1
	ole_meter.object.maxvalue = dw_1.rowcount()
