forward
global type w_imprime_saldo_dv from window
end type
type dw_1 from uo_datawindow within w_imprime_saldo_dv
end type
type cb_3 from commandbutton within w_imprime_saldo_dv
end type
type p_9 from picture within w_imprime_saldo_dv
end type
type p_8 from picture within w_imprime_saldo_dv
end type
type p_7 from picture within w_imprime_saldo_dv
end type
type p_6 from picture within w_imprime_saldo_dv
end type
type pb_fin from picturebutton within w_imprime_saldo_dv
end type
type p_4 from picture within w_imprime_saldo_dv
end type
type pb_antes from picturebutton within w_imprime_saldo_dv
end type
type p_3 from picture within w_imprime_saldo_dv
end type
type pb_sigue from picturebutton within w_imprime_saldo_dv
end type
type p_2 from picture within w_imprime_saldo_dv
end type
type pb_primer from picturebutton within w_imprime_saldo_dv
end type
type p_1 from picture within w_imprime_saldo_dv
end type
type cbx_1 from checkbox within w_imprime_saldo_dv
end type
type cb_2 from commandbutton within w_imprime_saldo_dv
end type
type cb_1 from commandbutton within w_imprime_saldo_dv
end type
type gb_1 from groupbox within w_imprime_saldo_dv
end type
end forward
...
global w_imprime_saldo_dv w_imprime_saldo_dv
...
public subroutine wf_formato (integer moneda);dw_1.Object.saldo_total2.Format    = '###,###,###,##0'
dw_1.Object.saldo_cp2.Format       = '###,###,###,##0'
dw_1.Object.saldo_lp2.Format       = '###,###,###,##0'
dw_1.Object.capital2.Format        = '###,###,###,##0'
dw_1.Object.capital_cp2.Format     = '###,###,###,##0'
dw_1.Object.capital_cp2.Format     = '###,###,###,##0'
dw_1.Object.interes2.Format        = '###,###,###,##0'
dw_1.Object.interes_cp2.Format     = '###,###,###,##0'
dw_1.Object.interes_lp2.Format     = '###,###,###,##0'
dw_1.Object.gc2.Format             = '###,###,###,##0'
dw_1.Object.gc_cp2.Format          = '###,###,###,##0'
dw_1.Object.gc_lp2.Format          = '###,###,###,##0'
...
if dw_1.retrieve(fecha) > 0 then
	...
	dw_1.sort()
	dw_1.object.tipo_moneda.text = 'Ofertas en Pesos ( $ )'
...
integer width = 3557
integer height = 2136
string dataobject = "dw_oferta_saldo_dv_1"
boolean border = true
...
OpenWithParm(w_resumen_saldo, Message.StringParm)
if cbx_1.checked = true then
	...
	cbx_1.text = 'Ofertas en Unidades de Fomento ( U.F. )'
	dw_1.SetFilter("moneda = '2'")
	dw_1.Filter()
	dw_1.object.tipo_moneda.text = 'Ofertas en Unidades de Fomento ( U.F. )'
end if
dw_1.Setsort("serie A,numero A")
dw_1.sort()
wf_formato(1)
...
string facename = "Arial"
long backcolor = 67108864
string text = "Ofertas en Unidades de Fomento ( U.F. )"
...
if this.checked = true then
	this.text = 'Ofertas en Pesos ( $ )'
	dw_1.SetFilter("moneda = '1'")
	dw_1.Filter()
	dw_1.object.tipo_moneda.text = 'Ofertas en Pesos ( $ )'
	dw_1.Setsort("serie A,numero A")
else
	this.text = 'Ofertas en Unidades de Fomento ( U.F. )'
	dw_1.SetFilter("moneda = '2'")
	dw_1.Filter()
	dw_1.object.tipo_moneda.text = 'Ofertas en Unidades de Fomento ( U.F. )'
end if
...
event clicked;close(w_imprime_saldo_dv)
end event
