forward
global type w_ejecutivo_detalle_ugn from window
end type
type cb_cerrar from commandbutton within w_ejecutivo_detalle_ugn
end type
type cb_grabar from commandbutton within w_ejecutivo_detalle_ugn
end type
type dw_lista_asig from datawindow within w_ejecutivo_detalle_ugn
end type
end forward
...
global w_ejecutivo_detalle_ugn w_ejecutivo_detalle_ugn

on w_ejecutivo_detalle_ugn.create
...
on w_ejecutivo_detalle_ugn.destroy
