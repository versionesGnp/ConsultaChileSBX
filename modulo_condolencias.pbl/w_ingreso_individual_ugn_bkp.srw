forward
global type w_ingreso_individual_ugn_bkp from window
end type
type pb_ok3 from picturebutton within w_ingreso_individual_ugn_bkp
end type
type st_7 from statictext within w_ingreso_individual_ugn_bkp
end type
type p_1 from picture within w_ingreso_individual_ugn_bkp
end type
type fec_ini_falle from editmask within w_ingreso_individual_ugn_bkp
end type
type st_filtrar from statictext within w_ingreso_individual_ugn_bkp
end type
type st_buscar from statictext within w_ingreso_individual_ugn_bkp
end type
type st_6 from statictext within w_ingreso_individual_ugn_bkp
end type
type pb_ok1 from picturebutton within w_ingreso_individual_ugn_bkp
end type
type pb_buscar from picturebutton within w_ingreso_individual_ugn_bkp
end type
type em_grupo from editmask within w_ingreso_individual_ugn_bkp
end type
type st_3 from statictext within w_ingreso_individual_ugn_bkp
end type
type st_5 from statictext within w_ingreso_individual_ugn_bkp
end type
type em_agente from editmask within w_ingreso_individual_ugn_bkp
end type
type cb_print_informe from commandbutton within w_ingreso_individual_ugn_bkp
end type
type cb_modif_antece from commandbutton within w_ingreso_individual_ugn_bkp
end type
type hpb_1 from hprogressbar within w_ingreso_individual_ugn_bkp
end type
type cb_actualizar from commandbutton within w_ingreso_individual_ugn_bkp
end type
type cb_ctacte2 from commandbutton within w_ingreso_individual_ugn_bkp
end type
type dw_dias_mora from datawindow within w_ingreso_individual_ugn_bkp
end type
type cb_cerrar from commandbutton within w_ingreso_individual_ugn_bkp
end type
type cb_ctacte from commandbutton within w_ingreso_individual_ugn_bkp
end type
type st_2 from statictext within w_ingreso_individual_ugn_bkp
end type
type sle_nombre from singlelineedit within w_ingreso_individual_ugn_bkp
end type
type pb_ok2 from picturebutton within w_ingreso_individual_ugn_bkp
end type
type cb_grabar_formula from commandbutton within w_ingreso_individual_ugn_bkp
end type
type cb_historico from commandbutton within w_ingreso_individual_ugn_bkp
end type
type cb_imprimir from commandbutton within w_ingreso_individual_ugn_bkp
end type
type cb_exportar from commandbutton within w_ingreso_individual_ugn_bkp
end type
type cb_filtrar from commandbutton within w_ingreso_individual_ugn_bkp
end type
type cb_ordenar from commandbutton within w_ingreso_individual_ugn_bkp
end type
type gb_1 from groupbox within w_ingreso_individual_ugn_bkp
end type
type st_porc from statictext within w_ingreso_individual_ugn_bkp
end type
type st_fondo from statictext within w_ingreso_individual_ugn_bkp
end type
type sle_ap_pat from singlelineedit within w_ingreso_individual_ugn_bkp
end type
type gb_4 from groupbox within w_ingreso_individual_ugn_bkp
end type
type gb_2 from groupbox within w_ingreso_individual_ugn_bkp
end type
type gb_3 from groupbox within w_ingreso_individual_ugn_bkp
end type
type tab_cobranza from uo_ugn_gestion within w_ingreso_individual_ugn_bkp
end type
type tab_cobranza from uo_ugn_gestion within w_ingreso_individual_ugn_bkp
end type
type dw_lista from datawindow within w_ingreso_individual_ugn_bkp
end type
type dw_print_agente from datawindow within w_ingreso_individual_ugn_bkp
end type
end forward
...
global w_ingreso_individual_ugn_bkp w_ingreso_individual_ugn_bkp
...
event ue_cargar;Long		ll_tot_reg,ll_indi,ll_rut,ll_count_reg,ll_numero,ll_count_pago,ll_tot_porc,ll_tot_porc_aux,&
...
if sqlca.sqlcode=0 then
	if ls_estado='A' then
		ll_tot_reg					= dw_lista.retrieve(gs_user,date(gdt_fec_sistema),ll_dias_ugn,ll_dias_sup)
	...
	//	ll_tot_filas			= dw_lista.retrieve(date(gdt_fec_sistema),ll_dias_ugn,ll_dias_sup)
		ll_tot_filas			 =  dw_lista.retrieve(gs_user,date(gdt_fec_sistema),ll_dias_ugn,ll_dias_sup)
...
dw_print_agente.retrieve(gs_user,date(gdt_fec_sistema),ll_dias_ugn,ll_dias_sup)
...
public subroutine wf_cargar_dw_contrato ();Long		ll_tot_reg_ctto,ll_indi_ctto,ll_numero,ll_mora_cred,ll_mora_mant,ll_dias_mora_cred,ll_dias_mora_mant,&
...
on w_ingreso_individual_ugn_bkp.create
...
on w_ingreso_individual_ugn_bkp.destroy
destroy(this.pb_ok3)
destroy(this.st_7)
destroy(this.p_1)
...
event open;Long		ll_tot_reg,ll_indi,ll_rut,ll_count_reg,ll_numero,ll_count_pago
Datetime	ldt_fecha,ldt_fec_llama
...
//	cb_modif_antece.y				= 48
	...
	if gs_user = 'JU2' or gs_depto = 'I' or gs_depto = 'G' then
...
Long		ll_grupo,ll_correlativo,ll_new,ll_new_tele,ll_rut_fall
...
if row > 0 then
	...
	if is_tipo_usuario = 'SUP' then  //UGN
	...
	elseif is_tipo_usuario = 'UGN' then //SUP
...
event rowfocuschanged;String	ls_nombre,ls_ap_pat,ls_ap_mat,ls_sector,ls_sepult,ls_nom_fall,ls_ap_pat_fall,&
			ls_ap_mat_fall  
Date		ld_fecha_prox_llamado,ld_fecha_mas2
Datetime	ldt_fec_sepult
Long		ll_grupo,ll_correlativo,ll_new,ll_new_tele,ll_rut_fall
