forward
global type w_ejecutivo_cabecera_ugn from window
end type
type cb_cerrar from commandbutton within w_ejecutivo_cabecera_ugn
end type
type cb_grabar from commandbutton within w_ejecutivo_cabecera_ugn
end type
type dw_ejecutivo_cabecera from datawindow within w_ejecutivo_cabecera_ugn
end type
end forward
...
global w_ejecutivo_cabecera_ugn w_ejecutivo_cabecera_ugn
...
on w_ejecutivo_cabecera_ugn.create
...
on w_ejecutivo_cabecera_ugn.destroy
