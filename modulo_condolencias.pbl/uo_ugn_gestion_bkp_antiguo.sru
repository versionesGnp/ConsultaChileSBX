forward
global type uo_ugn_gestion_bkp_antiguo from tab
end type
type tabpage_1 from userobject within uo_ugn_gestion_bkp_antiguo
end type
...
type tabpage_2 from userobject within uo_ugn_gestion_bkp_antiguo
end type
...
type tabpage_3 from userobject within uo_ugn_gestion_bkp_antiguo
end type
...
type tabpage_4 from userobject within uo_ugn_gestion_bkp_antiguo
end type
...
global uo_ugn_gestion_bkp_antiguo uo_ugn_gestion_bkp_antiguo

type variables
long	il_fila
end variables

on uo_ugn_gestion_bkp_antiguo.create
...
on uo_ugn_gestion_bkp_antiguo.destroy
...
event clicked;long		ll_ret,ll_tot_reg,ll_indi,ll_rut,ll_nro_grupo,ll_sum_reg,ll_count_reg,ll_row,ll_grupo,ll_correlativo,ll_grupo_asignado
