forward
global type w_informes_ugn_general_bk from window
end type
type cbx_todo from checkbox within w_informes_ugn_general_bk
end type
type cb_limpiar from commandbutton within w_informes_ugn_general_bk
end type
type dw_agente from datawindow within w_informes_ugn_general_bk
end type
type dw_parque from datawindow within w_informes_ugn_general_bk
end type
type pb_5 from picturebutton within w_informes_ugn_general_bk
end type
type pb_4 from picturebutton within w_informes_ugn_general_bk
end type
type pb_3 from picturebutton within w_informes_ugn_general_bk
end type
type pb_2 from picturebutton within w_informes_ugn_general_bk
end type
type cb_ordenar from commandbutton within w_informes_ugn_general_bk
end type
type cb_filtrar from commandbutton within w_informes_ugn_general_bk
end type
type cb_exportar from commandbutton within w_informes_ugn_general_bk
end type
type cb_imprimir from commandbutton within w_informes_ugn_general_bk
end type
type cb_cerrar from commandbutton within w_informes_ugn_general_bk
end type
type st_1 from statictext within w_informes_ugn_general_bk
end type
type st_2 from statictext within w_informes_ugn_general_bk
end type
type em_final from editmask within w_informes_ugn_general_bk
end type
type p_1 from picture within w_informes_ugn_general_bk
end type
type p_2 from picture within w_informes_ugn_general_bk
end type
type pb_procesar from picturebutton within w_informes_ugn_general_bk
end type
type dw_lista from datawindow within w_informes_ugn_general_bk
end type
type gb_1 from groupbox within w_informes_ugn_general_bk
end type
type gb_2 from groupbox within w_informes_ugn_general_bk
end type
type dw_lista_estado from datawindow within w_informes_ugn_general_bk
end type
type em_desde from editmask within w_informes_ugn_general_bk
end type
type st_help from statictext within w_informes_ugn_general_bk
end type
type st_16 from statictext within w_informes_ugn_general_bk
end type
end forward
...
global w_informes_ugn_general_bk w_informes_ugn_general_bk
...
on w_informes_ugn_general_bk.create
...
on w_informes_ugn_general_bk.destroy
...
event clicked;w_informes_ugn_general.width	= 2391
...
elseif is_opcion='AS' or is_opcion='AU' then
	dw_agente.reset()
	if is_opcion='AS' then
		idw_detalle.retrieve('SUP')
	elseif is_opcion='AU' then
...
integer taborder = 60
string title = "none"
string dataobject = "dw_informe_estadistico_parque_venta"
