forward
global type w_listado_dscto_cuota_mortuoria from window
end type
type cb_ctacte from commandbutton within w_listado_dscto_cuota_mortuoria
end type
type cb_limpiar from commandbutton within w_listado_dscto_cuota_mortuoria
end type
type cb_1 from commandbutton within w_listado_dscto_cuota_mortuoria
end type
type cb_2 from commandbutton within w_listado_dscto_cuota_mortuoria
end type
type cb_3 from commandbutton within w_listado_dscto_cuota_mortuoria
end type
type cb_imprimir from commandbutton within w_listado_dscto_cuota_mortuoria
end type
type pb_ok from picturebutton within w_listado_dscto_cuota_mortuoria
end type
type dw_fecha from datawindow within w_listado_dscto_cuota_mortuoria
end type
type cb_cerrar from commandbutton within w_listado_dscto_cuota_mortuoria
end type
type dw_lista from datawindow within w_listado_dscto_cuota_mortuoria
end type
type gb_1 from groupbox within w_listado_dscto_cuota_mortuoria
end type
end forward
...
string title = "Listado Descuento Cuota Mortuoria"
...
global w_listado_dscto_cuota_mortuoria w_listado_dscto_cuota_mortuoria

type variables
String		is_rut_empresa, is_opcion
end variables

on w_listado_dscto_cuota_mortuoria.create
...
on w_listado_dscto_cuota_mortuoria.destroy
...
gf_centrar(w_listado_dscto_cuota_mortuoria)
...
if is_opcion='G' then
	...
	w_listado_dscto_cuota_mortuoria.title		= 'Listado BE Terminadas de Pagar'
	...
	w_listado_dscto_cuota_mortuoria.title		= 'BE Emitida por Termino de Crédito'
	...
	if dw_lista.retrieve(gs_base,gs_serie,gi_numero) = 0 then
		...
		close(w_listado_dscto_cuota_mortuoria)
	end if
end if
end event
...
event clicked;close(w_listado_dscto_cuota_mortuoria)
end event
