forward
global type w_informe_detallado_gestion_reclamo_detalle from window
end type
type cb_limpiar from commandbutton within w_informe_detallado_gestion_reclamo_detalle
end type
type pb_tipo_filtrar from picturebutton within w_informe_detallado_gestion_reclamo_detalle
end type
type ddplb_estado from dropdownpicturelistbox within w_informe_detallado_gestion_reclamo_detalle
end type
type st_3 from statictext within w_informe_detallado_gestion_reclamo_detalle
end type
type ddplb_usuario from dropdownpicturelistbox within w_informe_detallado_gestion_reclamo_detalle
end type
type st_2 from statictext within w_informe_detallado_gestion_reclamo_detalle
end type
type ddplb_parque from dropdownpicturelistbox within w_informe_detallado_gestion_reclamo_detalle
end type
type st_1 from statictext within w_informe_detallado_gestion_reclamo_detalle
end type
type cb_ordenar from commandbutton within w_informe_detallado_gestion_reclamo_detalle
end type
type cb_filtrar from commandbutton within w_informe_detallado_gestion_reclamo_detalle
end type
type cb_exportar from commandbutton within w_informe_detallado_gestion_reclamo_detalle
end type
type p_inicio from picture within w_informe_detallado_gestion_reclamo_detalle
end type
type st_hasta from statictext within w_informe_detallado_gestion_reclamo_detalle
end type
type em_inicio from editmask within w_informe_detallado_gestion_reclamo_detalle
end type
type em_termino from editmask within w_informe_detallado_gestion_reclamo_detalle
end type
type st_desde from statictext within w_informe_detallado_gestion_reclamo_detalle
end type
type p_termino from picture within w_informe_detallado_gestion_reclamo_detalle
end type
type pb_ok from picturebutton within w_informe_detallado_gestion_reclamo_detalle
end type
type cb_imprimir from commandbutton within w_informe_detallado_gestion_reclamo_detalle
end type
type cb_cerrar from commandbutton within w_informe_detallado_gestion_reclamo_detalle
end type
type dw_lista from datawindow within w_informe_detallado_gestion_reclamo_detalle
end type
type gb_periodo from groupbox within w_informe_detallado_gestion_reclamo_detalle
end type
type gb_3 from groupbox within w_informe_detallado_gestion_reclamo_detalle
end type
type gb_1 from groupbox within w_informe_detallado_gestion_reclamo_detalle
end type
end forward
...
string title = "Informe Detalle Gestión Requerimiento"
...
global w_informe_detallado_gestion_reclamo_detalle w_informe_detallado_gestion_reclamo_detalle

on w_informe_detallado_gestion_reclamo_detalle.create
...
on w_informe_detallado_gestion_reclamo_detalle.destroy
...
gf_centrar(w_informe_detallado_gestion_reclamo_detalle)
...
if isvalid(w_informe_estadistico_gestion_reclamo) then
	if w_informe_estadistico_gestion_reclamo.dw_lista.rowcount() > 0 then 
		...
		if ls_estado='F' then
			...
			w_informe_detallado_gestion_reclamo_detalle.title	= 'Detalle Gestión Requerimiento del día '+string(ldt_fecha_proc,'dd/mm/yyyy')
		elseif ls_estado='T' then
			em_inicio.text		= string(ldt_fec_ini,'dd/mm/yyyy')
			em_termino.text	= string(ldt_fec_fin,'dd/mm/yyyy')
			w_informe_detallado_gestion_reclamo_detalle.title	= 'Detalle Gestión Requerimiento del día '+string(em_inicio.text,'dd/mm/yyyy')+' al '+string(em_termino.text,'dd/mm/yyyy')
		end if
	...
	w_informe_detallado_gestion_reclamo_detalle.title	= 'Detalle Gestión Requerimiento'
...
event clicked;close(w_informe_detallado_gestion_reclamo_detalle)
end event
...
integer taborder = 40
string title = "none"
string dataobject = "dw_listado_detalle_gestion_reclamos_detalle"
