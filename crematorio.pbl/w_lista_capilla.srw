forward
global type w_lista_capilla from window
end type
type cb_inactivar from commandbutton within w_lista_capilla
end type
type st_16 from statictext within w_lista_capilla
end type
type dw_parque from datawindow within w_lista_capilla
end type
type st_1 from statictext within w_lista_capilla
end type
type pb_ok from picturebutton within w_lista_capilla
end type
type dp_fecha from datepicker within w_lista_capilla
end type
type cb_exportar from commandbutton within w_lista_capilla
end type
type cb_imprimir from commandbutton within w_lista_capilla
end type
type cb_agregar from commandbutton within w_lista_capilla
end type
type cb_cerrar from commandbutton within w_lista_capilla
end type
type dw_lista from datawindow within w_lista_capilla
end type
type gb_1 from groupbox within w_lista_capilla
end type
end forward
...
global w_lista_capilla w_lista_capilla
...
String		is_nombre,is_ap_pat,is_ap_mat,is_ejecutivo,is_obs,is_tipo,is_uso_visualiza,is_uso_capilla,is_uso_pergola,is_ingreso_parque
datetime	idt_fecha_cremacion
end variables

on w_lista_capilla.create
...
//if is_ingreso_parque='S' then
//	w_lista_capilla.title			= 'Resumen de Ingreso Parque día '+string(idt_fecha_cremacion,'dd/mm/yyyy')
//	dw_lista.object.t_titulo.text	= 'Resumen de Ingreso Parque día '+string(idt_fecha_cremacion,'dd/mm/yyyy')
//else
	w_lista_capilla.title			= 'Resumen de Uso Capilla día '+string(idt_fecha_cremacion,'dd/mm/yyyy')
	dw_lista.object.t_titulo.text	= 'Resumen de Uso Capilla día '+string(idt_fecha_cremacion,'dd/mm/yyyy')
//end if
	...
	if il_cod_parque>0 then
		if is_tipo = 'C' then	// Resumen Capilla
			...
			if isvalid(w_ficha_crematorio) or isnull(is_nombre) or is_nombre='' then
				...
				SELECT 	"FC_AGENDA_CAPILLA"."FOLIO_CREMATORIO", 	"FC_AGENDA_CAPILLA"."FECHA_CREMACION",	"FC_AGENDA_CAPILLA"."HORA_CINERACION", 	"FC_AGENDA_CAPILLA"."MINUTO_CINERACION", 	"FC_AGENDA_CAPILLA"."RUT_TITULAR", 	"FC_AGENDA_CAPILLA"."RUT_FALLECIDO", 	"FC_AGENDA_CAPILLA"."NOMBRE_FALLECIDO",	"FC_AGENDA_CAPILLA"."AP_PATERNO_FALLECIDO",	"FC_AGENDA_CAPILLA"."AP_MATERNO_FALLECIDO",	"FC_AGENDA_CAPILLA"."FECHA_DEFUNCION",	"FC_AGENDA_CAPILLA"."ESTADO_GESTION", 	"FC_AGENDA_CAPILLA"."EJECUTIVO",	"FC_AGENDA_CAPILLA"."OBSERVACION", 	"FC_AGENDA_CAPILLA"."COD_PARQUE",	"FC_AGENDA_CAPILLA"."CODIGO_RELIGION",	"FC_AGENDA_CAPILLA"."SW_ORADOR",	"FC_AGENDA_CAPILLA"."SW_COVID",	"FC_AGENDA_CAPILLA"."SW_PROTOCOLO",	"FC_AGENDA_CAPILLA"."BASE",	"FC_AGENDA_CAPILLA"."SERIE",	"FC_AGENDA_CAPILLA"."NUMERO",	"FC_AGENDA_CAPILLA"."HORA_CINERACION_FIN",	"FC_AGENDA_CAPILLA"."MINUTO_CINERACION_FIN",	"FC_AGENDA_CAPILLA"."AGENDA_PERGOLA",	"FC_AGENDA_CAPILLA"."FECHA_PERGOLA",	"FC_AGENDA_CAPILLA"."HORA_INI_PERGOLA",	"FC_AGENDA_CAPILLA"."MINUTO_INI_PERGOLA",	"FC_AGENDA_CAPILLA"."HORA_FIN_PERGOLA",	"FC_AGENDA_CAPILLA"."MINUTO_FIN_PERGOLA",	"FC_AGENDA_CAPILLA"."AGENDA_CAPILLA",	"FC_AGENDA_CAPILLA"."FECHA_CAPILLA",	"FC_AGENDA_CAPILLA"."HORA_INI_CAPILLA",	"FC_AGENDA_CAPILLA"."MINUTO_INI_CAPILLA",	"FC_AGENDA_CAPILLA"."HORA_FIN_CAPILLA",	"FC_AGENDA_CAPILLA"."MINUTO_FIN_CAPILLA",	"FC_AGENDA_CAPILLA"."AGENDA_VISUALIZA",	"FC_AGENDA_CAPILLA"."FECHA_VISUALIZA",	"FC_AGENDA_CAPILLA"."HORA_INI_VISUALIZA",	"FC_AGENDA_CAPILLA"."MINUTO_INI_VISUALIZA",	"FC_AGENDA_CAPILLA"."HORA_FIN_VISUALIZA",	"FC_AGENDA_CAPILLA"."MINUTO_FIN_VISUALIZA",	"FC_AGENDA_CAPILLA"."AGENDA_EXTERNA"  
				FROM 	"FC_AGENDA_CAPILLA"  
				WHERE //( "FC_AGENDA_CAPILLA"."FECHA_CREMACION" = :idt_fecha_cremacion ) AND  
//						  ( "FC_AGENDA_CAPILLA"."FOLIO_CREMATORIO" <> :il_folio )  AND
						( "FC_AGENDA_CAPILLA"."FECHA_CAPILLA" = :idt_fecha_cremacion ) AND 
						  ( "FC_AGENDA_CAPILLA"."ESTADO_REG" <> 'I' ) 
				ORDER BY 	"FC_AGENDA_CAPILLA"."HORA_CINERACION" ASC,
								"FC_AGENDA_CAPILLA"."MINUTO_CINERACION" ASC,
								"FC_AGENDA_CAPILLA"."FOLIO_CREMATORIO" ASC
				USING	Trans_1;
				open x0;
				if Trans_1.sqlcode=0 then
					DO WHILE Trans_1.sqlcode=0
						...
						if not isnull(ls_nombre_fall) and ll_folio_c > 0 then
							ll_hora_c						= ll_hora_ini_capilla_c
							ll_min_c						= ll_min_ini_capilla_c
							ls_string						= 'hora='+string(ll_hora_c)+' and minuto='+string(ll_min_c)
							//ll_hora_ini_capilla_c,:ll_min_ini_capilla_c
...
//									dw_lista.setitem(ll_reg,'observacion',is_obs)
				...
				WHERE 	( "FC_CABECERA"."FOLIO_CREMATORIO" = "FC_CEREMONIA"."FOLIO_CREMATORIO" ) and  
							...
							( "FC_RESPONSABLE_RETIRO"."FECHA_USO_CAPILLA" = :idt_fecha_cremacion) AND //ldt_fecha_cabecera )  AND
				...
				if sqlca.sqlcode=0 then
					DO WHILE sqlca.sqlcode=0
						...
						if not isnull(ls_nombre_fall) and ll_numero > 0 then
							dw_lista.accepttext()
...
datetime value = DateTime(Date("2022-06-27"), Time("22:06:56.000000"))
integer textsize = -8
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
...
Long		ll_reg,ll_reg_hora,ll_tot_reg,ll_new,ll_min_new,ll_reg_hora_otra,ll_tot_reg_ant,ll_indi,ll_hora_sel,ll_min_sel,ll_hora_cineracion,ll_minuto_cineracion,&
			...
			ll_fila,ll_hora_ini,ll_min_ini,ll_hora_fin,ll_min_fin,ll_count_ingreso,ll_count_cap
...
//					elseif ll_count_pergola = 0 and ls_agenda_pergola='S' then
...
//						end if
//					end if
					Messagebox("Grabar","Grabación Exitosa Agenda Capilla Ficha Cremación Folio N° "+string(il_folio))
//				else
//					rollback;
...
//					if is_uso_visualiza='S' then
//						SELECT 	COUNT("FC_AGENDA_VISUALIZA"."NOMBRE_FALLECIDO")
//						INTO		:ll_count_cap
...
//						end if
//					end if
					Messagebox("Actualizar","Grabación Exitosa Agenda Capilla Ficha cremación Folio N° "+string(il_folio))
//				else
//					rollback;
...
event clicked;close(w_lista_capilla)
end event
