forward
global type w_informe_estado_cartera_cierre from window
end type
type rb_gral from radiobutton within w_informe_estado_cartera_cierre
end type
type rb_jefe from radiobutton within w_informe_estado_cartera_cierre
end type
type st_remuneracion from statictext within w_informe_estado_cartera_cierre
end type
type pb_remuneracion from picturebutton within w_informe_estado_cartera_cierre
end type
type rb_todos from radiobutton within w_informe_estado_cartera_cierre
end type
type st_imprimir from statictext within w_informe_estado_cartera_cierre
end type
type pb_imprimir from picturebutton within w_informe_estado_cartera_cierre
end type
type pb_exportar from picturebutton within w_informe_estado_cartera_cierre
end type
type pb_ordenar from picturebutton within w_informe_estado_cartera_cierre
end type
type pb_general from picturebutton within w_informe_estado_cartera_cierre
end type
type pb_filtrar from picturebutton within w_informe_estado_cartera_cierre
end type
type st_exportar from statictext within w_informe_estado_cartera_cierre
end type
type st_agentes_general from statictext within w_informe_estado_cartera_cierre
end type
type st_ordenar from statictext within w_informe_estado_cartera_cierre
end type
type st_filtrar from statictext within w_informe_estado_cartera_cierre
end type
type pb_licencias from picturebutton within w_informe_estado_cartera_cierre
end type
type st_licencias from statictext within w_informe_estado_cartera_cierre
end type
type st_estado from statictext within w_informe_estado_cartera_cierre
end type
type st_3 from statictext within w_informe_estado_cartera_cierre
end type
type rb_menor_6_meses from radiobutton within w_informe_estado_cartera_cierre
end type
type rb_mas_6_meses from radiobutton within w_informe_estado_cartera_cierre
end type
type dw_lista from datawindow within w_informe_estado_cartera_cierre
end type
type st_procesar from statictext within w_informe_estado_cartera_cierre
end type
type pb_aceptar from picturebutton within w_informe_estado_cartera_cierre
end type
type st_2 from statictext within w_informe_estado_cartera_cierre
end type
type st_1 from statictext within w_informe_estado_cartera_cierre
end type
type em_codigo from editmask within w_informe_estado_cartera_cierre
end type
type st_nombre from statictext within w_informe_estado_cartera_cierre
end type
type rb_supervisor from radiobutton within w_informe_estado_cartera_cierre
end type
type rb_agente from radiobutton within w_informe_estado_cartera_cierre
end type
type pb_buscar from picturebutton within w_informe_estado_cartera_cierre
end type
type pb_cerrar from picturebutton within w_informe_estado_cartera_cierre
end type
type dw_informe from datawindow within w_informe_estado_cartera_cierre
end type
type gb_1 from groupbox within w_informe_estado_cartera_cierre
end type
type gb_3 from groupbox within w_informe_estado_cartera_cierre
end type
type gb_2 from groupbox within w_informe_estado_cartera_cierre
end type
type ddlb_fec_fin from dropdownlistbox within w_informe_estado_cartera_cierre
end type
type ddlb_fec_ini from dropdownlistbox within w_informe_estado_cartera_cierre
end type
type gb_mas_menor from groupbox within w_informe_estado_cartera_cierre
end type
end forward
...
global w_informe_estado_cartera_cierre w_informe_estado_cartera_cierre
...
Long		ll_tot_reg, ll_indi,ll_dias_lic,ll_saldo_por_cob, ll_calc_dias
...
Long		ll_caja_vc_mora_vsp,ll_row,ll_rut_age
...
on w_informe_estado_cartera_cierre.create
...
on w_informe_estado_cartera_cierre.destroy
...
event open;Datetime	ld_fecha_cierre
...
gs_ventana	= 'w_informe_estado_cartera_cierre'
f_valida_objeto_1()
CHOOSE CASE is_opcion
	CASE 'G' // General
		this.title					= 'Informe General Estado Cartera Rendimiento ( Jefe de Venta )'
		rb_gral.checked			= true
		dw_informe.dataobject	= 'dwe_lista_cartera'
		dw_informe.settransobject(sqlca)
	CASE '1' // Jefe Venta
		this.title					= 'Informe Estado Cartera por Jefe Venta Rendimiento '
		rb_jefe.checked			= true
		dw_informe.dataobject	= 'dw_detalle_estado_cartera_jefe_cierre'
		dw_informe.settransobject(sqlca)
	CASE '2' // Supervisor
		this.title					= 'Informe Estado Cartera por Supervisor Rendimiento '
		rb_supervisor.checked	= true
		dw_informe.dataobject	= 'dw_detalle_estado_cartera_superv_cierre'
		dw_informe.settransobject(sqlca)
	CASE '3' // Agente
		this.title					= 'Informe Estado Cartera por Agente Rendimiento '
		rb_agente.checked			= true
		dw_informe.dataobject	= 'dw_detalle_estado_cartera_agente_cierre'
		dw_informe.settransobject(sqlca)
END CHOOSE
...
if dw_informe.rowcount() > 0 then
	if rb_gral.checked=true then
		dw_informe.object.t_cabecera.text	= 'ESTADO CARTERA REDIMIENTO POR VENDEDOR, VENTAS REALIZADAS ENTRE EL '+ddlb_fec_ini.text+' Y EL '+ddlb_fec_fin.text
	elseif rb_jefe.checked=true then
		dw_informe.object.t_cabecera.text	= 'ESTADO CARTERA REDIMIENTO POR JEFE DE VENTA, VENTAS REALIZADAS ENTRE EL '+ddlb_fec_ini.text+' Y EL '+ddlb_fec_fin.text
	elseif rb_supervisor.checked=true then
		dw_informe.object.t_cabecera.text	= 'ESTADO CARTERA REDIMIENTO POR SUPERVISOR, VENTAS REALIZADAS ENTRE EL '+ddlb_fec_ini.text+' Y EL '+ddlb_fec_fin.text
	elseif rb_agente.checked=true then
		dw_informe.object.t_cabecera.text	= 'ESTADO CARTERA REDIMIENTO POR AGENTE, VENTAS REALIZADAS ENTRE EL '+ddlb_fec_ini.text+' Y EL '+ddlb_fec_fin.text
	end if
	ls_filtro	= ""
...
if dw_informe.rowcount() > 0 then
	if rb_gral.checked=true then
		dw_informe.object.t_cabecera.text	= 'ESTADO CARTERA REDIMIENTO POR VENDEDOR, VENTAS REALIZADAS ENTRE EL '+ddlb_fec_ini.text+' Y EL '+ddlb_fec_fin.text+'~rsolamente agentes con menos de seis meses en el periodo de muestra'
	elseif rb_jefe.checked=true then
		dw_informe.object.t_cabecera.text	= 'ESTADO CARTERA REDIMIENTO POR JEFE DE VENTA, VENTAS REALIZADAS ENTRE EL '+ddlb_fec_ini.text+' Y EL '+ddlb_fec_fin.text+'~rsolamente agentes con menos de seis meses en el periodo de muestra'
	elseif rb_supervisor.checked=true then
		dw_informe.object.t_cabecera.text	= 'ESTADO CARTERA REDIMIENTO POR SUPERVISOR, VENTAS REALIZADAS ENTRE EL '+ddlb_fec_ini.text+' Y EL '+ddlb_fec_fin.text+'~rsolamente agentes con menos de seis meses en el periodo de muestra'
	elseif rb_agente.checked=true then
		dw_informe.object.t_cabecera.text	= 'ESTADO CARTERA REDIMIENTO POR AGENTE, VENTAS REALIZADAS ENTRE EL '+ddlb_fec_ini.text+' Y EL '+ddlb_fec_fin.text+'~rsolamente agentes con menos de seis meses en el periodo de muestra'
	end if
...
if dw_informe.rowcount() > 0 then
	if rb_gral.checked=true then
		dw_informe.object.t_cabecera.text	= 'ESTADO CARTERA REDIMIENTO POR VENDEDOR, VENTAS REALIZADAS ENTRE EL '+ddlb_fec_ini.text+' Y EL '+ddlb_fec_fin.text+'~rsolamente agentes con más de seis meses en el periodo de muestra'
	elseif rb_jefe.checked=true then
		dw_informe.object.t_cabecera.text	= 'ESTADO CARTERA REDIMIENTO POR JEFE DE VENTA, VENTAS REALIZADAS ENTRE EL '+ddlb_fec_ini.text+' Y EL '+ddlb_fec_fin.text+'~rsolamente agentes con más de seis meses en el periodo de muestra'
	elseif rb_supervisor.checked=true then
		dw_informe.object.t_cabecera.text	= 'ESTADO CARTERA REDIMIENTO POR SUPERVISOR, VENTAS REALIZADAS ENTRE EL '+ddlb_fec_ini.text+' Y EL '+ddlb_fec_fin.text+'~rsolamente agentes con más de seis meses en el periodo de muestra'
	elseif rb_agente.checked=true then
		dw_informe.object.t_cabecera.text	= 'ESTADO CARTERA REDIMIENTO POR AGENTE, VENTAS REALIZADAS ENTRE EL '+ddlb_fec_ini.text+' Y EL '+ddlb_fec_fin.text+'~rsolamente agentes con más de seis meses en el periodo de muestra'
	end if
...
string dataobject = "dw_detalle_estado_cartera_cierre"
...
integer taborder = 50
string title = "none"
string dataobject = "dw_detalle_estado_cartera_jefe_cierre"
