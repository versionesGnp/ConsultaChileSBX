forward
global type w_vista_presupuesto_anual from window
end type
type cb_2 from commandbutton within w_vista_presupuesto_anual
end type
type cb_cerrar from commandbutton within w_vista_presupuesto_anual
end type
type cb_imprimir from commandbutton within w_vista_presupuesto_anual
end type
type dw_lista from datawindow within w_vista_presupuesto_anual
end type
type cb_1 from commandbutton within w_vista_presupuesto_anual
end type
end forward
...
global w_vista_presupuesto_anual w_vista_presupuesto_anual
...
on w_vista_presupuesto_anual.create
...
on w_vista_presupuesto_anual.destroy
destroy(this.cb_2)
...
long	 	ll_cod_parque,ll_cod_grupo,ll_new,ll_indi,ll_tot_reg,ll_ppto_x_mes,ll_ppto_tot_mes,ll_count,ll_anno, & 
...
if ll_cod_parque=0 then
	...
	WHERE		"PRESUPUESTO_CONSULTA"."CODIGO_GRUPO" =   "PRESUPUESTO_PERMISOS"."COD_GRUPO" and
