forward
global type w_lista_soporte_bkp from window
end type
type rb_anulado from radiobutton within w_lista_soporte_bkp
end type
type rb_gestionado from radiobutton within w_lista_soporte_bkp
end type
type rb_pendiente from radiobutton within w_lista_soporte_bkp
end type
type rb_todos from radiobutton within w_lista_soporte_bkp
end type
type em_fec_fin from editmask within w_lista_soporte_bkp
end type
type st_4 from statictext within w_lista_soporte_bkp
end type
type em_fec_ini from editmask within w_lista_soporte_bkp
end type
type p_ini from picture within w_lista_soporte_bkp
end type
type st_3 from statictext within w_lista_soporte_bkp
end type
type p_fin from picture within w_lista_soporte_bkp
end type
type pb_ok2 from picturebutton within w_lista_soporte_bkp
end type
type cb_imprimir from commandbutton within w_lista_soporte_bkp
end type
type cb_filtrar from commandbutton within w_lista_soporte_bkp
end type
type cb_ordenar from commandbutton within w_lista_soporte_bkp
end type
type cb_exportar from commandbutton within w_lista_soporte_bkp
end type
type st_2 from statictext within w_lista_soporte_bkp
end type
type em_nombre from editmask within w_lista_soporte_bkp
end type
type pb_1 from picturebutton within w_lista_soporte_bkp
end type
type dw_lista from datawindow within w_lista_soporte_bkp
end type
type cb_aceptar from commandbutton within w_lista_soporte_bkp
end type
type cb_cerrar from commandbutton within w_lista_soporte_bkp
end type
type gb_2 from groupbox within w_lista_soporte_bkp
end type
type gb_1 from groupbox within w_lista_soporte_bkp
end type
end forward
...
global w_lista_soporte_bkp w_lista_soporte_bkp

type variables
long il_row
end variables

on w_lista_soporte_bkp.create
...
on w_lista_soporte_bkp.destroy
...
if rb_anulado.checked=true then
...
event clicked;String	ls_filtro
if rb_gestionado.checked=true then
...
if rb_pendiente.checked=true then
...
if row>0 then
	...
	elseif ls_columna='t_rojo' or ls_columna='t_rojo_t' then
		...
		dw_lista.SETfilter(ls_filtro)
		dw_lista.filter()
	elseif ls_columna='t_amarillo' or ls_columna='t_amarillo' then
		ls_filtro	= 'estado_ot = "P"'
		dw_lista.SETfilter(ls_filtro)
		dw_lista.filter()
...
event clicked;long 		ll_correlativo,ll_codigo_atencion 
