forward
global type w_ingreso_ci_o_reprog from window
end type
type dw_cajas from datawindow within w_ingreso_ci_o_reprog
end type
type st_3 from statictext within w_ingreso_ci_o_reprog
end type
type cb_copiar from commandbutton within w_ingreso_ci_o_reprog
end type
type cb_exportar from commandbutton within w_ingreso_ci_o_reprog
end type
type cb_imprimir from commandbutton within w_ingreso_ci_o_reprog
end type
type cb_consultar from commandbutton within w_ingreso_ci_o_reprog
end type
type st_2 from statictext within w_ingreso_ci_o_reprog
end type
type st_1 from statictext within w_ingreso_ci_o_reprog
end type
type em_hasta from editmask within w_ingreso_ci_o_reprog
end type
type em_de from editmask within w_ingreso_ci_o_reprog
end type
type cb_cerrar from commandbutton within w_ingreso_ci_o_reprog
end type
type dw_ingreso_folio_ci_o from datawindow within w_ingreso_ci_o_reprog
end type
type p_1 from picture within w_ingreso_ci_o_reprog
end type
end forward
...
global w_ingreso_ci_o_reprog w_ingreso_ci_o_reprog

on w_ingreso_ci_o_reprog.create
...
on w_ingreso_ci_o_reprog.destroy
...
event open;gf_centrar(w_ingreso_ci_o_reprog)
...
event clicked;if dw_ingreso_folio_ci_o.rowcount() > 0 then f_printdlg(dw_ingreso_folio_ci_o,gstr_print,w_ingreso_ci_o_reprog)
end event
...
event clicked;Close(w_ingreso_ci_o_reprog)
end event
...
integer height = 1144
integer taborder = 50
string dataobject = "dw_ingreso_folio_ci_o_reprog"
