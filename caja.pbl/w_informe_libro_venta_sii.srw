forward
global type w_informe_libro_venta_sii from window
end type
type dw_empresa from datawindow within w_informe_libro_venta_sii
end type
type cb_exportar from commandbutton within w_informe_libro_venta_sii
end type
type cb_exp_excel from commandbutton within w_informe_libro_venta_sii
end type
type dwe_exportar_excel from datawindow within w_informe_libro_venta_sii
end type
type st_3 from statictext within w_informe_libro_venta_sii
end type
type pb_ok from picturebutton within w_informe_libro_venta_sii
end type
type em_year from editmask within w_informe_libro_venta_sii
end type
type st_2 from statictext within w_informe_libro_venta_sii
end type
type ddlb_mes from dropdownlistbox within w_informe_libro_venta_sii
end type
type st_1 from statictext within w_informe_libro_venta_sii
end type
type dwe_exportar from datawindow within w_informe_libro_venta_sii
end type
type cb_imprimir from commandbutton within w_informe_libro_venta_sii
end type
type cb_filtrar from commandbutton within w_informe_libro_venta_sii
end type
type cb_expor from commandbutton within w_informe_libro_venta_sii
end type
type cb_ordenar from commandbutton within w_informe_libro_venta_sii
end type
type cb_cerrar from commandbutton within w_informe_libro_venta_sii
end type
type dw_lista from datawindow within w_informe_libro_venta_sii
end type
type gb_11 from groupbox within w_informe_libro_venta_sii
end type
end forward
...
global w_informe_libro_venta_sii w_informe_libro_venta_sii

type variables
String		is_opcion
end variables

on w_informe_libro_venta_sii.create
...
on w_informe_libro_venta_sii.destroy
...
gf_centrar(w_informe_libro_venta_sii)

dw_empresa.settransobject(sqlca)
dw_empresa.insertrow(0)
is_opcion						= Message.StringParm
if is_opcion='LV' then
	dw_lista.dataobject	= 'dw_libro_venta_group_sii'
elseif is_opcion='LV_BE' then
	dw_lista.dataobject	= 'dw_libro_venta_group_sii'
end if
...
event clicked;if dw_lista.rowcount() > 0 then f_printdlg(dw_lista,gstr_print,w_informe_libro_venta_sii)
end event
...
event clicked;close(w_informe_libro_venta_sii)
end event
...
string dataobject = "dw_libro_venta_group_sii"
