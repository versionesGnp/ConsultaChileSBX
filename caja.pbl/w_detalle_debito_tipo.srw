forward
global type w_detalle_debito_tipo from window
end type
type dw_cajas from datawindow within w_detalle_debito_tipo
end type
type st_2 from statictext within w_detalle_debito_tipo
end type
type p_1 from picture within w_detalle_debito_tipo
end type
type cb_3 from commandbutton within w_detalle_debito_tipo
end type
type st_1 from statictext within w_detalle_debito_tipo
end type
type em_1 from editmask within w_detalle_debito_tipo
end type
type cb_2 from commandbutton within w_detalle_debito_tipo
end type
type cb_1 from commandbutton within w_detalle_debito_tipo
end type
type cb_elim from commandbutton within w_detalle_debito_tipo
end type
type dw_1 from datawindow within w_detalle_debito_tipo
end type
end forward
...
global w_detalle_debito_tipo w_detalle_debito_tipo
...
gf_centrar(w_detalle_debito_tipo)
...
on w_detalle_debito_tipo.create
...
on w_detalle_debito_tipo.destroy
...
string text = "Detalle Tarjeta Débito"
...
event clicked;if dw_1.rowcount() > 0 then f_printdlg(dw_1,gstr_print,w_detalle_debito_tipo)
end event
...
integer height = 1184
integer taborder = 40
string dataobject = "detalle_debito_tipo"
