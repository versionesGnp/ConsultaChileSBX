forward
global type w_ingresar_nota_de_credito_2_bkp from window
end type
type dw_print_nc from datawindow within w_ingresar_nota_de_credito_2_bkp
end type
type st_7 from statictext within w_ingresar_nota_de_credito_2_bkp
end type
type ddplb_motivo from dropdownpicturelistbox within w_ingresar_nota_de_credito_2_bkp
end type
type dw_detalle_factura from datawindow within w_ingresar_nota_de_credito_2_bkp
end type
type sle_1 from uo_convierte_numero within w_ingresar_nota_de_credito_2_bkp
end type
type dw_factura from datawindow within w_ingresar_nota_de_credito_2_bkp
end type
type cb_ctacte from commandbutton within w_ingresar_nota_de_credito_2_bkp
end type
type cb_limpiar from commandbutton within w_ingresar_nota_de_credito_2_bkp
end type
type cb_grabar from commandbutton within w_ingresar_nota_de_credito_2_bkp
end type
type st_6 from statictext within w_ingresar_nota_de_credito_2_bkp
end type
type dw_nota_credito from datawindow within w_ingresar_nota_de_credito_2_bkp
end type
type cb_generar from commandbutton within w_ingresar_nota_de_credito_2_bkp
end type
type pb_eliminar from picturebutton within w_ingresar_nota_de_credito_2_bkp
end type
type pb_insertar from picturebutton within w_ingresar_nota_de_credito_2_bkp
end type
type dw_destino from datawindow within w_ingresar_nota_de_credito_2_bkp
end type
type rb_comprobante from radiobutton within w_ingresar_nota_de_credito_2_bkp
end type
type rb_contrato from radiobutton within w_ingresar_nota_de_credito_2_bkp
end type
type st_5 from statictext within w_ingresar_nota_de_credito_2_bkp
end type
type st_1 from statictext within w_ingresar_nota_de_credito_2_bkp
end type
type em_folio from editmask within w_ingresar_nota_de_credito_2_bkp
end type
type ddlb_tipo_cob from dropdownlistbox within w_ingresar_nota_de_credito_2_bkp
end type
type cb_cerrar from commandbutton within w_ingresar_nota_de_credito_2_bkp
end type
type dw_lista from datawindow within w_ingresar_nota_de_credito_2_bkp
end type
type pb_procesar from picturebutton within w_ingresar_nota_de_credito_2_bkp
end type
type em_numero from editmask within w_ingresar_nota_de_credito_2_bkp
end type
type st_4 from statictext within w_ingresar_nota_de_credito_2_bkp
end type
type st_3 from statictext within w_ingresar_nota_de_credito_2_bkp
end type
type st_2 from statictext within w_ingresar_nota_de_credito_2_bkp
end type
type ddlb_base from dropdownlistbox within w_ingresar_nota_de_credito_2_bkp
end type
type gb_1 from groupbox within w_ingresar_nota_de_credito_2_bkp
end type
type ddlb_serie from dropdownlistbox within w_ingresar_nota_de_credito_2_bkp
end type
type gb_2 from groupbox within w_ingresar_nota_de_credito_2_bkp
end type
type gb_3 from groupbox within w_ingresar_nota_de_credito_2_bkp
end type
end forward
...
global w_ingresar_nota_de_credito_2_bkp w_ingresar_nota_de_credito_2_bkp
...
on w_ingresar_nota_de_credito_2_bkp.create
...
on w_ingresar_nota_de_credito_2_bkp.destroy
