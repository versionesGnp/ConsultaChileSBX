forward
global type w_ingresar_benef_seguro_funeraria2 from window
end type
type st_salir from statictext within w_ingresar_benef_seguro_funeraria2
end type
type cb_salir from picturebutton within w_ingresar_benef_seguro_funeraria2
end type
type st_grabar from statictext within w_ingresar_benef_seguro_funeraria2
end type
type cb_grabar from picturebutton within w_ingresar_benef_seguro_funeraria2
end type
type st_1 from statictext within w_ingresar_benef_seguro_funeraria2
end type
type cb_borrar from picturebutton within w_ingresar_benef_seguro_funeraria2
end type
type st_borrar_benef from statictext within w_ingresar_benef_seguro_funeraria2
end type
type cb_insertar from picturebutton within w_ingresar_benef_seguro_funeraria2
end type
type st_insert_benef from statictext within w_ingresar_benef_seguro_funeraria2
end type
type dw_beneficiarios from datawindow within w_ingresar_benef_seguro_funeraria2
end type
end forward
...
global w_ingresar_benef_seguro_funeraria2 w_ingresar_benef_seguro_funeraria2
...
on w_ingresar_benef_seguro_funeraria2.create
...
on w_ingresar_benef_seguro_funeraria2.destroy
...
event open;gf_centrar(w_ingresar_benef_seguro_funeraria2)
...
if dw_beneficiarios.Retrieve(is_serie,il_numero,is_base)=0 then
	...
	close(w_ingresar_benef_seguro_funeraria2)
end if
...
event clicked;close(w_ingresar_benef_seguro_funeraria2)
end event
...
integer height = 796
integer taborder = 10
string dataobject = "dw_ingreso_benef_seguro_funeraria2"
