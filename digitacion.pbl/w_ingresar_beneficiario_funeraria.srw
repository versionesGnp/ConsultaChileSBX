forward
global type w_ingresar_beneficiario_funeraria from window
end type
type st_salir from statictext within w_ingresar_beneficiario_funeraria
end type
type cb_salir from picturebutton within w_ingresar_beneficiario_funeraria
end type
type st_grabar from statictext within w_ingresar_beneficiario_funeraria
end type
type cb_grabar from picturebutton within w_ingresar_beneficiario_funeraria
end type
type st_1 from statictext within w_ingresar_beneficiario_funeraria
end type
type cb_borrar from picturebutton within w_ingresar_beneficiario_funeraria
end type
type st_borrar_benef from statictext within w_ingresar_beneficiario_funeraria
end type
type cb_insertar from picturebutton within w_ingresar_beneficiario_funeraria
end type
type st_insert_benef from statictext within w_ingresar_beneficiario_funeraria
end type
type dw_beneficiarios from datawindow within w_ingresar_beneficiario_funeraria
end type
end forward
...
string title = "Ingreso Beneficiarios Aporte Funeraria"
...
global w_ingresar_beneficiario_funeraria w_ingresar_beneficiario_funeraria
...
on w_ingresar_beneficiario_funeraria.create
...
on w_ingresar_beneficiario_funeraria.destroy
...
event open;gf_centrar(w_ingresar_beneficiario_funeraria)
...
event clicked;close(w_ingresar_beneficiario_funeraria)
end event
...
string text = "Lista Beneficiarios"
boolean focusrectangle = false
end type
...
integer height = 768
integer taborder = 10
string dataobject = "dw_ingreso_beneficiarios_funeraria"
