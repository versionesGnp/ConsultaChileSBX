forward
global type w_anticipo_comisiones_aumento from window
end type
type pb_1 from picturebutton within w_anticipo_comisiones_aumento
end type
type cb_filtrar_a_pago from commandbutton within w_anticipo_comisiones_aumento
end type
type pb_aceptar from picturebutton within w_anticipo_comisiones_aumento
end type
type cbx_todos_rescomi from checkbox within w_anticipo_comisiones_aumento
end type
type cbx_todos_prom from checkbox within w_anticipo_comisiones_aumento
end type
type cbx_pagada from checkbox within w_anticipo_comisiones_aumento
end type
type cbx_castigada from checkbox within w_anticipo_comisiones_aumento
end type
type cbx_con_saldo from checkbox within w_anticipo_comisiones_aumento
end type
type cbx_pendiente from checkbox within w_anticipo_comisiones_aumento
end type
type cbx_resciliado from checkbox within w_anticipo_comisiones_aumento
end type
type cbx_vigente from checkbox within w_anticipo_comisiones_aumento
end type
type pb_filtrar from picturebutton within w_anticipo_comisiones_aumento
end type
type pb_ordenar from picturebutton within w_anticipo_comisiones_aumento
end type
type pb_imprimir from picturebutton within w_anticipo_comisiones_aumento
end type
type pb_exportar from picturebutton within w_anticipo_comisiones_aumento
end type
type pb_cerrar from picturebutton within w_anticipo_comisiones_aumento
end type
type dw_lista from datawindow within w_anticipo_comisiones_aumento
end type
type gb_2 from groupbox within w_anticipo_comisiones_aumento
end type
type gb_1 from groupbox within w_anticipo_comisiones_aumento
end type
end forward
...
string title = "Consulta Anticipo Comisiones Aumento Capacidad"
...
global w_anticipo_comisiones_aumento w_anticipo_comisiones_aumento
...
on w_anticipo_comisiones_aumento.create
...
on w_anticipo_comisiones_aumento.destroy
destroy(this.pb_1)
...
gf_centrar(w_anticipo_comisiones_aumento)
dw_lista.settransobject(sqlca)
this.title											= 'Consulta Anticipo Comisiones Aumento Capacidad'
w_contar_registros.st_titulo.text			= 'Comisiones Aumento Capacidad'
...
for ll_indi = 1 to ll_tot_reg
	...
	ll_count_porc									= f_buscar_porc_res_comi( ls_cod_age , serie , numero, "A" )
	dw_lista.setitem(ll_indi,'por_res_comi',ll_count_porc)
	ll_count_ingreso								= f_buscar_ingreso_res_comi( ls_cod_age , serie , numero, "A" )
	dw_lista.setitem(ll_indi,'ing_res_comi',ll_count_ingreso)
	if ret < 2 then
		ls_fec_prox_comi							= f_buscar_fecha_prox_comi(serie , numero, "A")
...
if ls_op_recep = "2" then
	...
	is_filtro	= "(comision_promesa_c_pie + comision_promesa_c_primera + comision_promesa_c_segunda + comision_promesa_c_tercera + comision_promesa_c_cuarta + comision_promesa_c_quinta + comision_promesa_c_sexta) = 0 and anexo_aumento_estado_comi<>'P'"
...
gs_ventana	= 'w_anticipo_comisiones_aumento'
f_valida_objeto_1()
SetPointer(Arrow!)
end event
...
event clicked;close(w_anticipo_comisiones_aumento)
end event
...
integer taborder = 10
string title = "none"
string dataobject = "dw_lista_contratos_sin_agrupar_aumento"
