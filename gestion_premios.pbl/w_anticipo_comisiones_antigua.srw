forward
global type w_anticipo_comisiones_antigua from window
end type
type cb_filtrar_a_pago from commandbutton within w_anticipo_comisiones_antigua
end type
type pb_1 from picturebutton within w_anticipo_comisiones_antigua
end type
type pb_aceptar from picturebutton within w_anticipo_comisiones_antigua
end type
type cbx_todos_rescomi from checkbox within w_anticipo_comisiones_antigua
end type
type cbx_todos_prom from checkbox within w_anticipo_comisiones_antigua
end type
type cbx_pagada from checkbox within w_anticipo_comisiones_antigua
end type
type cbx_castigada from checkbox within w_anticipo_comisiones_antigua
end type
type cbx_con_saldo from checkbox within w_anticipo_comisiones_antigua
end type
type cbx_pendiente from checkbox within w_anticipo_comisiones_antigua
end type
type cbx_resciliado from checkbox within w_anticipo_comisiones_antigua
end type
type cbx_vigente from checkbox within w_anticipo_comisiones_antigua
end type
type pb_filtrar from picturebutton within w_anticipo_comisiones_antigua
end type
type pb_ordenar from picturebutton within w_anticipo_comisiones_antigua
end type
type pb_imprimir from picturebutton within w_anticipo_comisiones_antigua
end type
type pb_exportar from picturebutton within w_anticipo_comisiones_antigua
end type
type pb_cerrar from picturebutton within w_anticipo_comisiones_antigua
end type
type gb_1 from groupbox within w_anticipo_comisiones_antigua
end type
type gb_2 from groupbox within w_anticipo_comisiones_antigua
end type
type dw_lista from datawindow within w_anticipo_comisiones_antigua
end type
end forward
...
global w_anticipo_comisiones_antigua w_anticipo_comisiones_antigua
...
on w_anticipo_comisiones_antigua.create
...
on w_anticipo_comisiones_antigua.destroy
...
gf_centrar(w_anticipo_comisiones_antigua)
dw_lista.settransobject(sqlca)
this.title						= 'Consulta Anticipo Comisiones Promesas'
w_contar_registros.st_titulo.text	= 'Comisiones Promesas Antiguas'
...
gs_ventana	= 'w_anticipo_comisiones_antigua'
f_valida_objeto_1()
SetPointer(Arrow!)
...
event clicked;close(w_anticipo_comisiones_antigua)
end event
...
integer height = 1892
integer taborder = 10
string dataobject = "dw_lista_contratos_sin_agrupar_antiguas"
