forward
global type w_anticipo_comisiones_antigua_lib from window
end type
type cb_filtrar_a_pago from commandbutton within w_anticipo_comisiones_antigua_lib
end type
type pb_1 from picturebutton within w_anticipo_comisiones_antigua_lib
end type
type pb_aceptar from picturebutton within w_anticipo_comisiones_antigua_lib
end type
type cbx_todos_rescomi from checkbox within w_anticipo_comisiones_antigua_lib
end type
type cbx_todos_prom from checkbox within w_anticipo_comisiones_antigua_lib
end type
type cbx_pagada from checkbox within w_anticipo_comisiones_antigua_lib
end type
type cbx_castigada from checkbox within w_anticipo_comisiones_antigua_lib
end type
type cbx_con_saldo from checkbox within w_anticipo_comisiones_antigua_lib
end type
type cbx_pendiente from checkbox within w_anticipo_comisiones_antigua_lib
end type
type cbx_resciliado from checkbox within w_anticipo_comisiones_antigua_lib
end type
type cbx_vigente from checkbox within w_anticipo_comisiones_antigua_lib
end type
type pb_filtrar from picturebutton within w_anticipo_comisiones_antigua_lib
end type
type pb_ordenar from picturebutton within w_anticipo_comisiones_antigua_lib
end type
type pb_imprimir from picturebutton within w_anticipo_comisiones_antigua_lib
end type
type pb_exportar from picturebutton within w_anticipo_comisiones_antigua_lib
end type
type pb_cerrar from picturebutton within w_anticipo_comisiones_antigua_lib
end type
type gb_1 from groupbox within w_anticipo_comisiones_antigua_lib
end type
type gb_2 from groupbox within w_anticipo_comisiones_antigua_lib
end type
type dw_lista from datawindow within w_anticipo_comisiones_antigua_lib
end type
end forward
...
global w_anticipo_comisiones_antigua_lib w_anticipo_comisiones_antigua_lib
...
on w_anticipo_comisiones_antigua_lib.create
...
on w_anticipo_comisiones_antigua_lib.destroy
...
gf_centrar(w_anticipo_comisiones_antigua_lib)
gs_ventana						= 'w_anticipo_comisiones_antigua_lib'
f_valida_objeto_1()
dw_lista.settransobject(sqlca)
this.title						= 'Consulta Anticipo Comisiones Liberadores Antiguas'
w_contar_registros.st_titulo.text	= 'Comisiones Liberadores Antiguas'
...
event clicked;close(w_anticipo_comisiones_antigua_lib)
end event
...
integer taborder = 10
string title = "none"
string dataobject = "dw_lista_ctto_sin_agrupar_antiguas_lib"
