...
forward
global type w_arch_mul_contrato_infocuponera from w_gen_document_doc
end type
type tab_1 from tab within w_arch_mul_contrato_infocuponera
end type
...
integer width = 5019
integer height = 2744
string title = "Información de Cuponera"
...
global w_arch_mul_contrato_infocuponera w_arch_mul_contrato_infocuponera
...
For i = 1 To li_ret
	...
	Choose Case ( i + 1 )
		...
		Case 2
			...
			tab_1.TabPage_2.dw_dh1.Retrieve( ls_emp, ls_bar, ls_cup, ls_caj, ld_ini, ld_fin )
		Case 3
			...
			tab_1.TabPage_3.dw_dh2.Retrieve( ls_emp, ls_bar, ls_cup, ls_caj, ld_ini, ld_fin )
		Case 4
			...
			tab_1.TabPage_4.dw_dh3.Retrieve( ls_emp, ls_bar, ls_cup, ls_caj, ld_ini, ld_fin )
		Case 5
			...
			tab_1.TabPage_5.dw_dh4.Retrieve( ls_emp, ls_bar, ls_cup, ls_caj, ld_ini, ld_fin )
		Case 6
			...
			tab_1.TabPage_6.dw_dh5.Retrieve( ls_emp, ls_bar, ls_cup, ls_caj, ld_ini, ld_fin )
		Case 7
			...
			tab_1.TabPage_7.dw_dh6.Retrieve( ls_emp, ls_bar, ls_cup, ls_caj, ld_ini, ld_fin )
	End Choose
...
on w_arch_mul_contrato_infocuponera.create
int iCurrent
call super::create
...
on w_arch_mul_contrato_infocuponera.destroy
call super::destroy
destroy(this.tab_1)
end on
...
dw_list.Height = dw_list.Height - 25
...
type dw_1 from w_gen_document_doc`dw_1 within w_arch_mul_contrato_infocuponera
integer width = 4686
integer height = 920
string dataobject = "d_arch_mul_contrato_infocuponera"
...
type dw_menu from w_gen_document_doc`dw_menu within w_arch_mul_contrato_infocuponera
integer width = 3497
string dataobject = "d_gen_menu_toolbar_return"
end type

type dw_list from w_gen_document_doc`dw_list within w_arch_mul_contrato_infocuponera
...
Choose Case dwo.Name
	Case 'cb_det'
		...
		lstr_parm.s_cad[ 2] = String( This.Object.folio_pago[ row] )
