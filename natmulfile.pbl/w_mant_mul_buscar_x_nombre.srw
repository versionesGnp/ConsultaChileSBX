...
forward
global type w_mant_mul_buscar_x_nombre from w_mant_gen_buscar_x_nombre
end type
end forward

global type w_mant_mul_buscar_x_nombre from w_mant_gen_buscar_x_nombre
end type
global w_mant_mul_buscar_x_nombre w_mant_mul_buscar_x_nombre
...
*/
String	ls_nil
dw_list.Retrieve( agente.Cod_Parque, ls_nil, ls_texto, agente.DB )
...
on w_mant_mul_buscar_x_nombre.create
call super::create
end on

on w_mant_mul_buscar_x_nombre.destroy
call super::destroy
end on
...
is_tabla = agente.tabla

dw_list.DataObject = agente.DataObject
...
SetNull( li_nil )
dw_list.Retrieve( agente.Cod_Parque, ls_nil, ls_nil, agente.DB )
end event

type dw_list from w_mant_gen_buscar_x_nombre`dw_list within w_mant_mul_buscar_x_nombre
string dataobject = "d_arch_mul_agente_basica"
end type

type dw_1 from w_mant_gen_buscar_x_nombre`dw_1 within w_mant_mul_buscar_x_nombre
end type

type cb_cancelar from w_mant_gen_buscar_x_nombre`cb_cancelar within w_mant_mul_buscar_x_nombre
end type

type cb_aceptar from w_mant_gen_buscar_x_nombre`cb_aceptar within w_mant_mul_buscar_x_nombre
end type
...
row = dw_list.GetRow()
Agente.cod_age = dw_list.Object.cod_age[ row]
Agente.cod_sup = dw_list.Object.cod_sup[ row]
Agente.cod_Jef = dw_list.Object.cod_Jef[ row]

CloseWithReturn( Parent, Agente )
