...
forward
global type w_arch_mul_revision from w_gen_document_doc
end type
end forward
...
integer width = 4325
integer height = 1900
string title = "Revisión de Contratos MultiProducto"
boolean ib_fulllist = true
boolean ib_permitemod = true
boolean ib_new = true
end type
global w_arch_mul_revision w_arch_mul_revision
...
dw_list.Retrieve( ls_cto, ln_rut, li_par, 'LIS', ls_DB )
...
on w_arch_mul_revision.create
call super::create
end on

on w_arch_mul_revision.destroy
call super::destroy
end on
...
type dw_1 from w_gen_document_doc`dw_1 within w_arch_mul_revision
integer width = 4210
integer height = 652
string dataobject = "d_arch_mul_revision"
end type
...
type dw_menu from w_gen_document_doc`dw_menu within w_arch_mul_revision
integer width = 3497
string dataobject = "d_gen_menu_toolbar_xls"
end type

type dw_list from w_gen_document_doc`dw_list within w_arch_mul_revision
boolean visible = true
integer x = 169
integer y = 628
integer width = 4064
integer height = 1072
string dataobject = "d_arch_mul_revision_det"
...
Choose Case dwo.Name
	...
	Case 'cb_det', 'p_det'
		...
		OpenSheetWithParm( w_arch_mul_revision_info, This, gw_frame, 1, Original! )
		w_arch_mul_revision_info.wf_OpenDoc( ls_bar, ll_rut, ll_par, ls_DB )
End Choose
end event
