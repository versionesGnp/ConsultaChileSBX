forward
global type w_detalle_mora_agente from window
end type
type cb_exportar from commandbutton within w_detalle_mora_agente
end type
type cb_filtrar from commandbutton within w_detalle_mora_agente
end type
type cb_ordenar from commandbutton within w_detalle_mora_agente
end type
type rb_vigente_mora from radiobutton within w_detalle_mora_agente
end type
type rb_todos from radiobutton within w_detalle_mora_agente
end type
type rb_vigente_3_mas from radiobutton within w_detalle_mora_agente
end type
type rb_vigente_dos from radiobutton within w_detalle_mora_agente
end type
type rb_vigente_uno from radiobutton within w_detalle_mora_agente
end type
type rb_vigente_dia from radiobutton within w_detalle_mora_agente
end type
type cb_cta_cte from commandbutton within w_detalle_mora_agente
end type
type cb_imprimir from commandbutton within w_detalle_mora_agente
end type
type cb_cerrar from commandbutton within w_detalle_mora_agente
end type
type dw_listado from datawindow within w_detalle_mora_agente
end type
type gb_1 from groupbox within w_detalle_mora_agente
end type
type gb_3 from groupbox within w_detalle_mora_agente
end type
end forward
...
global w_detalle_mora_agente w_detalle_mora_agente
...
on w_detalle_mora_agente.create
...
on w_detalle_mora_agente.destroy
...
gf_centrar(w_detalle_mora_agente)
dw_listado.dataobject	= 'dw_ventas_x_agente'
...
event clicked;close(w_detalle_mora_agente)
end event
...
integer taborder = 10
string title = "none"
string dataobject = "dw_ventas_x_agente"
