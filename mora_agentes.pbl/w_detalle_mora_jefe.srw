forward
global type w_detalle_mora_jefe from window
end type
type cb_ordenar from commandbutton within w_detalle_mora_jefe
end type
type cb_filtrar from commandbutton within w_detalle_mora_jefe
end type
type cb_exportar from commandbutton within w_detalle_mora_jefe
end type
type rb_vigente_dia from radiobutton within w_detalle_mora_jefe
end type
type rb_vigente_uno from radiobutton within w_detalle_mora_jefe
end type
type rb_vigente_dos from radiobutton within w_detalle_mora_jefe
end type
type rb_vigente_3_mas from radiobutton within w_detalle_mora_jefe
end type
type rb_todos from radiobutton within w_detalle_mora_jefe
end type
type rb_vigente_mora from radiobutton within w_detalle_mora_jefe
end type
type cb_cta_cte from commandbutton within w_detalle_mora_jefe
end type
type cb_imprimir from commandbutton within w_detalle_mora_jefe
end type
type cb_cerrar from commandbutton within w_detalle_mora_jefe
end type
type dw_listado from datawindow within w_detalle_mora_jefe
end type
type gb_1 from groupbox within w_detalle_mora_jefe
end type
type gb_3 from groupbox within w_detalle_mora_jefe
end type
end forward
...
global w_detalle_mora_jefe w_detalle_mora_jefe

type variables
Long	il_mes,il_ano,il_row
end variables

on w_detalle_mora_jefe.create
...
on w_detalle_mora_jefe.destroy
...
gf_centrar(w_detalle_mora_jefe)
dw_listado.dataobject	= 'dw_ventas_x_jefe'
...
event clicked;close(w_detalle_mora_jefe)
end event
...
integer taborder = 10
string title = "none"
string dataobject = "dw_ventas_x_jefe"
...
if row>0 then
	...
	if dw_listado.rowcount() > 0 then
		if ls_columna='a_mora' then
			...
			dw_listado.Object.oferta_v_cod_sup_t.border=6
		...
		elseif ls_columna='cod_age_t' then
			...
			dw_listado.Object.a_cliente_a_paterno.border=6
			dw_listado.Object.oferta_v_cod_sup_t.border=6
		elseif ls_columna='oferta_v_cod_sup_t' then
			ls_campo_ord	= 'oferta_v_cod_sup'
			dw_listado.Object.oferta_v_cod_sup_t.border=5
			dw_listado.Object.a_mora.border=6
			dw_listado.Object.a_oferta_v_cta_pag_s.border=6
			dw_listado.Object.a_oferta_v_fecha.border=6
			dw_listado.Object.a_cadena_mora_fecha_venc_cred.border=6
