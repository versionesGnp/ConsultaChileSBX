forward
global type w_informe_cob_tele_8_prociento from window
end type
type dw_parque from datawindow within w_informe_cob_tele_8_prociento
end type
type st_16 from statictext within w_informe_cob_tele_8_prociento
end type
type hpb_1 from hprogressbar within w_informe_cob_tele_8_prociento
end type
type st_fondo from statictext within w_informe_cob_tele_8_prociento
end type
type st_porc from statictext within w_informe_cob_tele_8_prociento
end type
type pb_1 from picturebutton within w_informe_cob_tele_8_prociento
end type
type sle_1 from singlelineedit within w_informe_cob_tele_8_prociento
end type
type st_4 from statictext within w_informe_cob_tele_8_prociento
end type
type sle_titulo from singlelineedit within w_informe_cob_tele_8_prociento
end type
type st_3 from statictext within w_informe_cob_tele_8_prociento
end type
type cb_imprimir from commandbutton within w_informe_cob_tele_8_prociento
end type
type cb_exportar from commandbutton within w_informe_cob_tele_8_prociento
end type
type cb_filtrar from commandbutton within w_informe_cob_tele_8_prociento
end type
type pb_aceptar from picturebutton within w_informe_cob_tele_8_prociento
end type
type p_fin from picture within w_informe_cob_tele_8_prociento
end type
type em_fec_fin from editmask within w_informe_cob_tele_8_prociento
end type
type st_2 from statictext within w_informe_cob_tele_8_prociento
end type
type p_ini from picture within w_informe_cob_tele_8_prociento
end type
type em_fec_ini from editmask within w_informe_cob_tele_8_prociento
end type
type st_1 from statictext within w_informe_cob_tele_8_prociento
end type
type cb_cerrar from commandbutton within w_informe_cob_tele_8_prociento
end type
type cb_ctacte from commandbutton within w_informe_cob_tele_8_prociento
end type
type dw_lista_detalle from datawindow within w_informe_cob_tele_8_prociento
end type
type dw_lista from datawindow within w_informe_cob_tele_8_prociento
end type
type gb_1 from groupbox within w_informe_cob_tele_8_prociento
end type
end forward
...
string title = "Informe Cobranza Telefónica 8%"
...
global w_informe_cob_tele_8_prociento w_informe_cob_tele_8_prociento

type variables
long	il_row
end variables

on w_informe_cob_tele_8_prociento.create
...
on w_informe_cob_tele_8_prociento.destroy
...
gf_centrar(w_informe_cob_tele_8_prociento)
...
String	ls_cod_jefe,ls_cod_sup,ls_cod_age,ls_base,ls_serie,ls_estado,ls_glosa,ls_filtro
	...
	if trim(em_fec_fin.text)='00/00/0000' or isnull(em_fec_fin.text) then
		...
		if ll_cod_parque>0 then
			if dw_lista_detalle.retrieve(ld_fec_ini,ld_fec_fin,ll_cod_parque)=0 then //,gs_user
				...
				dw_lista.reset()
				dw_lista.object.t_4.text		= 'INFORME COBRANZA TELEFONICA 8%'
				sle_titulo.text					= ''
				...
				for ll_indi=1 to ll_tot_reg
					...
					ldb_porce_facturado	= double(dw_lista_detalle.getitemnumber(ll_indi,'gestion_cobranza_porce_facturado'))
					ldb_porce_mora_cred	= double(dw_lista_detalle.getitemnumber(ll_indi,'gestion_cobranza_porce_mora_cred'))
					ldb_porce_suma			= double(dw_lista_detalle.getitemnumber(ll_indi,'gestion_cobranza_porce_suma'))
					ls_cod_jefe				= dw_lista_detalle.getitemstring(ll_indi,'oferta_v_cod_jef')
					ls_cod_sup				= dw_lista_detalle.getitemstring(ll_indi,'oferta_v_cod_sup')
					ls_cod_age				= dw_lista_detalle.getitemstring(ll_indi,'oferta_v_cod_age')
					...
					if not isnull(ls_cod_jefe) and not isnull(ls_cod_sup) and not isnull(ls_cod_age) and &
						...
						dw_lista.setitem(ll_new,'mora_cred',dw_lista_detalle.getitemnumber(ll_indi,'gestion_cobranza_mora_cred'))
						dw_lista.setitem(ll_new,'fecha_vcto_cred',date(dw_lista_detalle.getitemdatetime(ll_indi,'gestion_cobranza_fecha_venc_cred')))
						dw_lista.setitem(ll_new,'ctas_pag_cred',dw_lista_detalle.getitemnumber(ll_indi,'oferta_v_cta_pag_s'))
						dw_lista.setitem(ll_new,'plazo_cred',dw_lista_detalle.getitemnumber(ll_indi,'pago_oferta_nro_cuotas'))
						dw_lista.setitem(ll_new,'valor_cuota',double(dw_lista_detalle.getitemnumber(ll_indi,'pago_oferta_valor_cuota')))
						dw_lista.setitem(ll_new,'estado_cuponera',dw_lista_detalle.getitemnumber(ll_indi,'cadena_est_cup'))
						dw_lista.setitem(ll_new,'fallecido',dw_lista_detalle.getitemnumber(ll_indi,'gestion_cobranza_fallecidos'))
						...
						dw_lista.setitem(ll_new,'dias_mora_cred',dw_lista_detalle.getitemnumber(ll_indi,'gestion_cobranza_dias_mora_cred'))
						dw_lista.setitem(ll_new,'porce_facturado',ldb_porce_facturado)
						dw_lista.setitem(ll_new,'porce_mora_cred',ldb_porce_mora_cred)
						dw_lista.setitem(ll_new,'porce_suma',ldb_porce_suma)
						if isnull(trim(dw_lista_detalle.getitemString(ll_indi,'oferta_v_uso'))) or trim(dw_lista_detalle.getitemString(ll_indi,'oferta_v_uso'))='' then
							dw_lista.setitem(ll_new,'uso','XX')
						else
							dw_lista.setitem(ll_new,'uso',dw_lista_detalle.getitemString(ll_indi,'oferta_v_uso'))
						end if
...
event clicked;close(w_informe_cob_tele_8_prociento)
end event
...
integer height = 500
string title = "none"
string dataobject = "dw_informe_cob_tele_8_porciento"
...
integer taborder = 60
string title = "none"
string dataobject = "dwe_cob_tele_8_porciento"
boolean hscrollbar = true
boolean vscrollbar = true
