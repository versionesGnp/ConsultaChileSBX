forward
global type w_desasignar_cartera from window
end type
type cb_print from commandbutton within w_desasignar_cartera
end type
type cb_aceptar from commandbutton within w_desasignar_cartera
end type
type st_1 from statictext within w_desasignar_cartera
end type
type p_1 from picture within w_desasignar_cartera
end type
type em_fecha from editmask within w_desasignar_cartera
end type
type cb_cerrar from commandbutton within w_desasignar_cartera
end type
type dw_lista from datawindow within w_desasignar_cartera
end type
end forward
...
global w_desasignar_cartera w_desasignar_cartera

type variables
date	gd_fecha_proceso
end variables

on w_desasignar_cartera.create
...
on w_desasignar_cartera.destroy
