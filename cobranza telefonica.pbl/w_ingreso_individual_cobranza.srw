forward
global type w_ingreso_individual_cobranza from window
end type
type pb_ctto from picturebutton within w_ingreso_individual_cobranza
end type
type sle_2 from singlelineedit within w_ingreso_individual_cobranza
end type
type st_1 from statictext within w_ingreso_individual_cobranza
end type
type cb_mensaje from commandbutton within w_ingreso_individual_cobranza
end type
type hpb_1 from hprogressbar within w_ingreso_individual_cobranza
end type
type cb_actualizar from commandbutton within w_ingreso_individual_cobranza
end type
type cb_ctacte2 from commandbutton within w_ingreso_individual_cobranza
end type
type dw_dias_mora from datawindow within w_ingreso_individual_cobranza
end type
type cb_cerrar from commandbutton within w_ingreso_individual_cobranza
end type
type cb_ctacte from commandbutton within w_ingreso_individual_cobranza
end type
type pb_5 from picturebutton within w_ingreso_individual_cobranza
end type
type pb_4 from picturebutton within w_ingreso_individual_cobranza
end type
type pb_3 from picturebutton within w_ingreso_individual_cobranza
end type
type pb_2 from picturebutton within w_ingreso_individual_cobranza
end type
type st_2 from statictext within w_ingreso_individual_cobranza
end type
type sle_1 from singlelineedit within w_ingreso_individual_cobranza
end type
type pb_1 from picturebutton within w_ingreso_individual_cobranza
end type
type cb_grabar_formula from commandbutton within w_ingreso_individual_cobranza
end type
type cb_genera_lista from commandbutton within w_ingreso_individual_cobranza
end type
type cb_historico from commandbutton within w_ingreso_individual_cobranza
end type
type cb_imprimir from commandbutton within w_ingreso_individual_cobranza
end type
type cb_exportar from commandbutton within w_ingreso_individual_cobranza
end type
type cb_filtrar from commandbutton within w_ingreso_individual_cobranza
end type
type cb_ordenar from commandbutton within w_ingreso_individual_cobranza
end type
type gb_1 from groupbox within w_ingreso_individual_cobranza
end type
type gb_2 from groupbox within w_ingreso_individual_cobranza
end type
type st_porc from statictext within w_ingreso_individual_cobranza
end type
type st_fondo from statictext within w_ingreso_individual_cobranza
end type
type tab_cobranza from uo_cobranza within w_ingreso_individual_cobranza
end type
type tab_cobranza from uo_cobranza within w_ingreso_individual_cobranza
end type
type dw_lista from datawindow within w_ingreso_individual_cobranza
end type
end forward
...
global w_ingreso_individual_cobranza w_ingreso_individual_cobranza
...
ll_tot_reg					= dw_lista.retrieve(gs_user,date(gdt_fec_sistema))
...
on w_ingreso_individual_cobranza.create
...
on w_ingreso_individual_cobranza.destroy
...
SetPointer(HourGlass!)
gf_centrar(w_ingreso_individual_cobranza)
...
event clicked;close(w_ingreso_individual_cobranza)
end event
