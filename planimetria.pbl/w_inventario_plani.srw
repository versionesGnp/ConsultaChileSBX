forward
global type w_inventario_plani from window
end type
type cb_3 from commandbutton within w_inventario_plani
end type
type cb_2 from commandbutton within w_inventario_plani
end type
type cb_1 from commandbutton within w_inventario_plani
end type
type dw_inventario_plani from datawindow within w_inventario_plani
end type
end forward
...
global w_inventario_plani w_inventario_plani

on w_inventario_plani.create
...
if dw_inventario_plani.retrieve(gs_sector,numero) = 0 then
	...
	this.title = 'Promesa :'+gs_base+' - '+gs_serie+' - '+string(gi_numero,'###,###,##0')+'  Rut: '+string(gi_rut,'###,###,###,##0')+'      ( Estado: '+estado+' ).' 
...
event clicked;close(w_inventario_plani)
end event
...
integer taborder = 10
string title = "none"
string dataobject = "dw_inventario_plani"
