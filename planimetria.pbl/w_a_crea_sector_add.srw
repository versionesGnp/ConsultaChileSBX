forward
global type w_a_crea_sector_add from window
end type
type dw_a_crea_sector from datawindow within w_a_crea_sector_add
end type
type cb_3 from commandbutton within w_a_crea_sector_add
end type
type st_2 from statictext within w_a_crea_sector_add
end type
type cb_2 from commandbutton within w_a_crea_sector_add
end type
type em_total from editmask within w_a_crea_sector_add
end type
type st_total from statictext within w_a_crea_sector_add
end type
type st_capa from statictext within w_a_crea_sector_add
end type
type st_sector from statictext within w_a_crea_sector_add
end type
type sle_capacidad from singlelineedit within w_a_crea_sector_add
end type
type sle_sector from singlelineedit within w_a_crea_sector_add
end type
type st_1 from statictext within w_a_crea_sector_add
end type
type sle_zona from singlelineedit within w_a_crea_sector_add
end type
type cb_1 from commandbutton within w_a_crea_sector_add
end type
type gb_1 from groupbox within w_a_crea_sector_add
end type
end forward
...
global w_a_crea_sector_add w_a_crea_sector_add
...
on w_a_crea_sector_add.destroy
...
event open;
gf_centrar(w_a_crea_sector_add)
...
integer width = 3040
integer height = 840
string dataobject = "a_crea_sector_add"
...
event clicked;close(w_a_crea_sector_add)
end event
...
string text = "Agrega Sepulturas al Sector"
...
long ll_monto, ll_total, parque, maximo
STRING area, sector
...
parque = 1
  ...
  SELECT max("PLANIMETRIA"."NRO_SISTEMA" )
    into :maximo
    FROM "PLANIMETRIA"  
...
//		END IF
		...
		dw_a_crea_sector.SetItem(fila, "nro_sistema", i+maximo)
