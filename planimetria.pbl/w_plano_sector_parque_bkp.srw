forward
global type w_plano_sector_parque_bkp from window
end type
type pb_mostrar_mapa from picturebutton within w_plano_sector_parque_bkp
end type
type ddlb_parque from dropdownlistbox within w_plano_sector_parque_bkp
end type
type pb_105 from picturebutton within w_plano_sector_parque_bkp
end type
type pb_103 from picturebutton within w_plano_sector_parque_bkp
end type
type pb_12 from picturebutton within w_plano_sector_parque_bkp
end type
type st_40 from statictext within w_plano_sector_parque_bkp
end type
type dw_1 from datawindow within w_plano_sector_parque_bkp
end type
type st_parque from statictext within w_plano_sector_parque_bkp
end type
type pb_11 from picturebutton within w_plano_sector_parque_bkp
end type
type cb_2 from commandbutton within w_plano_sector_parque_bkp
end type
type pb_10 from picturebutton within w_plano_sector_parque_bkp
end type
type shl_1 from statichyperlink within w_plano_sector_parque_bkp
end type
type st_7 from statictext within w_plano_sector_parque_bkp
end type
type pb_9 from picturebutton within w_plano_sector_parque_bkp
end type
type pb_8 from picturebutton within w_plano_sector_parque_bkp
end type
type pb_7 from picturebutton within w_plano_sector_parque_bkp
end type
type cb_1 from commandbutton within w_plano_sector_parque_bkp
end type
type st_10 from statictext within w_plano_sector_parque_bkp
end type
type pb_6 from picturebutton within w_plano_sector_parque_bkp
end type
type st_22 from statictext within w_plano_sector_parque_bkp
end type
type pb_5 from picturebutton within w_plano_sector_parque_bkp
end type
type pb_4 from picturebutton within w_plano_sector_parque_bkp
end type
type pb_3 from picturebutton within w_plano_sector_parque_bkp
end type
type pb_2 from picturebutton within w_plano_sector_parque_bkp
end type
type pb_1 from picturebutton within w_plano_sector_parque_bkp
end type
type st_2 from statictext within w_plano_sector_parque_bkp
end type
type cb_8 from commandbutton within w_plano_sector_parque_bkp
end type
type st_21 from statictext within w_plano_sector_parque_bkp
end type
type ddlb_2 from dropdownlistbox within w_plano_sector_parque_bkp
end type
type cb_4 from commandbutton within w_plano_sector_parque_bkp
end type
type ddplb_1 from dropdownpicturelistbox within w_plano_sector_parque_bkp
end type
type ddlb_1 from dropdownlistbox within w_plano_sector_parque_bkp
end type
type gb_2 from groupbox within w_plano_sector_parque_bkp
end type
type hpb_1 from hprogressbar within w_plano_sector_parque_bkp
end type
type st_1 from statictext within w_plano_sector_parque_bkp
end type
type gb_3 from groupbox within w_plano_sector_parque_bkp
end type
type gb_9 from groupbox within w_plano_sector_parque_bkp
end type
type dw_plano_sector_parque from datawindow within w_plano_sector_parque_bkp
end type
type gb_4 from groupbox within w_plano_sector_parque_bkp
end type
type gb_6 from groupbox within w_plano_sector_parque_bkp
end type
type gb_58 from groupbox within w_plano_sector_parque_bkp
end type
end forward
...
global w_plano_sector_parque_bkp w_plano_sector_parque_bkp

type variables
datawindow dw_paso_menu

long fila,ll_numero,cambio_sector
string cadena_tipo
...
public subroutine wf_pinta_asig_s_fall (datawindow dw_paso);long i,j,h,sepultura,numero,can_fall,cant_inv_asig,cant_inv_no_asig,cant_inv_t,cant_fall
		...
		for i = 1 to dw_paso.rowcount()
			for j = 1 to 80
				...
				if sepultura > 0 then
					...
					INTO :can_fall  
					FROM "FALLECIDOS"  
					WHERE ( "FALLECIDOS"."SECTOR" = :gs_sector ) AND ( "FALLECIDOS"."N_SEP" = :sepultura )   ;
		...
		for i = 1 to dw_paso.rowcount()
			for j = 1 to 80
				...
				if sepultura_nd <> '0' then
					...
					INTO :can_fall  
					FROM "FALLECIDOS"  
					WHERE ( "FALLECIDOS"."SECTOR" = :gs_sector ) AND ( "FALLECIDOS"."N_SEP" = :sepultura_nd )   ;//sub_sector
					if sqlca.sqlcode = 0 and can_fall > 0 then
...
public subroutine wf_reservadas (ref datawindow dw_paso);long i,j,h,sepultura,numero,can_fall,cant_inv_asig,&
...
public subroutine wf_sepult_indiv (datawindow dw_paso);long i,j,h,sepultura,numero,can_fall,cant_inv_asig,cant_inv_no_asig,cant_inv_t,cant_fall
string sepultura_nd,sub_sector,n_sep
		...
		for i = 1 to dw_paso.rowcount()
			for j = 1 to 80
				...
				if sepultura_nd <> '0' then
					...
					INTO 		:can_fall  
					FROM 	"FALLECIDOS"  
					WHERE ( "FALLECIDOS"."SECTOR" = :sub_sector ) AND ( "FALLECIDOS"."N_SEP" = :sepultura_nd )   ;
					if sqlca.sqlcode = 0 and can_fall > 0 then
						dw_paso.setitem(i,'compute_'+string(j)+'_1',n_sep)
						cant_fall ++
					end if
...
public subroutine wf_sin_asig_con_fall (datawindow dw_paso);long i,j,h,sepultura,numero,can_fall,cant_inv_asig,cant_inv_no_asig,cant_inv_t,cant_fall
string sepultura_nd,sub_sector,n_sep
...
public subroutine wf_pinta_sector (ref datawindow dw_paso);long i,j,h,sepultura,numero,can_fall,cant_inv_asig,&
     cant_inv_no_asig,cant_inv_t,cant_fall,folio,count_reserv
string sepultura_nd,sub_sector,n_sep
		...
		for i = 1 to dw_paso.rowcount()
			for j = 1 to 80
				...
				if sepultura > 0 then
					...
					INTO :can_fall  
					FROM "FALLECIDOS"  
					WHERE ( "FALLECIDOS"."SECTOR" = :gs_sector ) AND ( "FALLECIDOS"."N_SEP" = :sepultura_nd )   ;
					if sqlca.sqlcode = 0 and can_fall > 0 then
						dw_paso.setitem(i,'compute_'+string(j)+'_1',sepultura)
//						cant_fall ++
...
public subroutine wf_sin_asig_sin_fall (datawindow dw_paso);long i,j,h,sepultura,numero,can_fall,cant_inv_asig,cant_inv_no_asig,cant_inv_t,cant_fall,cant_reserv
string sepultura_nd,sub_sector,n_sep
...
public subroutine wf_asig_con_fall (datawindow dw_paso);long i,j,h,sepultura,numero,can_fall,cant_inv_asig,cant_inv_no_asig,cant_inv_t,cant_fall
string sepultura_nd,sub_sector,n_sep
...
on w_plano_sector_parque_bkp.create
...
on w_plano_sector_parque_bkp.destroy
...
event open;string 	sql,ls_depto,ls_descrip_parque,ls_parque
...
//end if
//**************************************************************************************************
//SELECT COD_PARQUE, DEPTO into :ll_parque,:ls_depto FROM ENCARGADOS WHERE CODIGO_USUARIO = :gs_user ;
...
SELECT 	"COD_PARQ"."CODIGO",   
			"COD_PARQ"."NOMBRE"  
FROM 		"COD_PARQ"  
WHERE 	"COD_PARQ"."GRUPO" = 1  AND "COD_PARQ"."CODIGO" <> 106
USING		sqlca;
open x3;
...
String		ls_cod_parque,ls_descrip_parque,sql,ls_depto_asig,ls_pasa='S'
...
if ls_pasa='S' then
	if id_parque=1 and id_parque = ll_parque_asig then		// El Prado
	...
	elseif id_parque=101  and id_parque = ll_parque_asig then	// Canaan
		...
		f_ddlb_all(ddlb_2,sql)
		dw_plano_sector_parque.dataobject 					= 'dw_prueba_dibujo_canaan'
		dw_plano_sector_parque.Object.p_1.Filename		= 'mapa_canaan.jpg'	//"plano_canaan.bmp"
	...
	elseif id_parque = 103 and ls_descrip_parque='SANTIAGO'  and id_parque = ll_parque_asig then	//'Santiago' 
...
integer taborder = 50
string title = "none"
string dataobject = "dw_lista_tipo_sepultura_color"
...
if row>0 then
	...
	if i = 11 then i = 0
	s_i = string(i)
	if dw_plano_sector_parque.dataobject <> 'dw_prueba_dibujo' and &
		dw_plano_sector_parque.dataobject <> 'dw_prueba_dibujo_manantial' and &
		dw_plano_sector_parque.dataobject <> 'dw_prueba_dibujo_serena' and &
		dw_plano_sector_parque.dataobject <> 'dw_prueba_dibujo_santiago' and &
		dw_plano_sector_parque.dataobject <> 'dw_prueba_dibujo_santiago2' and &
		dw_plano_sector_parque.dataobject <> 'dw_prueba_dibujo_conce' and &
		...
		if sqlca.sqlcode = 0 then
			...
			dw_plano_sector_parque.dataobject = dw_jardin
			DECLARE sp_plani_paint PROCEDURE FOR SP_PLANIMETRIA_PAINT_PP(:gs_sector,:id_parque,:s_i ) ;
			execute sp_plani_paint;
...
event clicked;st_10.visible = false
if dw_plano_sector_parque.dataobject = 'dw_prueba_dibujo' or &
   dw_plano_sector_parque.dataobject = 'dw_prueba_dibujo_serena' or &
   dw_plano_sector_parque.dataobject = 'dw_prueba_dibujo_manantial' or &
   dw_plano_sector_parque.dataobject = 'dw_prueba_dibujo_santiago2' or &
   dw_plano_sector_parque.dataobject = 'dw_prueba_dibujo_santiago' then
...
if w_plano_sector_parque.dw_plano_sector_parque.dataobject <> 'dw_prueba_dibujo' and &
	...
	w_plano_sector_parque.dw_plano_sector_parque.dataobject <> 'dw_prueba_dibujo_santiago' then 
...
if dw_plano_sector_parque.dataobject <> 'dw_prueba_dibujo'  and dw_plano_sector_parque.dataobject <> 'dw_prueba_dibujo_serena' and &
	...
	dw_plano_sector_parque.dataobject <> 'dw_prueba_dibujo_santiago2' then
	st_10.visible = false
...
integer taborder = 10
string title = "none"
string dataobject = "dw_prueba_dibujo_canaan"
boolean hscrollbar = true
boolean vscrollbar = true
...
event mousemove;long i,sepultura,numero,count_fall,numero_reserva  
...
event clicked;long i,sepultura,numero,count_fall
string columna,base,serie,sepultura_nd,sub_sector,cadena,sep,sector,area,sql
...
if dataobject <> 'dw_prueba_dibujo' and dataobject <> 'dw_prueba_dibujo_serena' and dataobject <> 'dw_prueba_dibujo_conce' and &
	...
	if isnull(object.t_8.text) or object.t_8.text = '' then
		...
		if gi_numero <=0 or isnull(gi_numero) then
			object.t_8.text	= 'Promesa No Asignada.'
		else
			object.t_8.text	= 'Revisar asignación de Sepult. ( Asig. Promesa: '+gs_base+' - '+gs_serie+' - '+string(gi_numero,'###,###,###,###,##0')+' ).'
		end if
	end if
