//objectcomments pantalla supervisores
forward
global type w_informe_supervisores from window
end type
type p_4 from picture within w_informe_supervisores
end type
type p_3 from picture within w_informe_supervisores
end type
type cb_2 from commandbutton within w_informe_supervisores
end type
type dw_1 from datawindow within w_informe_supervisores
end type
type cb_1 from commandbutton within w_informe_supervisores
end type
type pb_consultar from picturebutton within w_informe_supervisores
end type
type st_1 from statictext within w_informe_supervisores
end type
type em_fec_ini from editmask within w_informe_supervisores
end type
type em_fec_fin from editmask within w_informe_supervisores
end type
type st_2 from statictext within w_informe_supervisores
end type
type dw_2 from datawindow within w_informe_supervisores
end type
type gb_1 from groupbox within w_informe_supervisores
end type
type cb_limpiar from commandbutton within w_informe_supervisores
end type
type gb_2 from groupbox within w_informe_supervisores
end type
type cb_anual from commandbutton within w_informe_supervisores
end type
type cb_semestral from commandbutton within w_informe_supervisores
end type
type cb_mensual from commandbutton within w_informe_supervisores
end type
end forward
...
global w_informe_supervisores w_informe_supervisores

on w_informe_supervisores.create
this.p_4=create p_4
this.p_3=create p_3
...
on w_informe_supervisores.destroy
destroy(this.p_4)
destroy(this.p_3)
destroy(this.cb_2)
destroy(this.dw_1)
...
if gs_depto='I' or gs_depto='R' then	 	
			gf_centrar(w_informe_supervisores)
...
event clicked;if isvalid(w_detalle_gestiones_supervisor_2) then close(w_detalle_gestiones_supervisor_2)
Open(w_detalle_gestiones_supervisor_2)
close(w_informe_supervisores)
end event
...
event clicked;close(w_informe_supervisores)
end event
...
//ls_cod_sup = '084'
	...
	if ldt_fech_ini <= ldt_fech_fin then	
		...
		if dw_1.retrieve(ldt_fech_ini,ldt_fech_fin,ls_cod_jef,ls_cod_sup)=0 then
...
em_fec_ini.text			= string(gdt_fec_sistema,'dd/mm/yyyy')
em_fec_fin.text			= string(gdt_fec_sistema,'dd/mm/yyyy')
w_informe_supervisores.triggerevent(open!)
