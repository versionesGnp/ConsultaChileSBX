forward
global type w_detalle_gestiones_jefe_v_2 from window
end type
type cb_gps from commandbutton within w_detalle_gestiones_jefe_v_2
end type
type dw_1 from datawindow within w_detalle_gestiones_jefe_v_2
end type
type pb_consultar from picturebutton within w_detalle_gestiones_jefe_v_2
end type
type st_2 from statictext within w_detalle_gestiones_jefe_v_2
end type
type em_fec_fin from editmask within w_detalle_gestiones_jefe_v_2
end type
type em_fec_ini from editmask within w_detalle_gestiones_jefe_v_2
end type
type st_1 from statictext within w_detalle_gestiones_jefe_v_2
end type
type dw_gestion_detalle from datawindow within w_detalle_gestiones_jefe_v_2
end type
type cb_1 from commandbutton within w_detalle_gestiones_jefe_v_2
end type
type cb_2 from commandbutton within w_detalle_gestiones_jefe_v_2
end type
type p_3 from picture within w_detalle_gestiones_jefe_v_2
end type
type p_4 from picture within w_detalle_gestiones_jefe_v_2
end type
type gb_1 from groupbox within w_detalle_gestiones_jefe_v_2
end type
type gb_2 from groupbox within w_detalle_gestiones_jefe_v_2
end type
type cb_imprimir from commandbutton within w_detalle_gestiones_jefe_v_2
end type
type cb_limpiar from commandbutton within w_detalle_gestiones_jefe_v_2
end type
type cb_anual from commandbutton within w_detalle_gestiones_jefe_v_2
end type
type cb_semestral from commandbutton within w_detalle_gestiones_jefe_v_2
end type
type cb_mes from commandbutton within w_detalle_gestiones_jefe_v_2
end type
end forward
...
string title = "Efectividad Gestion Jefe Ventas"
...
global w_detalle_gestiones_jefe_v_2 w_detalle_gestiones_jefe_v_2

type variables
long il_row
end variables

on w_detalle_gestiones_jefe_v_2.create
...
on w_detalle_gestiones_jefe_v_2.destroy
destroy(this.cb_gps)
destroy(this.dw_1)
...
if gs_depto='I' or gs_depto='B' or gs_depto='X' then
		gf_centrar(w_detalle_gestiones_jefe_v_2)
	...
	close(w_detalle_gestiones_jefe_v_2)
end if	
...
event clicked;close(w_detalle_gestiones_jefe_v_2)
end event
...
w_detalle_gestiones_jefe_v_2.triggerevent(open!)
end event
