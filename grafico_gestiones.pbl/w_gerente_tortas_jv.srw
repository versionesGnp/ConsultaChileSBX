forward
global type w_gerente_tortas_jv from window
end type
type p_4 from picture within w_gerente_tortas_jv
end type
type p_3 from picture within w_gerente_tortas_jv
end type
type dw_3 from datawindow within w_gerente_tortas_jv
end type
type dw_2 from datawindow within w_gerente_tortas_jv
end type
type st_1 from statictext within w_gerente_tortas_jv
end type
type cb_4 from commandbutton within w_gerente_tortas_jv
end type
type em_fec_ini from editmask within w_gerente_tortas_jv
end type
type em_fec_fin from editmask within w_gerente_tortas_jv
end type
type st_2 from statictext within w_gerente_tortas_jv
end type
type dw_1 from datawindow within w_gerente_tortas_jv
end type
type pb_consultar from picturebutton within w_gerente_tortas_jv
end type
type cb_jefe_ven from commandbutton within w_gerente_tortas_jv
end type
type gb_1 from groupbox within w_gerente_tortas_jv
end type
type gb_2 from groupbox within w_gerente_tortas_jv
end type
type cb_anual from commandbutton within w_gerente_tortas_jv
end type
type cb_semestral from commandbutton within w_gerente_tortas_jv
end type
type cb_mes from commandbutton within w_gerente_tortas_jv
end type
type cb_limpiar from commandbutton within w_gerente_tortas_jv
end type
end forward
...
global w_gerente_tortas_jv w_gerente_tortas_jv

on w_gerente_tortas_jv.create
this.p_4=create p_4
this.p_3=create p_3
...
on w_gerente_tortas_jv.destroy
destroy(this.p_4)
destroy(this.p_3)
destroy(this.dw_3)
destroy(this.dw_2)
...
event clicked;close(w_gerente_tortas_jv)
end event
...
integer height = 92
integer taborder = 10
string dataobject = "dwe_listado_gra_jv"
boolean border = false
boolean livescroll = true
end type

event itemchanged;string ls_jefven
ls_jefven			= dw_1.getitemstring(1,'cod_jef')

if not isnull(ls_jefven) and ls_jefven = '' then
...
w_gerente_tortas_jv.triggerevent(open!)
end event
