forward
global type w_detalle_gestiones_2_bkp from window
end type
type p_4 from picture within w_detalle_gestiones_2_bkp
end type
type p_3 from picture within w_detalle_gestiones_2_bkp
end type
type cb_cta_corr from commandbutton within w_detalle_gestiones_2_bkp
end type
type cb_1 from commandbutton within w_detalle_gestiones_2_bkp
end type
type dw_gestion_detalle from datawindow within w_detalle_gestiones_2_bkp
end type
type cb_limpiar from commandbutton within w_detalle_gestiones_2_bkp
end type
type cb_mes from commandbutton within w_detalle_gestiones_2_bkp
end type
type cb_semestral from commandbutton within w_detalle_gestiones_2_bkp
end type
type cb_anual from commandbutton within w_detalle_gestiones_2_bkp
end type
type cb_imprimir from commandbutton within w_detalle_gestiones_2_bkp
end type
type st_1 from statictext within w_detalle_gestiones_2_bkp
end type
type em_fec_ini from editmask within w_detalle_gestiones_2_bkp
end type
type em_fec_fin from editmask within w_detalle_gestiones_2_bkp
end type
type st_2 from statictext within w_detalle_gestiones_2_bkp
end type
type pb_consultar from picturebutton within w_detalle_gestiones_2_bkp
end type
type dw_1 from datawindow within w_detalle_gestiones_2_bkp
end type
type gb_1 from groupbox within w_detalle_gestiones_2_bkp
end type
type gb_2 from groupbox within w_detalle_gestiones_2_bkp
end type
end forward
...
global w_detalle_gestiones_2_bkp w_detalle_gestiones_2_bkp

type variables
long il_row
end variables

on w_detalle_gestiones_2_bkp.create
this.p_4=create p_4
this.p_3=create p_3
...
on w_detalle_gestiones_2_bkp.destroy
destroy(this.p_4)
destroy(this.p_3)
