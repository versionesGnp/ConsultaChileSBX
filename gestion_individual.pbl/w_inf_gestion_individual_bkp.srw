forward
global type w_inf_gestion_individual_bkp from window
end type
type st_licencias from statictext within w_inf_gestion_individual_bkp
end type
type pb_licencias from picturebutton within w_inf_gestion_individual_bkp
end type
type st_detalle from statictext within w_inf_gestion_individual_bkp
end type
type cb_cancelar_preg from commandbutton within w_inf_gestion_individual_bkp
end type
type cb_aceptar_preg from commandbutton within w_inf_gestion_individual_bkp
end type
type rb_con_ventas from radiobutton within w_inf_gestion_individual_bkp
end type
type rb_todos from radiobutton within w_inf_gestion_individual_bkp
end type
type rb_inactivo from radiobutton within w_inf_gestion_individual_bkp
end type
type rb_activo from radiobutton within w_inf_gestion_individual_bkp
end type
type st_fondo_pregunta from statictext within w_inf_gestion_individual_bkp
end type
type st_filtrar from statictext within w_inf_gestion_individual_bkp
end type
type st_ordenar from statictext within w_inf_gestion_individual_bkp
end type
type st_agentes_general from statictext within w_inf_gestion_individual_bkp
end type
type st_exportar from statictext within w_inf_gestion_individual_bkp
end type
type st_procesar from statictext within w_inf_gestion_individual_bkp
end type
type pb_filtrar from picturebutton within w_inf_gestion_individual_bkp
end type
type dw_general from datawindow within w_inf_gestion_individual_bkp
end type
type pb_general from picturebutton within w_inf_gestion_individual_bkp
end type
type st_grupo from statictext within w_inf_gestion_individual_bkp
end type
type pb_ordenar from picturebutton within w_inf_gestion_individual_bkp
end type
type pb_exportar from picturebutton within w_inf_gestion_individual_bkp
end type
type pb_aceptar from picturebutton within w_inf_gestion_individual_bkp
end type
type pb_imprimir from picturebutton within w_inf_gestion_individual_bkp
end type
type pb_salir from picturebutton within w_inf_gestion_individual_bkp
end type
type dw_detalle from datawindow within w_inf_gestion_individual_bkp
end type
type st_nombre from statictext within w_inf_gestion_individual_bkp
end type
type pb_buscar from picturebutton within w_inf_gestion_individual_bkp
end type
type em_codigo from editmask within w_inf_gestion_individual_bkp
end type
type em_1 from editmask within w_inf_gestion_individual_bkp
end type
type p_1 from picture within w_inf_gestion_individual_bkp
end type
type em_2 from editmask within w_inf_gestion_individual_bkp
end type
type p_2 from picture within w_inf_gestion_individual_bkp
end type
type st_1 from statictext within w_inf_gestion_individual_bkp
end type
type st_2 from statictext within w_inf_gestion_individual_bkp
end type
type rb_agente from radiobutton within w_inf_gestion_individual_bkp
end type
type rb_supervisor from radiobutton within w_inf_gestion_individual_bkp
end type
type rb_jefe from radiobutton within w_inf_gestion_individual_bkp
end type
type dw_lista from datawindow within w_inf_gestion_individual_bkp
end type
type gb_2 from groupbox within w_inf_gestion_individual_bkp
end type
type gb_1 from groupbox within w_inf_gestion_individual_bkp
end type
type em_grupo from editmask within w_inf_gestion_individual_bkp
end type
type gb_3 from groupbox within w_inf_gestion_individual_bkp
end type
type st_porc from statictext within w_inf_gestion_individual_bkp
end type
type hpb_1 from hprogressbar within w_inf_gestion_individual_bkp
end type
type st_fondo from statictext within w_inf_gestion_individual_bkp
end type
type st_volver from statictext within w_inf_gestion_individual_bkp
end type
type dw_informe from datawindow within w_inf_gestion_individual_bkp
end type
type dw_sin_detalle from datawindow within w_inf_gestion_individual_bkp
end type
type st_imprimir from statictext within w_inf_gestion_individual_bkp
end type
end forward
...
global w_inf_gestion_individual_bkp w_inf_gestion_individual_bkp
...
if rb_jefe.checked = true then
	...
	adw_informe.object.titulo.text = 'Informe Gestion Cierre Venta Jefe de Venta'
...
if rb_supervisor.checked = true then
	...
	adw_informe.object.titulo.text = 'Informe Gestion Cierre Venta Supervisor'
	adw_informe.object.c_por_agente.Visible 	= 1
...
if rb_agente.checked = true then
	...
	adw_informe.object.titulo.text = 'Informe Gestion Cierre Venta Agente'
...
elseif adw_informe.dataobject = 'dw_resumen_promesas_por_jefe_ind' or &
	adw_informe.dataobject = 'dw_resumen_promesas_por_supervisor_ind' then
	if rb_jefe.checked = true then
		adw_informe.dataobject = 'dw_resumen_promesas_por_jefe_ind'
		adw_informe.settransobject(sqlca)
		adw_informe.retrieve(gd_fecha_inicio,gd_fecha_fin,trim(is_codigo),il_empresa)
		adw_informe.object.titulo.text = 'Resumen Cierre Venta de Supervisores por Jefe de Venta'
		adw_informe.object.usuario.text = gs_user
	end if
	if rb_supervisor.checked = true then
		adw_informe.dataobject = 'dw_resumen_promesas_por_supervisor_ind'
		adw_informe.settransobject(sqlca)
		adw_informe.retrieve(gd_fecha_inicio,gd_fecha_fin,trim(is_codigo),il_empresa)
		adw_informe.object.titulo.text = 'Resumen Cierre Venta de Agentes por Supervisor'
		adw_informe.object.usuario.text = gs_user
	end if
	if rb_agente.checked = true then
		adw_informe.dataobject = 'dw_informe'
...
CHOOSE CASE is_ventana
	CASE '1' //jefe
		this.title = "Informe Gestion Cierre Venta por Jefe de Venta"
	...
	CASE '2' //supervisor
		this.title = "Informe Gestion Cierre Venta por Supervisor"
	...
	CASE '3' //agente
		this.title = "Informe Gestion Cierre Venta por Agente"
		rb_jefe.checked 			= false
		rb_supervisor.checked 	= false
...
on w_inf_gestion_individual_bkp.create
...
this.Control[]={this.st_licencias,&
this.pb_licencias,&
this.st_detalle,&
...
on w_inf_gestion_individual_bkp.destroy
...
String	ls_cod_age, ls_cod_age_aux, ls_select
...
if gd_fecha_inicio <= gd_fecha_fin then
	...
	SetPointer(HourGlass!)
	if rb_agente.checked = true then
		if rb_activo.checked=true   										then dw_general.dataobject = 'dw_ofertas_periodo_general_por_agente_ac'
		if rb_inactivo.checked=true 										then dw_general.dataobject = 'dw_ofertas_periodo_general_por_agente_in'
		if rb_con_ventas.checked=true or rb_todos.checked=true 	then dw_general.dataobject = 'dw_ofertas_periodo_general_por_agente'
...
string dataobject = "dw_ofertas_periodo_general_por_agente_ac"
...
if gd_fecha_inicio <= gd_fecha_fin then
	if em_codigo.text <> '' then
		CHOOSE CASE is_ventana
			CASE '1'
				pb_general.enabled		= true
				dw_detalle.dataobject 	= 'dw_ofertas_periodo_33_buscar_jefe_ind'
				dw_detalle.settransobject(sqlca)
			CASE '2'
				pb_general.enabled		= false
				dw_detalle.dataobject 	= 'dw_ofertas_periodo_33_buscar_superv_ind'
				dw_detalle.settransobject(sqlca)
			CASE '3'
				pb_general.enabled		= true
				dw_detalle.dataobject 	= 'dw_ofertas_periodo_33_buscar_agente_ind'
				dw_detalle.settransobject(sqlca)
		END CHOOSE
...
integer width = 123
integer height = 116
string dataobject = "dw_ofertas_periodo_33_buscar_agente_ind"
boolean livescroll = true
end type
...
string	ls_nombre//, ls_sw_sp, ls_codigo, ls_nom, ls_a_paterno
if this.text <> '' then
//	ls_codigo	= trim(this.text)
//	if rb_jefe.checked = true then ls_sw_sp = '1'
//	if rb_supervisor.checked = true then ls_sw_sp = '2'
//	if rb_agente.checked = true then ls_sw_sp = '3'
//	string dept
//	dept = trim(this.text)
//	DECLARE x1 PROCEDURE FOR SP_BUSCAR_ENCARGADO(:dept);
//	execute x1;
//	FETCH x1 into :ls_a_paterno ;
	
//	st_dato_sp.text = ls_a_paterno
...
event clicked;st_detalle.visible	= false
if dw_informe.dataobject = 'dw_resumen_promesas_por_jefe_ind' or dw_informe.dataobject = 'dw_resumen_promesas_por_supervisor_ind' then
	em_grupo.visible	= false
	st_grupo.visible	= false
end if
if dw_informe.dataobject='dwe_cartera_general_por_agente' or &
	dw_informe.dataobject='dw_detalle_general_por_jefe_venta_ind' then
...
event clicked;st_detalle.visible	= false
if dw_informe.dataobject = 'dw_resumen_promesas_por_supervisor_ind' or dw_informe.dataobject = 'dw_resumen_promesas_por_jefe_ind' then
...
event clicked;if dw_informe.dataobject = 'dw_resumen_promesas_por_supervisor_ind' or dw_informe.dataobject = 'dw_resumen_promesas_por_jefe_ind' then
	em_grupo.visible		= true
	st_grupo.visible		= true
end if
if dw_informe.dataobject='dwe_cartera_general_por_agente' or &
...
if trim(this.text) <> '' then
	CHOOSE CASE dw_informe.dataobject
		CASE 'dw_resumen_promesas_por_jefe_ind'
...
if this.dataobject = 'dwe_cartera_general_por_agente' or &
	this.dataobject = 'dw_detalle_general_por_jefe_venta_ind' then
	if row > 0 then
	...
	if this.rowcount() > 0 then
			...
			CHOOSE CASE ls_columna
				...
				CASE 'c_por_agente'
					if this.object.c_por_agente.text = 'Por Supervisor' then
						pb_ordenar.visible 		= true
						dw_informe.dataobject	= 'dw_resumen_promesas_por_jefe_ind'
						dw_informe.settransobject(sqlca)
						dw_informe.retrieve(gd_fecha_inicio,gd_fecha_fin,trim(is_codigo),il_empresa)
						dw_informe.object.titulo.text	= 'Resumen Cierre Venta de Supervisores por Jefe Venta'
					...
					elseif this.object.c_por_agente.text = 'Por Agente' then
						pb_ordenar.visible 		= true
						dw_informe.dataobject	= 'dw_resumen_promesas_por_supervisor_ind'
						dw_informe.settransobject(sqlca)
						dw_informe.retrieve(gd_fecha_inicio,gd_fecha_fin,trim(is_codigo),il_empresa)
						dw_informe.object.titulo.text	= 'Resumen Cierre Venta de Agentes por Supervisor'
						ls_colx = dw_informe.describe("fec_ing_t.x")
						dw_informe.Modify("datawindow.horizontalscrollsplit=" + ls_colx)
						dw_informe.object.usuario.text = gs_user
		...
		elseif this.dataobject = 'dw_resumen_promesas_por_jefe_ind' or this.dataobject = 'dw_resumen_promesas_por_supervisor_ind' then
			CHOOSE CASE ls_columna
				CASE 'c_volver'
					pb_ordenar.visible 		= false
					wf_cargar_gestion1(dw_informe)
	...
	if this.dataobject = 'dw_resumen_promesas_por_jefe_ind' then 
		st_grupo.text		= ' Buscar Cód.Superv. '
		st_grupo.visible 	= true
		em_grupo.visible 	= true
		em_grupo.setfocus()
	end if
	if this.dataobject = 'dw_resumen_promesas_por_supervisor_ind' then
		st_grupo.text		= ' Buscar Cód.Agente '
		st_grupo.visible = true
		em_grupo.visible = true
		em_grupo.setfocus()
...
if this.dataobject = 'dwe_cartera_general_por_agente' or &
	...
	if row > 0 then
		...
		if this.dataobject = 'dwe_cartera_general_por_agente' then
			...
			if rb_activo.checked=true then
				ls_string	= ls_codigo+'~t'+ls_fec_ini+'~t'+ls_fec_fin+'~t'+'1'
			end if
			if rb_inactivo.checked=true then
				ls_string	= ls_codigo+'~t'+ls_fec_ini+'~t'+ls_fec_fin+'~t'+'2'
			end if
			if rb_con_ventas.checked=true then
				ls_string	= ls_codigo+'~t'+ls_fec_ini+'~t'+ls_fec_fin+'~t'+'3'
			end if
			if rb_todos.checked=true then
				ls_string	= ls_codigo+'~t'+ls_fec_ini+'~t'+ls_fec_fin+'~t'+'4'
			end if
			OpenWithParm(w_detalle_ventas_agente, ls_string)
		elseif this.dataobject = 'dw_detalle_general_por_jefe_venta_ind' then
