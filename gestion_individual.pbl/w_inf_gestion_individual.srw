forward
global type w_inf_gestion_individual from window
end type
type rb_aumento from radiobutton within w_inf_gestion_individual
end type
type rb_promesas from radiobutton within w_inf_gestion_individual
end type
type st_licencias from statictext within w_inf_gestion_individual
end type
type pb_licencias from picturebutton within w_inf_gestion_individual
end type
type st_detalle from statictext within w_inf_gestion_individual
end type
type cb_cancelar_preg from commandbutton within w_inf_gestion_individual
end type
type cb_aceptar_preg from commandbutton within w_inf_gestion_individual
end type
type rb_con_ventas from radiobutton within w_inf_gestion_individual
end type
type rb_todos from radiobutton within w_inf_gestion_individual
end type
type rb_inactivo from radiobutton within w_inf_gestion_individual
end type
type rb_activo from radiobutton within w_inf_gestion_individual
end type
type st_filtrar from statictext within w_inf_gestion_individual
end type
type st_ordenar from statictext within w_inf_gestion_individual
end type
type st_agentes_general from statictext within w_inf_gestion_individual
end type
type st_exportar from statictext within w_inf_gestion_individual
end type
type st_procesar from statictext within w_inf_gestion_individual
end type
type pb_filtrar from picturebutton within w_inf_gestion_individual
end type
type dw_general from datawindow within w_inf_gestion_individual
end type
type pb_general from picturebutton within w_inf_gestion_individual
end type
type st_grupo from statictext within w_inf_gestion_individual
end type
type pb_ordenar from picturebutton within w_inf_gestion_individual
end type
type pb_exportar from picturebutton within w_inf_gestion_individual
end type
type pb_aceptar from picturebutton within w_inf_gestion_individual
end type
type pb_imprimir from picturebutton within w_inf_gestion_individual
end type
type pb_salir from picturebutton within w_inf_gestion_individual
end type
type dw_detalle from datawindow within w_inf_gestion_individual
end type
type st_nombre from statictext within w_inf_gestion_individual
end type
type pb_buscar from picturebutton within w_inf_gestion_individual
end type
type em_codigo from editmask within w_inf_gestion_individual
end type
type em_1 from editmask within w_inf_gestion_individual
end type
type p_1 from picture within w_inf_gestion_individual
end type
type em_2 from editmask within w_inf_gestion_individual
end type
type p_2 from picture within w_inf_gestion_individual
end type
type st_1 from statictext within w_inf_gestion_individual
end type
type st_2 from statictext within w_inf_gestion_individual
end type
type rb_agente from radiobutton within w_inf_gestion_individual
end type
type rb_supervisor from radiobutton within w_inf_gestion_individual
end type
type rb_jefe from radiobutton within w_inf_gestion_individual
end type
type dw_lista from datawindow within w_inf_gestion_individual
end type
type gb_2 from groupbox within w_inf_gestion_individual
end type
type gb_1 from groupbox within w_inf_gestion_individual
end type
type em_grupo from editmask within w_inf_gestion_individual
end type
type gb_3 from groupbox within w_inf_gestion_individual
end type
type st_porc from statictext within w_inf_gestion_individual
end type
type hpb_1 from hprogressbar within w_inf_gestion_individual
end type
type st_fondo from statictext within w_inf_gestion_individual
end type
type st_volver from statictext within w_inf_gestion_individual
end type
type st_imprimir from statictext within w_inf_gestion_individual
end type
type st_fondo_pregunta from statictext within w_inf_gestion_individual
end type
type dw_informe from datawindow within w_inf_gestion_individual
end type
type dw_sin_detalle from datawindow within w_inf_gestion_individual
end type
type gb_4 from groupbox within w_inf_gestion_individual
end type
end forward
...
global w_inf_gestion_individual w_inf_gestion_individual

type variables
Datawindow dw_paso
Date id_fec_ini_age, id_fec_fin_age, id_fec_ini_sup
Date id_fec_fin_sup
String is_codigo_age, is_codigo_sup, is_codigo_jef
...
//	if adw_detalle.dataobject='
	if dw_detalle.dataobject = 'dw_ofertas_periodo_33_buscar_jefe_cierre' or &
		dw_detalle.dataobject = 'dw_ofertas_periodo_33_buscar_sup_cierre' or &
		dw_detalle.dataobject = 'dw_ofertas_periodo_33_buscar_age_cierre' then
	...
	elseif dw_detalle.dataobject = 'dw_aumento_periodo_33_buscar_jefe_cierre' or &
		dw_detalle.dataobject = 'dw_aumento_periodo_33_buscar_sup_cierre' or &
		dw_detalle.dataobject = 'dw_aumento_periodo_33_buscar_age_cierre' then
		is_estado_cont		= adw_detalle.getitemstring(ll_indi,'cadena_estado')
		il_cant_mora		= adw_detalle.getitemNumber(ll_indi,'funcion_mora')
		is_cod_jefe			= adw_detalle.getitemstring(ll_indi,'jefe_ventas_jefe_ventas')
...
elseif adw_informe.dataobject = 'dw_resumen_promesas_por_jefe_cierre' or &
	adw_informe.dataobject = 'dw_resumen_promesas_por_sup_cierre' then
	if rb_jefe.checked = true then
		adw_informe.dataobject = 'dw_resumen_promesas_por_jefe_cierre'
		adw_informe.settransobject(sqlca)
	...
	if rb_supervisor.checked = true then
		adw_informe.dataobject = 'dw_resumen_promesas_por_sup_cierre'
		adw_informe.settransobject(sqlca)
		adw_informe.retrieve(gd_fecha_inicio,gd_fecha_fin,trim(is_codigo),il_empresa)
...
event open;gf_centrar(w_inf_gestion_individual)
...
gs_ventana	= 'w_inf_gestion_individual'
f_valida_objeto_1()
end event

on w_inf_gestion_individual.create
...
on w_inf_gestion_individual.destroy
...
if gd_fecha_inicio <= gd_fecha_fin then
	...
	if rb_agente.checked = true then
		if rb_activo.checked=true then 
			if ls_base='O' then
				dw_general.dataobject = 'dw_oferta_periodo_gral_por_age_ac_cierre'
			elseif ls_base='A' then
				dw_general.dataobject = 'dw_aumento_periodo_gral_age_ac_cierre'
			end if
		end if
		if rb_inactivo.checked=true then 
			if ls_base='O' then
				dw_general.dataobject = 'dw_ofertas_periodo_gral_age_in_cierre'
			elseif ls_base='A' then
				dw_general.dataobject = 'dw_aumento_periodo_gral_age_in_cierre'
			end if
		end if
		if rb_con_ventas.checked=true or rb_todos.checked=true then 
			if ls_base='O' then
				dw_general.dataobject = 'dw_ofertas_periodo_gral_por_age_cierre'
			elseif ls_base='A' then
				dw_general.dataobject = 'dw_aumento_periodo_gral_por_age_cierre'
			end if
		end if
...
string dataobject = "dw_aumento_periodo_gral_por_age_cierre"
	...
	if em_codigo.text <> '' then
		CHOOSE CASE is_ventana
			CASE '1'
				if rb_promesas.checked=true then
					pb_general.enabled					= true
					dw_detalle.dataobject 				= 'dw_ofertas_periodo_33_buscar_jefe_cierre'
				else
					dw_detalle.dataobject 				= 'dw_aumento_periodo_33_buscar_jefe_cierre'
				end if
				dw_detalle.settransobject(sqlca)
			CASE '2'
				if rb_promesas.checked=true then
					pb_general.enabled					= false
					dw_detalle.dataobject 				= 'dw_ofertas_periodo_33_buscar_sup_cierre'
				else
					dw_detalle.dataobject 				= 'dw_aumento_periodo_33_buscar_sup_cierre'
				end if
				dw_detalle.settransobject(sqlca)
			CASE '3'
				if rb_promesas.checked=true then
					pb_general.enabled					= true
					dw_detalle.dataobject 				= 'dw_ofertas_periodo_33_buscar_age_cierre'
				else
					dw_detalle.dataobject 				= 'dw_aumento_periodo_33_buscar_age_cierre'
				end if
				dw_detalle.settransobject(sqlca)
		END CHOOSE
...
integer width = 123
integer height = 116
string dataobject = "dw_ofertas_periodo_33_buscar_jefe_cierre"
boolean livescroll = true
end type
...
if this.text <> '' then
	...
	next
	if ll_sw = 0 then messagebox("Error","No existe Codigo : "+em_codigo.text)
	em_grupo.text = ''
end if
end event
...
if rb_aumento.checked=true then dw_informe.object.tot_vtas_t.text	= 'Total~rAum.Cap.'
st_detalle.visible	= false
if dw_informe.dataobject = 'dw_resumen_promesas_por_jefe_cierre' or dw_informe.dataobject = 'dw_resumen_promesas_por_sup_cierre' or &
	dw_informe.dataobject = 'dw_resumen_aumento_por_jefe_cierre' or dw_informe.dataobject = 'dw_resumen_aumento_por_sup_cierre' then
	em_grupo.visible	= false
	st_grupo.visible	= false
end if
if dw_informe.dataobject='dwe_cartera_general_por_agente' or &
	dw_informe.dataobject='dw_detalle_general_por_jefe_venta_cierre' then
...
if rb_aumento.checked=true then dw_informe.object.tot_vtas_t.text	= 'Total~rAum.Cap.'
st_detalle.visible	= false
if dw_informe.dataobject = 'dw_resumen_promesas_por_sup_cierre' or dw_informe.dataobject = 'dw_resumen_promesas_por_jefe_cierre' or &
	dw_informe.dataobject = 'dw_resumen_aumento_por_sup_cierre' or dw_informe.dataobject = 'dw_resumen_aumento_por_jefe_cierre'then
...
if trim(this.text) <> '' then
	CHOOSE CASE dw_informe.dataobject
		CASE 'dw_resumen_promesas_por_jefe_cierre','dw_resumen_aumento_por_jefe_cierre'
			...
			if ll_row > 0 then
				...
				OpenWithParm(w_muestra_detalle_gestion_ind,ls_string)
			else
				messagebox("Advertencia","No existe Código")
			end if
		CASE 'dw_resumen_promesas_por_sup_cierre','dw_resumen_aumento_por_sup_cierre'
...
integer width = 3063
integer height = 1736
string dataobject = "dw_resumen_promesas_por_jefe_cierre"
boolean hscrollbar = true
boolean vscrollbar = true
...
if this.dataobject = 'dwe_cartera_general_por_agente' or &
	this.dataobject = 'dw_detalle_general_por_jefe_venta_cierre' then
	if row > 0 then
	...
	if this.rowcount() > 0 then
		if this.dataobject = 'dw_informe' then
			...
			CHOOSE CASE ls_columna
				...
				CASE 'c_por_agente'
					if this.object.c_por_agente.text = 'Por Supervisor' then
						if rb_promesas.checked=true then
							pb_ordenar.visible 		= true
							dw_informe.dataobject	= 'dw_resumen_promesas_por_jefe_cierre'
							dw_informe.settransobject(sqlca)
						...
						elseif rb_aumento.checked=true then
							pb_ordenar.visible 		= true
							dw_informe.dataobject	= 'dw_resumen_aumento_por_jefe_cierre'
							dw_informe.settransobject(sqlca)
							dw_informe.retrieve(gd_fecha_inicio,gd_fecha_fin,trim(is_codigo),il_empresa)
							dw_informe.object.titulo.text	= 'Resumen Actual de Supervisores por Jefe Venta'
							ls_colx = dw_informe.describe("fec_ing_t.x")
					...
					elseif this.object.c_por_agente.text = 'Por Agente' then
						if rb_promesas.checked=true then
							pb_ordenar.visible 		= true
							dw_informe.dataobject	= 'dw_resumen_promesas_por_sup_cierre'
							dw_informe.settransobject(sqlca)
							dw_informe.retrieve(gd_fecha_inicio,gd_fecha_fin,trim(is_codigo),il_empresa)
						...
						elseif rb_aumento.checked=true then
							pb_ordenar.visible 		= true
							dw_informe.dataobject	= 'dw_resumen_aumento_por_sup_cierre'
							dw_informe.settransobject(sqlca)
							dw_informe.retrieve(gd_fecha_inicio,gd_fecha_fin,trim(is_codigo),il_empresa)
							dw_informe.object.titulo.text	= 'Resumen Actual de Agentes por Supervisor'
							ls_colx = dw_informe.describe("fec_ing_t.x")
			...
			END CHOOSE
		elseif this.dataobject = 'dw_resumen_promesas_por_jefe_cierre' or this.dataobject = 'dw_resumen_promesas_por_sup_cierre' or &
				 this.dataobject = 'dw_resumen_aumento_por_jefe_cierre' or this.dataobject = 'dw_resumen_aumento_por_sup_cierre' then
			CHOOSE CASE ls_columna
				CASE 'c_volver'
					pb_ordenar.visible 		= false
					wf_cargar_gestion1(dw_informe)
	...
	if this.dataobject = 'dw_resumen_promesas_por_jefe_cierre' or this.dataobject = 'dw_resumen_aumento_por_jefe_cierre' then 
		st_grupo.text		= ' Buscar Cód.Superv. '
		st_grupo.visible 	= true
		em_grupo.visible 	= true
		em_grupo.setfocus()
	end if
	if this.dataobject = 'dw_resumen_promesas_por_sup_cierre' or this.dataobject = 'dw_resumen_aumento_por_sup_cierre' then
		st_grupo.text		= ' Buscar Cód.Agente '
		st_grupo.visible = true
		em_grupo.visible = true
		em_grupo.setfocus()
...
event doubleclicked;String	ls_columna, ls_cadena, ls_codigo, ls_formula, ls_fec_ini, ls_fec_fin, ls_string,&
			ls_op_base,ls_tipo_fecha='C'
Long		ll_nro_caracter, ll_valor
Int		li_new
ls_columna						= dwo.name
//'dw_resumen_promesas_por_jefe_cierre'
//'dw_resumen_promesas_por_sup_cierre'
//'dw_detalle_general_por_jefe_venta_cierre'
if this.dataobject = 'dwe_cartera_general_por_agente' or &
	this.dataobject = 'dw_detalle_general_por_jefe_venta_cierre' then
	if row > 0 then
		...
		elseif this.dataobject = 'dw_detalle_general_por_jefe_venta_cierre' then
