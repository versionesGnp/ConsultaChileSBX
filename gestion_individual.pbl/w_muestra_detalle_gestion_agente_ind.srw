forward
global type w_muestra_detalle_gestion_agente_ind from window
end type
type hpb_1 from hprogressbar within w_muestra_detalle_gestion_agente_ind
end type
type st_fondo from statictext within w_muestra_detalle_gestion_agente_ind
end type
type st_porc from statictext within w_muestra_detalle_gestion_agente_ind
end type
type dw_lista from datawindow within w_muestra_detalle_gestion_agente_ind
end type
type cb_sort from commandbutton within w_muestra_detalle_gestion_agente_ind
end type
type cb_exportar from commandbutton within w_muestra_detalle_gestion_agente_ind
end type
type cb_imprimir from commandbutton within w_muestra_detalle_gestion_agente_ind
end type
type cb_salir from commandbutton within w_muestra_detalle_gestion_agente_ind
end type
type st_salir from statictext within w_muestra_detalle_gestion_agente_ind
end type
type dw_muestra from datawindow within w_muestra_detalle_gestion_agente_ind
end type
end forward
...
global w_muestra_detalle_gestion_agente_ind w_muestra_detalle_gestion_agente_ind
...
on w_muestra_detalle_gestion_agente_ind.create
...
on w_muestra_detalle_gestion_agente_ind.destroy
destroy(this.hpb_1)
...
gf_centrar(w_muestra_detalle_gestion_agente_ind)
...
gs_ventana	= 'w_muestra_detalle_gestion_agente_ind'
f_valida_objeto_1()
end event
...
event clicked;st_salir.visible			= false
dw_muestra.dataobject	= 'dw_resumen_promesas_por_agente_ind'
dw_muestra.settransobject(sqlca)
dw_muestra.object.titulo.text = 'Informe Gestion Actual por Agente'
...
integer height = 1972
integer taborder = 10
string dataobject = "dw_resumen_promesas_por_agente"
...
if this.rowcount() > 0 then
	if this.dataobject = 'dw_resumen_promesas_por_agente_ind' then
