forward
global type w_prepago_pagare from window
end type
type cb_3 from commandbutton within w_prepago_pagare
end type
type dw_3 from datawindow within w_prepago_pagare
end type
type dw_4 from datawindow within w_prepago_pagare
end type
type dw_2 from datawindow within w_prepago_pagare
end type
type dw_1 from datawindow within w_prepago_pagare
end type
type cb_1 from commandbutton within w_prepago_pagare
end type
type gb_1 from groupbox within w_prepago_pagare
end type
end forward
...
global w_prepago_pagare w_prepago_pagare
...
event open;////PROMESA
//double 	nro,valor,valor_uf,ldb_precio,ldb_pie,ll_pie_pagado_peso,ldb_valor_cuota,&
...
//ldt_fecha_promesa				= dw_1.getitemdatetime(1,'pagare_fecha')
...
ll_ctas_pag						= dw_1.getitemnumber(1,'pagare_cta_pag_isa') + dw_1.getitemnumber(1,'pagare_cta_pag_la')
ldb_valor_cuota				= round(double(dw_1.getitemnumber(1,'pagare_valor_cuo')),4)
ldb_tasa							= (double(dw_1.getitemnumber(1,'c_tasa_prepago')) / 100)
