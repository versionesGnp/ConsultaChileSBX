forward
global type w_prepago_bkp from window
end type
type cb_pagare from commandbutton within w_prepago_bkp
end type
type cb_3 from commandbutton within w_prepago_bkp
end type
type dw_3 from datawindow within w_prepago_bkp
end type
type dw_4 from datawindow within w_prepago_bkp
end type
type dw_2 from datawindow within w_prepago_bkp
end type
type dw_1 from datawindow within w_prepago_bkp
end type
type cb_1 from commandbutton within w_prepago_bkp
end type
type gb_1 from groupbox within w_prepago_bkp
end type
end forward
...
global w_prepago_bkp w_prepago_bkp
...
event clicked;if dw_3.rowcount() > 0 then
	f_printdlg(dw_3,gstr_print,w_prepago)
else
