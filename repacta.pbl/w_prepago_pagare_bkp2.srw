forward
global type w_prepago_pagare_bkp2 from window
end type
type cb_3 from commandbutton within w_prepago_pagare_bkp2
end type
type dw_3 from datawindow within w_prepago_pagare_bkp2
end type
type dw_4 from datawindow within w_prepago_pagare_bkp2
end type
type dw_2 from datawindow within w_prepago_pagare_bkp2
end type
type dw_1 from datawindow within w_prepago_pagare_bkp2
end type
type cb_1 from commandbutton within w_prepago_pagare_bkp2
end type
type gb_1 from groupbox within w_prepago_pagare_bkp2
end type
end forward
...
global w_prepago_pagare_bkp2 w_prepago_pagare_bkp2
...
on w_prepago_pagare_bkp2.create
...
on w_prepago_pagare_bkp2.destroy
destroy(this.cb_3)
destroy(this.dw_3)
destroy(this.dw_4)
destroy(this.dw_2)
...
event open;double 	nro,valor,valor_uf,ldb_precio,ldb_pie,ll_pie_pagado_peso,ldb_valor_cuota,&
			...
			ldb_capital_total_pagado,ldb_interes_mora,ld_gasto
...
nro 					= dw_2.getitemnumber(1,'pagare_plazo')
...
ldb_precio						= double(dw_1.getitemnumber(1,'pagare_kapital'))
ldb_pie							= double(dw_1.getitemnumber(1,'pagare_pie'))
ll_pie_pagado_peso			= double(dw_1.getitemnumber(1,'pagare_pie_pagado'))
ls_moneda						= dw_1.getitemstring(1,'pagare_moneda')
ll_plazo							= dw_1.getitemnumber(1,'nro_cuotas')
ll_ctas_mora					= dw_1.getitemnumber(1,'c_cuotas_mora')
ll_ctas_pag						= dw_1.getitemnumber(1,'pagare_cta_pag_isa') + dw_1.getitemnumber(1,'pagare_cta_pag_la')
ldb_valor_cuota				= round(double(dw_1.getitemnumber(1,'pagare_valor_cuo')),4)
ldb_tasa							= (double(dw_1.getitemnumber(1,'pagare_tasa')) / 100)
ldt_fecha_pagare				= dw_1.getitemdatetime(1,'pagare_fecha')
...
ldb_capital_total_pagado	= ldb_capital_pagado// + ldb_pie_pagado
...
dw_3.setitem(1,'vp',ldb_valor_presente)
if ls_moneda='1' then //peso 
