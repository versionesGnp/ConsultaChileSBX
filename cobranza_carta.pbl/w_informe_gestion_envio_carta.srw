forward
global type w_informe_gestion_envio_carta from window
end type
type dw_parque from datawindow within w_informe_gestion_envio_carta
end type
type st_16 from statictext within w_informe_gestion_envio_carta
end type
type hpb_1 from hprogressbar within w_informe_gestion_envio_carta
end type
type st_fondo from statictext within w_informe_gestion_envio_carta
end type
type st_porc from statictext within w_informe_gestion_envio_carta
end type
type pb_1 from picturebutton within w_informe_gestion_envio_carta
end type
type sle_1 from singlelineedit within w_informe_gestion_envio_carta
end type
type st_4 from statictext within w_informe_gestion_envio_carta
end type
type sle_titulo from singlelineedit within w_informe_gestion_envio_carta
end type
type st_3 from statictext within w_informe_gestion_envio_carta
end type
type cb_imprimir from commandbutton within w_informe_gestion_envio_carta
end type
type cb_exportar from commandbutton within w_informe_gestion_envio_carta
end type
type cb_filtrar from commandbutton within w_informe_gestion_envio_carta
end type
type pb_aceptar from picturebutton within w_informe_gestion_envio_carta
end type
type p_fin from picture within w_informe_gestion_envio_carta
end type
type em_fec_fin from editmask within w_informe_gestion_envio_carta
end type
type st_2 from statictext within w_informe_gestion_envio_carta
end type
type p_ini from picture within w_informe_gestion_envio_carta
end type
type em_fec_ini from editmask within w_informe_gestion_envio_carta
end type
type st_1 from statictext within w_informe_gestion_envio_carta
end type
type cb_cerrar from commandbutton within w_informe_gestion_envio_carta
end type
type cb_ctacte from commandbutton within w_informe_gestion_envio_carta
end type
type dw_lista_detalle from datawindow within w_informe_gestion_envio_carta
end type
type dw_lista from datawindow within w_informe_gestion_envio_carta
end type
type gb_1 from groupbox within w_informe_gestion_envio_carta
end type
end forward
...
string title = "Informe Gestion Envio Carta Cobranza  ( Estado_Comi<>~'P~' and Serie<>~'R~' and Estado_Ctto=~'V~' and Mora_Cred=0)"
...
global w_informe_gestion_envio_carta w_informe_gestion_envio_carta

type variables
long	il_row
end variables

on w_informe_gestion_envio_carta.create
...
on w_informe_gestion_envio_carta.destroy
...
gf_centrar(w_informe_gestion_envio_carta)
	...
	if trim(em_fec_fin.text)='00/00/0000' or isnull(em_fec_fin.text) then
		...
		if ll_cod_parque>0 then
			if dw_lista_detalle.retrieve(ld_fec_ini,ld_fec_fin,ll_cod_parque)=0 then //gs_user,
				...
				dw_lista.reset()
				dw_lista.object.t_4.text		= 'INFORME GESTION ENVIO CARTA COBRANZA'
				sle_titulo.text					= ''
...
event clicked;close(w_informe_gestion_envio_carta)
end event
...
integer height = 500
string title = "none"
string dataobject = "dw_informe_gestion_envio_carta"
...
integer taborder = 60
string title = "none"
string dataobject = "dwe_envio_carta_cob"
boolean hscrollbar = true
boolean vscrollbar = true
