forward
global type w_reeplazar_documentos_bkp from window
end type
type cb_ctacte from commandbutton within w_reeplazar_documentos_bkp
end type
type dw_lista_original_doc_cob from datawindow within w_reeplazar_documentos_bkp
end type
type cb_grabar from commandbutton within w_reeplazar_documentos_bkp
end type
type st_eliminar from statictext within w_reeplazar_documentos_bkp
end type
type st_insertar from statictext within w_reeplazar_documentos_bkp
end type
type pb_eliminar from picturebutton within w_reeplazar_documentos_bkp
end type
type pb_insertar from picturebutton within w_reeplazar_documentos_bkp
end type
type dw_lista_modificados from datawindow within w_reeplazar_documentos_bkp
end type
type st_identificar from statictext within w_reeplazar_documentos_bkp
end type
type st_ayuda from statictext within w_reeplazar_documentos_bkp
end type
type cb_cerrar from commandbutton within w_reeplazar_documentos_bkp
end type
type dw_lista_destino from datawindow within w_reeplazar_documentos_bkp
end type
type dw_lista_original from datawindow within w_reeplazar_documentos_bkp
end type
end forward
...
global w_reeplazar_documentos_bkp w_reeplazar_documentos_bkp
...
on w_reeplazar_documentos_bkp.create
...
on w_reeplazar_documentos_bkp.destroy
...
String	ls_cod_pago,ls_estado_ch,ls_glosa_ch
