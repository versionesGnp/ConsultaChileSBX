forward
global type w_premios_calidad_cartera_sup from window
end type
type cb_politica from commandbutton within w_premios_calidad_cartera_sup
end type
type cb_detalle from commandbutton within w_premios_calidad_cartera_sup
end type
type cb_clasif_hist from commandbutton within w_premios_calidad_cartera_sup
end type
type cb_grabar from commandbutton within w_premios_calidad_cartera_sup
end type
type cb_limpiar from commandbutton within w_premios_calidad_cartera_sup
end type
type pb_aceptar from picturebutton within w_premios_calidad_cartera_sup
end type
type cb_cerrar from commandbutton within w_premios_calidad_cartera_sup
end type
type cb_imprimir from commandbutton within w_premios_calidad_cartera_sup
end type
type dw_lista from datawindow within w_premios_calidad_cartera_sup
end type
type dw_seleccion from datawindow within w_premios_calidad_cartera_sup
end type
type dw_fecha_cierre from datawindow within w_premios_calidad_cartera_sup
end type
type gb_1 from groupbox within w_premios_calidad_cartera_sup
end type
end forward
...
global w_premios_calidad_cartera_sup w_premios_calidad_cartera_sup
...
on w_premios_calidad_cartera_sup.create
...
on w_premios_calidad_cartera_sup.destroy
...
gf_centrar(w_premios_calidad_cartera_sup)
		...
		if not isnull(ldb_valor_uf) or ldb_valor_uf > 0 then
			...
			if sqlca.sqlcode = 0 then
				if not isnull(ldt_fecha_consul) then
					messagebox("Advertencia","Proceso Premio Calidad Cartera Supervisor N.F. Fue Grabado con Fecha :"+string(ldt_fecha_cierre,"dd/mm/yyyy"))
				end if
			else
...
event clicked;close(w_premios_calidad_cartera_sup)
end event
