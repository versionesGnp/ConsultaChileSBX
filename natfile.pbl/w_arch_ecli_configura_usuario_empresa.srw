...
forward
global type w_arch_ecli_configura_usuario_empresa from w_gen_document_doc
end type
type r_1 from rectangle within w_arch_ecli_configura_usuario_empresa
end type
type r_2 from rectangle within w_arch_ecli_configura_usuario_empresa
end type
end forward
...
global w_arch_ecli_configura_usuario_empresa w_arch_ecli_configura_usuario_empresa
...
on w_arch_ecli_configura_usuario_empresa.create
int iCurrent
call super::create
this.r_1=create r_1
this.r_2=create r_2
...
on w_arch_ecli_configura_usuario_empresa.destroy
call super::destroy
destroy(this.r_1)
destroy(this.r_2)
end on
...
type dw_1 from w_gen_document_doc`dw_1 within w_arch_ecli_configura_usuario_empresa
integer x = 50
integer y = 184
integer width = 1696
integer height = 1636
string dataobject = "d_arch_ecli_configura_usuario_empresa"
...
type dw_menu from w_gen_document_doc`dw_menu within w_arch_ecli_configura_usuario_empresa
...
type dw_list from w_gen_document_doc`dw_list within w_arch_ecli_configura_usuario_empresa
boolean visible = true
integer x = 1897
integer y = 184
integer width = 1696
integer height = 1636
string dataobject = "d_arch_ecli_configura_usuario_empresa_det"
boolean hscrollbar = false
boolean border = false
boolean hsplitscroll = false
end type

event dw_list::itemchanged;call super::itemchanged;Long		i, ll_sel, ll_sub
String	ls_usu, ls_emp, ls_sub, ls_xsub, ls_sel
...
ls_emp = f_Trim( dw_list.Object.c_codigo_emp[ row ] )
...
If data = '1' Then
	Insert Into genloginemp 
		( c_codigo_usu, c_codigo_emp ) 
	Values
		( :ls_usu, :ls_emp )
	Using SqlCa ;
End If

If f_SqlError( SqlCa, 'No se pudo actualizar las empresas por usuario.' ) = -1 Then
...
/*
Long		i, li_dock
String	ls_usu, ls_opc, ls_sub, ls_sel, ls_xsub
...
ls_usu = f_Trim( dw_1.Object.c_codigo_usu[ dw_1.GetRow( ) ] )
ls_sub = f_Trim( dw_list.Object.c_codigo_sub[ dw_list.GetRow( ) ] )
ls_sel = f_Trim( dw_list.Object.c_sel[ dw_list.GetRow( ) ] )

If ls_sel = '1' Then ls_sel = '0' Else ls_sel = '1'
dw_list.Object.c_sub[ dw_list.GetRow( ) ] = ls_sel
...
For i = 1 To dw_list.RowCount( )
	...
	If Not ls_sel = '1' Then Continue
	
	Insert Into genloginopc 
		( c_codigo_usu, c_codigo_opc, c_favorito_opc, n_dock_opc ) 
	Values
		( :ls_usu, :ls_opc, '0', :li_dock )
	Using SqlCa ;
	
	If f_SqlError( SqlCa, 'No se pudo actualizar las opciones del usuario (Insert).' ) = -1 Then
		RollBack Using SqlCa ;
		Return 
	End If
Next
...
//This.Object.DataWindow.Header.Height = 90
This.Object.DataWindow.Detail.Height = 160
end event
