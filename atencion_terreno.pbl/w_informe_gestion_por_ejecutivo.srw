forward
global type w_informe_gestion_por_ejecutivo from window
end type
type cb_limpiar from commandbutton within w_informe_gestion_por_ejecutivo
end type
type cb_ctacte from commandbutton within w_informe_gestion_por_ejecutivo
end type
type cb_imprimir from commandbutton within w_informe_gestion_por_ejecutivo
end type
type cb_exportar from commandbutton within w_informe_gestion_por_ejecutivo
end type
type cb_filtrar from commandbutton within w_informe_gestion_por_ejecutivo
end type
type cb_ordenar from commandbutton within w_informe_gestion_por_ejecutivo
end type
type cb_cerrar from commandbutton within w_informe_gestion_por_ejecutivo
end type
type dw_encargado from datawindow within w_informe_gestion_por_ejecutivo
end type
type st_1 from statictext within w_informe_gestion_por_ejecutivo
end type
type st_2 from statictext within w_informe_gestion_por_ejecutivo
end type
type em_final from editmask within w_informe_gestion_por_ejecutivo
end type
type p_1 from picture within w_informe_gestion_por_ejecutivo
end type
type p_2 from picture within w_informe_gestion_por_ejecutivo
end type
type em_desde from editmask within w_informe_gestion_por_ejecutivo
end type
type pb_procesar from picturebutton within w_informe_gestion_por_ejecutivo
end type
type dw_lista from datawindow within w_informe_gestion_por_ejecutivo
end type
type gb_1 from groupbox within w_informe_gestion_por_ejecutivo
end type
end forward
...
global w_informe_gestion_por_ejecutivo w_informe_gestion_por_ejecutivo

type variables
Long	il_row
end variables

on w_informe_gestion_por_ejecutivo.create
...
on w_informe_gestion_por_ejecutivo.destroy
...
event open;gf_centrar(w_informe_gestion_por_ejecutivo)
...
event clicked;close(w_informe_gestion_por_ejecutivo)
end event
