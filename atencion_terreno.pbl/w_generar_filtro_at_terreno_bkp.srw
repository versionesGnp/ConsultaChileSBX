forward
global type w_generar_filtro_at_terreno_bkp from window
end type
type st_1 from statictext within w_generar_filtro_at_terreno_bkp
end type
type em_ctto from editmask within w_generar_filtro_at_terreno_bkp
end type
type pb_buscar from picturebutton within w_generar_filtro_at_terreno_bkp
end type
type cbx_parque from checkbox within w_generar_filtro_at_terreno_bkp
end type
type cb_1 from commandbutton within w_generar_filtro_at_terreno_bkp
end type
type cb_actualizar from commandbutton within w_generar_filtro_at_terreno_bkp
end type
type cb_seleccionar from commandbutton within w_generar_filtro_at_terreno_bkp
end type
type cb_mostrar from commandbutton within w_generar_filtro_at_terreno_bkp
end type
type cb_limpiar from commandbutton within w_generar_filtro_at_terreno_bkp
end type
type st_buscar from statictext within w_generar_filtro_at_terreno_bkp
end type
type cb_grabar_formula from picturebutton within w_generar_filtro_at_terreno_bkp
end type
type pb_filtrar from picturebutton within w_generar_filtro_at_terreno_bkp
end type
type dw_filtro from datawindow within w_generar_filtro_at_terreno_bkp
end type
type cb_geo from commandbutton within w_generar_filtro_at_terreno_bkp
end type
type tab_cobranza from uo_atencion_terreno within w_generar_filtro_at_terreno_bkp
end type
type tab_cobranza from uo_atencion_terreno within w_generar_filtro_at_terreno_bkp
end type
type st_porc from statictext within w_generar_filtro_at_terreno_bkp
end type
type hpb_1 from hprogressbar within w_generar_filtro_at_terreno_bkp
end type
type st_fondo from statictext within w_generar_filtro_at_terreno_bkp
end type
type cb_ordenar from commandbutton within w_generar_filtro_at_terreno_bkp
end type
type cb_filtrar from commandbutton within w_generar_filtro_at_terreno_bkp
end type
type cb_imprimir from commandbutton within w_generar_filtro_at_terreno_bkp
end type
type cb_historico from commandbutton within w_generar_filtro_at_terreno_bkp
end type
type cb_ctacte from commandbutton within w_generar_filtro_at_terreno_bkp
end type
type cb_asignar from commandbutton within w_generar_filtro_at_terreno_bkp
end type
type pb_ok from picturebutton within w_generar_filtro_at_terreno_bkp
end type
type dw_seleccionar from datawindow within w_generar_filtro_at_terreno_bkp
end type
type cb_cerrar from commandbutton within w_generar_filtro_at_terreno_bkp
end type
type dw_lista from datawindow within w_generar_filtro_at_terreno_bkp
end type
type gb_1 from groupbox within w_generar_filtro_at_terreno_bkp
end type
type gb_2 from groupbox within w_generar_filtro_at_terreno_bkp
end type
type gb_4 from groupbox within w_generar_filtro_at_terreno_bkp
end type
end forward
...
global w_generar_filtro_at_terreno_bkp w_generar_filtro_at_terreno_bkp
...
on w_generar_filtro_at_terreno_bkp.create
...
on w_generar_filtro_at_terreno_bkp.destroy
destroy(this.st_1)
