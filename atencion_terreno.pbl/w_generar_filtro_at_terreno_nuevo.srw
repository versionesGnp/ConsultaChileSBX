forward
global type w_generar_filtro_at_terreno_nuevo from window
end type
type st_1 from statictext within w_generar_filtro_at_terreno_nuevo
end type
type em_ctto from editmask within w_generar_filtro_at_terreno_nuevo
end type
type pb_buscar from picturebutton within w_generar_filtro_at_terreno_nuevo
end type
type cbx_parque from checkbox within w_generar_filtro_at_terreno_nuevo
end type
type cb_1 from commandbutton within w_generar_filtro_at_terreno_nuevo
end type
type cb_actualizar from commandbutton within w_generar_filtro_at_terreno_nuevo
end type
type cb_seleccionar from commandbutton within w_generar_filtro_at_terreno_nuevo
end type
type cb_mostrar from commandbutton within w_generar_filtro_at_terreno_nuevo
end type
type cb_limpiar from commandbutton within w_generar_filtro_at_terreno_nuevo
end type
type st_buscar from statictext within w_generar_filtro_at_terreno_nuevo
end type
type cb_grabar_formula from picturebutton within w_generar_filtro_at_terreno_nuevo
end type
type pb_filtrar from picturebutton within w_generar_filtro_at_terreno_nuevo
end type
type dw_filtro from datawindow within w_generar_filtro_at_terreno_nuevo
end type
type cb_geo from commandbutton within w_generar_filtro_at_terreno_nuevo
end type
type tab_cobranza from uo_atencion_terreno within w_generar_filtro_at_terreno_nuevo
end type
type tab_cobranza from uo_atencion_terreno within w_generar_filtro_at_terreno_nuevo
end type
type st_porc from statictext within w_generar_filtro_at_terreno_nuevo
end type
type hpb_1 from hprogressbar within w_generar_filtro_at_terreno_nuevo
end type
type st_fondo from statictext within w_generar_filtro_at_terreno_nuevo
end type
type cb_ordenar from commandbutton within w_generar_filtro_at_terreno_nuevo
end type
type cb_filtrar from commandbutton within w_generar_filtro_at_terreno_nuevo
end type
type cb_imprimir from commandbutton within w_generar_filtro_at_terreno_nuevo
end type
type cb_historico from commandbutton within w_generar_filtro_at_terreno_nuevo
end type
type cb_ctacte from commandbutton within w_generar_filtro_at_terreno_nuevo
end type
type cb_asignar from commandbutton within w_generar_filtro_at_terreno_nuevo
end type
type pb_ok from picturebutton within w_generar_filtro_at_terreno_nuevo
end type
type dw_seleccionar from datawindow within w_generar_filtro_at_terreno_nuevo
end type
type cb_cerrar from commandbutton within w_generar_filtro_at_terreno_nuevo
end type
type dw_lista from datawindow within w_generar_filtro_at_terreno_nuevo
end type
type gb_1 from groupbox within w_generar_filtro_at_terreno_nuevo
end type
type gb_2 from groupbox within w_generar_filtro_at_terreno_nuevo
end type
type gb_4 from groupbox within w_generar_filtro_at_terreno_nuevo
end type
end forward
...
global w_generar_filtro_at_terreno_nuevo w_generar_filtro_at_terreno_nuevo
...
on w_generar_filtro_at_terreno_nuevo.create
...
on w_generar_filtro_at_terreno_nuevo.destroy
destroy(this.st_1)
...
event clicked;Long		ll_parque,ll_indi,ll_tot_reg,ll_sum_reg,ll_rut,ll_tot_porc,ll_tot_porc_aux,&
			ll_numero
String		ls_base,ls_serie,ls_usuario_asignado,ls_pasa
...
integer height = 1604
integer taborder = 70
string dataobject = "dw_lista_filtro_asigna_cartera_terr_parq"
