forward
global type w_envio_emails from window
end type
type cb_1 from commandbutton within w_envio_emails
end type
type cb_3 from commandbutton within w_envio_emails
end type
type cb_imprimir from commandbutton within w_envio_emails
end type
type cb_limpiar from commandbutton within w_envio_emails
end type
type st_cuenta from statictext within w_envio_emails
end type
type st_porc from statictext within w_envio_emails
end type
type hpb_1 from hprogressbar within w_envio_emails
end type
type dw_importar from datawindow within w_envio_emails
end type
type cb_ortografia from commandbutton within w_envio_emails
end type
type cb_cerrar from commandbutton within w_envio_emails
end type
type cb_enviar from commandbutton within w_envio_emails
end type
type cb_buscar from commandbutton within w_envio_emails
end type
type st_fondo from statictext within w_envio_emails
end type
type gb_1 from groupbox within w_envio_emails
end type
type dw_detalle from datawindow within w_envio_emails
end type
type dw_grupo from datawindow within w_envio_emails
end type
end forward
...
global w_envio_emails w_envio_emails

type variables
string named
end variables

on w_envio_emails.create
...
if sqlca.sqlcode=0 then
   ...
   USING		sqlca;
	...
	messagebox("Advertencia","Usted NO tiene Acceso para mandar E-mail")
...
event clicked;string		ls_res,ls_email_de,ls_asunto,ls_cuerpo_email,ls_email_para,ls_remit,ls_prioridad,ls_gestion,&
			...
			ls_base_adi,ls_glosa_adi,ls_serie_adi
...
time		ld_hora
Double	ll_numero,	ll_numero_adi
