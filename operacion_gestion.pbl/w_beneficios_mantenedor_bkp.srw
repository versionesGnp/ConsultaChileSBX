forward
global type w_beneficios_mantenedor_bkp from window
end type
type cb_imprimir from commandbutton within w_beneficios_mantenedor_bkp
end type
type cb_borrar_linea from commandbutton within w_beneficios_mantenedor_bkp
end type
type sle_pie from statictext within w_beneficios_mantenedor_bkp
end type
type sle_moneda from statictext within w_beneficios_mantenedor_bkp
end type
type sle_numero from statictext within w_beneficios_mantenedor_bkp
end type
type sle_serie from statictext within w_beneficios_mantenedor_bkp
end type
type sle_base from statictext within w_beneficios_mantenedor_bkp
end type
type cb_agregar from commandbutton within w_beneficios_mantenedor_bkp
end type
type dw_ingreso from datawindow within w_beneficios_mantenedor_bkp
end type
type st_pie from statictext within w_beneficios_mantenedor_bkp
end type
type st_2 from statictext within w_beneficios_mantenedor_bkp
end type
type st_1 from statictext within w_beneficios_mantenedor_bkp
end type
type cb_grabar from commandbutton within w_beneficios_mantenedor_bkp
end type
type cb_cerrar from commandbutton within w_beneficios_mantenedor_bkp
end type
type st_6 from statictext within w_beneficios_mantenedor_bkp
end type
type gb_1 from groupbox within w_beneficios_mantenedor_bkp
end type
end forward
...
global w_beneficios_mantenedor_bkp w_beneficios_mantenedor_bkp
...
on w_beneficios_mantenedor_bkp.create
...
on w_beneficios_mantenedor_bkp.destroy
...
if idw_detalle.retrieve(4,gl_cod_parque)=0 then
...
if idw_detalle2.retrieve(4)=0 then			
