forward
global type w_premios_ofertas_3 from window
end type
type hpb_1 from hprogressbar within w_premios_ofertas_3
end type
type rb_con from radiobutton within w_premios_ofertas_3
end type
type rb_sin from radiobutton within w_premios_ofertas_3
end type
type st_3 from statictext within w_premios_ofertas_3
end type
type ddlb_1 from dropdownlistbox within w_premios_ofertas_3
end type
type rb_estadistica from radiobutton within w_premios_ofertas_3
end type
type st_fecha from statictext within w_premios_ofertas_3
end type
type rb_resumen from radiobutton within w_premios_ofertas_3
end type
type rb_supervisores from radiobutton within w_premios_ofertas_3
end type
type rb_agentes from radiobutton within w_premios_ofertas_3
end type
type dw_2 from datawindow within w_premios_ofertas_3
end type
type cb_3 from commandbutton within w_premios_ofertas_3
end type
type cb_imprimir from commandbutton within w_premios_ofertas_3
end type
type dw_paso from datawindow within w_premios_ofertas_3
end type
type dw_1 from datawindow within w_premios_ofertas_3
end type
type dw_ofertas from datawindow within w_premios_ofertas_3
end type
type st_2 from statictext within w_premios_ofertas_3
end type
type st_1 from statictext within w_premios_ofertas_3
end type
type p_2 from picture within w_premios_ofertas_3
end type
type em_2 from editmask within w_premios_ofertas_3
end type
type p_1 from picture within w_premios_ofertas_3
end type
type em_1 from editmask within w_premios_ofertas_3
end type
type cb_2 from commandbutton within w_premios_ofertas_3
end type
type cb_1 from commandbutton within w_premios_ofertas_3
end type
type gb_2 from groupbox within w_premios_ofertas_3
end type
type gb_1 from groupbox within w_premios_ofertas_3
end type
type gb_3 from groupbox within w_premios_ofertas_3
end type
type gb_5 from groupbox within w_premios_ofertas_3
end type
end forward
...
global w_premios_ofertas_3 w_premios_ofertas_3
...
on w_premios_ofertas_3.destroy
destroy(this.hpb_1)
destroy(this.rb_con)
destroy(this.rb_sin)
destroy(this.st_3)
...
event clicked;close(w_premios_ofertas_3)
end event
