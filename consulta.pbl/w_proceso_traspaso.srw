forward
global type w_proceso_traspaso from window
end type
type cb_3 from commandbutton within w_proceso_traspaso
end type
type cb_6 from commandbutton within w_proceso_traspaso
end type
type cb_5 from commandbutton within w_proceso_traspaso
end type
type cb_4 from commandbutton within w_proceso_traspaso
end type
type dw_3 from datawindow within w_proceso_traspaso
end type
type dw_2 from datawindow within w_proceso_traspaso
end type
type cb_2 from commandbutton within w_proceso_traspaso
end type
type cb_1 from commandbutton within w_proceso_traspaso
end type
type dw_1 from datawindow within w_proceso_traspaso
end type
end forward
...
global w_proceso_traspaso w_proceso_traspaso
...
if dw_1.retrieve() > 0 then
	wf_sort('fecha_pago')
	dw_1.object.titulo.text = 'Rezagos de '+gs_conexion
					...
					if estado = 'V' then	
						...
						CHOOSE CASE gs_base
							...
							CASE "R"
								...
								dw_3.Retrieve(gs_serie, gi_numero)
						END CHOOSE
						if dw_3.dataobject='d_trapaso_datos_reproman_1' and dw_3.rowcount()>0 then
...
event open;gf_centrar(w_proceso_traspaso)
dw_1.settransobject (sqlca)
gs_ventana	= 'w_proceso_traspaso'
f_valida_objeto()
postevent ('proceso')
...
integer height = 760
integer taborder = 80
string dataobject = "d_trapaso_datos_reproman_1"
...
event clicked;close(w_proceso_traspaso)
end event
