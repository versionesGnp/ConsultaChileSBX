forward
global type w_cuenta_corriente_aumento_capacidad_bkp from window
end type
type cb_convenio from commandbutton within w_cuenta_corriente_aumento_capacidad_bkp
end type
type cb_est_cheque from commandbutton within w_cuenta_corriente_aumento_capacidad_bkp
end type
type cb_detalle from commandbutton within w_cuenta_corriente_aumento_capacidad_bkp
end type
type cb_cupones from commandbutton within w_cuenta_corriente_aumento_capacidad_bkp
end type
type cb_rescomi_vta from commandbutton within w_cuenta_corriente_aumento_capacidad_bkp
end type
type cb_operaciones from commandbutton within w_cuenta_corriente_aumento_capacidad_bkp
end type
type cb_agente from commandbutton within w_cuenta_corriente_aumento_capacidad_bkp
end type
type cb_5 from commandbutton within w_cuenta_corriente_aumento_capacidad_bkp
end type
type dw_agente_super from datawindow within w_cuenta_corriente_aumento_capacidad_bkp
end type
type cb_2 from commandbutton within w_cuenta_corriente_aumento_capacidad_bkp
end type
type cb_1 from commandbutton within w_cuenta_corriente_aumento_capacidad_bkp
end type
type cb_imprimir from commandbutton within w_cuenta_corriente_aumento_capacidad_bkp
end type
type dw_encabezado_cuenta_cte from datawindow within w_cuenta_corriente_aumento_capacidad_bkp
end type
type cb_cerrar from commandbutton within w_cuenta_corriente_aumento_capacidad_bkp
end type
type dw_estado_cta_cte from datawindow within w_cuenta_corriente_aumento_capacidad_bkp
end type
type dw_listado_cuenta_cte from datawindow within w_cuenta_corriente_aumento_capacidad_bkp
end type
type dw_listado_cuenta_cte_cta from datawindow within w_cuenta_corriente_aumento_capacidad_bkp
end type
type dw_cons_docu_w from datawindow within w_cuenta_corriente_aumento_capacidad_bkp
end type
end forward
...
global w_cuenta_corriente_aumento_capacidad_bkp w_cuenta_corriente_aumento_capacidad_bkp
...
on w_cuenta_corriente_aumento_capacidad_bkp.create
...
on w_cuenta_corriente_aumento_capacidad_bkp.destroy
