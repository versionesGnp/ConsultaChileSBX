forward
global type w_mensaje_cobranza_telefonica from window
end type
type dw_datos_cliente from datawindow within w_mensaje_cobranza_telefonica
end type
type mle_glosa from multilineedit within w_mensaje_cobranza_telefonica
end type
type em_fecha_cob from editmask within w_mensaje_cobranza_telefonica
end type
type em_usuario from editmask within w_mensaje_cobranza_telefonica
end type
type em_estado_cob from editmask within w_mensaje_cobranza_telefonica
end type
type st_33 from statictext within w_mensaje_cobranza_telefonica
end type
type st_55 from statictext within w_mensaje_cobranza_telefonica
end type
type st_11 from statictext within w_mensaje_cobranza_telefonica
end type
type st_22 from statictext within w_mensaje_cobranza_telefonica
end type
type st_5 from statictext within w_mensaje_cobranza_telefonica
end type
type st_4 from statictext within w_mensaje_cobranza_telefonica
end type
type st_3 from statictext within w_mensaje_cobranza_telefonica
end type
type st_2 from statictext within w_mensaje_cobranza_telefonica
end type
type st_1 from statictext within w_mensaje_cobranza_telefonica
end type
type em_1 from editmask within w_mensaje_cobranza_telefonica
end type
type cb_2 from commandbutton within w_mensaje_cobranza_telefonica
end type
type cb_1 from commandbutton within w_mensaje_cobranza_telefonica
end type
type ddlb_1 from dropdownlistbox within w_mensaje_cobranza_telefonica
end type
type mle_1 from multilineedit within w_mensaje_cobranza_telefonica
end type
type gb_1 from groupbox within w_mensaje_cobranza_telefonica
end type
type gb_2 from groupbox within w_mensaje_cobranza_telefonica
end type
type gb_11 from groupbox within w_mensaje_cobranza_telefonica
end type
end forward
...
global w_mensaje_cobranza_telefonica w_mensaje_cobranza_telefonica
...
on w_mensaje_cobranza_telefonica.create
...
on w_mensaje_cobranza_telefonica.destroy
...
event open;string 	ls_titulo,ls_base,ls_serie,ls_glosa,ls_estado_1,ls_sql,ls_estado_cob,ls_glosa_cob,&
			ls_estado_descrip,ls_usuario,ls_cod,ls_descrip
...
//else
	...
	ORDER BY 	"ESTADO_COBRANZA"."COD_ESATDO" ASC  
	Using		sqlca;
	open x1;
	DO WHILE sqlca.sqlcode=0
		if sqlca.sqlcode=0 then
			...
			if not isnull(ls_cod) then
				ls_descrip	= ls_cod+ ' - '+ls_descrip
				ddlb_1.additem(ls_descrip)
			end if
