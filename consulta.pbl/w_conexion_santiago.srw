forward
global type w_conexion_santiago from window
end type
type rb_parque_stgo from radiobutton within w_conexion_santiago
end type
type st_1 from statictext within w_conexion_santiago
end type
type mle_1 from multilineedit within w_conexion_santiago
end type
type rb_serena from radiobutton within w_conexion_santiago
end type
type rb_santiago from radiobutton within w_conexion_santiago
end type
type cb_2 from commandbutton within w_conexion_santiago
end type
type cb_1 from commandbutton within w_conexion_santiago
end type
type gb_1 from groupbox within w_conexion_santiago
end type
end forward
...
global w_conexion_santiago w_conexion_santiago
...
on w_conexion_santiago.destroy
